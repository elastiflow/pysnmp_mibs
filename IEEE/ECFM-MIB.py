# SNMP MIB module (ECFM-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/rob/MIBs/IEEE/ECFM-MIB.mib
# Produced by pysmi-1.5.11 at Fri May 23 18:12:18 2025
...
class Dot1agCfmTransmitStatus(TextualConvention, Integer32):
    status = "current"
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
...
dot1agCfmStackEntry.setIndexNames(
    (0, "ECFM-MIB", "dot1agCfmStackifIndex"),
    (0, "ECFM-MIB", "dot1agCfmStackVlanIdOrNone"),
    (0, "ECFM-MIB", "dot1agCfmStackMdLevel"),
    (0, "ECFM-MIB", "dot1agCfmStackDirection"),
)
if mibBuilder.loadTexts:
...
if mibBuilder.loadTexts:
    dot1agCfmStackVlanIdOrNone.setStatus("current")
...
if mibBuilder.loadTexts:
    dot1agCfmStackMdLevel.setStatus("current")
...
if mibBuilder.loadTexts:
    dot1agCfmStackMdIndex.setStatus("current")
...
if mibBuilder.loadTexts:
    dot1agCfmStackMaIndex.setStatus("current")
...
if mibBuilder.loadTexts:
    dot1agCfmDefaultMdTable.setStatus("current")
...
dot1agCfmDefaultMdEntry.setIndexNames(
    (0, "ECFM-MIB", "dot1agCfmDefaultMdPrimaryVid"),
)
if mibBuilder.loadTexts:
    dot1agCfmDefaultMdEntry.setStatus("current")
...
if mibBuilder.loadTexts:
    dot1agCfmDefaultMdPrimaryVid.setStatus("current")
...
if mibBuilder.loadTexts:
    dot1agCfmDefaultMdStatus.setStatus("current")
...
if mibBuilder.loadTexts:
    dot1agCfmDefaultMdLevel.setStatus("current")
...
if mibBuilder.loadTexts:
    dot1agCfmDefaultMdMhfCreation.setStatus("current")
...
if mibBuilder.loadTexts:
    dot1agCfmDefaultMdIdPermission.setStatus("current")
...
if mibBuilder.loadTexts:
    dot1agCfmVlanTable.setStatus("current")
...
dot1agCfmVlanEntry.setIndexNames(
    (0, "ECFM-MIB", "dot1agCfmVlanVid"),
)
if mibBuilder.loadTexts:
    dot1agCfmVlanEntry.setStatus("current")
...
if mibBuilder.loadTexts:
    dot1agCfmVlanVid.setStatus("current")
...
if mibBuilder.loadTexts:
    dot1agCfmVlanPrimaryVid.setStatus("current")
...
if mibBuilder.loadTexts:
    dot1agCfmVlanRowStatus.setStatus("current")
...
dot1agCfmConfigErrorListEntry = _Dot1agCfmConfigErrorListEntry_Object(
    (1, 0, 8802, 1, 1, 3, 1, 4, 1, 1)
)
dot1agCfmConfigErrorListEntry.setIndexNames(
    (0, "ECFM-MIB", "dot1agCfmConfigErrorListVid"),
    (0, "ECFM-MIB", "dot1agCfmConfigErrorListIfIndex"),
)
if mibBuilder.loadTexts:
...
dot1agCfmMaPrimaryVlanId.setMaxAccess("read-create")
if mibBuilder.loadTexts:
...
_Dot1agCfmMaNumberOfVids_Type = Unsigned32
_Dot1agCfmMaNumberOfVids_Object = MibTableColumn
dot1agCfmMaNumberOfVids = _Dot1agCfmMaNumberOfVids_Object(
    (1, 0, 8802, 1, 1, 3, 1, 6, 1, 1, 8),
    _Dot1agCfmMaNumberOfVids_Type()
)
dot1agCfmMaNumberOfVids.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    dot1agCfmMaNumberOfVids.setStatus("current")
...
dot1agCfmMaMepListEntry.setIndexNames(
    (0, "ECFM-MIB", "dot1agCfmMdIndex"),
    (0, "ECFM-MIB", "dot1agCfmMaIndex"),
    (0, "ECFM-MIB", "dot1agCfmMaMepListIdentifier"),
)
if mibBuilder.loadTexts:
...
class _Dot1agCfmMepTransmitLbmStatus_Type(Dot1agCfmTransmitStatus):
    """Custom type dot1agCfmMepTransmitLbmStatus based on Dot1agCfmTransmitStatus"""
    defaultValue = 0


_Dot1agCfmMepTransmitLbmStatus_Type.__name__ = "Dot1agCfmTransmitStatus"
_Dot1agCfmMepTransmitLbmStatus_Object = MibTableColumn
dot1agCfmMepTransmitLbmStatus = _Dot1agCfmMepTransmitLbmStatus_Object(
    (1, 0, 8802, 1, 1, 3, 1, 7, 1, 1, 26),
...
class _Dot1agCfmMepTransmitLtmStatus_Type(Dot1agCfmTransmitStatus):
    """Custom type dot1agCfmMepTransmitLtmStatus based on Dot1agCfmTransmitStatus"""
    defaultValue = 0


_Dot1agCfmMepTransmitLtmStatus_Type.__name__ = "Dot1agCfmTransmitStatus"
_Dot1agCfmMepTransmitLtmStatus_Object = MibTableColumn
dot1agCfmMepTransmitLtmStatus = _Dot1agCfmMepTransmitLtmStatus_Object(
    (1, 0, 8802, 1, 1, 3, 1, 7, 1, 1, 36),
...
dot1agCfmMepDbEntry = _Dot1agCfmMepDbEntry_Object(
    (1, 0, 8802, 1, 1, 3, 1, 7, 3, 1)
)
dot1agCfmMepDbEntry.setIndexNames(
    (0, "ECFM-MIB", "dot1agCfmMdIndex"),
    (0, "ECFM-MIB", "dot1agCfmMaIndex"),
    (0, "ECFM-MIB", "dot1agCfmMepIdentifier"),
    (0, "ECFM-MIB", "dot1agCfmMepDbRMepIdentifier"),
)
if mibBuilder.loadTexts:
...
dot1agCfmStackGroup.setObjects(
      *(("ECFM-MIB", "dot1agCfmStackMdIndex"),
        ("ECFM-MIB", "dot1agCfmStackMaIndex"),
        ("ECFM-MIB", "dot1agCfmStackMepId"),
        ("ECFM-MIB", "dot1agCfmStackMacAddress"))
)
if mibBuilder.loadTexts:
...
dot1agCfmDefaultMdGroup.setObjects(
      *(("ECFM-MIB", "dot1agCfmDefaultMdDefLevel"),
        ("ECFM-MIB", "dot1agCfmDefaultMdDefMhfCreation"),
        ("ECFM-MIB", "dot1agCfmDefaultMdDefIdPermission"),
        ("ECFM-MIB", "dot1agCfmDefaultMdStatus"),
        ("ECFM-MIB", "dot1agCfmDefaultMdLevel"),
        ("ECFM-MIB", "dot1agCfmDefaultMdMhfCreation"),
        ("ECFM-MIB", "dot1agCfmDefaultMdIdPermission"))
)
if mibBuilder.loadTexts:
    dot1agCfmDefaultMdGroup.setStatus("current")

dot1agCfmVlanIdGroup = ObjectGroup(
    (1, 0, 8802, 1, 1, 3, 2, 2, 3)
)
dot1agCfmVlanIdGroup.setObjects(
      *(("ECFM-MIB", "dot1agCfmVlanPrimaryVid"),
        ("ECFM-MIB", "dot1agCfmVlanRowStatus"))
)
if mibBuilder.loadTexts:
    dot1agCfmVlanIdGroup.setStatus("current")

dot1agCfmConfigErrorListGroup = ObjectGroup(
    (1, 0, 8802, 1, 1, 3, 2, 2, 4)
)
dot1agCfmConfigErrorListGroup.setObjects(
    ("ECFM-MIB", "dot1agCfmConfigErrorListErrorType")
)
if mibBuilder.loadTexts:
...
dot1agCfmMdGroup.setObjects(
      *(("ECFM-MIB", "dot1agCfmMdTableNextIndex"),
        ("ECFM-MIB", "dot1agCfmMdName"),
        ("ECFM-MIB", "dot1agCfmMdFormat"),
        ("ECFM-MIB", "dot1agCfmMdMdLevel"),
        ("ECFM-MIB", "dot1agCfmMdMhfCreation"),
        ("ECFM-MIB", "dot1agCfmMdMhfIdPermission"),
        ("ECFM-MIB", "dot1agCfmMdMaTableNextIndex"),
        ("ECFM-MIB", "dot1agCfmMdRowStatus"))
)
if mibBuilder.loadTexts:
...
dot1agCfmMaGroup.setObjects(
      *(("ECFM-MIB", "dot1agCfmMaName"),
        ("ECFM-MIB", "dot1agCfmMaPrimaryVlanId"),
        ("ECFM-MIB", "dot1agCfmMaFormat"),
        ("ECFM-MIB", "dot1agCfmMaMhfCreation"),
        ("ECFM-MIB", "dot1agCfmMaIdPermission"),
        ("ECFM-MIB", "dot1agCfmMaCcmInterval"),
        ("ECFM-MIB", "dot1agCfmMaRowStatus"),
        ("ECFM-MIB", "dot1agCfmMaNumberOfVids"),
        ("ECFM-MIB", "dot1agCfmMaMepListRowStatus"))
)
if mibBuilder.loadTexts:
...
dot1agCfmMepGroup.setObjects(
      *(("ECFM-MIB", "dot1agCfmMepIfIndex"),
        ("ECFM-MIB", "dot1agCfmMepDirection"),
        ("ECFM-MIB", "dot1agCfmMepPrimaryVid"),
        ("ECFM-MIB", "dot1agCfmMepActive"),
        ("ECFM-MIB", "dot1agCfmMepFngState"),
        ("ECFM-MIB", "dot1agCfmMepCciEnabled"),
        ("ECFM-MIB", "dot1agCfmMepCcmLtmPriority"),
        ("ECFM-MIB", "dot1agCfmMepMacAddress"),
        ("ECFM-MIB", "dot1agCfmMepLowPrDef"),
        ("ECFM-MIB", "dot1agCfmMepFngAlarmTime"),
        ("ECFM-MIB", "dot1agCfmMepFngResetTime"),
        ("ECFM-MIB", "dot1agCfmMepHighestPrDefect"),
        ("ECFM-MIB", "dot1agCfmMepDefects"),
        ("ECFM-MIB", "dot1agCfmMepErrorCcmLastFailure"),
        ("ECFM-MIB", "dot1agCfmMepXconCcmLastFailure"),
        ("ECFM-MIB", "dot1agCfmMepCcmSequenceErrors"),
        ("ECFM-MIB", "dot1agCfmMepCciSentCcms"),
        ("ECFM-MIB", "dot1agCfmMepNextLbmTransId"),
        ("ECFM-MIB", "dot1agCfmMepLbrIn"),
        ("ECFM-MIB", "dot1agCfmMepLbrInOutOfOrder"),
        ("ECFM-MIB", "dot1agCfmMepLbrBadMsdu"),
        ("ECFM-MIB", "dot1agCfmMepLtmNextSeqNumber"),
        ("ECFM-MIB", "dot1agCfmMepUnexpLtrIn"),
        ("ECFM-MIB", "dot1agCfmMepLbrOut"),
        ("ECFM-MIB", "dot1agCfmMepTransmitLbmStatus"),
        ("ECFM-MIB", "dot1agCfmMepTransmitLbmDestMacAddress"),
        ("ECFM-MIB", "dot1agCfmMepTransmitLbmDestMepId"),
        ("ECFM-MIB", "dot1agCfmMepTransmitLbmDestIsMepId"),
        ("ECFM-MIB", "dot1agCfmMepTransmitLbmMessages"),
        ("ECFM-MIB", "dot1agCfmMepTransmitLbmDataTlv"),
        ("ECFM-MIB", "dot1agCfmMepTransmitLbmVlanPriority"),
        ("ECFM-MIB", "dot1agCfmMepTransmitLbmVlanDropEnable"),
        ("ECFM-MIB", "dot1agCfmMepTransmitLbmResultOK"),
        ("ECFM-MIB", "dot1agCfmMepTransmitLbmSeqNumber"),
        ("ECFM-MIB", "dot1agCfmMepTransmitLtmStatus"),
        ("ECFM-MIB", "dot1agCfmMepTransmitLtmFlags"),
        ("ECFM-MIB", "dot1agCfmMepTransmitLtmTargetMacAddress"),
        ("ECFM-MIB", "dot1agCfmMepTransmitLtmTargetMepId"),
        ("ECFM-MIB", "dot1agCfmMepTransmitLtmTargetIsMepId"),
        ("ECFM-MIB", "dot1agCfmMepTransmitLtmTtl"),
        ("ECFM-MIB", "dot1agCfmMepTransmitLtmResult"),
        ("ECFM-MIB", "dot1agCfmMepTransmitLtmSeqNumber"),
        ("ECFM-MIB", "dot1agCfmMepTransmitLtmEgressIdentifier"),
        ("ECFM-MIB", "dot1agCfmMepRowStatus"),
        ("ECFM-MIB", "dot1agCfmLtrForwarded"),
        ("ECFM-MIB", "dot1agCfmLtrRelay"),
        ("ECFM-MIB", "dot1agCfmLtrChassisIdSubtype"),
        ("ECFM-MIB", "dot1agCfmLtrChassisId"),
        ("ECFM-MIB", "dot1agCfmLtrManAddress"),
        ("ECFM-MIB", "dot1agCfmLtrManAddressDomain"),
        ("ECFM-MIB", "dot1agCfmLtrIngress"),
        ("ECFM-MIB", "dot1agCfmLtrIngressMac"),
        ("ECFM-MIB", "dot1agCfmLtrIngressPortIdSubtype"),
        ("ECFM-MIB", "dot1agCfmLtrIngressPortId"),
        ("ECFM-MIB", "dot1agCfmLtrEgress"),
        ("ECFM-MIB", "dot1agCfmLtrEgressMac"),
        ("ECFM-MIB", "dot1agCfmLtrEgressPortIdSubtype"),
        ("ECFM-MIB", "dot1agCfmLtrEgressPortId"),
        ("ECFM-MIB", "dot1agCfmLtrTerminalMep"),
        ("ECFM-MIB", "dot1agCfmLtrLastEgressIdentifier"),
        ("ECFM-MIB", "dot1agCfmLtrNextEgressIdentifier"),
        ("ECFM-MIB", "dot1agCfmLtrTtl"),
        ("ECFM-MIB", "dot1agCfmLtrOrganizationSpecificTlv"))
)
if mibBuilder.loadTexts:
...
dot1agCfmMepDbGroup.setObjects(
      *(("ECFM-MIB", "dot1agCfmMepDbRMepState"),
        ("ECFM-MIB", "dot1agCfmMepDbRMepFailedOkTime"),
        ("ECFM-MIB", "dot1agCfmMepDbMacAddress"),
        ("ECFM-MIB", "dot1agCfmMepDbRdi"),
        ("ECFM-MIB", "dot1agCfmMepDbPortStatusTlv"),
        ("ECFM-MIB", "dot1agCfmMepDbInterfaceStatusTlv"),
        ("ECFM-MIB", "dot1agCfmMepDbChassisIdSubtype"),
        ("ECFM-MIB", "dot1agCfmMepDbChassisId"),
        ("ECFM-MIB", "dot1agCfmMepDbManAddressDomain"),
        ("ECFM-MIB", "dot1agCfmMepDbManAddress"))
)
if mibBuilder.loadTexts:
...
dot1agCfmCompliance.setObjects(
      *(("ECFM-MIB", "dot1agCfmStackGroup"),
        ("ECFM-MIB", "dot1agCfmDefaultMdGroup"),
        ("ECFM-MIB", "dot1agCfmConfigErrorListGroup"),
        ("ECFM-MIB", "dot1agCfmMdGroup"),
        ("ECFM-MIB", "dot1agCfmMaGroup"),
        ("ECFM-MIB", "dot1agCfmMepGroup"),
        ("ECFM-MIB", "dot1agCfmMepDbGroup"),
        ("ECFM-MIB", "dot1agCfmNotificationsGroup"),
        ("ECFM-MIB", "dot1agCfmVlanIdGroup"))
)
if mibBuilder.loadTexts:
...
mibBuilder.exportSymbols(
    ...
    **{"Dot1agCfmMaintDomainNameType": Dot1agCfmMaintDomainNameType,
       ...
       "Dot1agCfmTransmitStatus": Dot1agCfmTransmitStatus,
