...
# Notes
# -----
# ASN.1 source file:///Users/rob/MIBs/IEEE/IEEE8021-PSFP-MIB.mib
...
_Ieee8021PSFPSupportedCycleMaxNumerator_Type = Unsigned32
_Ieee8021PSFPSupportedCycleMaxNumerator_Object = MibTableColumn
ieee8021PSFPSupportedCycleMaxNumerator = _Ieee8021PSFPSupportedCycleMaxNumerator_Object(
    (1, 3, 111, 2, 802, 1, 1, 31, 1, 4, 1, 1, 5),
    _Ieee8021PSFPSupportedCycleMaxNumerator_Type()
)
ieee8021PSFPSupportedCycleMaxNumerator.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    ieee8021PSFPSupportedCycleMaxNumerator.setStatus("current")
_Ieee8021PSFPSupportedCycleMaxDenominator_Type = Unsigned32
_Ieee8021PSFPSupportedCycleMaxDenominator_Object = MibTableColumn
ieee8021PSFPSupportedCycleMaxDenominator = _Ieee8021PSFPSupportedCycleMaxDenominator_Object(
    (1, 3, 111, 2, 802, 1, 1, 31, 1, 4, 1, 1, 6),
    _Ieee8021PSFPSupportedCycleMaxDenominator_Type()
)
ieee8021PSFPSupportedCycleMaxDenominator.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    ieee8021PSFPSupportedCycleMaxDenominator.setStatus("current")
_Ieee8021PSFPSupportedIntervalMax_Type = Unsigned32
_Ieee8021PSFPSupportedIntervalMax_Object = MibTableColumn
ieee8021PSFPSupportedIntervalMax = _Ieee8021PSFPSupportedIntervalMax_Object(
    (1, 3, 111, 2, 802, 1, 1, 31, 1, 4, 1, 1, 7),
    _Ieee8021PSFPSupportedIntervalMax_Type()
)
ieee8021PSFPSupportedIntervalMax.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    ieee8021PSFPSupportedIntervalMax.setStatus("current")
...
ieee8021PSFPObjectsGroup.setObjects(
      *(("IEEE8021-PSFP-MIB", "ieee8021PSFPStreamHandleSpec"),
        ...
        ("IEEE8021-PSFP-MIB", "ieee8021PSFPSupportedCycleMaxNumerator"),
        ("IEEE8021-PSFP-MIB", "ieee8021PSFPSupportedCycleMaxDenominator"),
        ("IEEE8021-PSFP-MIB", "ieee8021PSFPSupportedIntervalMax"))
)
if mibBuilder.loadTexts:
...
mibBuilder.exportSymbols(
    ...
    **{"ieee8021PSFPMib": ieee8021PSFPMib,
       ...
       "ieee8021PSFPSupportedCycleMaxNumerator": ieee8021PSFPSupportedCycleMaxNumerator,
       "ieee8021PSFPSupportedCycleMaxDenominator": ieee8021PSFPSupportedCycleMaxDenominator,
       "ieee8021PSFPSupportedIntervalMax": ieee8021PSFPSupportedIntervalMax,
