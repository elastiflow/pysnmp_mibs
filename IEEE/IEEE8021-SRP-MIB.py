...
# Notes
# -----
# ASN.1 source file:///Users/rob/MIBs/IEEE/IEEE8021-SRP-MIB.mib
...
class _Ieee8021SrpStreamDataFramePriority_Type(Integer32):
    """Custom type ieee8021SrpStreamDataFramePriority based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_Ieee8021SrpStreamDataFramePriority_Type.__name__ = "Integer32"
...
class _Ieee8021SrpStreamPreloadDataFramePriority_Type(Integer32):
    """Custom type ieee8021SrpStreamPreloadDataFramePriority based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 7),
    )
...
_Ieee8021SrpStreamPreloadDataFramePriority_Type.__name__ = "Integer32"
...
ieee8021SrpReservationPreloadDirection.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
