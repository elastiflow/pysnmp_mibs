...
# Notes
# -----
# ASN.1 source file:///Users/rob/MIBs/IEEE/IEEE8021-ST-MIB.mib
...
_Ieee8021STSupportedCycleMaxNumerator_Type = Unsigned32
_Ieee8021STSupportedCycleMaxNumerator_Object = MibTableColumn
ieee8021STSupportedCycleMaxNumerator = _Ieee8021STSupportedCycleMaxNumerator_Object(
    (1, 3, 111, 2, 802, 1, 1, 30, 1, 2, 1, 1, 23),
    _Ieee8021STSupportedCycleMaxNumerator_Type()
)
ieee8021STSupportedCycleMaxNumerator.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    ieee8021STSupportedCycleMaxNumerator.setStatus("current")
_Ieee8021STSupportedCycleMaxDenominator_Type = Unsigned32
_Ieee8021STSupportedCycleMaxDenominator_Object = MibTableColumn
ieee8021STSupportedCycleMaxDenominator = _Ieee8021STSupportedCycleMaxDenominator_Object(
    (1, 3, 111, 2, 802, 1, 1, 30, 1, 2, 1, 1, 24),
    _Ieee8021STSupportedCycleMaxDenominator_Type()
)
ieee8021STSupportedCycleMaxDenominator.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    ieee8021STSupportedCycleMaxDenominator.setStatus("current")
_Ieee8021STSupportedIntervalMax_Type = Unsigned32
_Ieee8021STSupportedIntervalMax_Object = MibTableColumn
ieee8021STSupportedIntervalMax = _Ieee8021STSupportedIntervalMax_Object(
    (1, 3, 111, 2, 802, 1, 1, 30, 1, 2, 1, 1, 25),
    _Ieee8021STSupportedIntervalMax_Type()
)
ieee8021STSupportedIntervalMax.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    ieee8021STSupportedIntervalMax.setStatus("current")
...
ieee8021STObjectsGroup.setObjects(
      *(("IEEE8021-ST-MIB", "ieee8021STMaxSDU"),
        ...
        ("IEEE8021-ST-MIB", "ieee8021STSupportedCycleMaxNumerator"),
        ("IEEE8021-ST-MIB", "ieee8021STSupportedCycleMaxDenominator"),
        ("IEEE8021-ST-MIB", "ieee8021STSupportedIntervalMax"))
)
if mibBuilder.loadTexts:
...
mibBuilder.exportSymbols(
    ...
    **{"IEEE8021STTrafficClassValue": IEEE8021STTrafficClassValue,
       ...
       "ieee8021STSupportedCycleMaxNumerator": ieee8021STSupportedCycleMaxNumerator,
       "ieee8021STSupportedCycleMaxDenominator": ieee8021STSupportedCycleMaxDenominator,
