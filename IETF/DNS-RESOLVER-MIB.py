...
# Notes
# -----
# ASN.1 source file:///Users/rob/MIBs/Standards/IETF/DNS-RESOLVER-MIB.mib
...
dnsResLameDelegationGroup.setObjects(
      *(("DNS-RESOLVER-MIB", "dnsResLameDelegationOverflows"),
        ("DNS-RESOLVER-MIB", "dnsResLameDelegationSource"),
        ("DNS-RESOLVER-MIB", "dnsResLameDelegationName"),
        ("DNS-RESOLVER-MIB", "dnsResLameDelegationClass"),
...
dnsResCacheGroup.setObjects(
      *(("DNS-RESOLVER-MIB", "dnsResCacheStatus"),
        ...
        ("DNS-RESOLVER-MIB", "dnsResCacheRRName"),
        ("DNS-RESOLVER-MIB", "dnsResCacheRRClass"),
        ("DNS-RESOLVER-MIB", "dnsResCacheRRType"),
        ...
        ("DNS-RESOLVER-MIB", "dnsResCacheRRIndex"),
...
dnsResNCacheGroup.setObjects(
      *(("DNS-RESOLVER-MIB", "dnsResNCacheStatus"),
        ...
        ("DNS-RESOLVER-MIB", "dnsResNCacheErrQName"),
        ("DNS-RESOLVER-MIB", "dnsResNCacheErrQClass"),
        ("DNS-RESOLVER-MIB", "dnsResNCacheErrQType"),
...
dnsResMIBCompliance.setObjects(
      *(("DNS-RESOLVER-MIB", "dnsResConfigGroup"),
        ("DNS-RESOLVER-MIB", "dnsResCounterGroup"),
        ("DNS-RESOLVER-MIB", "dnsResCacheGroup"),
        ("DNS-RESOLVER-MIB", "dnsResNCacheGroup"),
        ("DNS-RESOLVER-MIB", "dnsResLameDelegationGroup"),
        ("DNS-RESOLVER-MIB", "dnsResOptCounterGroup"))
)
if mibBuilder.loadTexts:
