...
# Notes
# -----
# ASN.1 source file:///Users/rob/MIBs/Standards/IETF/DNS-SERVER-MIB.mib
...
dnsServMIBCompliance.setObjects(
      *(("DNS-SERVER-MIB", "dnsServConfigGroup"),
        ("DNS-SERVER-MIB", "dnsServCounterGroup"),
        ("DNS-SERVER-MIB", "dnsServOptCounterGroup"),
        ("DNS-SERVER-MIB", "dnsServZoneGroup"))
)
if mibBuilder.loadTexts:
