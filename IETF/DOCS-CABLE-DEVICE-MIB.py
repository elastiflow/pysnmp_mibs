...
# Notes
# -----
# ASN.1 source file:///Users/rob/MIBs/Standards/IETF/DOCS-CABLE-DEVICE-MIB.mib
# Produced by pysmi-1.5.11 at Wed May 21 14:30:42 2025
...
_DocsDevNmAccessIp_Type.__name__ = "IpAddress"
...
_DocsDevNmAccessIpMask_Type.__name__ = "IpAddress"
...
_DocsDevEvThrottleThreshold_Type.__name__ = "Unsigned32"
...
_DocsDevEvSyslogAddressType_Type.__name__ = "InetAddressType"
...
_DocsDevFilterIpBroadcast_Type.__name__ = "TruthValue"
...
_DocsDevFilterIpSaddr_Type.__name__ = "IpAddress"
...
_DocsDevFilterIpSmask_Type.__name__ = "IpAddress"
...
_DocsDevFilterIpDaddr_Type.__name__ = "IpAddress"
...
_DocsDevFilterIpDmask_Type.__name__ = "IpAddress"
...
_DocsDevFilterIpContinue_Type.__name__ = "TruthValue"
...
_DocsDevFilterPolicyPtr_Type.__name__ = "RowPointer"
...
docsDevBasicCompliance.setObjects(
      *(("DOCS-CABLE-DEVICE-MIB", "docsDevBaseGroup"),
        ("DOCS-CABLE-DEVICE-MIB", "docsDevEventGroup"),
        ("DOCS-CABLE-DEVICE-MIB", "docsDevFilterGroup"),
        ("DOCS-CABLE-DEVICE-MIB", "docsDevNmAccessGroup"),
        ("DOCS-CABLE-DEVICE-MIB", "docsDevServerGroup"),
        ("DOCS-CABLE-DEVICE-MIB", "docsDevSoftwareGroup"),
        ("DOCS-CABLE-DEVICE-MIB", "docsDevCpeGroup"))
)
if mibBuilder.loadTexts:
...
docsDevCmCompliance.setObjects(
      *(("DIFFSERV-MIB", "diffServMIBDataPathGroup"),
        ...
        ("DOCS-CABLE-DEVICE-MIB", "docsDevBaseGroup"),
        ("DOCS-CABLE-DEVICE-MIB", "docsDevBaseIgmpGroup"),
        ("DOCS-CABLE-DEVICE-MIB", "docsDevBaseMaxCpeGroup"),
        ...
        ("DOCS-CABLE-DEVICE-MIB", "docsDevInetCpeGroup"))
)
if mibBuilder.loadTexts:
...
docsDevCmtsCompliance.setObjects(
      *(("DOCS-CABLE-DEVICE-MIB", "docsDevBaseGroup"),
        ("DOCS-CABLE-DEVICE-MIB", "docsDevBaseIgmpGroup"),
        ("DOCS-CABLE-DEVICE-MIB", "docsDevBaseMaxCpeGroup"),
        ("DOCS-CABLE-DEVICE-MIB", "docsDevSoftwareGroupV2"),
