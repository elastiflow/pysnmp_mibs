...
# Notes
# -----
# ASN.1 source file:///Users/rob/MIBs/Standards/IETF/DOCS-IETF-CABLE-DEVICE-NOTIFICATION-MIB.mib
...
docsDevCmNotifCompliance.setObjects(
      *(("DOCS-IETF-CABLE-DEVICE-NOTIFICATION-MIB", "docsDevCmNotifControlGroup"),
        ("DOCS-IETF-CABLE-DEVICE-NOTIFICATION-MIB", "docsDevCmNotificationGroup"))
)
if mibBuilder.loadTexts:
...
docsDevCmtsNotifCompliance.setObjects(
      *(("DOCS-IETF-CABLE-DEVICE-NOTIFICATION-MIB", "docsDevCmtsNotifControlGroup"),
        ("DOCS-IETF-CABLE-DEVICE-NOTIFICATION-MIB", "docsDevCmtsNotificationGroup"))
)
if mibBuilder.loadTexts:
