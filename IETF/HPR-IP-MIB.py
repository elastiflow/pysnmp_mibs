...
# Notes
# -----
# ASN.1 source file:///Users/rob/MIBs/Standards/IETF/HPR-IP-MIB.mib
...
hprIpCompliance.setObjects(
      *(("HPR-IP-MIB", "hprIpMonitoringGroup"),
        ("HPR-IP-MIB", "hprIpConfigurationGroup"))
)
if mibBuilder.loadTexts:
