...
# Notes
# -----
# ASN.1 source file:///Users/rob/MIBs/Standards/IETF/IPSEC-SPD-MIB.mib
...
_SpdEndGroupStorageType_Type.__name__ = "StorageType"
...
_SpdGroupContFilter_Type = VariablePointer
...
_SpdGroupContStorageType_Type.__name__ = "StorageType"
...
class _SpdRuleDefDescription_Type(SnmpAdminString):
    """Custom type spdRuleDefDescription based on SnmpAdminString"""
    defaultValue = OctetString("")


_SpdRuleDefDescription_Type.__name__ = "SnmpAdminString"
...
_SpdRuleDefFilterNegated_Type.__name__ = "TruthValue"
...
_SpdRuleDefAdminStatus_Type.__name__ = "SpdAdminStatus"
...
_SpdRuleDefStorageType_Type.__name__ = "StorageType"
...
class _SpdCompFiltDescription_Type(SnmpAdminString):
    """Custom type spdCompFiltDescription based on SnmpAdminString"""
    defaultValue = OctetString("")


_SpdCompFiltDescription_Type.__name__ = "SnmpAdminString"
...
_SpdCompFiltLogicType_Type.__name__ = "SpdBooleanOperator"
...
_SpdCompFiltStorageType_Type.__name__ = "StorageType"
...
_SpdSubFiltSubfilterIsNegated_Type.__name__ = "TruthValue"
...
_SpdSubFiltStorageType_Type.__name__ = "StorageType"
...
_SpdIpOffFiltStorageType_Type.__name__ = "StorageType"
...
_SpdTimeFiltPeriod_Type.__name__ = "SpdTimePeriod"
...
_SpdTimeFiltTimeOfDayMask_Type.__name__ = "SpdTimePeriod"
...
_SpdTimeFiltStorageType_Type.__name__ = "StorageType"
...
_SpdIpsoHeadFiltStorageType_Type.__name__ = "StorageType"
...
_SpdCompActStorageType_Type.__name__ = "StorageType"
...
_SpdSubActStorageType_Type.__name__ = "StorageType"
...
spdRuleFilterFullCompliance.setObjects(
      *(("IPSEC-SPD-MIB", "spdEndpointGroup"),
        ("IPSEC-SPD-MIB", "spdGroupContentsGroup"),
        ("IPSEC-SPD-MIB", "spdRuleDefinitionGroup"),
        ("IPSEC-SPD-MIB", "spdStaticFilterGroup"),
        ("IPSEC-SPD-MIB", "spdStaticActionGroup"),
        ("IPSEC-SPD-MIB", "diffServMIBMultiFieldClfrGroup"),
        ("IPSEC-SPD-MIB", "spdIpsecSystemPolicyNameGroup"),
        ("IPSEC-SPD-MIB", "spdCompoundFilterGroup"),
        ("IPSEC-SPD-MIB", "spdIPOffsetFilterGroup"),
        ("IPSEC-SPD-MIB", "spdTimeFilterGroup"),
        ("IPSEC-SPD-MIB", "spdIpsoHeaderFilterGroup"),
        ("IPSEC-SPD-MIB", "spdCompoundActionGroup"))
)
if mibBuilder.loadTexts:
...
spdLoggingCompliance.setObjects(
      *(("IPSEC-SPD-MIB", "spdActionLoggingObjectGroup"),
        ("IPSEC-SPD-MIB", "spdActionNotificationGroup"))
)
if mibBuilder.loadTexts:
...
spdRuleFilterReadOnlyCompliance.setObjects(
      *(("IPSEC-SPD-MIB", "spdEndpointGroup"),
        ("IPSEC-SPD-MIB", "spdGroupContentsGroup"),
        ("IPSEC-SPD-MIB", "spdRuleDefinitionGroup"),
        ("IPSEC-SPD-MIB", "spdStaticFilterGroup"),
