...
# Notes
# -----
# ASN.1 source file:///Users/rob/MIBs/Standards/IETF/MIP-MIB.mib
...
mipSecNotifcationsGroup = NotificationGroup(
    (1, 3, 6, 1, 2, 1, 44, 3, 1, 13)
)
mipSecNotifcationsGroup.setObjects(
    ("MIP-MIB", "mipAuthFailure")
)
if mibBuilder.loadTexts:
    mipSecNotifcationsGroup.setStatus(
        "current"
    )
...
mibBuilder.exportSymbols(
    ...
    **{"RegistrationFlags": RegistrationFlags,
       ...
       "mipSecNotifcationsGroup": mipSecNotifcationsGroup,
