...
# Notes
# -----
# ASN.1 source file:///Users/rob/MIBs/Standards/IETF/MPLS-TE-EXT-STD-MIB.mib
...
_MplsTunnelExtNodeConfigIccValid_Type.__name__ = "TruthValue"
...
_MplsTunnelExtNodeConfigStorageType_Type.__name__ = "StorageType"
...
_MplsTunnelExtOppositeDirTnlValid_Type.__name__ = "TruthValue"
...
_MplsTunnelExtDestTnlValid_Type.__name__ = "TruthValue"
...
_MplsTunnelExtIngressLSRLocalIdValid_Type.__name__ = "TruthValue"
...
_MplsTunnelExtEgressLSRLocalIdValid_Type.__name__ = "TruthValue"
...
mplsTeExtModuleFullCompliance.setObjects(
      *(("MPLS-TE-EXT-STD-MIB", "mplsTunnelExtGroup"),
        ("MPLS-TE-EXT-STD-MIB", "mplsTunnelExtIpOperatorGroup"),
        ("MPLS-TE-EXT-STD-MIB", "mplsTunnelExtIccOperatorGroup"))
)
if mibBuilder.loadTexts:
...
mplsTeExtModuleReadOnlyCompliance.setObjects(
      *(("MPLS-TE-EXT-STD-MIB", "mplsTunnelExtGroup"),
        ("MPLS-TE-EXT-STD-MIB", "mplsTunnelExtIpOperatorGroup"),
        ("MPLS-TE-EXT-STD-MIB", "mplsTunnelExtIccOperatorGroup"))
)
