# SNMP MIB module (RFC1158-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/rob/MIBs/Standards/IETF/RFC1158-MIB.mib
# Produced by pysmi-1.5.11 at Wed May 21 13:13:54 2025
...
atEntry.setIndexNames(
    (0, "RFC1158-MIB", "atIfIndex"),
    (0, "RFC1158-MIB", "atNetAddress"),
)
if mibBuilder.loadTexts:
...
ipNetToMediaEntry.setIndexNames(
    (0, "RFC1158-MIB", "ipNetToMediaIfIndex"),
    (0, "RFC1158-MIB", "ipNetToMediaNetAddress"),
)
if mibBuilder.loadTexts:
...
tcpConnEntry.setIndexNames(
    (0, "RFC1158-MIB", "tcpConnLocalAddress"),
    (0, "RFC1158-MIB", "tcpConnLocalPort"),
    (0, "RFC1158-MIB", "tcpConnRemAddress"),
    (0, "RFC1158-MIB", "tcpConnRemPort"),
)
if mibBuilder.loadTexts:
...
udpEntry.setIndexNames(
    (0, "RFC1158-MIB", "udpLocalAddress"),
    (0, "RFC1158-MIB", "udpLocalPort"),
)
if mibBuilder.loadTexts:
