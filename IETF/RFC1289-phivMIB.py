# SNMP MIB module (RFC1289-phivMIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/rob/MIBs/Standards/IETF/RFC1289-phivMIB.mib
# Produced by pysmi-1.5.11 at Wed May 21 14:58:39 2025
...
phivEndRemoteEntry.setIndexNames(
    (0, "RFC1289-phivMIB", "phivEndRemoteHostNodeID"),
)
if mibBuilder.loadTexts:
...
_PhivEndCircuitIndex_Type = Integer32
...
phivEndCountEntry.setIndexNames(
    (0, "RFC1289-phivMIB", "phivEndCountHostNodeID"),
)
if mibBuilder.loadTexts:
...
_PhivEndCountUsrBytesRec_Type = PhivCounter
...
_PhivEndCountUsrBytesSent_Type = PhivCounter
...
_PhivEndUCountUsrMessRec_Type = PhivCounter
...
_PhivEndCountUsrMessSent_Type = PhivCounter
...
_PhivEndCountTotalBytesRec_Type = PhivCounter
...
_PhivEndCountTotalBytesSent_Type = PhivCounter
...
_PhivEndCountTotalMessRec_Type = PhivCounter
...
_PhivEndCountTotalMessSent_Type = PhivCounter
...
_PhivRouteSegBuffSize_Type = Integer32
...
if mibBuilder.loadTexts:
    phivRouteType.setStatus("mandatory")
...
phivLevel1RouteEntry.setIndexNames(
    (0, "RFC1289-phivMIB", "phivLevel1RouteNodeAddr"),
)
if mibBuilder.loadTexts:
...
_PhivLevel1RouteCircuitIndex_Type = Integer32
...
if mibBuilder.loadTexts:
    phivRouteSystemAddr.setStatus("mandatory")
...
phivCircuitParametersEntry.setIndexNames(
    (0, "RFC1289-phivMIB", "phivCircuitIndex"),
)
if mibBuilder.loadTexts:
...
_PhivCircuitCountTermCongLoss_Type = PhivCounter
...
_PhivCircuitCountDataBlocksRecd_Type = PhivCounter
...
phivDDCMPCircuitParametersEntry.setIndexNames(
    (0, "RFC1289-phivMIB", "phivDDCMPCircuitIndex"),
)
if mibBuilder.loadTexts:
    phivDDCMPCircuitParametersEntry.setStatus("mandatory")
_PhivDDCMPCircuitIndex_Type = Integer32
...
phivDDCMPLineCountEntry.setIndexNames(
    (0, "RFC1289-phivMIB", "phivDDCMPLineCountIndex"),
)
if mibBuilder.loadTexts:
    phivDDCMPLineCountEntry.setStatus("mandatory")
_PhivDDCMPLineCountIndex_Type = Integer32
...
phivControlParametersEntry.setIndexNames(
    (0, "RFC1289-phivMIB", "phivControlCircuitIndex"),
)
if mibBuilder.loadTexts:
    phivControlParametersEntry.setStatus("mandatory")
_PhivControlCircuitIndex_Type = Integer32
...
phivEthLinkParametersEntry.setIndexNames(
    (0, "RFC1289-phivMIB", "phivEthLinkIndex"),
)
if mibBuilder.loadTexts:
    phivEthLinkParametersEntry.setStatus("mandatory")
_PhivEthLinkIndex_Type = Integer32
...
phivCountersCountEntry.setIndexNames(
    (0, "RFC1289-phivMIB", "phivCountersIndex"),
)
if mibBuilder.loadTexts:
    phivCountersCountEntry.setStatus("mandatory")
_PhivCountersIndex_Type = Integer32
...
_PhivCountersCountBytesRecd_Type = PhivCounter
...
_PhivCountersCountBytesSent_Type = PhivCounter
...
_PhivCountersCountDataBlocksRecd_Type = PhivCounter
...
if mibBuilder.loadTexts:
    phivCountersCountDataBlocksRecd.setStatus("mandatory")
_PhivCountersCountDataBlocksSent_Type = PhivCounter
...
if mibBuilder.loadTexts:
    phivCountersCountDataBlocksSent.setStatus("mandatory")
...
_PhivCountersCountMcastBytesRecd_Type = PhivCounter
...
_PhivCountersCountDataBlksRecd_Type = PhivCounter
...
_PhivCountersCountDataBlksSent_Type = PhivCounter
...
_PhivCountersCountMcastBlksRecd_Type = PhivCounter
...
_PhivCountersCountBlksSentDef_Type = PhivCounter
...
_PhivCountersCountBlksSentSingleCol_Type = PhivCounter
...
_PhivCountersCountBlksSentMultCol_Type = PhivCounter
...
if mibBuilder.loadTexts:
    phivAdjCircuitIndex.setStatus("mandatory")
...
if mibBuilder.loadTexts:
    phivAdjNodeAddr.setStatus("mandatory")
...
if mibBuilder.loadTexts:
    phivAdjBlockSize.setStatus("mandatory")
...
if mibBuilder.loadTexts:
    phivAdjListenTimer.setStatus("mandatory")
...
if mibBuilder.loadTexts:
    phivAdjCircuitEtherServPhysAddr.setStatus("mandatory")
...
if mibBuilder.loadTexts:
    phivAdjType.setStatus("mandatory")
...
if mibBuilder.loadTexts:
    phivAdjState.setStatus("mandatory")
...
if mibBuilder.loadTexts:
    phivAdjPriority.setStatus("mandatory")
...
if mibBuilder.loadTexts:
    phivAdjExecListenTimer.setStatus("mandatory")
...
phivLineEntry.setIndexNames(
    (0, "RFC1289-phivMIB", "phivLineIndex"),
)
if mibBuilder.loadTexts:
    phivLineEntry.setStatus("mandatory")
_PhivLineIndex_Type = Integer32
...
phivNonBroadcastEntry.setIndexNames(
    (0, "RFC1289-phivMIB", "phivNonBroadcastIndex"),
)
if mibBuilder.loadTexts:
    phivNonBroadcastEntry.setStatus("mandatory")
_PhivNonBroadcastIndex_Type = Integer32
...
_PhivAreaCircuitIndex_Type = Integer32
