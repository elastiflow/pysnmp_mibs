# SNMP MIB module (RFC1493-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/rob/MIBs/Standards/IETF/RFC1493-MIB.mib
# Produced by pysmi-1.5.11 at Wed May 21 14:57:27 2025
...
dot1dTpFdbEntry.setIndexNames(
    (0, "RFC1493-MIB", "dot1dTpFdbAddress"),
)
if mibBuilder.loadTexts:
...
dot1dStaticEntry.setIndexNames(
    (0, "RFC1493-MIB", "dot1dStaticAddress"),
    (0, "RFC1493-MIB", "dot1dStaticReceivePort"),
)
if mibBuilder.loadTexts:
