# SNMP MIB module (TOKEN-BUS-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/rob/MIBs/Standards/IETF/TOKEN-BUS-MIB.mib
...
dot4InitEntry.setIndexNames(
    (0, "TOKEN-BUS-MIB", "dot4InitIfIndex"),
)
if mibBuilder.loadTexts:
...
dot4StatsEntry.setIndexNames(
    (0, "TOKEN-BUS-MIB", "dot4StatsIfIndex"),
)
if mibBuilder.loadTexts:
