# SNMP MIB module (ABB-DVMRP-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/rob/MIBs/abb_17268/ABB-DVMRP-MIB.mib
...
hmDVMRPMIB = ModuleIdentity(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 4, 100)
)
...
hmDVMRPVersionString = _HmDVMRPVersionString_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 4, 100, 1, 1, 1, 1),
...
hmDVMRPReachableRoutes = _HmDVMRPReachableRoutes_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 4, 100, 1, 1, 1, 4),
...
hmDVMRPUpdateInterval = _HmDVMRPUpdateInterval_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 4, 100, 1, 1, 1, 10),
...
hmDVMRPPruneLifetime = _HmDVMRPPruneLifetime_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 4, 100, 1, 1, 1, 11),
...
hmDVMRPInterfaceTable = _HmDVMRPInterfaceTable_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 4, 100, 1, 1, 2)
)
if mibBuilder.loadTexts:
...
hmDVMRPInterfaceEntry = _HmDVMRPInterfaceEntry_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 4, 100, 1, 1, 2, 1)
)
hmDVMRPInterfaceEntry.setIndexNames(
    (0, "ABB-DVMRP-MIB", "hmDVMRPInterfaceIfIndex"),
)
if mibBuilder.loadTexts:
...
hmDVMRPInterfaceIfIndex = _HmDVMRPInterfaceIfIndex_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 4, 100, 1, 1, 2, 1, 1),
...
hmDVMRPInterfaceLocalAddress = _HmDVMRPInterfaceLocalAddress_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 4, 100, 1, 1, 2, 1, 2),
    _HmDVMRPInterfaceLocalAddress_Type()
)
hmDVMRPInterfaceLocalAddress.setMaxAccess("read-create")
if mibBuilder.loadTexts:
...
hmDVMRPInterfaceRcvBadPkts = _HmDVMRPInterfaceRcvBadPkts_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 4, 100, 1, 1, 2, 1, 5),
...
hmDVMRPInterfaceRcvBadRoutes = _HmDVMRPInterfaceRcvBadRoutes_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 4, 100, 1, 1, 2, 1, 6),
...
hmDVMRPInterfaceSentRoutes = _HmDVMRPInterfaceSentRoutes_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 4, 100, 1, 1, 2, 1, 7),
...
hmDVMRPInterfaceInterfaceKey = _HmDVMRPInterfaceInterfaceKey_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 4, 100, 1, 1, 2, 1, 8),
...
hmDVMRPInterfaceInterfaceKeyVersion = _HmDVMRPInterfaceInterfaceKeyVersion_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 4, 100, 1, 1, 2, 1, 9),
...
hmDVMRPNeighborTable = _HmDVMRPNeighborTable_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 4, 100, 1, 1, 3)
)
if mibBuilder.loadTexts:
...
hmDVMRPNeighborEntry = _HmDVMRPNeighborEntry_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 4, 100, 1, 1, 3, 1)
)
hmDVMRPNeighborEntry.setIndexNames(
    (0, "ABB-DVMRP-MIB", "hmDVMRPNeighborIfIndex"),
    (0, "ABB-DVMRP-MIB", "hmDVMRPNeighborAddress"),
)
if mibBuilder.loadTexts:
...
hmDVMRPNeighborIfIndex = _HmDVMRPNeighborIfIndex_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 4, 100, 1, 1, 3, 1, 1),
...
hmDVMRPNeighborAddress = _HmDVMRPNeighborAddress_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 4, 100, 1, 1, 3, 1, 2),
...
hmDVMRPNeighborUpTime = _HmDVMRPNeighborUpTime_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 4, 100, 1, 1, 3, 1, 3),
...
hmDVMRPNeighborExpiryTime = _HmDVMRPNeighborExpiryTime_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 4, 100, 1, 1, 3, 1, 4),
...
hmDVMRPNeighborGenerationId = _HmDVMRPNeighborGenerationId_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 4, 100, 1, 1, 3, 1, 5),
...
hmDVMRPNeighborMajorVersion = _HmDVMRPNeighborMajorVersion_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 4, 100, 1, 1, 3, 1, 6),
...
hmDVMRPNeighborMinorVersion = _HmDVMRPNeighborMinorVersion_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 4, 100, 1, 1, 3, 1, 7),
...
hmDVMRPNeighborCapabilities = _HmDVMRPNeighborCapabilities_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 4, 100, 1, 1, 3, 1, 8),
...
hmDVMRPNeighborRcvRoutes = _HmDVMRPNeighborRcvRoutes_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 4, 100, 1, 1, 3, 1, 9),
...
hmDVMRPNeighborRcvBadPkts = _HmDVMRPNeighborRcvBadPkts_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 4, 100, 1, 1, 3, 1, 10),
...
hmDVMRPNeighborRcvBadRoutes = _HmDVMRPNeighborRcvBadRoutes_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 4, 100, 1, 1, 3, 1, 11),
...
hmDVMRPNeighborState = _HmDVMRPNeighborState_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 4, 100, 1, 1, 3, 1, 12),
...
hmDVMRPRouteTable = _HmDVMRPRouteTable_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 4, 100, 1, 1, 4)
)
if mibBuilder.loadTexts:
    hmDVMRPRouteTable.setStatus("current")
_HmDVMRPRouteEntry_Object = MibTableRow
hmDVMRPRouteEntry = _HmDVMRPRouteEntry_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 4, 100, 1, 1, 4, 1)
)
hmDVMRPRouteEntry.setIndexNames(
    (0, "ABB-DVMRP-MIB", "hmDVMRPRouteSource"),
    (0, "ABB-DVMRP-MIB", "hmDVMRPRouteSourceMask"),
)
if mibBuilder.loadTexts:
...
hmDVMRPRouteSource = _HmDVMRPRouteSource_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 4, 100, 1, 1, 4, 1, 1),
...
hmDVMRPRouteSourceMask = _HmDVMRPRouteSourceMask_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 4, 100, 1, 1, 4, 1, 2),
...
hmDVMRPRouteUpstreamNeighbor = _HmDVMRPRouteUpstreamNeighbor_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 4, 100, 1, 1, 4, 1, 3),
...
hmDVMRPRouteIfIndex = _HmDVMRPRouteIfIndex_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 4, 100, 1, 1, 4, 1, 4),
...
hmDVMRPRouteMetric = _HmDVMRPRouteMetric_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 4, 100, 1, 1, 4, 1, 5),
...
hmDVMRPRouteExpiryTime = _HmDVMRPRouteExpiryTime_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 4, 100, 1, 1, 4, 1, 6),
...
hmDVMRPRouteUpTime = _HmDVMRPRouteUpTime_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 4, 100, 1, 1, 4, 1, 7),
...
hmDVMRPRouteNextHopTable = _HmDVMRPRouteNextHopTable_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 4, 100, 1, 1, 5)
)
if mibBuilder.loadTexts:
...
hmDVMRPRouteNextHopEntry = _HmDVMRPRouteNextHopEntry_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 4, 100, 1, 1, 5, 1)
)
hmDVMRPRouteNextHopEntry.setIndexNames(
    (0, "ABB-DVMRP-MIB", "hmDVMRPRouteNextHopSource"),
    (0, "ABB-DVMRP-MIB", "hmDVMRPRouteNextHopSourceMask"),
    (0, "ABB-DVMRP-MIB", "hmDVMRPRouteNextHopIfIndex"),
)
if mibBuilder.loadTexts:
...
hmDVMRPRouteNextHopSource = _HmDVMRPRouteNextHopSource_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 4, 100, 1, 1, 5, 1, 1),
...
hmDVMRPRouteNextHopSourceMask = _HmDVMRPRouteNextHopSourceMask_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 4, 100, 1, 1, 5, 1, 2),
...
hmDVMRPRouteNextHopIfIndex = _HmDVMRPRouteNextHopIfIndex_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 4, 100, 1, 1, 5, 1, 3),
...
hmDVMRPRouteNextHopType = _HmDVMRPRouteNextHopType_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 4, 100, 1, 1, 5, 1, 4),
...
hmDVMRPPruneTable = _HmDVMRPPruneTable_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 4, 100, 1, 1, 6)
)
if mibBuilder.loadTexts:
    hmDVMRPPruneTable.setStatus("current")
_HmDVMRPPruneEntry_Object = MibTableRow
hmDVMRPPruneEntry = _HmDVMRPPruneEntry_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 4, 100, 1, 1, 6, 1)
)
hmDVMRPPruneEntry.setIndexNames(
    (0, "ABB-DVMRP-MIB", "hmDVMRPPruneGroup"),
    (0, "ABB-DVMRP-MIB", "hmDVMRPPruneSource"),
    (0, "ABB-DVMRP-MIB", "hmDVMRPPruneSourceMask"),
)
if mibBuilder.loadTexts:
...
hmDVMRPPruneGroup = _HmDVMRPPruneGroup_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 4, 100, 1, 1, 6, 1, 1),
...
hmDVMRPPruneSource = _HmDVMRPPruneSource_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 4, 100, 1, 1, 6, 1, 2),
...
hmDVMRPPruneSourceMask = _HmDVMRPPruneSourceMask_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 4, 100, 1, 1, 6, 1, 3),
...
hmDVMRPPruneExpiryTime = _HmDVMRPPruneExpiryTime_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 4, 100, 1, 1, 6, 1, 4),
...
hmDVMRPTraps = _HmDVMRPTraps_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 4, 100, 1, 1, 7)
)
_HmDVMRPMIBConformance_ObjectIdentity = ObjectIdentity
hmDVMRPMIBConformance = _HmDVMRPMIBConformance_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 4, 100, 2)
)
_HmDVMRPMIBCompliances_ObjectIdentity = ObjectIdentity
hmDVMRPMIBCompliances = _HmDVMRPMIBCompliances_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 4, 100, 2, 1)
)
_HmDVMRPMIBGroups_ObjectIdentity = ObjectIdentity
hmDVMRPMIBGroups = _HmDVMRPMIBGroups_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 4, 100, 2, 2)
)

# Managed Objects groups

hmDVMRPGeneralGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 4, 100, 2, 2, 2)
)
hmDVMRPGeneralGroup.setObjects(
      *(("ABB-DVMRP-MIB", "hmDVMRPVersionString"),
        ("ABB-DVMRP-MIB", "hmDVMRPGenerationId"),
        ("ABB-DVMRP-MIB", "hmDVMRPNumRoutes"),
        ("ABB-DVMRP-MIB", "hmDVMRPReachableRoutes"))
)
if mibBuilder.loadTexts:
    hmDVMRPGeneralGroup.setStatus("current")

hmDVMRPInterfaceGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 4, 100, 2, 2, 3)
)
hmDVMRPInterfaceGroup.setObjects(
      *(("ABB-DVMRP-MIB", "hmDVMRPInterfaceLocalAddress"),
        ("ABB-DVMRP-MIB", "hmDVMRPInterfaceMetric"),
        ("ABB-DVMRP-MIB", "hmDVMRPInterfaceStatus"),
        ("ABB-DVMRP-MIB", "hmDVMRPInterfaceRcvBadPkts"),
        ("ABB-DVMRP-MIB", "hmDVMRPInterfaceRcvBadRoutes"),
        ("ABB-DVMRP-MIB", "hmDVMRPInterfaceSentRoutes"))
)
if mibBuilder.loadTexts:
    hmDVMRPInterfaceGroup.setStatus("current")

hmDVMRPNeighborGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 4, 100, 2, 2, 4)
)
hmDVMRPNeighborGroup.setObjects(
      *(("ABB-DVMRP-MIB", "hmDVMRPNeighborUpTime"),
        ("ABB-DVMRP-MIB", "hmDVMRPNeighborExpiryTime"),
        ("ABB-DVMRP-MIB", "hmDVMRPNeighborGenerationId"),
        ("ABB-DVMRP-MIB", "hmDVMRPNeighborMajorVersion"),
        ("ABB-DVMRP-MIB", "hmDVMRPNeighborMinorVersion"),
        ("ABB-DVMRP-MIB", "hmDVMRPNeighborCapabilities"),
        ("ABB-DVMRP-MIB", "hmDVMRPNeighborRcvRoutes"),
        ("ABB-DVMRP-MIB", "hmDVMRPNeighborRcvBadPkts"),
        ("ABB-DVMRP-MIB", "hmDVMRPNeighborRcvBadRoutes"),
        ("ABB-DVMRP-MIB", "hmDVMRPNeighborState"))
)
if mibBuilder.loadTexts:
    hmDVMRPNeighborGroup.setStatus("current")

hmDVMRPRoutingGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 4, 100, 2, 2, 5)
)
hmDVMRPRoutingGroup.setObjects(
      *(("ABB-DVMRP-MIB", "hmDVMRPRouteUpstreamNeighbor"),
        ("ABB-DVMRP-MIB", "hmDVMRPRouteIfIndex"),
        ("ABB-DVMRP-MIB", "hmDVMRPRouteMetric"),
        ("ABB-DVMRP-MIB", "hmDVMRPRouteExpiryTime"),
        ("ABB-DVMRP-MIB", "hmDVMRPRouteUpTime"),
        ("ABB-DVMRP-MIB", "hmDVMRPRouteNextHopType"))
)
if mibBuilder.loadTexts:
    hmDVMRPRoutingGroup.setStatus("current")

hmDVMRPSecurityGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 4, 100, 2, 2, 6)
)
hmDVMRPSecurityGroup.setObjects(
      *(("ABB-DVMRP-MIB", "hmDVMRPInterfaceInterfaceKey"),
        ("ABB-DVMRP-MIB", "hmDVMRPInterfaceInterfaceKeyVersion"))
)
if mibBuilder.loadTexts:
    hmDVMRPSecurityGroup.setStatus("current")

hmDVMRPTreeGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 4, 100, 2, 2, 7)
)
hmDVMRPTreeGroup.setObjects(
    ("ABB-DVMRP-MIB", "hmDVMRPPruneExpiryTime")
)
if mibBuilder.loadTexts:
...
hmDVMRPNeighborLoss = NotificationType(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 4, 100, 1, 1, 7, 1)
)
...
hmDVMRPNeighborNotPruning = NotificationType(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 4, 100, 1, 1, 7, 2)
)
...
hmDVMRPNotificationGroup = NotificationGroup(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 4, 100, 2, 2, 8)
)
hmDVMRPNotificationGroup.setObjects(
      *(("ABB-DVMRP-MIB", "hmDVMRPNeighborLoss"),
        ("ABB-DVMRP-MIB", "hmDVMRPNeighborNotPruning"))
)
if mibBuilder.loadTexts:
...
hmDVMRPMIBCompliance = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 4, 100, 2, 1, 1)
)
hmDVMRPMIBCompliance.setObjects(
      *(("ABB-DVMRP-MIB", "hmDVMRPGeneralGroup"),
        ("ABB-DVMRP-MIB", "hmDVMRPInterfaceGroup"),
        ("ABB-DVMRP-MIB", "hmDVMRPNeighborGroup"),
        ("ABB-DVMRP-MIB", "hmDVMRPRoutingGroup"),
        ("ABB-DVMRP-MIB", "hmDVMRPTreeGroup"),
        ("ABB-DVMRP-MIB", "hmDVMRPSecurityGroup"))
)
if mibBuilder.loadTexts:
