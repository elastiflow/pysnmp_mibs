# SNMP MIB module (ABB-PIM-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/rob/MIBs/abb_17268/ABB-PIM-MIB.mib
...
hmPIMMIB = ModuleIdentity(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 4, 99)
)
...
hmPIMJoinPruneInterval = _HmPIMJoinPruneInterval_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 4, 99, 1, 1, 1),
...
hmPIMInterfaceTable = _HmPIMInterfaceTable_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 4, 99, 1, 1, 2)
)
if mibBuilder.loadTexts:
...
hmPIMInterfaceEntry = _HmPIMInterfaceEntry_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 4, 99, 1, 1, 2, 1)
)
hmPIMInterfaceEntry.setIndexNames(
    (0, "ABB-PIM-MIB", "hmPIMInterfaceIfIndex"),
)
if mibBuilder.loadTexts:
...
hmPIMInterfaceIfIndex = _HmPIMInterfaceIfIndex_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 4, 99, 1, 1, 2, 1, 1),
...
hmPIMInterfaceAddress = _HmPIMInterfaceAddress_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 4, 99, 1, 1, 2, 1, 2),
...
hmPIMInterfaceNetMask = _HmPIMInterfaceNetMask_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 4, 99, 1, 1, 2, 1, 3),
...
hmPIMInterfaceMode = _HmPIMInterfaceMode_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 4, 99, 1, 1, 2, 1, 4),
...
hmPIMInterfaceDR = _HmPIMInterfaceDR_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 4, 99, 1, 1, 2, 1, 5),
...
hmPIMInterfaceHelloInterval = _HmPIMInterfaceHelloInterval_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 4, 99, 1, 1, 2, 1, 6),
...
hmPIMInterfaceStatus = _HmPIMInterfaceStatus_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 4, 99, 1, 1, 2, 1, 7),
...
hmPIMInterfaceJoinPruneInterval = _HmPIMInterfaceJoinPruneInterval_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 4, 99, 1, 1, 2, 1, 8),
...
hmPIMInterfaceCBSRPreference = _HmPIMInterfaceCBSRPreference_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 4, 99, 1, 1, 2, 1, 9),
...
hmPIMNeighborAddress = _HmPIMNeighborAddress_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 4, 99, 1, 1, 3, 1, 1),
...
hmPIMNeighborIfIndex = _HmPIMNeighborIfIndex_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 4, 99, 1, 1, 3, 1, 2),
...
hmPIMNeighborUpTime = _HmPIMNeighborUpTime_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 4, 99, 1, 1, 3, 1, 3),
...
hmPIMNeighborExpiryTime = _HmPIMNeighborExpiryTime_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 4, 99, 1, 1, 3, 1, 4),
...
hmPIMNeighborMode = _HmPIMNeighborMode_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 4, 99, 1, 1, 3, 1, 5),
...
hmPIMIpMRouteUpstreamAssertTimer = _HmPIMIpMRouteUpstreamAssertTimer_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 4, 99, 1, 1, 4, 1, 1),
...
hmPIMIpMRouteAssertMetric = _HmPIMIpMRouteAssertMetric_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 4, 99, 1, 1, 4, 1, 2),
...
hmPIMIpMRouteAssertMetricPref = _HmPIMIpMRouteAssertMetricPref_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 4, 99, 1, 1, 4, 1, 3),
...
hmPIMIpMRouteAssertRPTBit = _HmPIMIpMRouteAssertRPTBit_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 4, 99, 1, 1, 4, 1, 4),
...
hmPIMIpMRouteFlags = _HmPIMIpMRouteFlags_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 4, 99, 1, 1, 4, 1, 5),
...
hmPIMRPTable = _HmPIMRPTable_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 4, 99, 1, 1, 5)
)
if mibBuilder.loadTexts:
    hmPIMRPTable.setStatus("deprecated")
_HmPIMRPEntry_Object = MibTableRow
hmPIMRPEntry = _HmPIMRPEntry_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 4, 99, 1, 1, 5, 1)
)
hmPIMRPEntry.setIndexNames(
    (0, "ABB-PIM-MIB", "hmPIMRPGroupAddress"),
    (0, "ABB-PIM-MIB", "hmPIMRPAddress"),
)
if mibBuilder.loadTexts:
...
hmPIMRPGroupAddress = _HmPIMRPGroupAddress_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 4, 99, 1, 1, 5, 1, 1),
...
hmPIMRPAddress = _HmPIMRPAddress_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 4, 99, 1, 1, 5, 1, 2),
...
hmPIMRPState = _HmPIMRPState_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 4, 99, 1, 1, 5, 1, 3),
    _HmPIMRPState_Type()
)
...
hmPIMRPStateTimer = _HmPIMRPStateTimer_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 4, 99, 1, 1, 5, 1, 4),
...
hmPIMRPLastChange = _HmPIMRPLastChange_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 4, 99, 1, 1, 5, 1, 5),
...
hmPIMRPRowStatus = _HmPIMRPRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 4, 99, 1, 1, 5, 1, 6),
...
hmPIMRPSetTable = _HmPIMRPSetTable_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 4, 99, 1, 1, 6)
)
if mibBuilder.loadTexts:
    hmPIMRPSetTable.setStatus("current")
_HmPIMRPSetEntry_Object = MibTableRow
hmPIMRPSetEntry = _HmPIMRPSetEntry_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 4, 99, 1, 1, 6, 1)
)
hmPIMRPSetEntry.setIndexNames(
    (0, "ABB-PIM-MIB", "hmPIMRPSetComponent"),
    (0, "ABB-PIM-MIB", "hmPIMRPSetGroupAddress"),
    (0, "ABB-PIM-MIB", "hmPIMRPSetGroupMask"),
    (0, "ABB-PIM-MIB", "hmPIMRPSetAddress"),
)
if mibBuilder.loadTexts:
...
hmPIMRPSetGroupAddress = _HmPIMRPSetGroupAddress_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 4, 99, 1, 1, 6, 1, 1),
...
hmPIMRPSetGroupMask = _HmPIMRPSetGroupMask_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 4, 99, 1, 1, 6, 1, 2),
...
hmPIMRPSetAddress = _HmPIMRPSetAddress_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 4, 99, 1, 1, 6, 1, 3),
...
hmPIMRPSetHoldTime = _HmPIMRPSetHoldTime_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 4, 99, 1, 1, 6, 1, 4),
...
hmPIMRPSetExpiryTime = _HmPIMRPSetExpiryTime_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 4, 99, 1, 1, 6, 1, 5),
...
hmPIMRPSetComponent = _HmPIMRPSetComponent_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 4, 99, 1, 1, 6, 1, 6),
...
hmPIMIpMRouteNextHopTable = _HmPIMIpMRouteNextHopTable_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 4, 99, 1, 1, 7)
)
if mibBuilder.loadTexts:
...
hmPIMIpMRouteNextHopEntry = _HmPIMIpMRouteNextHopEntry_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 4, 99, 1, 1, 7, 1)
)
...
hmPIMIpMRouteNextHopPruneReason = _HmPIMIpMRouteNextHopPruneReason_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 4, 99, 1, 1, 7, 1, 2),
...
hmPIMCandidateRPTable = _HmPIMCandidateRPTable_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 4, 99, 1, 1, 11)
)
if mibBuilder.loadTexts:
...
hmPIMCandidateRPEntry = _HmPIMCandidateRPEntry_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 4, 99, 1, 1, 11, 1)
)
hmPIMCandidateRPEntry.setIndexNames(
    (0, "ABB-PIM-MIB", "hmPIMCandidateRPGroupAddress"),
    (0, "ABB-PIM-MIB", "hmPIMCandidateRPGroupMask"),
)
if mibBuilder.loadTexts:
...
hmPIMCandidateRPGroupAddress = _HmPIMCandidateRPGroupAddress_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 4, 99, 1, 1, 11, 1, 1),
...
hmPIMCandidateRPGroupMask = _HmPIMCandidateRPGroupMask_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 4, 99, 1, 1, 11, 1, 2),
...
hmPIMCandidateRPAddress = _HmPIMCandidateRPAddress_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 4, 99, 1, 1, 11, 1, 3),
...
hmPIMCandidateRPRowStatus = _HmPIMCandidateRPRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 4, 99, 1, 1, 11, 1, 4),
...
hmPIMComponentTable = _HmPIMComponentTable_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 4, 99, 1, 1, 12)
)
if mibBuilder.loadTexts:
...
hmPIMComponentEntry = _HmPIMComponentEntry_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 4, 99, 1, 1, 12, 1)
)
hmPIMComponentEntry.setIndexNames(
    (0, "ABB-PIM-MIB", "hmPIMComponentIndex"),
)
if mibBuilder.loadTexts:
...
hmPIMComponentIndex = _HmPIMComponentIndex_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 4, 99, 1, 1, 12, 1, 1),
...
hmPIMComponentBSRAddress = _HmPIMComponentBSRAddress_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 4, 99, 1, 1, 12, 1, 2),
...
hmPIMComponentBSRExpiryTime = _HmPIMComponentBSRExpiryTime_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 4, 99, 1, 1, 12, 1, 3),
...
hmPIMComponentCRPHoldTime = _HmPIMComponentCRPHoldTime_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 4, 99, 1, 1, 12, 1, 4),
...
hmPIMComponentStatus = _HmPIMComponentStatus_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 4, 99, 1, 1, 12, 1, 5),
...
hmPIMMIBConformance = _HmPIMMIBConformance_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 4, 99, 2)
)
_HmPIMMIBCompliances_ObjectIdentity = ObjectIdentity
hmPIMMIBCompliances = _HmPIMMIBCompliances_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 4, 99, 2, 1)
)
_HmPIMMIBGroups_ObjectIdentity = ObjectIdentity
hmPIMMIBGroups = _HmPIMMIBGroups_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 4, 99, 2, 2)
)

# Managed Objects groups

hmPIMV2MIBGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 4, 99, 2, 2, 2)
)
hmPIMV2MIBGroup.setObjects(
      *(("ABB-PIM-MIB", "hmPIMJoinPruneInterval"),
        ("ABB-PIM-MIB", "hmPIMNeighborIfIndex"),
        ("ABB-PIM-MIB", "hmPIMNeighborUpTime"),
        ("ABB-PIM-MIB", "hmPIMNeighborExpiryTime"),
        ("ABB-PIM-MIB", "hmPIMInterfaceAddress"),
        ("ABB-PIM-MIB", "hmPIMInterfaceNetMask"),
        ("ABB-PIM-MIB", "hmPIMInterfaceDR"),
        ("ABB-PIM-MIB", "hmPIMInterfaceHelloInterval"),
        ("ABB-PIM-MIB", "hmPIMInterfaceStatus"),
        ("ABB-PIM-MIB", "hmPIMInterfaceJoinPruneInterval"),
        ("ABB-PIM-MIB", "hmPIMInterfaceCBSRPreference"),
        ("ABB-PIM-MIB", "hmPIMInterfaceMode"),
        ("ABB-PIM-MIB", "hmPIMRPSetHoldTime"),
        ("ABB-PIM-MIB", "hmPIMRPSetExpiryTime"),
        ("ABB-PIM-MIB", "hmPIMComponentBSRAddress"),
        ("ABB-PIM-MIB", "hmPIMComponentBSRExpiryTime"),
        ("ABB-PIM-MIB", "hmPIMComponentCRPHoldTime"),
        ("ABB-PIM-MIB", "hmPIMComponentStatus"),
        ("ABB-PIM-MIB", "hmPIMIpMRouteFlags"),
        ("ABB-PIM-MIB", "hmPIMIpMRouteUpstreamAssertTimer"))
)
if mibBuilder.loadTexts:
    hmPIMV2MIBGroup.setStatus("current")

hmPIMV2CandidateRPMIBGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 4, 99, 2, 2, 3)
)
hmPIMV2CandidateRPMIBGroup.setObjects(
      *(("ABB-PIM-MIB", "hmPIMCandidateRPAddress"),
        ("ABB-PIM-MIB", "hmPIMCandidateRPRowStatus"))
)
if mibBuilder.loadTexts:
    hmPIMV2CandidateRPMIBGroup.setStatus("current")

hmPIMV1MIBGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 4, 99, 2, 2, 4)
)
hmPIMV1MIBGroup.setObjects(
      *(("ABB-PIM-MIB", "hmPIMJoinPruneInterval"),
        ...
        ("ABB-PIM-MIB", "hmPIMInterfaceDR"),
        ("ABB-PIM-MIB", "hmPIMInterfaceHelloInterval"),
        ("ABB-PIM-MIB", "hmPIMRPState"),
        ("ABB-PIM-MIB", "hmPIMRPStateTimer"),
        ("ABB-PIM-MIB", "hmPIMRPLastChange"),
        ("ABB-PIM-MIB", "hmPIMRPRowStatus"))
)
if mibBuilder.loadTexts:
    hmPIMV1MIBGroup.setStatus("deprecated")

hmPIMDenseV2MIBGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 4, 99, 2, 2, 5)
)
...
hmPIMNextHopGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 4, 99, 2, 2, 6)
)
hmPIMNextHopGroup.setObjects(
    ("ABB-PIM-MIB", "hmPIMIpMRouteNextHopPruneReason")
)
if mibBuilder.loadTexts:
    hmPIMNextHopGroup.setStatus("current")

hmPIMAssertGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 4, 99, 2, 2, 7)
)
hmPIMAssertGroup.setObjects(
      *(("ABB-PIM-MIB", "hmPIMIpMRouteAssertMetric"),
        ("ABB-PIM-MIB", "hmPIMIpMRouteAssertMetricPref"),
        ("ABB-PIM-MIB", "hmPIMIpMRouteAssertRPTBit"))
)
if mibBuilder.loadTexts:
...
hmPIMNeighborLoss = NotificationType(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 4, 99, 1, 0, 1)
)
...
hmPIMNotificationGroup = NotificationGroup(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 4, 99, 2, 2, 1)
)
hmPIMNotificationGroup.setObjects(
    ("ABB-PIM-MIB", "hmPIMNeighborLoss")
)
if mibBuilder.loadTexts:
...
hmPIMV1MIBCompliance = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 4, 99, 2, 1, 1)
)
hmPIMV1MIBCompliance.setObjects(
    ("ABB-PIM-MIB", "hmPIMV1MIBGroup")
)
if mibBuilder.loadTexts:
...
hmPIMSparseV2MIBCompliance = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 4, 99, 2, 1, 2)
)
hmPIMSparseV2MIBCompliance.setObjects(
      *(("ABB-PIM-MIB", "hmPIMV2MIBGroup"),
        ("ABB-PIM-MIB", "hmPIMV2CandidateRPMIBGroup"))
)
if mibBuilder.loadTexts:
...
hmPIMDenseV2MIBCompliance = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 4, 99, 2, 1, 3)
)
hmPIMDenseV2MIBCompliance.setObjects(
    ("ABB-PIM-MIB", "hmPIMDenseV2MIBGroup")
)
if mibBuilder.loadTexts:
