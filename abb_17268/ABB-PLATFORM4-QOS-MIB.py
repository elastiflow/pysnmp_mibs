# SNMP MIB module (ABB-PLATFORM4-QOS-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/rob/MIBs/abb_17268/ABB-PLATFORM4-QOS-MIB.mib
...
aclIndex = _AclIndex_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 3, 2, 1, 1, 1),
    _AclIndex_Type()
)
...
aclStatus = _AclStatus_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 3, 2, 1, 1, 3),
    _AclStatus_Type()
)
...
aclRuleIndex = _AclRuleIndex_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 3, 2, 4, 1, 1),
    _AclRuleIndex_Type()
)
...
aclRuleAction = _AclRuleAction_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 3, 2, 4, 1, 2),
    _AclRuleAction_Type()
)
...
aclRuleProtocol = _AclRuleProtocol_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 3, 2, 4, 1, 3),
...
aclRuleSrcIpAddress = _AclRuleSrcIpAddress_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 3, 2, 4, 1, 4),
...
aclRuleSrcIpMask = _AclRuleSrcIpMask_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 3, 2, 4, 1, 5),
...
aclRuleSrcL4Port = _AclRuleSrcL4Port_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 3, 2, 4, 1, 6),
...
aclRuleSrcL4PortRangeStart = _AclRuleSrcL4PortRangeStart_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 3, 2, 4, 1, 7),
...
aclRuleSrcL4PortRangeEnd = _AclRuleSrcL4PortRangeEnd_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 3, 2, 4, 1, 8),
...
aclRuleDestIpAddress = _AclRuleDestIpAddress_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 3, 2, 4, 1, 9),
...
aclRuleDestIpMask = _AclRuleDestIpMask_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 3, 2, 4, 1, 10),
...
aclRuleDestL4Port = _AclRuleDestL4Port_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 3, 2, 4, 1, 11),
...
aclRuleDestL4PortRangeStart = _AclRuleDestL4PortRangeStart_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 3, 2, 4, 1, 12),
...
aclRuleDestL4PortRangeEnd = _AclRuleDestL4PortRangeEnd_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 3, 2, 4, 1, 13),
...
aclRuleIPDSCP = _AclRuleIPDSCP_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 3, 2, 4, 1, 14),
    _AclRuleIPDSCP_Type()
)
...
aclRuleIpPrecedence = _AclRuleIpPrecedence_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 3, 2, 4, 1, 15),
...
aclRuleIpTosBits = _AclRuleIpTosBits_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 3, 2, 4, 1, 16),
...
aclRuleIpTosMask = _AclRuleIpTosMask_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 3, 2, 4, 1, 17),
...
aclRuleStatus = _AclRuleStatus_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 3, 2, 4, 1, 18),
    _AclRuleStatus_Type()
)
...
aclRuleAssignQueueId = _AclRuleAssignQueueId_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 3, 2, 4, 1, 19),
...
aclRuleRedirectIntf = _AclRuleRedirectIntf_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 3, 2, 4, 1, 20),
...
aclRuleMatchEvery = _AclRuleMatchEvery_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 3, 2, 4, 1, 21),
...
aclMacIndexNextFree = _AclMacIndexNextFree_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 3, 2, 5),
...
aclMacIndex = _AclMacIndex_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 3, 2, 6, 1, 1),
    _AclMacIndex_Type()
)
...
aclMacName = _AclMacName_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 3, 2, 6, 1, 2),
    _AclMacName_Type()
)
...
aclMacStatus = _AclMacStatus_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 3, 2, 6, 1, 3),
    _AclMacStatus_Type()
)
...
aclMacRuleIndex = _AclMacRuleIndex_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 3, 2, 7, 1, 1),
...
aclMacRuleAction = _AclMacRuleAction_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 3, 2, 7, 1, 2),
...
aclMacRuleCos = _AclMacRuleCos_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 3, 2, 7, 1, 3),
    _AclMacRuleCos_Type()
)
...
aclMacRuleCos2 = _AclMacRuleCos2_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 3, 2, 7, 1, 4),
...
aclMacRuleDestMacAddr = _AclMacRuleDestMacAddr_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 3, 2, 7, 1, 5),
...
aclMacRuleDestMacMask = _AclMacRuleDestMacMask_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 3, 2, 7, 1, 6),
...
aclMacRuleEtypeKey = _AclMacRuleEtypeKey_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 3, 2, 7, 1, 7),
...
aclMacRuleEtypeValue = _AclMacRuleEtypeValue_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 3, 2, 7, 1, 8),
...
aclMacRuleSrcMacAddr = _AclMacRuleSrcMacAddr_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 3, 2, 7, 1, 9),
...
aclMacRuleSrcMacMask = _AclMacRuleSrcMacMask_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 3, 2, 7, 1, 10),
...
aclMacRuleVlanId = _AclMacRuleVlanId_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 3, 2, 7, 1, 11),
...
aclMacRuleVlanIdRangeStart = _AclMacRuleVlanIdRangeStart_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 3, 2, 7, 1, 12),
...
aclMacRuleVlanIdRangeEnd = _AclMacRuleVlanIdRangeEnd_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 3, 2, 7, 1, 13),
...
aclMacRuleVlanId2 = _AclMacRuleVlanId2_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 3, 2, 7, 1, 14),
...
aclMacRuleVlanId2RangeStart = _AclMacRuleVlanId2RangeStart_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 3, 2, 7, 1, 15),
...
aclMacRuleVlanId2RangeEnd = _AclMacRuleVlanId2RangeEnd_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 3, 2, 7, 1, 16),
...
aclMacRuleStatus = _AclMacRuleStatus_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 3, 2, 7, 1, 17),
...
aclMacRuleAssignQueueId = _AclMacRuleAssignQueueId_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 3, 2, 7, 1, 18),
...
aclMacRuleRedirectIntf = _AclMacRuleRedirectIntf_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 3, 2, 7, 1, 19),
...
aclMacRuleMatchEvery = _AclMacRuleMatchEvery_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 3, 2, 7, 1, 20),
...
aclIfTable = _AclIfTable_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 3, 2, 8)
)
if mibBuilder.loadTexts:
    aclIfTable.setStatus("current")
_AclIfEntry_Object = MibTableRow
aclIfEntry = _AclIfEntry_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 3, 2, 8, 1)
)
aclIfEntry.setIndexNames(
    (0, "ABB-PLATFORM4-QOS-MIB", "aclIfIndex"),
    (0, "ABB-PLATFORM4-QOS-MIB", "aclIfDirection"),
    (0, "ABB-PLATFORM4-QOS-MIB", "aclIfSequence"),
    (0, "ABB-PLATFORM4-QOS-MIB", "aclIfAclType"),
    (0, "ABB-PLATFORM4-QOS-MIB", "aclIfAclId"),
)
if mibBuilder.loadTexts:
...
aclIfIndex = _AclIfIndex_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 3, 2, 8, 1, 1),
    _AclIfIndex_Type()
)
...
aclIfDirection = _AclIfDirection_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 3, 2, 8, 1, 2),
...
aclIfSequence = _AclIfSequence_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 3, 2, 8, 1, 3),
    _AclIfSequence_Type()
)
...
aclIfAclType = _AclIfAclType_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 3, 2, 8, 1, 4),
    _AclIfAclType_Type()
)
...
aclIfAclId = _AclIfAclId_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 3, 2, 8, 1, 5),
    _AclIfAclId_Type()
)
...
aclIfStatus = _AclIfStatus_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 3, 2, 8, 1, 6),
    _AclIfStatus_Type()
)
...
hmAgentCosMapIpPrecEntry = _HmAgentCosMapIpPrecEntry_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 3, 3, 1, 1, 1)
)
hmAgentCosMapIpPrecEntry.setIndexNames(
    (0, "ABB-PLATFORM4-QOS-MIB", "hmAgentCosMapIpPrecIntfIndex"),
    (0, "ABB-PLATFORM4-QOS-MIB", "hmAgentCosMapIpPrecValue"),
)
if mibBuilder.loadTexts:
...
hmAgentCosMapIpPrecIntfIndex = _HmAgentCosMapIpPrecIntfIndex_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 3, 3, 1, 1, 1, 1),
...
hmAgentCosMapIpPrecValue = _HmAgentCosMapIpPrecValue_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 3, 3, 1, 1, 1, 2),
...
hmAgentCosMapIpPrecTrafficClass = _HmAgentCosMapIpPrecTrafficClass_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 3, 3, 1, 1, 1, 3),
...
hmAgentCosMapIpDscpTable = _HmAgentCosMapIpDscpTable_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 3, 3, 1, 2)
)
if mibBuilder.loadTexts:
...
hmAgentCosMapIpDscpEntry = _HmAgentCosMapIpDscpEntry_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 3, 3, 1, 2, 1)
)
hmAgentCosMapIpDscpEntry.setIndexNames(
    (0, "ABB-PLATFORM4-QOS-MIB", "hmAgentCosMapIpDscpIntfIndex"),
    (0, "ABB-PLATFORM4-QOS-MIB", "hmAgentCosMapIpDscpValue"),
)
if mibBuilder.loadTexts:
...
hmAgentCosMapIpDscpIntfIndex = _HmAgentCosMapIpDscpIntfIndex_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 3, 3, 1, 2, 1, 1),
...
hmAgentCosMapIpDscpValue = _HmAgentCosMapIpDscpValue_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 3, 3, 1, 2, 1, 2),
...
hmAgentCosMapIpDscpTrafficClass = _HmAgentCosMapIpDscpTrafficClass_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 3, 3, 1, 2, 1, 3),
...
hmAgentCosMapIntfTrustTable = _HmAgentCosMapIntfTrustTable_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 3, 3, 1, 3)
)
if mibBuilder.loadTexts:
...
hmAgentCosMapIntfTrustEntry = _HmAgentCosMapIntfTrustEntry_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 3, 3, 1, 3, 1)
)
hmAgentCosMapIntfTrustEntry.setIndexNames(
    (0, "ABB-PLATFORM4-QOS-MIB", "hmAgentCosMapIntfTrustIntfIndex"),
)
if mibBuilder.loadTexts:
...
hmAgentCosMapIntfTrustIntfIndex = _HmAgentCosMapIntfTrustIntfIndex_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 3, 3, 1, 3, 1, 1),
...
hmAgentCosMapIntfTrustMode = _HmAgentCosMapIntfTrustMode_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 3, 3, 1, 3, 1, 2),
...
hmAgentCosMapUntrustedTrafficClass = _HmAgentCosMapUntrustedTrafficClass_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 3, 3, 1, 3, 1, 3),
...
hmAgentCosQueueCfgGroup = _HmAgentCosQueueCfgGroup_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 3, 3, 2)
)
...
hmAgentCosQueueNumQueuesPerPort = _HmAgentCosQueueNumQueuesPerPort_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 3, 3, 2, 1),
...
hmAgentCosQueueNumDropPrecedenceLevels = _HmAgentCosQueueNumDropPrecedenceLevels_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 3, 3, 2, 2),
...
hmAgentCosQueueControlTable = _HmAgentCosQueueControlTable_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 3, 3, 2, 3)
)
if mibBuilder.loadTexts:
...
hmAgentCosQueueControlEntry = _HmAgentCosQueueControlEntry_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 3, 3, 2, 3, 1)
)
hmAgentCosQueueControlEntry.setIndexNames(
    (0, "ABB-PLATFORM4-QOS-MIB", "hmAgentCosQueueIntfIndex"),
)
if mibBuilder.loadTexts:
...
hmAgentCosQueueIntfIndex = _HmAgentCosQueueIntfIndex_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 3, 3, 2, 3, 1, 1),
...
class _HmAgentCosQueueIntfShapingRate_Type(PercentByFives):
    """Custom type hmAgentCosQueueIntfShapingRate based on PercentByFives"""
    defaultValue = 0


_HmAgentCosQueueIntfShapingRate_Type.__name__ = "PercentByFives"
...
hmAgentCosQueueIntfShapingRate = _HmAgentCosQueueIntfShapingRate_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 3, 3, 2, 3, 1, 2),
...
hmAgentCosQueueMgmtTypeIntf = _HmAgentCosQueueMgmtTypeIntf_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 3, 3, 2, 3, 1, 3),
...
hmAgentCosQueueWredDecayExponent = _HmAgentCosQueueWredDecayExponent_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 3, 3, 2, 3, 1, 4),
...
hmAgentCosQueueDefaultsRestore = _HmAgentCosQueueDefaultsRestore_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 3, 3, 2, 3, 1, 5),
...
hmAgentCosQueueTable = _HmAgentCosQueueTable_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 3, 3, 2, 4)
)
if mibBuilder.loadTexts:
...
hmAgentCosQueueEntry = _HmAgentCosQueueEntry_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 3, 3, 2, 4, 1)
)
hmAgentCosQueueEntry.setIndexNames(
    (0, "ABB-PLATFORM4-QOS-MIB", "hmAgentCosQueueIntfIndex"),
    (0, "ABB-PLATFORM4-QOS-MIB", "hmAgentCosQueueIndex"),
)
if mibBuilder.loadTexts:
...
hmAgentCosQueueIndex = _HmAgentCosQueueIndex_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 3, 3, 2, 4, 1, 1),
...
hmAgentCosQueueSchedulerType = _HmAgentCosQueueSchedulerType_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 3, 3, 2, 4, 1, 2),
...
class _HmAgentCosQueueMinBandwidth_Type(PercentByFives):
    """Custom type hmAgentCosQueueMinBandwidth based on PercentByFives"""
    defaultValue = 0


_HmAgentCosQueueMinBandwidth_Type.__name__ = "PercentByFives"
_HmAgentCosQueueMinBandwidth_Object = MibTableColumn
hmAgentCosQueueMinBandwidth = _HmAgentCosQueueMinBandwidth_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 3, 3, 2, 4, 1, 3),
...
class _HmAgentCosQueueMaxBandwidth_Type(PercentByFives):
    """Custom type hmAgentCosQueueMaxBandwidth based on PercentByFives"""
    defaultValue = 0


_HmAgentCosQueueMaxBandwidth_Type.__name__ = "PercentByFives"
_HmAgentCosQueueMaxBandwidth_Object = MibTableColumn
hmAgentCosQueueMaxBandwidth = _HmAgentCosQueueMaxBandwidth_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 3, 3, 2, 4, 1, 4),
...
hmAgentCosQueueMgmtType = _HmAgentCosQueueMgmtType_Object(
    (1, 3, 6, 1, 4, 1, 17268, 2818, 6, 15, 3, 3, 2, 4, 1, 5),
