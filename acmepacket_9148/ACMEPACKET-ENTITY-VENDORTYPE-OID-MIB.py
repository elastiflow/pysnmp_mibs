...
# Notes
# -----
# ASN.1 source file:///Users/rob/MIBs/acmepacket_9148/ACMEPACKET-ENTITY-VENDORTYPE-OID-MIB.mib
...
_ApevChassisSD5_ObjectIdentity = ObjectIdentity
apevChassisSD5 = _ApevChassisSD5_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 9148, 6, 1, 1, 3, 2, 7)
)
_ApevChassisSD6_ObjectIdentity = ObjectIdentity
apevChassisSD6 = _ApevChassisSD6_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 9148, 6, 1, 1, 3, 2, 8)
)
...
_ApevPowerSupply1100W_ObjectIdentity = ObjectIdentity
apevPowerSupply1100W = _ApevPowerSupply1100W_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 9148, 6, 1, 1, 5, 4)
)
_ApevPowerSupply60W_ObjectIdentity = ObjectIdentity
apevPowerSupply60W = _ApevPowerSupply60W_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 9148, 6, 1, 1, 5, 5)
)
...
_ApevFan40x10_ObjectIdentity = ObjectIdentity
apevFan40x10 = _ApevFan40x10_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 9148, 6, 1, 1, 6, 4)
)
...
_ApevPHY210GigPortsDataPlane_ObjectIdentity = ObjectIdentity
apevPHY210GigPortsDataPlane = _ApevPHY210GigPortsDataPlane_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 9148, 6, 1, 1, 8, 2, 17)
)
_ApevPHYTranscodingCarrier_ObjectIdentity = ObjectIdentity
apevPHYTranscodingCarrier = _ApevPHYTranscodingCarrier_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 9148, 6, 1, 1, 8, 2, 18)
)
_ApevPHYISR_ObjectIdentity = ObjectIdentity
apevPHYISR = _ApevPHYISR_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 9148, 6, 1, 1, 8, 2, 19)
)
_ApevPHY210GigSecPortsDataPlane_ObjectIdentity = ObjectIdentity
apevPHY210GigSecPortsDataPlane = _ApevPHY210GigSecPortsDataPlane_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 9148, 6, 1, 1, 8, 2, 20)
)
...
_ApevModuleMain_ObjectIdentity = ObjectIdentity
apevModuleMain = _ApevModuleMain_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 9148, 6, 1, 1, 8, 8, 7)
)
_ApevModuleMgmt_ObjectIdentity = ObjectIdentity
apevModuleMgmt = _ApevModuleMgmt_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 9148, 6, 1, 1, 8, 8, 8)
)
_ApevModuleFlex_ObjectIdentity = ObjectIdentity
apevModuleFlex = _ApevModuleFlex_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 9148, 6, 1, 1, 8, 8, 9)
)
...
mibBuilder.exportSymbols(
    ...
    **{"acmepacketEntityVendortypeOIDMIB": acmepacketEntityVendortypeOIDMIB,
       ...
       "apevChassisSD5": apevChassisSD5,
       "apevChassisSD6": apevChassisSD6,
       ...
       "apevPowerSupply60W": apevPowerSupply60W,
       "apevFan": apevFan,
       ...
       "apevPHY210GigPortsDataPlane": apevPHY210GigPortsDataPlane,
       "apevPHYTranscodingCarrier": apevPHYTranscodingCarrier,
       "apevPHYISR": apevPHYISR,
       "apevPHY210GigSecPortsDataPlane": apevPHY210GigSecPortsDataPlane,
       ...
       "apevModuleMgmt": apevModuleMgmt,
       "apevModuleFlex": apevModuleFlex,
       "apevPort": apevPort,
