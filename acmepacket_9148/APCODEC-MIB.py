...
# Notes
# -----
# ASN.1 source file:///Users/rob/MIBs/acmepacket_9148/APCODEC-MIB.mib
...
_ApCodecRealmCountAMRWB_Type = Counter32
_ApCodecRealmCountAMRWB_Object = MibTableColumn
apCodecRealmCountAMRWB = _ApCodecRealmCountAMRWB_Object(
    (1, 3, 6, 1, 4, 1, 9148, 3, 7, 1, 1, 1, 19),
    _ApCodecRealmCountAMRWB_Type()
)
apCodecRealmCountAMRWB.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    apCodecRealmCountAMRWB.setStatus("current")
_ApCodecRealmCountEVRC0_Type = Counter32
_ApCodecRealmCountEVRC0_Object = MibTableColumn
apCodecRealmCountEVRC0 = _ApCodecRealmCountEVRC0_Object(
    (1, 3, 6, 1, 4, 1, 9148, 3, 7, 1, 1, 1, 20),
    _ApCodecRealmCountEVRC0_Type()
)
apCodecRealmCountEVRC0.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    apCodecRealmCountEVRC0.setStatus("current")
_ApCodecRealmCountEVRC1_Type = Counter32
_ApCodecRealmCountEVRC1_Object = MibTableColumn
apCodecRealmCountEVRC1 = _ApCodecRealmCountEVRC1_Object(
    (1, 3, 6, 1, 4, 1, 9148, 3, 7, 1, 1, 1, 21),
    _ApCodecRealmCountEVRC1_Type()
)
apCodecRealmCountEVRC1.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    apCodecRealmCountEVRC1.setStatus("current")
_ApCodecRealmCountEVRCB_Type = Counter32
_ApCodecRealmCountEVRCB_Object = MibTableColumn
apCodecRealmCountEVRCB = _ApCodecRealmCountEVRCB_Object(
    (1, 3, 6, 1, 4, 1, 9148, 3, 7, 1, 1, 1, 22),
    _ApCodecRealmCountEVRCB_Type()
)
apCodecRealmCountEVRCB.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    apCodecRealmCountEVRCB.setStatus("current")
_ApCodecRealmCountEVRCB0_Type = Counter32
_ApCodecRealmCountEVRCB0_Object = MibTableColumn
apCodecRealmCountEVRCB0 = _ApCodecRealmCountEVRCB0_Object(
    (1, 3, 6, 1, 4, 1, 9148, 3, 7, 1, 1, 1, 23),
    _ApCodecRealmCountEVRCB0_Type()
)
apCodecRealmCountEVRCB0.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    apCodecRealmCountEVRCB0.setStatus("current")
_ApCodecRealmCountEVRCB1_Type = Counter32
_ApCodecRealmCountEVRCB1_Object = MibTableColumn
apCodecRealmCountEVRCB1 = _ApCodecRealmCountEVRCB1_Object(
    (1, 3, 6, 1, 4, 1, 9148, 3, 7, 1, 1, 1, 24),
    _ApCodecRealmCountEVRCB1_Type()
)
apCodecRealmCountEVRCB1.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    apCodecRealmCountEVRCB1.setStatus("current")
...
apCodecRealmStatsObjectsGroup3 = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 9148, 3, 7, 5, 2, 5)
)
apCodecRealmStatsObjectsGroup3.setObjects(
    ("APCODEC-MIB", "apCodecRealmCountAMRWB")
)
if mibBuilder.loadTexts:
    apCodecRealmStatsObjectsGroup3.setStatus("current")

apCodecRealmStatsObjectsGroup4 = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 9148, 3, 7, 5, 2, 6)
)
apCodecRealmStatsObjectsGroup4.setObjects(
      *(("APCODEC-MIB", "apCodecRealmCountEVRC0"),
        ("APCODEC-MIB", "apCodecRealmCountEVRC1"),
        ("APCODEC-MIB", "apCodecRealmCountEVRCB"),
        ("APCODEC-MIB", "apCodecRealmCountEVRCB0"),
        ("APCODEC-MIB", "apCodecRealmCountEVRCB1"))
)
if mibBuilder.loadTexts:
    apCodecRealmStatsObjectsGroup4.setStatus("current")
...
mibBuilder.exportSymbols(
    ...
    **{"ApCodecDigitTypes": ApCodecDigitTypes,
       ...
       "apCodecRealmCountAMRWB": apCodecRealmCountAMRWB,
       "apCodecRealmCountEVRC0": apCodecRealmCountEVRC0,
       "apCodecRealmCountEVRC1": apCodecRealmCountEVRC1,
       "apCodecRealmCountEVRCB": apCodecRealmCountEVRCB,
       "apCodecRealmCountEVRCB0": apCodecRealmCountEVRCB0,
       ...
       "apCodecRealmStatsObjectsGroup3": apCodecRealmStatsObjectsGroup3,
