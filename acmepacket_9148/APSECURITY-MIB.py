...
# Notes
# -----
# ASN.1 source file:///Users/rob/MIBs/acmepacket_9148/APSECURITY-MIB.mib
...
_ApSecurityIkeInterfaceBlacklistAuthIDError_Type = Unsigned32
_ApSecurityIkeInterfaceBlacklistAuthIDError_Object = MibTableColumn
apSecurityIkeInterfaceBlacklistAuthIDError = _ApSecurityIkeInterfaceBlacklistAuthIDError_Object(
    (1, 3, 6, 1, 4, 1, 9148, 3, 9, 1, 9, 1, 34),
    _ApSecurityIkeInterfaceBlacklistAuthIDError_Type()
)
apSecurityIkeInterfaceBlacklistAuthIDError.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    apSecurityIkeInterfaceBlacklistAuthIDError.setStatus("current")
...
apSecurityIkeIfcBlAuthIDErrorObjectsGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 9148, 3, 9, 4, 2, 6)
)
apSecurityIkeIfcBlAuthIDErrorObjectsGroup.setObjects(
    ("APSECURITY-MIB", "apSecurityIkeInterfaceBlacklistAuthIDError")
)
if mibBuilder.loadTexts:
    apSecurityIkeIfcBlAuthIDErrorObjectsGroup.setStatus("current")
...
mibBuilder.exportSymbols(
    ...
    **{"apSecurityModule": apSecurityModule,
       ...
       "apSecurityIkeInterfaceBlacklistAuthIDError": apSecurityIkeInterfaceBlacklistAuthIDError,
       ...
       "apSecurityIkeIfcBlAuthIDErrorObjectsGroup": apSecurityIkeIfcBlAuthIDErrorObjectsGroup,
