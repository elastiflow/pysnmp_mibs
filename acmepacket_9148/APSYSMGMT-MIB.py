...
# Notes
# -----
# ASN.1 source file:///Users/rob/MIBs/acmepacket_9148/APSYSMGMT-MIB.mib
...
_ApSysXCodeEVRCCapacity_Type = SysMgmtPercentage
_ApSysXCodeEVRCCapacity_Object = MibScalar
apSysXCodeEVRCCapacity = _ApSysXCodeEVRCCapacity_Object(
    (1, 3, 6, 1, 4, 1, 9148, 3, 2, 1, 1, 39),
    _ApSysXCodeEVRCCapacity_Type()
)
apSysXCodeEVRCCapacity.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    apSysXCodeEVRCCapacity.setStatus("current")
_ApSysXCodeEVRCBCapacity_Type = SysMgmtPercentage
_ApSysXCodeEVRCBCapacity_Object = MibScalar
apSysXCodeEVRCBCapacity = _ApSysXCodeEVRCBCapacity_Object(
    (1, 3, 6, 1, 4, 1, 9148, 3, 2, 1, 1, 40),
    _ApSysXCodeEVRCBCapacity_Type()
)
apSysXCodeEVRCBCapacity.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    apSysXCodeEVRCBCapacity.setStatus("current")
_ApSysAcpTlsEnabled_Type = TruthValue
_ApSysAcpTlsEnabled_Object = MibScalar
apSysAcpTlsEnabled = _ApSysAcpTlsEnabled_Object(
    (1, 3, 6, 1, 4, 1, 9148, 3, 2, 1, 1, 41),
    _ApSysAcpTlsEnabled_Type()
)
apSysAcpTlsEnabled.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    apSysAcpTlsEnabled.setStatus("current")
_ApSysXCodeG729Capacity_Type = SysMgmtPercentage
_ApSysXCodeG729Capacity_Object = MibScalar
apSysXCodeG729Capacity = _ApSysXCodeG729Capacity_Object(
    (1, 3, 6, 1, 4, 1, 9148, 3, 2, 1, 1, 42),
    _ApSysXCodeG729Capacity_Type()
)
apSysXCodeG729Capacity.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    apSysXCodeG729Capacity.setStatus("current")
_ApSysCPULoadAvgOneMinute_Type = SysMgmtPercentage
_ApSysCPULoadAvgOneMinute_Object = MibScalar
apSysCPULoadAvgOneMinute = _ApSysCPULoadAvgOneMinute_Object(
    (1, 3, 6, 1, 4, 1, 9148, 3, 2, 1, 1, 43),
    _ApSysCPULoadAvgOneMinute_Type()
)
apSysCPULoadAvgOneMinute.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    apSysCPULoadAvgOneMinute.setStatus("current")
_ApSysCPULoadAvgFiveMinute_Type = SysMgmtPercentage
_ApSysCPULoadAvgFiveMinute_Object = MibScalar
apSysCPULoadAvgFiveMinute = _ApSysCPULoadAvgFiveMinute_Object(
    (1, 3, 6, 1, 4, 1, 9148, 3, 2, 1, 1, 44),
    _ApSysCPULoadAvgFiveMinute_Type()
)
apSysCPULoadAvgFiveMinute.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    apSysCPULoadAvgFiveMinute.setStatus("current")
_ApSysCPULoadAvgFiftnMinute_Type = SysMgmtPercentage
_ApSysCPULoadAvgFiftnMinute_Object = MibScalar
apSysCPULoadAvgFiftnMinute = _ApSysCPULoadAvgFiftnMinute_Object(
    (1, 3, 6, 1, 4, 1, 9148, 3, 2, 1, 1, 45),
    _ApSysCPULoadAvgFiftnMinute_Type()
)
apSysCPULoadAvgFiftnMinute.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    apSysCPULoadAvgFiftnMinute.setStatus("current")
...
apSysMgmtGeneralGroup.setObjects(
      *(("APSYSMGMT-MIB", "apSysCPUUtil"),
        ...
        ("APSYSMGMT-MIB", "apSysAcpTlsEnabled"))
)
if mibBuilder.loadTexts:
...
apSysMgmtXCodeEVRCUtilGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 9148, 3, 2, 4, 2, 29)
)
apSysMgmtXCodeEVRCUtilGroup.setObjects(
      *(("APSYSMGMT-MIB", "apSysXCodeEVRCCapacity"),
        ("APSYSMGMT-MIB", "apSysXCodeEVRCBCapacity"))
)
if mibBuilder.loadTexts:
    apSysMgmtXCodeEVRCUtilGroup.setStatus("current")

apSysMgmtXCodeG729UtilGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 9148, 3, 2, 4, 2, 30)
)
apSysMgmtXCodeG729UtilGroup.setObjects(
    ("APSYSMGMT-MIB", "apSysXCodeG729Capacity")
)
if mibBuilder.loadTexts:
    apSysMgmtXCodeG729UtilGroup.setStatus("current")

apSysMgmtCPULoadAvgGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 9148, 3, 2, 4, 2, 31)
)
apSysMgmtCPULoadAvgGroup.setObjects(
      *(("APSYSMGMT-MIB", "apSysCPULoadAvgOneMinute"),
        ("APSYSMGMT-MIB", "apSysCPULoadAvgFiveMinute"),
        ("APSYSMGMT-MIB", "apSysCPULoadAvgFiftnMinute"))
)
if mibBuilder.loadTexts:
    apSysMgmtCPULoadAvgGroup.setStatus("current")
...
apSysMgmtCPULoadAvgTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 9148, 3, 2, 6, 0, 86)
)
apSysMgmtCPULoadAvgTrap.setObjects(
    ("APSYSMGMT-MIB", "apSysCPULoadAvgFiveMinute")
)
if mibBuilder.loadTexts:
    apSysMgmtCPULoadAvgTrap.setStatus(
        "current"
    )

apSysMgmtCPULoadAvgClearTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 9148, 3, 2, 6, 0, 87)
)
apSysMgmtCPULoadAvgClearTrap.setObjects(
    ("APSYSMGMT-MIB", "apSysCPULoadAvgFiveMinute")
)
if mibBuilder.loadTexts:
    apSysMgmtCPULoadAvgClearTrap.setStatus(
        "current"
    )
...
apSysMgmtCPULoadAvgNotificationsGroup = NotificationGroup(
    (1, 3, 6, 1, 4, 1, 9148, 3, 2, 4, 3, 39)
)
apSysMgmtCPULoadAvgNotificationsGroup.setObjects(
      *(("APSYSMGMT-MIB", "apSysMgmtCPULoadAvgTrap"),
        ("APSYSMGMT-MIB", "apSysMgmtCPULoadAvgClearTrap"))
)
if mibBuilder.loadTexts:
    apSysMgmtCPULoadAvgNotificationsGroup.setStatus(
        "current"
    )
...
mibBuilder.exportSymbols(
    ...
    **{"SysMgmtPercentage": SysMgmtPercentage,
       ...
       "apSysCPULoadAvgOneMinute": apSysCPULoadAvgOneMinute,
       "apSysCPULoadAvgFiveMinute": apSysCPULoadAvgFiveMinute,
       "apSysCPULoadAvgFiftnMinute": apSysCPULoadAvgFiftnMinute,
       ...
       "apSysMgmtXCodeEVRCUtilGroup": apSysMgmtXCodeEVRCUtilGroup,
       "apSysMgmtXCodeG729UtilGroup": apSysMgmtXCodeG729UtilGroup,
       "apSysMgmtCPULoadAvgGroup": apSysMgmtCPULoadAvgGroup,
       ...
       "apSysMgmtCPULoadAvgNotificationsGroup": apSysMgmtCPULoadAvgNotificationsGroup,
