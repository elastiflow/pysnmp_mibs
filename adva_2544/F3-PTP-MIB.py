...
# Notes
# -----
# ASN.1 source file:///Users/rob/MIBs/adva_2544/F3-PTP-MIB.mib
...
if mibBuilder.loadTexts:
    f3PtpTSClockClass.setStatus("current")
...
f3PtpTrafficPortFlowPointEntry.setIndexNames(
    ...
    (0, "CM-ENTITY-MIB", "shelfIndex"),
    (0, "CM-ENTITY-MIB", "slotIndex"),
    (0, "F3-PTP-MIB", "cmEthernetTrafficPortIndex"),
...
if mibBuilder.loadTexts:
    f3PtpPTPPortNotSlave.setStatus("current")
...
if mibBuilder.loadTexts:
    f3PtpPTPPortStatsUnknownMasterDiscards.setStatus("current")
...
if mibBuilder.loadTexts:
    f3PtpPTPPortStatsMsgMiscDiscards.setStatus("current")
...
if mibBuilder.loadTexts:
    f3PtpPTPPortHistoryUnknownMasterDiscards.setStatus("current")
...
if mibBuilder.loadTexts:
    f3PtpPTPPortHistoryMsgMiscDiscards.setStatus("current")
