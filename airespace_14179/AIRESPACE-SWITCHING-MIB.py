...
# Notes
# -----
# ASN.1 source file:///Users/rob/MIBs/airespace_14179/AIRESPACE-SWITCHING-MIB.mib
# Produced by pysmi-1.5.11 at Fri May 23 23:46:33 2025
...
class _AgentInterfaceUrlAclName_Type(DisplayString):
    """Custom type agentInterfaceUrlAclName based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 32),
    )
...
_AgentInterfaceUrlAclName_Type.__name__ = "DisplayString"
_AgentInterfaceUrlAclName_Object = MibTableColumn
agentInterfaceUrlAclName = _AgentInterfaceUrlAclName_Object(
    (1, 3, 6, 1, 4, 1, 14179, 1, 2, 13, 1, 18),
    _AgentInterfaceUrlAclName_Type()
)
agentInterfaceUrlAclName.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    agentInterfaceUrlAclName.setStatus("current")
...
class _AgentDhcpScopeVlan_Type(Integer32):
    """Custom type agentDhcpScopeVlan based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_AgentDhcpScopeVlan_Type.__name__ = "Integer32"
_AgentDhcpScopeVlan_Object = MibTableColumn
agentDhcpScopeVlan = _AgentDhcpScopeVlan_Object(
    (1, 3, 6, 1, 4, 1, 14179, 1, 2, 15, 1, 1, 19),
    _AgentDhcpScopeVlan_Type()
)
agentDhcpScopeVlan.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    agentDhcpScopeVlan.setStatus("current")


class _AgentDhcpScopeVlanNative_Type(Integer32):
    """Custom type agentDhcpScopeVlanNative based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_AgentDhcpScopeVlanNative_Type.__name__ = "Integer32"
_AgentDhcpScopeVlanNative_Object = MibTableColumn
agentDhcpScopeVlanNative = _AgentDhcpScopeVlanNative_Object(
    (1, 3, 6, 1, 4, 1, 14179, 1, 2, 15, 1, 1, 20),
    _AgentDhcpScopeVlanNative_Type()
)
agentDhcpScopeVlanNative.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    agentDhcpScopeVlanNative.setStatus("current")
...
_AgentDhcpLeaseGroup_ObjectIdentity = ObjectIdentity
agentDhcpLeaseGroup = _AgentDhcpLeaseGroup_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 14179, 1, 2, 16)
)
_AgentDhcpLeaseTable_Object = MibTable
agentDhcpLeaseTable = _AgentDhcpLeaseTable_Object(
    (1, 3, 6, 1, 4, 1, 14179, 1, 2, 16, 1)
)
if mibBuilder.loadTexts:
    agentDhcpLeaseTable.setStatus("current")
_AgentDhcpLeaseEntry_Object = MibTableRow
agentDhcpLeaseEntry = _AgentDhcpLeaseEntry_Object(
    (1, 3, 6, 1, 4, 1, 14179, 1, 2, 16, 1, 1)
)
agentDhcpLeaseEntry.setIndexNames(
    (0, "AIRESPACE-SWITCHING-MIB", "agentDhcpLeaseMacAddress"),
)
if mibBuilder.loadTexts:
    agentDhcpLeaseEntry.setStatus("current")
_AgentDhcpLeaseMacAddress_Type = MacAddress
_AgentDhcpLeaseMacAddress_Object = MibTableColumn
agentDhcpLeaseMacAddress = _AgentDhcpLeaseMacAddress_Object(
    (1, 3, 6, 1, 4, 1, 14179, 1, 2, 16, 1, 1, 1),
    _AgentDhcpLeaseMacAddress_Type()
)
agentDhcpLeaseMacAddress.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    agentDhcpLeaseMacAddress.setStatus("current")
_AgentDhcpLeaseIPAddress_Type = IpAddress
_AgentDhcpLeaseIPAddress_Object = MibTableColumn
agentDhcpLeaseIPAddress = _AgentDhcpLeaseIPAddress_Object(
    (1, 3, 6, 1, 4, 1, 14179, 1, 2, 16, 1, 1, 2),
    _AgentDhcpLeaseIPAddress_Type()
)
agentDhcpLeaseIPAddress.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    agentDhcpLeaseIPAddress.setStatus("current")


class _AgentDhcpLeaseExpiry_Type(Integer32):
    """Custom type agentDhcpLeaseExpiry based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_AgentDhcpLeaseExpiry_Type.__name__ = "Integer32"
_AgentDhcpLeaseExpiry_Object = MibTableColumn
agentDhcpLeaseExpiry = _AgentDhcpLeaseExpiry_Object(
    (1, 3, 6, 1, 4, 1, 14179, 1, 2, 16, 1, 1, 3),
    _AgentDhcpLeaseExpiry_Type()
)
agentDhcpLeaseExpiry.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    agentDhcpLeaseExpiry.setStatus("current")
_AgentDhcpClearLeaseGroup_ObjectIdentity = ObjectIdentity
agentDhcpClearLeaseGroup = _AgentDhcpClearLeaseGroup_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 14179, 1, 2, 17)
)
_AgentDhcpClearLeaseIPAddress_Type = IpAddress
_AgentDhcpClearLeaseIPAddress_Object = MibScalar
agentDhcpClearLeaseIPAddress = _AgentDhcpClearLeaseIPAddress_Object(
    (1, 3, 6, 1, 4, 1, 14179, 1, 2, 17, 1),
    _AgentDhcpClearLeaseIPAddress_Type()
)
agentDhcpClearLeaseIPAddress.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    agentDhcpClearLeaseIPAddress.setStatus("current")
...
bsnSwitchingAgentConfigGroup.setObjects(
      *(("AIRESPACE-SWITCHING-MIB", "agentLoginSessionIndex"),
        ...
        ("AIRESPACE-SWITCHING-MIB", "agentInterfaceUrlAclName"),
        ...
        ("AIRESPACE-SWITCHING-MIB", "agentDhcpScopeVlan"),
        ("AIRESPACE-SWITCHING-MIB", "agentDhcpScopeVlanNative"),
...
mibBuilder.exportSymbols(
    ...
    **{"bsnSwitching": bsnSwitching,
       ...
       "agentInterfaceUrlAclName": agentInterfaceUrlAclName,
       ...
       "agentDhcpScopeVlan": agentDhcpScopeVlan,
       "agentDhcpScopeVlanNative": agentDhcpScopeVlanNative,
       "agentDhcpScopeRowStatus": agentDhcpScopeRowStatus,
       "agentDhcpLeaseGroup": agentDhcpLeaseGroup,
       "agentDhcpLeaseTable": agentDhcpLeaseTable,
       "agentDhcpLeaseEntry": agentDhcpLeaseEntry,
       "agentDhcpLeaseMacAddress": agentDhcpLeaseMacAddress,
       "agentDhcpLeaseIPAddress": agentDhcpLeaseIPAddress,
       "agentDhcpLeaseExpiry": agentDhcpLeaseExpiry,
       "agentDhcpClearLeaseGroup": agentDhcpClearLeaseGroup,
       "agentDhcpClearLeaseIPAddress": agentDhcpClearLeaseIPAddress,
