...
# Notes
# -----
# ASN.1 source file:///Users/rob/MIBs/arista_30065/ARISTA-HARDWARE-UTILIZATION-MIB.mib
...
class _AristaHardwareUtilizationSharedFeatures_Type(OctetString):
    """Custom type aristaHardwareUtilizationSharedFeatures based on OctetString"""
...
_AristaHardwareUtilizationSharedFeatures_Type.__name__ = "OctetString"
_AristaHardwareUtilizationSharedFeatures_Object = MibTableColumn
aristaHardwareUtilizationSharedFeatures = _AristaHardwareUtilizationSharedFeatures_Object(
    (1, 3, 6, 1, 4, 1, 30065, 3, 22, 1, 1, 1, 10),
    _AristaHardwareUtilizationSharedFeatures_Type()
)
aristaHardwareUtilizationSharedFeatures.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    aristaHardwareUtilizationSharedFeatures.setStatus("current")
...
aristaHardwareUtilizationTableGroup.setObjects(
      *(("ARISTA-HARDWARE-UTILIZATION-MIB", "aristaHardwareUtilizationInUseEntries"),
        ...
        ("ARISTA-HARDWARE-UTILIZATION-MIB", "aristaHardwareUtilizationSharedFeatures"))
)
if mibBuilder.loadTexts:
...
mibBuilder.exportSymbols(
    ...
    **{"aristaHardwareUtilizationMIB": aristaHardwareUtilizationMIB,
       ...
       "aristaHardwareUtilizationSharedFeatures": aristaHardwareUtilizationSharedFeatures,
