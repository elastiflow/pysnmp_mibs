...
# Notes
# -----
# ASN.1 source file:///Users/rob/MIBs/aruba_14823/WLSX-SWITCH-MIB.mib
...
if mibBuilder.loadTexts:
    wlsxSwitchMasterIp.setStatus("obsolete")
...
if mibBuilder.loadTexts:
    wlsxSwitchMasterIpv6.setStatus("obsolete")
_WlsxSwitchConductorIp_Type = IpAddress
_WlsxSwitchConductorIp_Object = MibScalar
wlsxSwitchConductorIp = _WlsxSwitchConductorIp_Object(
    (1, 3, 6, 1, 4, 1, 14823, 2, 2, 1, 1, 1, 15),
    _WlsxSwitchConductorIp_Type()
)
wlsxSwitchConductorIp.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    wlsxSwitchConductorIp.setStatus("current")


class _WlsxSwitchConductorIpv6_Type(DisplayString):
    """Custom type wlsxSwitchConductorIpv6 based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 45),
    )
...
_WlsxSwitchConductorIpv6_Type.__name__ = "DisplayString"
_WlsxSwitchConductorIpv6_Object = MibScalar
wlsxSwitchConductorIpv6 = _WlsxSwitchConductorIpv6_Object(
    (1, 3, 6, 1, 4, 1, 14823, 2, 2, 1, 1, 1, 16),
    _WlsxSwitchConductorIpv6_Type()
)
wlsxSwitchConductorIpv6.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    wlsxSwitchConductorIpv6.setStatus("current")
...
if mibBuilder.loadTexts:
    apCurrentChannel.setStatus("deprecated")
...
_ApCurrentChannelV2_Type = Integer32
_ApCurrentChannelV2_Object = MibTableColumn
apCurrentChannelV2 = _ApCurrentChannelV2_Object(
    (1, 3, 6, 1, 4, 1, 14823, 2, 2, 1, 1, 3, 3, 1, 17),
    _ApCurrentChannelV2_Type()
)
apCurrentChannelV2.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    apCurrentChannelV2.setStatus("current")
_ApSecChannelNum_Type = Integer32
_ApSecChannelNum_Object = MibTableColumn
apSecChannelNum = _ApSecChannelNum_Object(
    (1, 3, 6, 1, 4, 1, 14823, 2, 2, 1, 1, 3, 3, 1, 18),
    _ApSecChannelNum_Type()
)
apSecChannelNum.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    apSecChannelNum.setStatus("current")
_ApHTMode_Type = ArubaHTMode
_ApHTMode_Object = MibTableColumn
apHTMode = _ApHTMode_Object(
    (1, 3, 6, 1, 4, 1, 14823, 2, 2, 1, 1, 3, 3, 1, 19),
    _ApHTMode_Type()
)
apHTMode.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    apHTMode.setStatus("current")
...
if mibBuilder.loadTexts:
    apStatsChannel.setStatus("deprecated")
...
_ApStatsChannelV2_Type = Integer32
_ApStatsChannelV2_Object = MibTableColumn
apStatsChannelV2 = _ApStatsChannelV2_Object(
    (1, 3, 6, 1, 4, 1, 14823, 2, 2, 1, 1, 3, 5, 1, 18),
    _ApStatsChannelV2_Type()
)
apStatsChannelV2.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    apStatsChannelV2.setStatus("current")
_ApStatsSecChannel_Type = Integer32
_ApStatsSecChannel_Object = MibTableColumn
apStatsSecChannel = _ApStatsSecChannel_Object(
    (1, 3, 6, 1, 4, 1, 14823, 2, 2, 1, 1, 3, 5, 1, 19),
    _ApStatsSecChannel_Type()
)
apStatsSecChannel.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    apStatsSecChannel.setStatus("current")
_ApStatsPhyType_Type = ArubaPhyType
_ApStatsPhyType_Object = MibTableColumn
apStatsPhyType = _ApStatsPhyType_Object(
    (1, 3, 6, 1, 4, 1, 14823, 2, 2, 1, 1, 3, 5, 1, 20),
    _ApStatsPhyType_Type()
)
apStatsPhyType.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    apStatsPhyType.setStatus("current")
_ApStatsHTMode_Type = ArubaHTMode
_ApStatsHTMode_Object = MibTableColumn
apStatsHTMode = _ApStatsHTMode_Object(
    (1, 3, 6, 1, 4, 1, 14823, 2, 2, 1, 1, 3, 5, 1, 21),
    _ApStatsHTMode_Type()
)
apStatsHTMode.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    apStatsHTMode.setStatus("current")
...
if mibBuilder.loadTexts:
    wlsxStationBlackListReason.setStatus("obsolete")
...
if mibBuilder.loadTexts:
    wlsxStationBlackListReasonStr.setStatus("obsolete")
...
mibBuilder.exportSymbols(
    ...
    **{"wlsxSwitchMIB": wlsxSwitchMIB,
       ...
       "wlsxSwitchConductorIp": wlsxSwitchConductorIp,
       "wlsxSwitchConductorIpv6": wlsxSwitchConductorIpv6,
       ...
       "apCurrentChannelV2": apCurrentChannelV2,
       "apSecChannelNum": apSecChannelNum,
       "apHTMode": apHTMode,
       ...
       "apStatsChannelV2": apStatsChannelV2,
       "apStatsSecChannel": apStatsSecChannel,
       "apStatsPhyType": apStatsPhyType,
       "apStatsHTMode": apStatsHTMode,
