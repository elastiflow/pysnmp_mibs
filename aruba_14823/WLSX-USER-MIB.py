...
# Notes
# -----
# ASN.1 source file:///Users/rob/MIBs/aruba_14823/WLSX-USER-MIB.mib
...
_NVIAUserDeviceID_Type = MacAddress
_NVIAUserDeviceID_Object = MibTableColumn
nVIAUserDeviceID = _NVIAUserDeviceID_Object(
    (1, 3, 6, 1, 4, 1, 14823, 2, 2, 1, 4, 1, 2, 1, 44),
    _NVIAUserDeviceID_Type()
)
nVIAUserDeviceID.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    nVIAUserDeviceID.setStatus("current")
...
mibBuilder.exportSymbols(
    ...
    **{"wlsxUserMIB": wlsxUserMIB,
       ...
       "nVIAUserDeviceID": nVIAUserDeviceID,
