...
atmfVpcChange.setObjects(
      *(("ATM-FORUM-MIB", "atmfVpcPortIndex"),
        ("ATM-FORUM-MIB", "atmfVpcVpi"),
        ("ATM-FORUM-MIB", "atmfVpcOperStatus"))
)
if mibBuilder.loadTexts:
...
atmfVccChange.setObjects(
      *(("ATM-FORUM-MIB", "atmfVccPortIndex"),
        ("ATM-FORUM-MIB", "atmfVccVci"),
        ("ATM-FORUM-MIB", "atmfVccVpi"),
        ("ATM-FORUM-MIB", "atmfVccOperStatus"))
)
if mibBuilder.loadTexts:
