...
# Notes
# -----
# ASN.1 source file:///Users/rob/MIBs/atmforum_353/ATM-POLICY-CONSTRAINT-MIB.mib
...
class _PolicyConstraintName_Type(DisplayString):
    """Custom type policyConstraintName based on DisplayString"""
    defaultValue = OctetString("")


_PolicyConstraintName_Type.__name__ = "DisplayString"
...
class _PolicyName_Type(DisplayString):
    """Custom type policyName based on DisplayString"""
    defaultValue = OctetString("")


_PolicyName_Type.__name__ = "DisplayString"
...
policyConstraintMIBCompliance.setObjects(
      *(("ATM-POLICY-CONSTRAINT-MIB", "policyConstraintMIBMandatoryGroup"),
        ("ATM-POLICY-CONSTRAINT-MIB", "atmTraceConnAndPathFilterMandatoryGroup2"))
)
if mibBuilder.loadTexts:
