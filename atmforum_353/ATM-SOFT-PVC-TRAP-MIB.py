# SNMP MIB module (ATM-SOFT-PVC-TRAP-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/rob/MIBs/atmforum_353/ATM-SOFT-PVC-TRAP-MIB.mib
...
(atmSoftPvcCallFailures,
 ...
 atmSoftPvcTrapsPrefix) = mibBuilder.importSymbols(
    "ATM-SOFT-PVC-MIB",
    "atmSoftPvcCallFailures",
    "atmSoftPvcCurrentlyFailingSoftPVccs",
    "atmSoftPvcCurrentlyFailingSoftPVpcs",
...
atmSoftPvcCallFailuresTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 353, 5, 5, 1, 2, 1, 0, 0, 1)
)
