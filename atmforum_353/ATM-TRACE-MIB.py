...
# Notes
# -----
# ASN.1 source file:///Users/rob/MIBs/atmforum_353/ATM-TRACE-MIB.mib
...
_AtmTraceConnTraceConnId_Type.__name__ = "TruthValue"
...
_AtmTraceConnTraceCallRef_Type.__name__ = "TruthValue"
...
_AtmTraceConnPassAlongRequest_Type.__name__ = "TruthValue"
...
_AtmTraceConnTrapOnCompletion_Type.__name__ = "TruthValue"
...
_AtmTraceConnTraceNeNsc_Type.__name__ = "TruthValue"
...
_AtmTraceConnTraceRpNsc_Type.__name__ = "TruthValue"
...
_AtmTraceConnTraceIncoming_Type.__name__ = "TruthValue"
...
_AtmTraceConnTraceLabels_Type.__name__ = "TruthValue"
...
_AtmTracePathTestConnCastType_Type.__name__ = "AtmConnCastType"
...
_AtmTracePathTestP2MpNewConn_Type.__name__ = "TruthValue"
...
_AtmTracePathTestOrigVpi_Type.__name__ = "AtmVpIdentifier"
...
_AtmTracePathTestOrigVci_Type.__name__ = "AtmVcIdentifier"
...
class _AtmTracePathTestCallingParty_Type(AtmAddr):
    """Custom type atmTracePathTestCallingParty based on AtmAddr"""
    defaultValue = OctetString("")


_AtmTracePathTestCallingParty_Type.__name__ = "AtmAddr"
...
_AtmTracePathTestRxTrafDescrIndex_Type.__name__ = "AtmTrafficDescrParamIndex"
...
_AtmTracePathTestTxTrafDescrIndex_Type.__name__ = "AtmTrafficDescrParamIndex"
...
_AtmTracePathTestClearCallAtTDest_Type.__name__ = "TruthValue"
...
_AtmTracePathTestTraceCrankback_Type.__name__ = "TruthValue"
...
_AtmTracePathTestTraceConnId_Type.__name__ = "TruthValue"
...
_AtmTracePathTestTraceCallRef_Type.__name__ = "TruthValue"
...
_AtmTracePathTestPassAlongRequest_Type.__name__ = "TruthValue"
...
_AtmTracePathTestTrapOnCompletion_Type.__name__ = "TruthValue"
...
_AtmTracePathTestTraceNeNsc_Type.__name__ = "TruthValue"
...
_AtmTracePathTestTraceRpNsc_Type.__name__ = "TruthValue"
...
_AtmTracePathTestTraceIncoming_Type.__name__ = "TruthValue"
...
_AtmTracePathTestPolicyConstraint_Type.__name__ = "PolicyConstraintIndex"
...
_AtmTracePathTestTraceLabels_Type.__name__ = "TruthValue"
...
_AtmTraceFilterInIf_Type.__name__ = "InterfaceIndexOrZero"
...
_AtmTraceFilterOutIf_Type.__name__ = "InterfaceIndexOrZero"
...
class _AtmTraceFilterCallingPartyPrefix_Type(AtmAddr):
    """Custom type atmTraceFilterCallingPartyPrefix based on AtmAddr"""
    defaultValue = OctetString("")


_AtmTraceFilterCallingPartyPrefix_Type.__name__ = "AtmAddr"
...
class _AtmTraceFilterCalledPartyPrefix_Type(AtmAddr):
    """Custom type atmTraceFilterCalledPartyPrefix based on AtmAddr"""
    defaultValue = OctetString("")


_AtmTraceFilterCalledPartyPrefix_Type.__name__ = "AtmAddr"
...
_AtmTraceFilterClearCallAtTDest_Type.__name__ = "TruthValue"
...
_AtmTraceFilterTraceCrankback_Type.__name__ = "TruthValue"
...
_AtmTraceFilterTraceConnId_Type.__name__ = "TruthValue"
...
_AtmTraceFilterTraceCallRef_Type.__name__ = "TruthValue"
...
_AtmTraceFilterPassAlongRequest_Type.__name__ = "TruthValue"
...
_AtmTraceFilterTrapEnable_Type.__name__ = "TruthValue"
...
_AtmTraceFilterPolicy_Type.__name__ = "TruthValue"
...
_AtmTraceFilterTraceNeNsc_Type.__name__ = "TruthValue"
...
_AtmTraceFilterTraceRpNsc_Type.__name__ = "TruthValue"
...
_AtmTraceFilterTraceIncoming_Type.__name__ = "TruthValue"
...
_AtmTraceFilterTraceLabels_Type.__name__ = "TruthValue"
...
_AtmTraceIfTraceBoundary_Type.__name__ = "TruthValue"
...
atmTracePathFilterPolicyMandatoryGroup2 = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 353, 5, 9, 2, 1, 3, 2, 16)
)
atmTracePathFilterPolicyMandatoryGroup2.setObjects(
...
if mibBuilder.loadTexts:
    atmTracePathFilterPolicyMandatoryGroup2.setStatus("current")
...
atmTracePathTestMplsMandatoryGroup2 = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 353, 5, 9, 2, 1, 3, 2, 19)
)
atmTracePathTestMplsMandatoryGroup2.setObjects(
    ("ATM-TRACE-MIB", "atmTracePathTestTraceLabels")
)
if mibBuilder.loadTexts:
    atmTracePathTestMplsMandatoryGroup2.setStatus("current")

atmTracePathFilterMplsMandatoryGroup2 = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 353, 5, 9, 2, 1, 3, 2, 20)
)
atmTracePathFilterMplsMandatoryGroup2.setObjects(
    ("ATM-TRACE-MIB", "atmTraceFilterTraceLabels")
)
if mibBuilder.loadTexts:
    atmTracePathFilterMplsMandatoryGroup2.setStatus("current")
...
atmTraceMIBCompliance.setObjects(
      *(("ATM-TRACE-MIB", "atmTraceMIBMandatoryGroup"),
        ("ATM-TRACE-MIB", "atmTraceConnAndPathFilterMandatoryGroup"),
        ("ATM-TRACE-MIB", "atmTracePathMandatoryGroup"),
        ("ATM-TRACE-MIB", "atmTraceConnMandatoryGroup"),
        ("ATM-TRACE-MIB", "atmTracePathTestMandatoryGroup"),
        ("ATM-TRACE-MIB", "atmTracePathFilterMandatoryGroup"))
)
if mibBuilder.loadTexts:
...
atmTraceMIBCompliance2.setObjects(
      *(("ATM-TRACE-MIB", "atmTraceMIBMandatoryGroup"),
        ("ATM-TRACE-MIB", "atmTraceConnAndPathFilterMandatoryGroup"),
        ("ATM-TRACE-MIB", "atmTracePathMandatoryGroup"),
        ("ATM-TRACE-MIB", "atmTraceConnMandatoryGroup"),
        ("ATM-TRACE-MIB", "atmTracePathTestMandatoryGroup"),
        ("ATM-TRACE-MIB", "atmTracePathFilterMandatoryGroup"),
        ("ATM-TRACE-MIB", "atmTraceConnAndPathFilterPolicyMandatoryGroup"),
        ("ATM-TRACE-MIB", "atmTraceConnPolicyMandatoryGroup"),
        ("ATM-TRACE-MIB", "atmTracePathTestPolicyMandatoryGroup"),
        ("ATM-TRACE-MIB", "atmTracePathFilterPolicyMandatoryGroup"),
        ("ATM-TRACE-MIB", "atmTraceConnAndPathFilterMplsMandatoryGroup"),
        ("ATM-TRACE-MIB", "atmTraceConnMplsMandatoryGroup"),
        ("ATM-TRACE-MIB", "atmTracePathTestMplsMandatoryGroup"),
        ("ATM-TRACE-MIB", "atmTracePathFilterMplsMandatoryGroup"))
)
if mibBuilder.loadTexts:
...
mibBuilder.exportSymbols(
    ...
    **{"CallReference": CallReference,
       ...
       "atmTracePathFilterPolicyMandatoryGroup2": atmTracePathFilterPolicyMandatoryGroup2,
       ...
       "atmTracePathTestMplsMandatoryGroup2": atmTracePathTestMplsMandatoryGroup2,
       "atmTracePathFilterMplsMandatoryGroup2": atmTracePathFilterMplsMandatoryGroup2}
)
