...
# Notes
# -----
# ASN.1 source file:///Users/rob/MIBs/atmforum_353/PNNI-MIB.mib
...
class GfrCapability(TextualConvention, Integer32):
    status = "current"
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
...
_PnniNodeCoBiTransportSupported_Type = TruthValue
_PnniNodeCoBiTransportSupported_Object = MibTableColumn
pnniNodeCoBiTransportSupported = _PnniNodeCoBiTransportSupported_Object(
    (1, 3, 6, 1, 4, 1, 353, 5, 4, 1, 1, 2, 1, 16),
    _PnniNodeCoBiTransportSupported_Type()
)
pnniNodeCoBiTransportSupported.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    pnniNodeCoBiTransportSupported.setStatus("current")
_PnniNodeClBiTransportSupported_Type = TruthValue
_PnniNodeClBiTransportSupported_Object = MibTableColumn
pnniNodeClBiTransportSupported = _PnniNodeClBiTransportSupported_Object(
    (1, 3, 6, 1, 4, 1, 353, 5, 4, 1, 1, 2, 1, 17),
    _PnniNodeClBiTransportSupported_Type()
)
pnniNodeClBiTransportSupported.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    pnniNodeClBiTransportSupported.setStatus("current")
...
class _PnniNodeBeCRT_Type(Integer32):
    """Custom type pnniNodeBeCRT based on Integer32"""
    defaultValue = 20
...
_PnniNodeBeCRT_Type.__name__ = "Integer32"
_PnniNodeBeCRT_Object = MibTableColumn
pnniNodeBeCRT = _PnniNodeBeCRT_Object(
    (1, 3, 6, 1, 4, 1, 353, 5, 4, 1, 1, 4, 1, 14),
    _PnniNodeBeCRT_Type()
)
pnniNodeBeCRT.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    pnniNodeBeCRT.setStatus("current")
if mibBuilder.loadTexts:
    pnniNodeBeCRT.setUnits("percent")
_PnniNodeGenerateUbrAvCR_Type = TruthValue
_PnniNodeGenerateUbrAvCR_Object = MibTableColumn
pnniNodeGenerateUbrAvCR = _PnniNodeGenerateUbrAvCR_Object(
    (1, 3, 6, 1, 4, 1, 353, 5, 4, 1, 1, 4, 1, 15),
    _PnniNodeGenerateUbrAvCR_Type()
)
pnniNodeGenerateUbrAvCR.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    pnniNodeGenerateUbrAvCR.setStatus("current")
_PnniNodeGenerateBeCR_Type = TruthValue
_PnniNodeGenerateBeCR_Object = MibTableColumn
pnniNodeGenerateBeCR = _PnniNodeGenerateBeCR_Object(
    (1, 3, 6, 1, 4, 1, 353, 5, 4, 1, 1, 4, 1, 16),
    _PnniNodeGenerateBeCR_Type()
)
pnniNodeGenerateBeCR.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    pnniNodeGenerateBeCR.setStatus("current")


class _PnniNodeBeCRTuningFactor_Type(Integer32):
    """Custom type pnniNodeBeCRTuningFactor based on Integer32"""
    defaultValue = 100
...
_PnniNodeBeCRTuningFactor_Type.__name__ = "Integer32"
_PnniNodeBeCRTuningFactor_Object = MibTableColumn
pnniNodeBeCRTuningFactor = _PnniNodeBeCRTuningFactor_Object(
    (1, 3, 6, 1, 4, 1, 353, 5, 4, 1, 1, 4, 1, 17),
    _PnniNodeBeCRTuningFactor_Type()
)
pnniNodeBeCRTuningFactor.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    pnniNodeBeCRTuningFactor.setStatus("current")
if mibBuilder.loadTexts:
    pnniNodeBeCRTuningFactor.setUnits("percent")


class _PnniNodeAccBctPm_Type(Integer32):
    """Custom type pnniNodeAccBctPm based on Integer32"""
    defaultValue = 25
...
_PnniNodeAccBctPm_Type.__name__ = "Integer32"
_PnniNodeAccBctPm_Object = MibTableColumn
pnniNodeAccBctPm = _PnniNodeAccBctPm_Object(
    (1, 3, 6, 1, 4, 1, 353, 5, 4, 1, 1, 4, 1, 18),
    _PnniNodeAccBctPm_Type()
)
pnniNodeAccBctPm.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    pnniNodeAccBctPm.setStatus("current")
if mibBuilder.loadTexts:
    pnniNodeAccBctPm.setUnits("percent")
...
class _PnniIfAdmWeightGfr_Type(Unsigned32):
    """Custom type pnniIfAdmWeightGfr based on Unsigned32"""
    defaultValue = 5040
...
_PnniIfAdmWeightGfr_Type.__name__ = "Unsigned32"
_PnniIfAdmWeightGfr_Object = MibTableColumn
pnniIfAdmWeightGfr = _PnniIfAdmWeightGfr_Object(
    (1, 3, 6, 1, 4, 1, 353, 5, 4, 1, 1, 8, 1, 12),
    _PnniIfAdmWeightGfr_Type()
)
pnniIfAdmWeightGfr.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    pnniIfAdmWeightGfr.setStatus("current")
...
_PnniMetricsAvcrIndicatorForUbr_Type = TruthValue
_PnniMetricsAvcrIndicatorForUbr_Object = MibTableColumn
pnniMetricsAvcrIndicatorForUbr = _PnniMetricsAvcrIndicatorForUbr_Object(
    (1, 3, 6, 1, 4, 1, 353, 5, 4, 1, 1, 18, 1, 16),
    _PnniMetricsAvcrIndicatorForUbr_Type()
)
pnniMetricsAvcrIndicatorForUbr.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    pnniMetricsAvcrIndicatorForUbr.setStatus("current")
_PnniMetrics9_Type = Unsigned32
_PnniMetrics9_Object = MibTableColumn
pnniMetrics9 = _PnniMetrics9_Object(
    (1, 3, 6, 1, 4, 1, 353, 5, 4, 1, 1, 18, 1, 17),
    _PnniMetrics9_Type()
)
pnniMetrics9.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    pnniMetrics9.setStatus("current")
_PnniMetricsGfrCapability_Type = GfrCapability
_PnniMetricsGfrCapability_Object = MibTableColumn
pnniMetricsGfrCapability = _PnniMetricsGfrCapability_Object(
    (1, 3, 6, 1, 4, 1, 353, 5, 4, 1, 1, 18, 1, 18),
    _PnniMetricsGfrCapability_Type()
)
pnniMetricsGfrCapability.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    pnniMetricsGfrCapability.setStatus("current")
_PnniMetrics10_Type = Unsigned32
_PnniMetrics10_Object = MibTableColumn
pnniMetrics10 = _PnniMetrics10_Object(
    (1, 3, 6, 1, 4, 1, 353, 5, 4, 1, 1, 18, 1, 19),
    _PnniMetrics10_Type()
)
pnniMetrics10.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    pnniMetrics10.setStatus("current")
...
_PnniRouteNodeGfrCapability_Type = GfrCapability
_PnniRouteNodeGfrCapability_Object = MibTableColumn
pnniRouteNodeGfrCapability = _PnniRouteNodeGfrCapability_Object(
    (1, 3, 6, 1, 4, 1, 353, 5, 4, 1, 1, 19, 2, 1, 29),
    _PnniRouteNodeGfrCapability_Type()
)
pnniRouteNodeGfrCapability.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    pnniRouteNodeGfrCapability.setStatus("current")
...
pnniNodeGssOptionalGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 353, 5, 4, 1, 2, 2, 32)
)
pnniNodeGssOptionalGroup.setObjects(
      *(("PNNI-MIB", "pnniNodeCoBiTransportSupported"),
        ("PNNI-MIB", "pnniNodeClBiTransportSupported"))
)
if mibBuilder.loadTexts:
    pnniNodeGssOptionalGroup.setStatus("current")

pnniUbrWithMdcrOptionalGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 353, 5, 4, 1, 2, 2, 33)
)
pnniUbrWithMdcrOptionalGroup.setObjects(
      *(("PNNI-MIB", "pnniNodeBeCRT"),
        ("PNNI-MIB", "pnniNodeGenerateUbrAvCR"),
        ("PNNI-MIB", "pnniNodeGenerateBeCR"),
        ("PNNI-MIB", "pnniNodeBeCRTuningFactor"),
        ("PNNI-MIB", "pnniMetricsAvcrIndicatorForUbr"),
        ("PNNI-MIB", "pnniMetrics9"))
)
if mibBuilder.loadTexts:
    pnniUbrWithMdcrOptionalGroup.setStatus("current")

pnniGfrOptionalGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 353, 5, 4, 1, 2, 2, 34)
)
pnniGfrOptionalGroup.setObjects(
      *(("PNNI-MIB", "pnniIfAdmWeightGfr"),
        ("PNNI-MIB", "pnniMetricsGfrCapability"),
        ("PNNI-MIB", "pnniMetrics10"),
        ("PNNI-MIB", "pnniRouteNodeGfrCapability"),
        ("PNNI-MIB", "pnniNodeAccBctPm"))
)
if mibBuilder.loadTexts:
    pnniGfrOptionalGroup.setStatus("current")
...
mibBuilder.exportSymbols(
    ...
    **{"PnniAtmAddr": PnniAtmAddr,
       ...
       "pnniNodeCoBiTransportSupported": pnniNodeCoBiTransportSupported,
       "pnniNodeClBiTransportSupported": pnniNodeClBiTransportSupported,
       ...
       "pnniNodeBeCRT": pnniNodeBeCRT,
       "pnniNodeGenerateUbrAvCR": pnniNodeGenerateUbrAvCR,
       "pnniNodeGenerateBeCR": pnniNodeGenerateBeCR,
       "pnniNodeBeCRTuningFactor": pnniNodeBeCRTuningFactor,
       "pnniNodeAccBctPm": pnniNodeAccBctPm,
       ...
       "pnniIfAdmWeightGfr": pnniIfAdmWeightGfr,
       ...
       "pnniMetricsAvcrIndicatorForUbr": pnniMetricsAvcrIndicatorForUbr,
       "pnniMetrics9": pnniMetrics9,
       "pnniMetricsGfrCapability": pnniMetricsGfrCapability,
       "pnniMetrics10": pnniMetrics10,
       ...
       "pnniRouteNodeGfrCapability": pnniRouteNodeGfrCapability,
       ...
       "pnniNodeGssOptionalGroup": pnniNodeGssOptionalGroup,
       "pnniUbrWithMdcrOptionalGroup": pnniUbrWithMdcrOptionalGroup,
       "pnniGfrOptionalGroup": pnniGfrOptionalGroup}
)
