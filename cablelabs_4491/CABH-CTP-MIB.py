...
# Notes
# -----
# ASN.1 source file:///Users/rob/MIBs/cablelabs_4491/CABH-CTP-MIB.mib
...
_CabhCtpLastSetToFactory_Type = TimeStamp
_CabhCtpLastSetToFactory_Object = MibScalar
cabhCtpLastSetToFactory = _CabhCtpLastSetToFactory_Object(
    (1, 3, 6, 1, 4, 1, 4491, 2, 4, 5, 1, 1, 2),
    _CabhCtpLastSetToFactory_Type()
)
cabhCtpLastSetToFactory.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cabhCtpLastSetToFactory.setStatus("current")
...
cabhCtpNotification = _CabhCtpNotification_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 4491, 2, 4, 5, 2)
)
_CabhCtpNotifications_ObjectIdentity = ObjectIdentity
cabhCtpNotifications = _CabhCtpNotifications_ObjectIdentity(
...
cabhCtpGroup.setObjects(
      *(("CABH-CTP-MIB", "cabhCtpSetToFactory"),
        ("CABH-CTP-MIB", "cabhCtpLastSetToFactory"),
...
mibBuilder.exportSymbols(
    ...
    **{"cabhCtpMib": cabhCtpMib,
       ...
       "cabhCtpLastSetToFactory": cabhCtpLastSetToFactory,
       ...
       "cabhCtpNotifications": cabhCtpNotifications,
