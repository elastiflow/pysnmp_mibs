...
# Notes
# -----
# ASN.1 source file:///Users/rob/MIBs/cablelabs_4491/CABH-QOS-MIB.mib
...
_CabhPriorityQosLastSetToFactory_Type = TimeStamp
_CabhPriorityQosLastSetToFactory_Object = MibScalar
cabhPriorityQosLastSetToFactory = _CabhPriorityQosLastSetToFactory_Object(
    (1, 3, 6, 1, 4, 1, 4491, 2, 4, 6, 1, 1, 1, 3),
    _CabhPriorityQosLastSetToFactory_Type()
)
cabhPriorityQosLastSetToFactory.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cabhPriorityQosLastSetToFactory.setStatus("current")
...
cabhPriorityQosGroup.setObjects(
      *(("CABH-QOS-MIB", "cabhPriorityQosMasterDefaultCHPriority"),
        ...
        ("CABH-QOS-MIB", "cabhPriorityQosLastSetToFactory"),
...
mibBuilder.exportSymbols(
    ...
    **{"cabhQosMib": cabhQosMib,
       ...
       "cabhPriorityQosLastSetToFactory": cabhPriorityQosLastSetToFactory,
