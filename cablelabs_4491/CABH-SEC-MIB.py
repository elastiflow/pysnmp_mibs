...
# Notes
# -----
# ASN.1 source file:///Users/rob/MIBs/cablelabs_4491/CABH-SEC-MIB.mib
...
class _CabhSecFwPolicyFileURL_Type(SnmpAdminString):
    """Custom type cabhSecFwPolicyFileURL based on SnmpAdminString"""
    defaultValue = OctetString("")


_CabhSecFwPolicyFileURL_Type.__name__ = "SnmpAdminString"
...
class _CabhSecFwPolicySuccessfulFileURL_Type(SnmpAdminString):
    """Custom type cabhSecFwPolicySuccessfulFileURL based on SnmpAdminString"""
    defaultValue = OctetString("")


_CabhSecFwPolicySuccessfulFileURL_Type.__name__ = "SnmpAdminString"
...
class _CabhSec2FwPolicyFileURL_Type(SnmpAdminString):
    """Custom type cabhSec2FwPolicyFileURL based on SnmpAdminString"""
    defaultValue = OctetString("")


_CabhSec2FwPolicyFileURL_Type.__name__ = "SnmpAdminString"
...
class _CabhSec2FwPolicyFileCurrentVersion_Type(SnmpAdminString):
    """Custom type cabhSec2FwPolicyFileCurrentVersion based on SnmpAdminString"""
    defaultValue = OctetString("")


_CabhSec2FwPolicyFileCurrentVersion_Type.__name__ = "SnmpAdminString"
...
_CabhSec2FwClearPreviousRuleset_Type.__name__ = "TruthValue"
...
_CabhSec2FwEventSetToFactory_Type.__name__ = "TruthValue"
...
class _CabhSec2FwPolicySuccessfulFileURL_Type(SnmpAdminString):
    """Custom type cabhSec2FwPolicySuccessfulFileURL based on SnmpAdminString"""
    defaultValue = OctetString("")


_CabhSec2FwPolicySuccessfulFileURL_Type.__name__ = "SnmpAdminString"
...
_CabhSec2FwClearLocalRuleset_Type.__name__ = "TruthValue"
...
_CabhSec2FwEventLogReset_Type.__name__ = "TruthValue"
...
_CabhSec2FwLogReplayCount_Type.__name__ = "Unsigned32"
...
_CabhSec2FwLogMIBPointer_Type.__name__ = "VariablePointer"
...
_CabhSec2FwFactoryDefaultFilterSaddr_Type.__name__ = "InetAddress"
...
_CabhSec2FwFactoryDefaultFilterSmask_Type.__name__ = "InetAddress"
...
_CabhSec2FwFactoryDefaultFilterDaddr_Type.__name__ = "InetAddress"
...
_CabhSec2FwFactoryDefaultFilterDmask_Type.__name__ = "InetAddress"
...
_CabhSec2FwFactoryDefaultFilterContinue_Type.__name__ = "TruthValue"
...
_CabhSec2FwLocalFilterIpIfIndex_Type.__name__ = "InterfaceIndexOrZero"
...
_CabhSec2FwLocalFilterIpSaddr_Type.__name__ = "InetAddress"
...
_CabhSec2FwLocalFilterIpSmask_Type.__name__ = "InetAddress"
...
_CabhSec2FwLocalFilterIpDaddr_Type.__name__ = "InetAddress"
...
_CabhSec2FwLocalFilterIpDmask_Type.__name__ = "InetAddress"
...
_CabhSec2FwLocalFilterIpContinue_Type.__name__ = "TruthValue"
...
cabhSecCompliance.setObjects(
      *(("CABH-SEC-MIB", "cabhSecCertGroup"),
        ("CABH-SEC-MIB", "cabhSecKerbGroup"),
        ("CABH-SEC-MIB", "cabhSecGroup"))
)
if mibBuilder.loadTexts:
...
cabhSec2Compliance.setObjects(
      *(("CABH-SEC-MIB", "cabhSecCertGroup"),
        ("CABH-SEC-MIB", "cabhSecKerbGroup"),
        ("CABH-SEC-MIB", "cabhSec2Group"))
)
if mibBuilder.loadTexts:
