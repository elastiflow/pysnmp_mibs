...
# Notes
# -----
# ASN.1 source file:///Users/rob/MIBs/cablelabs_4491/CCAP-MIB.mib
...
_CcapMpegDecryptSessionDecrypted_Type.__name__ = "TruthValue"
...
ccapCompliance.setObjects(
      *(("CCAP-MIB", "ccapInterfacesGroup"),
        ("CCAP-MIB", "ccapMpegGroup"),
        ("CCAP-MIB", "ccapCryptoGroup"))
)
if mibBuilder.loadTexts:
