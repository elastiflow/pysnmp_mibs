...
# Notes
# -----
# ASN.1 source file:///Users/rob/MIBs/cablelabs_4491/CLAB-ANI-NID-MIB.mib
...
class _ClabAniNidCfgMcastMac_Type(Integer32):
    """Custom type clabAniNidCfgMcastMac based on Integer32"""
...
_ClabAniNidCfgMcastMac_Type.__name__ = "Integer32"
_ClabAniNidCfgMcastMac_Object = MibScalar
clabAniNidCfgMcastMac = _ClabAniNidCfgMcastMac_Object(
    (1, 3, 6, 1, 4, 1, 4491, 4, 8, 1, 1, 2),
    _ClabAniNidCfgMcastMac_Type()
)
clabAniNidCfgMcastMac.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    clabAniNidCfgMcastMac.setStatus("current")
...
_ClabAniNidStatusReportCircuitIndex_Type = Unsigned32
...
clabAniNidGroup.setObjects(
      *(("CLAB-ANI-NID-MIB", "clabAniNidCfgID"),
        ("CLAB-ANI-NID-MIB", "clabAniNidCfgMcastMac"),
...
clabAniNidCompliance.setObjects(
    ("CLAB-ANI-NID-MIB", "clabAniNidGroup")
)
if mibBuilder.loadTexts:
...
mibBuilder.exportSymbols(
    ...
    **{"clabAniNidMib": clabAniNidMib,
       ...
       "clabAniNidCfgMcastMac": clabAniNidCfgMcastMac,
