...
# Notes
# -----
# ASN.1 source file:///Users/rob/MIBs/cablelabs_4491/DOCS-IF31-MIB.mib
...
(AttributeMask,
 ...
 docsIf3RxChStatusEntry) = mibBuilder.importSymbols(
    "DOCS-IF3-MIB",
    "AttributeMask",
    "IfDirection",
    "RangingState",
...
class PartialChannelType(TextualConvention, Bits):
    status = "current"
    namedValues = NamedValues(
        *(("fecErrorsDsProfile", 0),
          ("fecErrorsNcpProfile", 1),
          ("fecErrorsPlc", 2))
    )
...
_DocsIf31CmtsCmUsOfdmaChannelRxMerThreshold_Type.__name__ = "Unsigned32"
...
docsIf31CmEmDlsStatusAssignedEmIds.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
...
_DocsIf31CmtsDsOfdmSubcarrierStatusModulation_Type = DsOfdmModulationType
_DocsIf31CmtsDsOfdmSubcarrierStatusModulation_Object = MibTableColumn
docsIf31CmtsDsOfdmSubcarrierStatusModulation = _DocsIf31CmtsDsOfdmSubcarrierStatusModulation_Object(
    (1, 3, 6, 1, 4, 1, 4491, 2, 1, 28, 1, 21, 1, 3),
    _DocsIf31CmtsDsOfdmSubcarrierStatusModulation_Type()
)
docsIf31CmtsDsOfdmSubcarrierStatusModulation.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    docsIf31CmtsDsOfdmSubcarrierStatusModulation.setStatus("current")
...
docsIf3RxChStatusEntry.registerAugmentions(
    ("DOCS-IF31-MIB",
     "docsIf31RxChStatusEntry")
)
docsIf31RxChStatusEntry.setIndexNames(*docsIf3RxChStatusEntry.getIndexNames())
...
docsIf31CmtsGroup.setObjects(
      *(("DOCS-IF31-MIB", "docsIf31DocsisBaseCapability"),
        ...
        ("DOCS-IF31-MIB", "docsIf31CmtsDsOfdmSubcarrierStatusModulation"),
...
docsIf31CmtsCompliance.setObjects(
    ("DOCS-IF31-MIB", "docsIf31CmtsGroup")
)
if mibBuilder.loadTexts:
...
docsIf31CmCompliance.setObjects(
    ("DOCS-IF31-MIB", "docsIf31CmGroup")
)
if mibBuilder.loadTexts:
...
mibBuilder.exportSymbols(
    ...
    **{"ClabsDocsisVersion": ClabsDocsisVersion,
       ...
       "docsIf31CmtsDsOfdmSubcarrierStatusModulation": docsIf31CmtsDsOfdmSubcarrierStatusModulation,
