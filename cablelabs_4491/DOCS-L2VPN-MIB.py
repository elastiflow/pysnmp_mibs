...
# Notes
# -----
# ASN.1 source file:///Users/rob/MIBs/cablelabs_4491/DOCS-L2VPN-MIB.mib
...
_DocsL2vpnPktClassL2vpnIdx_Type = DocsL2vpnIndex
_DocsL2vpnPktClassL2vpnIdx_Object = MibTableColumn
docsL2vpnPktClassL2vpnIdx = _DocsL2vpnPktClassL2vpnIdx_Object(
    (1, 3, 6, 1, 4, 1, 4491, 2, 1, 8, 1, 8, 1, 1),
    _DocsL2vpnPktClassL2vpnIdx_Type()
)
docsL2vpnPktClassL2vpnIdx.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    docsL2vpnPktClassL2vpnIdx.setStatus("current")
...
docsL2vpnBaseGroup.setObjects(
      *(("DOCS-L2VPN-MIB", "docsL2vpnIdToIndexIdx"),
        ...
        ("DOCS-L2VPN-MIB", "docsL2vpnPktClassL2vpnIdx"),
...
mibBuilder.exportSymbols(
    ...
    **{"DocsL2vpnIdentifier": DocsL2vpnIdentifier,
       ...
       "docsL2vpnPktClassL2vpnIdx": docsL2vpnPktClassL2vpnIdx,
