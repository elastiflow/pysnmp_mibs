...
# Notes
# -----
# ASN.1 source file:///Users/rob/MIBs/cablelabs_4491/DSG-IF-MIB.mib
...
_DsgIfClassSrcIpAddrType_Type.__name__ = "InetAddressType"
...
_DsgIfClassSrcIpAddr_Type.__name__ = "InetAddress"
...
_DsgIfClassSrcIpPrefixLength_Type.__name__ = "InetAddressPrefixLength"
...
_DsgIfClassDestIpAddressType_Type.__name__ = "InetAddressType"
...
_DsgIfClassDestIpAddress_Type.__name__ = "InetAddress"
...
_DsgIfClassDestPortStart_Type.__name__ = "InetPortNumber"
...
_DsgIfClassDestPortEnd_Type.__name__ = "InetPortNumber"
...
_DsgIfClassIncludeInDCD_Type.__name__ = "TruthValue"
...
class _DsgIfTunnelGroupIndex_Type(Unsigned32):
    """Custom type dsgIfTunnelGroupIndex based on Unsigned32"""
    defaultValue = 0


_DsgIfTunnelGroupIndex_Type.__name__ = "Unsigned32"
...
class _DsgIfTunnelClientIdListIndex_Type(Unsigned32):
    """Custom type dsgIfTunnelClientIdListIndex based on Unsigned32"""
    defaultValue = 0


_DsgIfTunnelClientIdListIndex_Type.__name__ = "Unsigned32"
...
_DsgIfTunnelMacAddress_Type.__name__ = "MacAddress"
...
_DsgIfTunnelGrpDsIfIndex_Type = InterfaceIndexOrZero
...
_DsgIfTunnelGrpVendorParamId_Type.__name__ = "Unsigned32"
...
_DsgIfDownTimerIndex_Type.__name__ = "Unsigned32"
...
_DsgIfDownVendorParamId_Type.__name__ = "Unsigned32"
...
_DsgIfDownChannelListIndex_Type.__name__ = "Unsigned32"
...
class _DsgIfDownEnableDCD_Type(TruthValue):
    """Custom type dsgIfDownEnableDCD based on TruthValue"""
    defaultValue = 2


_DsgIfDownEnableDCD_Type.__name__ = "TruthValue"
...
_DsgIfClientVendorParamId_Type.__name__ = "Unsigned32"
...
dsgIfAgentBasicCompliance = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 4491, 2, 1, 3, 4, 2, 1)
)
dsgIfAgentBasicCompliance.setObjects(
      *(("DSG-IF-MIB", "dsgIfClassifierGroup"),
        ("DSG-IF-MIB", "dsgIfBaseGroup"),
        ("DSG-IF-MIB", "dsgIfDCDGroup"))
)
if mibBuilder.loadTexts:
    dsgIfAgentBasicCompliance.setStatus(
        "current"
    )
...
mibBuilder.exportSymbols(
    ...
    **{"Dsid": Dsid,
       ...
       "dsgIfAgentBasicCompliance": dsgIfAgentBasicCompliance}
)
