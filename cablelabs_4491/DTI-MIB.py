...
# Notes
# -----
# ASN.1 source file:///Users/rob/MIBs/cablelabs_4491/DTI-MIB.mib
...
_DtiProtocolPerformanceFrameErrorRate_Type = EntitySensorValue
...
_DtiProtocolPerformanceFrameErrorRateScale_Type = EntitySensorDataScale
_DtiProtocolPerformanceFrameErrorRateScale_Object = MibTableColumn
dtiProtocolPerformanceFrameErrorRateScale = _DtiProtocolPerformanceFrameErrorRateScale_Object(
    (1, 3, 6, 1, 4, 1, 4491, 2, 1, 7, 1, 1, 3, 1, 6),
    _DtiProtocolPerformanceFrameErrorRateScale_Type()
)
dtiProtocolPerformanceFrameErrorRateScale.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    dtiProtocolPerformanceFrameErrorRateScale.setStatus("current")
...
dtiBaseGroup.setObjects(
      *(("DTI-MIB", "dtiProtocolServerToDState"),
        ...
        ("DTI-MIB", "dtiProtocolPerformanceFrameErrorRateScale"),
...
mibBuilder.exportSymbols(
    ...
    **{"DtiCableAdvance": DtiCableAdvance,
       ...
       "dtiProtocolPerformanceFrameErrorRateScale": dtiProtocolPerformanceFrameErrorRateScale,
