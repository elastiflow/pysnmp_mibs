# SNMP MIB module (E5-121-AS-ATM-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/rob/MIBs/calix_6321/E5-121-AS-ATM-MIB.mib
...
asChannelStatusEntry = _AsChannelStatusEntry_Object(
    (1, 3, 6, 1, 4, 1, 6321, 1, 2, 3, 4, 99, 7, 1)
)
...
asChannelTxPackets = _AsChannelTxPackets_Object(
    (1, 3, 6, 1, 4, 1, 6321, 1, 2, 3, 4, 99, 7, 1, 1),
...
asChannelRxPackets = _AsChannelRxPackets_Object(
    (1, 3, 6, 1, 4, 1, 6321, 1, 2, 3, 4, 99, 7, 1, 2),
...
asChannelTxCells = _AsChannelTxCells_Object(
    (1, 3, 6, 1, 4, 1, 6321, 1, 2, 3, 4, 99, 7, 1, 3),
...
asChannelRxCells = _AsChannelRxCells_Object(
    (1, 3, 6, 1, 4, 1, 6321, 1, 2, 3, 4, 99, 7, 1, 4),
