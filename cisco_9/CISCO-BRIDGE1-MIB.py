# SNMP MIB module (CISCO-BRIDGE1-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/rob/MIBs/cisco_9/CISCO-BRIDGE1-MIB.mib
...
dot1dBasePortEntry.setIndexNames(
    (0, "CISCO-BRIDGE1-MIB", "dot1dBasePort"),
)
if mibBuilder.loadTexts:
...
dot1dStpPortEntry.setIndexNames(
    (0, "CISCO-BRIDGE1-MIB", "dot1dStpPort"),
)
if mibBuilder.loadTexts:
...
dot1dTpFdbEntry.setIndexNames(
    (0, "CISCO-BRIDGE1-MIB", "dot1dTpFdbAddress"),
)
if mibBuilder.loadTexts:
...
dot1dTpPortEntry.setIndexNames(
    (0, "CISCO-BRIDGE1-MIB", "dot1dTpPort"),
)
if mibBuilder.loadTexts:
...
dot1dStaticEntry.setIndexNames(
    (0, "CISCO-BRIDGE1-MIB", "dot1dStaticAddress"),
    (0, "CISCO-BRIDGE1-MIB", "dot1dStaticReceivePort"),
)
if mibBuilder.loadTexts:
