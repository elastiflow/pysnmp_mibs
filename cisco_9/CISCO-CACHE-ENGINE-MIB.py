...
# Notes
# -----
# ASN.1 source file:///Users/rob/MIBs/cisco_9/CISCO-CACHE-ENGINE-MIB.mib
...
ciscoCacheEngineMIBCompliance.setObjects(
      *(("CISCO-CACHE-ENGINE-MIB", "cceFarmGroup"),
        ("CISCO-CACHE-ENGINE-MIB", "cceBasicGroup"),
        ("CISCO-CACHE-ENGINE-MIB", "cceDnsGroup"),
        ("CISCO-CACHE-ENGINE-MIB", "cceIcpClientGroup"),
        ("CISCO-CACHE-ENGINE-MIB", "cceIcpServerGroup"),
        ("CISCO-CACHE-ENGINE-MIB", "cceProxyGroup"),
        ("CISCO-CACHE-ENGINE-MIB", "cceTimeGroup"),
        ("CISCO-CACHE-ENGINE-MIB", "cceCacheFarmGroup"),
        ("CISCO-CACHE-ENGINE-MIB", "cceFreshGroup"),
        ("CISCO-CACHE-ENGINE-MIB", "cceTCPGroup"),
        ("CISCO-CACHE-ENGINE-MIB", "cceUrlGroup"),
        ("CISCO-CACHE-ENGINE-MIB", "cceEventsGroup"),
        ("CISCO-CACHE-ENGINE-MIB", "cceLogGroup"),
        ("CISCO-CACHE-ENGINE-MIB", "cceDiagDumpGroup"),
        ("CISCO-CACHE-ENGINE-MIB", "cceImsGroup"),
        ("CISCO-CACHE-ENGINE-MIB", "ccePerfGroup"),
        ("CISCO-CACHE-ENGINE-MIB", "cceReqGroup"),
        ("CISCO-CACHE-ENGINE-MIB", "cceSaveGroup"),
        ("CISCO-CACHE-ENGINE-MIB", "cceUsageGroup"),
        ("CISCO-CACHE-ENGINE-MIB", "cceInterfacesGroup"))
)
if mibBuilder.loadTexts:
