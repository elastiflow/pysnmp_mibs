...
# Notes
# -----
# ASN.1 source file:///Users/rob/MIBs/cisco_9/CISCO-DIFFSERV-EXT-MIB.mib
...
_CdsmFCMultiFieldMatchSrcAddr_Type.__name__ = "CdsmFcAddrAndMask"
...
_CdsmFCMultiFieldMatchDstAddr_Type.__name__ = "CdsmFcAddrAndMask"
...
_CdsmFCMultiFieldMatchIntf_Type.__name__ = "InterfaceIndexOrZero"
...
_CdsmFCMultiFieldMatchWildCard_Type.__name__ = "TruthValue"
...
ciscoDiffServExtMIBCompliance.setObjects(
      *(("CISCO-DIFFSERV-EXT-MIB", "ciscoDiffServExtGroup"),
        ("CISCO-DIFFSERV-EXT-MIB", "ciscoDiffServVsanGroup"),
        ("CISCO-DIFFSERV-EXT-MIB", "ciscoDiffServSchedQGroup"))
)
if mibBuilder.loadTexts:
...
ciscoDiffServExtMIBComplianceR1.setObjects(
      *(("CISCO-DIFFSERV-EXT-MIB", "ciscoDiffServExtGroup1"),
        ("CISCO-DIFFSERV-EXT-MIB", "ciscoDiffServVsanGroup"),
        ("CISCO-DIFFSERV-EXT-MIB", "ciscoDiffServSchedQGroup"),
        ("CISCO-DIFFSERV-EXT-MIB", "ciscoDiffServChkSumGroup"))
)
if mibBuilder.loadTexts:
...
ciscoDiffServExtMIBComplianceR2.setObjects(
      *(("CISCO-DIFFSERV-EXT-MIB", "ciscoDiffServExtGroup2"),
        ("CISCO-DIFFSERV-EXT-MIB", "ciscoDiffServVsanGroup"),
        ("CISCO-DIFFSERV-EXT-MIB", "ciscoDiffServSchedQGroup"),
        ("CISCO-DIFFSERV-EXT-MIB", "ciscoDiffServChkSumGroup"))
)
