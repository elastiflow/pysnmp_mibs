...
# Notes
# -----
# ASN.1 source file:///Users/rob/MIBs/cisco_9/CISCO-DM-MIB.mib
...
_DmConfigDomainId_Type.__name__ = "DomainIdOrZero"
...
_DmEnable_Type.__name__ = "TruthValue"
...
_DmAutoReconfigure_Type.__name__ = "TruthValue"
...
_DmFabricName_Type.__name__ = "FcNameIdOrZero"
...
_DmPrincipalSwitchWwn_Type.__name__ = "FcNameIdOrZero"
...
_DmFcIdPersistency_Type.__name__ = "TruthValue"
...
class _DmOptimize_Type(OctetString):
    """Custom type dmOptimize based on OctetString"""
    subtypeSpec = OctetString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_DmOptimize_Type.__name__ = "OctetString"
_DmOptimize_Object = MibTableColumn
dmOptimize = _DmOptimize_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 302, 1, 1, 1, 1, 27),
    _DmOptimize_Type()
)
dmOptimize.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    dmOptimize.setStatus("current")
...
_DmIfRcfReject_Type.__name__ = "TruthValue"
...
_DmReConfFabricChangeNotifyEnable_Type.__name__ = "TruthValue"
...
if mibBuilder.loadTexts:
    dmGroupRev1.setStatus("deprecated")
...
dmGroupRev2 = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 9, 9, 302, 2, 2, 9)
)
dmGroupRev2.setObjects(
      *(("CISCO-DM-MIB", "dmConfigDomainId"),
        ("CISCO-DM-MIB", "dmConfigDomainIdType"),
        ("CISCO-DM-MIB", "dmEnable"),
        ("CISCO-DM-MIB", "dmAutoReconfigure"),
        ...
        ("CISCO-DM-MIB", "dmIfRole"),
        ("CISCO-DM-MIB", "dmIfRowStatus"),
        ("CISCO-DM-MIB", "dmOptimize"))
)
if mibBuilder.loadTexts:
    dmGroupRev2.setStatus("current")
...
dmMIBCompliance.setObjects(
      *(("CISCO-DM-MIB", "dmGroup"),
        ("CISCO-DM-MIB", "dmDatabaseGroup"),
        ("CISCO-DM-MIB", "dmAreaGroup"),
        ("CISCO-DM-MIB", "dmCacheGroup"),
        ("CISCO-DM-MIB", "dmNotificationGroup"))
)
if mibBuilder.loadTexts:
...
dmMIBCompliance1.setObjects(
      *(("CISCO-DM-MIB", "dmGroupRev1"),
        ("CISCO-DM-MIB", "dmDatabaseGroup"),
        ("CISCO-DM-MIB", "dmAreaGroup"),
        ("CISCO-DM-MIB", "dmCacheGroup"),
        ("CISCO-DM-MIB", "dmNotificationGroup"),
        ("CISCO-DM-MIB", "dmFcIdPersistencyGroup"))
)
if mibBuilder.loadTexts:
...
dmMIBCompliance2.setObjects(
      *(("CISCO-DM-MIB", "dmGroupRev1"),
        ...
        ("CISCO-DM-MIB", "dmNotificationGroup"),
        ("CISCO-DM-MIB", "dmFcIdPersistencyGroup"),
        ("CISCO-DM-MIB", "dmDomainIDAllowedGroup"))
)
if mibBuilder.loadTexts:
...
dmMIBCompliance3 = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 9, 9, 302, 2, 1, 4)
)
dmMIBCompliance3.setObjects(
      *(("CISCO-DM-MIB", "dmGroupRev2"),
        ("CISCO-DM-MIB", "dmDatabaseGroup"),
        ("CISCO-DM-MIB", "dmAreaGroup"),
        ("CISCO-DM-MIB", "dmCacheGroup"),
        ("CISCO-DM-MIB", "dmNotificationGroup"),
...
mibBuilder.exportSymbols(
    ...
    **{"DomainPriority": DomainPriority,
       ...
       "dmMIBCompliance3": dmMIBCompliance3,
