...
# Notes
# -----
# ASN.1 source file:///Users/rob/MIBs/cisco_9/CISCO-DOCS-REMOTE-QUERY-MIB.mib
...
cdrqDocsRemoteQueryCompliance.setObjects(
      *(("CISCO-DOCS-REMOTE-QUERY-MIB", "cdrqPollerGroup"),
        ("CISCO-DOCS-REMOTE-QUERY-MIB", "cdrqCMGroup"))
)
if mibBuilder.loadTexts:
