...
# Notes
# -----
# ASN.1 source file:///Users/rob/MIBs/cisco_9/CISCO-LWAPP-CDP-MIB.mib
...
_ClcCdpAdvtVersion_Type.__name__ = "CLCdpAdvtVersionType"
...
_ClcCdpGlobalEnable_Type.__name__ = "TruthValue"
...
_ClcCdpApCacheNeighName_Type = SnmpAdminString
...
_ClcCdpApCacheNeighInterface_Type = SnmpAdminString
...
_ClcCdpApCacheNeighVersion_Type = SnmpAdminString
...
_ClcCdpApCacheAdvtVersion_Type.__name__ = "CLCdpAdvtVersionType"
...
_ClcCdpApCachePlatform_Type = SnmpAdminString
...
_ClcCdpCtAddressTable_Object = MibTable
clcCdpCtAddressTable = _ClcCdpCtAddressTable_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 623, 1, 3, 2)
)
if mibBuilder.loadTexts:
    clcCdpCtAddressTable.setStatus("current")
_ClcCdpCtAddressEntry_Object = MibTableRow
clcCdpCtAddressEntry = _ClcCdpCtAddressEntry_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 623, 1, 3, 2, 1)
)
clcCdpCtAddressEntry.setIndexNames(
    (0, "CISCO-LWAPP-AP-MIB", "cLApSysMacAddress"),
    (0, "CISCO-LWAPP-CDP-MIB", "clcCdpApCacheDeviceIndex"),
    (0, "CISCO-LWAPP-CDP-MIB", "clcCdpCtAddressIndex"),
)
if mibBuilder.loadTexts:
    clcCdpCtAddressEntry.setStatus("current")


class _ClcCdpCtAddressIndex_Type(Integer32):
    """Custom type clcCdpCtAddressIndex based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_ClcCdpCtAddressIndex_Type.__name__ = "Integer32"
_ClcCdpCtAddressIndex_Object = MibTableColumn
clcCdpCtAddressIndex = _ClcCdpCtAddressIndex_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 623, 1, 3, 2, 1, 1),
    _ClcCdpCtAddressIndex_Type()
)
clcCdpCtAddressIndex.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    clcCdpCtAddressIndex.setStatus("current")
_ClcCdpCtAddressType_Type = CiscoNetworkProtocol
_ClcCdpCtAddressType_Object = MibTableColumn
clcCdpCtAddressType = _ClcCdpCtAddressType_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 623, 1, 3, 2, 1, 2),
    _ClcCdpCtAddressType_Type()
)
clcCdpCtAddressType.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    clcCdpCtAddressType.setStatus("current")
_ClcCdpCtAddress_Type = CiscoNetworkAddress
_ClcCdpCtAddress_Object = MibTableColumn
clcCdpCtAddress = _ClcCdpCtAddress_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 623, 1, 3, 2, 1, 3),
    _ClcCdpCtAddress_Type()
)
clcCdpCtAddress.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    clcCdpCtAddress.setStatus("current")
...
_ClcCdpApCdpEnable_Type.__name__ = "TruthValue"
...
ciscoLwappCdpMIBCompliance.setObjects(
      *(("CISCO-LWAPP-CDP-MIB", "clcCdpRev01ConfigGroup"),
        ("CISCO-LWAPP-CDP-MIB", "clcCdpRev01StatusGroup"))
)
if mibBuilder.loadTexts:
...
ciscoLwappCdpMIBComplianceRev1.setObjects(
      *(("CISCO-LWAPP-CDP-MIB", "clcCdpRev01ConfigGroup"),
        ("CISCO-LWAPP-CDP-MIB", "clcCdpRev01StatusGroup"),
        ("CISCO-LWAPP-CDP-MIB", "clcCdpRev02StatusGroup"))
)
if mibBuilder.loadTexts:
...
mibBuilder.exportSymbols(
    ...
    **{"ciscoLwappCdpMIB": ciscoLwappCdpMIB,
       ...
       "clcCdpCtAddressTable": clcCdpCtAddressTable,
       "clcCdpCtAddressEntry": clcCdpCtAddressEntry,
       "clcCdpCtAddressIndex": clcCdpCtAddressIndex,
       "clcCdpCtAddressType": clcCdpCtAddressType,
       "clcCdpCtAddress": clcCdpCtAddress,
