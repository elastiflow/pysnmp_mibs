...
# Notes
# -----
# ASN.1 source file:///Users/rob/MIBs/cisco_9/CISCO-LWAPP-CLIENT-ROAMING-MIB.mib
...
_ClcrDot11aMode_Type.__name__ = "CLDot11RfParamMode"
...
_ClcrDot11bMode_Type.__name__ = "CLDot11RfParamMode"
...
_ClcrRoamStats_ObjectIdentity = ObjectIdentity
clcrRoamStats = _ClcrRoamStats_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 9, 9, 523, 1, 5)
)
_ClcrRoamIntraCount_Type = Counter32
_ClcrRoamIntraCount_Object = MibScalar
clcrRoamIntraCount = _ClcrRoamIntraCount_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 523, 1, 5, 1),
    _ClcrRoamIntraCount_Type()
)
clcrRoamIntraCount.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    clcrRoamIntraCount.setStatus("current")
...
clcrMIBCompliance.setObjects(
      *(("CISCO-LWAPP-CLIENT-ROAMING-MIB", "ciscoLwappClRoamDot11aRfParamsGroup"),
...
clcrMIBComplianceRev1.setObjects(
      *(("CISCO-LWAPP-CLIENT-ROAMING-MIB", "ciscoLwappClRoamDot11aRfParamsGroupSup1"),
        ("CISCO-LWAPP-CLIENT-ROAMING-MIB", "ciscoLwappClRoamDot11bRfParamsGroupSup1"),
        ("CISCO-LWAPP-CLIENT-ROAMING-MIB", "ciscoLwappClRoamroamReasonGroup"),
        ("CISCO-LWAPP-CLIENT-ROAMING-MIB", "ciscoLwappClRoamroamingStatsGroup"))
)
if mibBuilder.loadTexts:
...
mibBuilder.exportSymbols(
    ...
    **{"ciscoLwappClRoamMIB": ciscoLwappClRoamMIB,
       ...
       "clcrRoamStats": clcrRoamStats,
       "clcrRoamIntraCount": clcrRoamIntraCount,
