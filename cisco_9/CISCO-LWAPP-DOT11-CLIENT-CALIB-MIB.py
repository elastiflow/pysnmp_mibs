...
# Notes
# -----
# ASN.1 source file:///Users/rob/MIBs/cisco_9/CISCO-LWAPP-DOT11-CLIENT-CALIB-MIB.mib
...
_CLD11ClientCalibBeaconIntervalExt_Type.__name__ = "TimeInterval"
...
_CLD11ClientCalibStorageType_Type.__name__ = "StorageType"
...
_CLD11RfidRssiExpiryTime_Type = Unsigned32
_CLD11RfidRssiExpiryTime_Object = MibScalar
cLD11RfidRssiExpiryTime = _CLD11RfidRssiExpiryTime_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 522, 1, 1, 21),
    _CLD11RfidRssiExpiryTime_Type()
)
cLD11RfidRssiExpiryTime.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    cLD11RfidRssiExpiryTime.setStatus("current")
if mibBuilder.loadTexts:
    cLD11RfidRssiExpiryTime.setUnits("seconds")
_CLD11RfidRssiHalflifeTime_Type = Unsigned32
_CLD11RfidRssiHalflifeTime_Object = MibScalar
cLD11RfidRssiHalflifeTime = _CLD11RfidRssiHalflifeTime_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 522, 1, 1, 22),
    _CLD11RfidRssiHalflifeTime_Type()
)
cLD11RfidRssiHalflifeTime.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    cLD11RfidRssiHalflifeTime.setStatus("current")
if mibBuilder.loadTexts:
    cLD11RfidRssiHalflifeTime.setUnits("seconds")
_CLD11RfidNotifyThresholdTime_Type = Unsigned32
_CLD11RfidNotifyThresholdTime_Object = MibScalar
cLD11RfidNotifyThresholdTime = _CLD11RfidNotifyThresholdTime_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 522, 1, 1, 24),
    _CLD11RfidNotifyThresholdTime_Type()
)
cLD11RfidNotifyThresholdTime.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    cLD11RfidNotifyThresholdTime.setStatus("current")
if mibBuilder.loadTexts:
    cLD11RfidNotifyThresholdTime.setUnits("seconds")
_CLD11RfidDataEnable_Type = TruthValue
_CLD11RfidDataEnable_Object = MibScalar
cLD11RfidDataEnable = _CLD11RfidDataEnable_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 522, 1, 1, 25),
    _CLD11RfidDataEnable_Type()
)
cLD11RfidDataEnable.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    cLD11RfidDataEnable.setStatus("current")
_CLD11RfidTimeout_Type = Unsigned32
_CLD11RfidTimeout_Object = MibScalar
cLD11RfidTimeout = _CLD11RfidTimeout_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 522, 1, 1, 26),
    _CLD11RfidTimeout_Type()
)
cLD11RfidTimeout.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    cLD11RfidTimeout.setStatus("current")
if mibBuilder.loadTexts:
    cLD11RfidTimeout.setUnits("seconds")
...
cLD11ClientCalibGlobalConfigGroup.setObjects(
      *(("CISCO-LWAPP-DOT11-CLIENT-CALIB-MIB", "cLD11ClientCalibRssiAlgorithm"),
        ...
        ("CISCO-LWAPP-DOT11-CLIENT-CALIB-MIB", "cLD11RfidRssiExpiryTime"),
        ("CISCO-LWAPP-DOT11-CLIENT-CALIB-MIB", "cLD11RfidRssiHalflifeTime"),
        ("CISCO-LWAPP-DOT11-CLIENT-CALIB-MIB", "cLD11RfidNotifyThresholdTime"),
        ("CISCO-LWAPP-DOT11-CLIENT-CALIB-MIB", "cLD11RfidDataEnable"),
        ("CISCO-LWAPP-DOT11-CLIENT-CALIB-MIB", "cLD11RfidTimeout"))
)
if mibBuilder.loadTexts:
...
ciscoLwappDot11ClientCalibMIBCompliance.setObjects(
    ("CISCO-LWAPP-DOT11-CLIENT-CALIB-MIB", "ciscoLwappDot11ClientCalibMIBConfigGroup")
)
if mibBuilder.loadTexts:
...
ciscoLwappDot11ClientCalibMIBComplianceRev1.setObjects(
      *(("CISCO-LWAPP-DOT11-CLIENT-CALIB-MIB", "cLD11ClientCalibClientConfigGroup"),
        ("CISCO-LWAPP-DOT11-CLIENT-CALIB-MIB", "cLD11ClientCalibGlobalConfigGroup"),
        ("CISCO-LWAPP-DOT11-CLIENT-CALIB-MIB", "cLD11ClientCalibRssiDataSampleGroup"))
)
if mibBuilder.loadTexts:
...
mibBuilder.exportSymbols(
    ...
    **{"ciscoLwappDot11ClientCalibMIB": ciscoLwappDot11ClientCalibMIB,
       ...
       "cLD11RfidRssiExpiryTime": cLD11RfidRssiExpiryTime,
       "cLD11RfidRssiHalflifeTime": cLD11RfidRssiHalflifeTime,
       "cLD11RfidNotifyThresholdTime": cLD11RfidNotifyThresholdTime,
       "cLD11RfidDataEnable": cLD11RfidDataEnable,
       "cLD11RfidTimeout": cLD11RfidTimeout,
