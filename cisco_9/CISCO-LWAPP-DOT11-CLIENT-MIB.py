...
# Notes
# -----
# ASN.1 source file:///Users/rob/MIBs/cisco_9/CISCO-LWAPP-DOT11-CLIENT-MIB.mib
...
_CldcKeyDecryptErrorEnabled_Type.__name__ = "TruthValue"
...
_CiscoLwappDot11ClientStaticIpFailTrapEnabled_Type.__name__ = "TruthValue"
...
class _CldcMaxClientsTrapEnabled_Type(TruthValue):
    """Custom type cldcMaxClientsTrapEnabled based on TruthValue"""
    defaultValue = 1


_CldcMaxClientsTrapEnabled_Type.__name__ = "TruthValue"
_CldcMaxClientsTrapEnabled_Object = MibScalar
cldcMaxClientsTrapEnabled = _CldcMaxClientsTrapEnabled_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 599, 1, 1, 6),
    _CldcMaxClientsTrapEnabled_Type()
)
cldcMaxClientsTrapEnabled.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    cldcMaxClientsTrapEnabled.setStatus("current")


class _CldcMaxClientsTrapThreshold_Type(Unsigned32):
    """Custom type cldcMaxClientsTrapThreshold based on Unsigned32"""
...
_CldcMaxClientsTrapThreshold_Type.__name__ = "Unsigned32"
_CldcMaxClientsTrapThreshold_Object = MibScalar
cldcMaxClientsTrapThreshold = _CldcMaxClientsTrapThreshold_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 599, 1, 1, 7),
    _CldcMaxClientsTrapThreshold_Type()
)
cldcMaxClientsTrapThreshold.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    cldcMaxClientsTrapThreshold.setStatus("current")
if mibBuilder.loadTexts:
    cldcMaxClientsTrapThreshold.setUnits("Percent")


class _CldcMaxClientsTrapPeriod_Type(Unsigned32):
    """Custom type cldcMaxClientsTrapPeriod based on Unsigned32"""
    subtypeSpec = Unsigned32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_CldcMaxClientsTrapPeriod_Type.__name__ = "Unsigned32"
_CldcMaxClientsTrapPeriod_Object = MibScalar
cldcMaxClientsTrapPeriod = _CldcMaxClientsTrapPeriod_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 599, 1, 1, 8),
    _CldcMaxClientsTrapPeriod_Type()
)
cldcMaxClientsTrapPeriod.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    cldcMaxClientsTrapPeriod.setStatus("current")
if mibBuilder.loadTexts:
    cldcMaxClientsTrapPeriod.setUnits("Minutes")
...
class _CldcClientEncryptionCipher_Type(Integer32):
    """Custom type cldcClientEncryptionCipher based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_CldcClientEncryptionCipher_Type.__name__ = "Integer32"
_CldcClientEncryptionCipher_Object = MibScalar
cldcClientEncryptionCipher = _CldcClientEncryptionCipher_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 599, 1, 2, 14),
    _CldcClientEncryptionCipher_Type()
)
cldcClientEncryptionCipher.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    cldcClientEncryptionCipher.setStatus("current")
...
class _CldcClientInterface_Type(SnmpAdminString):
    """Custom type cldcClientInterface based on SnmpAdminString"""
...
_CldcClientInterface_Type.__name__ = "SnmpAdminString"
...
_CldcMaxClientsCount_Type = Unsigned32
_CldcMaxClientsCount_Object = MibScalar
cldcMaxClientsCount = _CldcMaxClientsCount_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 599, 1, 2, 45),
    _CldcMaxClientsCount_Type()
)
cldcMaxClientsCount.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    cldcMaxClientsCount.setStatus("current")
_CldcMaxThresholdReachedClear_Type = TruthValue
_CldcMaxThresholdReachedClear_Object = MibScalar
cldcMaxThresholdReachedClear = _CldcMaxThresholdReachedClear_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 599, 1, 2, 46),
    _CldcMaxThresholdReachedClear_Type()
)
cldcMaxThresholdReachedClear.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    cldcMaxThresholdReachedClear.setStatus("current")
...
if mibBuilder.loadTexts:
    cldcClientUpTime.setUnits("Seconds")
...
_CldcClientIpv6AclName_Type = SnmpAdminString
...
class _CldcClientTunnelType_Type(Integer32):
    """Custom type cldcClientTunnelType based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_CldcClientTunnelType_Type.__name__ = "Integer32"
_CldcClientTunnelType_Object = MibTableColumn
cldcClientTunnelType = _CldcClientTunnelType_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 599, 1, 3, 1, 1, 46),
    _CldcClientTunnelType_Type()
)
cldcClientTunnelType.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cldcClientTunnelType.setStatus("current")
_CldcClientMaxDataRate_Type = Unsigned32
_CldcClientMaxDataRate_Object = MibTableColumn
cldcClientMaxDataRate = _CldcClientMaxDataRate_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 599, 1, 3, 1, 1, 47),
    _CldcClientMaxDataRate_Type()
)
cldcClientMaxDataRate.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cldcClientMaxDataRate.setStatus("current")
_CldcClientHtCapable_Type = TruthValue
_CldcClientHtCapable_Object = MibTableColumn
cldcClientHtCapable = _CldcClientHtCapable_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 599, 1, 3, 1, 1, 48),
    _CldcClientHtCapable_Type()
)
cldcClientHtCapable.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cldcClientHtCapable.setStatus("current")
_CldcClientVhtCapable_Type = TruthValue
_CldcClientVhtCapable_Object = MibTableColumn
cldcClientVhtCapable = _CldcClientVhtCapable_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 599, 1, 3, 1, 1, 49),
    _CldcClientVhtCapable_Type()
)
cldcClientVhtCapable.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cldcClientVhtCapable.setStatus("current")
_CldcClientCurrentTxRate_Type = Unsigned32
_CldcClientCurrentTxRate_Object = MibTableColumn
cldcClientCurrentTxRate = _CldcClientCurrentTxRate_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 599, 1, 3, 1, 1, 50),
    _CldcClientCurrentTxRate_Type()
)
cldcClientCurrentTxRate.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cldcClientCurrentTxRate.setStatus("current")
if mibBuilder.loadTexts:
    cldcClientCurrentTxRate.setUnits("Mbit/s")
_CldcClientiPSKTag_Type = OctetString
_CldcClientiPSKTag_Object = MibTableColumn
cldcClientiPSKTag = _CldcClientiPSKTag_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 599, 1, 3, 1, 1, 51),
    _CldcClientiPSKTag_Type()
)
cldcClientiPSKTag.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cldcClientiPSKTag.setStatus("current")


class _CldcClientMobileStPolicyType_Type(Integer32):
    """Custom type cldcClientMobileStPolicyType based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_CldcClientMobileStPolicyType_Type.__name__ = "Integer32"
_CldcClientMobileStPolicyType_Object = MibTableColumn
cldcClientMobileStPolicyType = _CldcClientMobileStPolicyType_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 599, 1, 3, 1, 1, 52),
    _CldcClientMobileStPolicyType_Type()
)
cldcClientMobileStPolicyType.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cldcClientMobileStPolicyType.setStatus("current")
...
if mibBuilder.loadTexts:
    cldcSleepingClientRemainingTime.setUnits("seconds")
...
_CiscoLwappDot11CCXClientMIBConform_ObjectIdentity = ObjectIdentity
ciscoLwappDot11CCXClientMIBConform = _CiscoLwappDot11CCXClientMIBConform_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 9, 9, 599, 2, 3)
)
...
ciscoLwappDot11ClientMIBStatusGroup.setObjects(
      *(("CISCO-LWAPP-DOT11-CLIENT-MIB", "cldcClientStatus"),
        ...
        ("CISCO-LWAPP-DOT11-CLIENT-MIB", "cldcClientChannel"),
        ...
        ("CISCO-LWAPP-DOT11-CLIENT-MIB", "cldcClientMdnsProfile"),
        ("CISCO-LWAPP-DOT11-CLIENT-MIB", "cldcClientMdnsAdvCount"),
        ("CISCO-LWAPP-DOT11-CLIENT-MIB", "cldcClientPolicyName"),
        ("CISCO-LWAPP-DOT11-CLIENT-MIB", "cldcClientAAARole"),
        ("CISCO-LWAPP-DOT11-CLIENT-MIB", "cldcClientDeviceType"),
        ("CISCO-LWAPP-DOT11-CLIENT-MIB", "cldcUserAuthType"),
        ("CISCO-LWAPP-DOT11-CLIENT-MIB", "cldcClientTunnelType"),
        ("CISCO-LWAPP-DOT11-CLIENT-MIB", "cldcClientMaxDataRate"),
        ("CISCO-LWAPP-DOT11-CLIENT-MIB", "cldcClientHtCapable"),
        ("CISCO-LWAPP-DOT11-CLIENT-MIB", "cldcClientVhtCapable"),
...
ciscoLwappDot11ClientMIBStatusGroupRev2.setObjects(
      *(("CISCO-LWAPP-DOT11-CLIENT-MIB", "cldcClientLoginTime"),
        ...
        ("CISCO-LWAPP-DOT11-CLIENT-MIB", "cldcSleepingClientSsid"),
        ("CISCO-LWAPP-DOT11-CLIENT-MIB", "cldcSleepingClientUserName"),
        ("CISCO-LWAPP-DOT11-CLIENT-MIB", "cldcSleepingClientRemainingTime"),
        ("CISCO-LWAPP-DOT11-CLIENT-MIB", "cldcSleepingClientRowStatus"),
        ("CISCO-LWAPP-DOT11-CLIENT-MIB", "cldcClientDataBytesReceived"),
        ("CISCO-LWAPP-DOT11-CLIENT-MIB", "cldcClientRealtimeBytesReceived"),
        ("CISCO-LWAPP-DOT11-CLIENT-MIB", "cldcClientRxDataBytesDropped"),
        ("CISCO-LWAPP-DOT11-CLIENT-MIB", "cldcClientRxRealtimeBytesDropped"),
        ("CISCO-LWAPP-DOT11-CLIENT-MIB", "cldcClientDataBytesSent"),
        ("CISCO-LWAPP-DOT11-CLIENT-MIB", "cldcClientRealtimeBytesSent"),
        ("CISCO-LWAPP-DOT11-CLIENT-MIB", "cldcClientTxDataBytesDropped"),
        ("CISCO-LWAPP-DOT11-CLIENT-MIB", "cldcClientTxRealtimeBytesDropped"),
        ("CISCO-LWAPP-DOT11-CLIENT-MIB", "cldcClientDataPacketsReceived"),
        ("CISCO-LWAPP-DOT11-CLIENT-MIB", "cldcClientRealtimePacketsReceived"),
        ("CISCO-LWAPP-DOT11-CLIENT-MIB", "cldcClientRxDataPacketsDropped"),
        ("CISCO-LWAPP-DOT11-CLIENT-MIB", "cldcClientRxRealtimePacketsDropped"),
        ("CISCO-LWAPP-DOT11-CLIENT-MIB", "cldcClientDataPacketsSent"),
        ("CISCO-LWAPP-DOT11-CLIENT-MIB", "cldcClientRealtimePacketsSent"),
        ("CISCO-LWAPP-DOT11-CLIENT-MIB", "cldcClientTxDataPacketsDropped"),
        ("CISCO-LWAPP-DOT11-CLIENT-MIB", "cldcClientTxRealtimePacketsDropped"),
        ...
        ("CISCO-LWAPP-DOT11-CLIENT-MIB", "ciscoLwappDot11ClientStaticIpFailTrapEnabled"),
        ("CISCO-LWAPP-DOT11-CLIENT-MIB", "cldcClientCurrentTxRate"),
        ("CISCO-LWAPP-DOT11-CLIENT-MIB", "cldcClientMobileStPolicyType"))
)
if mibBuilder.loadTexts:
...
ciscoLwappDot11ClientMIBStatusGroupRev2Sup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 9, 9, 599, 2, 2, 7)
)
ciscoLwappDot11ClientMIBStatusGroupRev2Sup.setObjects(
      *(("CISCO-LWAPP-DOT11-CLIENT-MIB", "cldcClientSecurityTagId"),
        ("CISCO-LWAPP-DOT11-CLIENT-MIB", "cldcClientTypeKTS"),
        ("CISCO-LWAPP-DOT11-CLIENT-MIB", "cldcClientIpv6AclName"),
        ("CISCO-LWAPP-DOT11-CLIENT-MIB", "cldcClientIpv6AclApplied"),
        ("CISCO-LWAPP-DOT11-CLIENT-MIB", "cldcClientByIpAddressDiscoverType"),
        ("CISCO-LWAPP-DOT11-CLIENT-MIB", "cldcClientRaPacketsDropped"),
        ("CISCO-LWAPP-DOT11-CLIENT-MIB", "cldcClientInterimUpdatesCount"))
)
if mibBuilder.loadTexts:
    ciscoLwappDot11ClientMIBStatusGroupRev2Sup.setStatus("current")

ciscoLwappDot11ClientMIBCcxGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 9, 9, 599, 2, 2, 8)
)
ciscoLwappDot11ClientMIBCcxGroup.setObjects(
...
if mibBuilder.loadTexts:
    ciscoLwappDot11ClientMIBCcxGroup.setStatus("current")

ciscoLwappDot11ClientMIBSup1Group = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 9, 9, 599, 2, 2, 9)
)
ciscoLwappDot11ClientMIBSup1Group.setObjects(
      *(("CISCO-LWAPP-DOT11-CLIENT-MIB", "cldcClientRSSI"),
        ...
        ("CISCO-LWAPP-DOT11-CLIENT-MIB", "cldcDOT11ClientTxDataPackets"),
        ("CISCO-LWAPP-DOT11-CLIENT-MIB", "cldcDOT11ClientTxDataBytes"),
        ("CISCO-LWAPP-DOT11-CLIENT-MIB", "cldcDOT11ClientRxDataPackets"),
        ("CISCO-LWAPP-DOT11-CLIENT-MIB", "cldcDOT11ClientRxDataBytes"),
        ...
        ("CISCO-LWAPP-DOT11-CLIENT-MIB", "cldcClientEncryptionCipher"),
...
if mibBuilder.loadTexts:
    ciscoLwappDot11ClientMIBSup1Group.setStatus("current")

ciscoLwappDot11ClientMIBConfigGroupRev2 = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 9, 9, 599, 2, 2, 10)
)
ciscoLwappDot11ClientMIBConfigGroupRev2.setObjects(
      *(("CISCO-LWAPP-DOT11-CLIENT-MIB", "cldcMaxClientsTrapPeriod"),
        ("CISCO-LWAPP-DOT11-CLIENT-MIB", "cldcMaxClientsTrapThreshold"))
)
if mibBuilder.loadTexts:
    ciscoLwappDot11ClientMIBConfigGroupRev2.setStatus("current")

ciscoLwappDot11ClientMIBNotifControlGroupRev2 = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 9, 9, 599, 2, 2, 12)
)
ciscoLwappDot11ClientMIBNotifControlGroupRev2.setObjects(
    ("CISCO-LWAPP-DOT11-CLIENT-MIB", "cldcMaxClientsTrapEnabled")
)
if mibBuilder.loadTexts:
    ciscoLwappDot11ClientMIBNotifControlGroupRev2.setStatus("current")

ciscoLwappDot11ClientMIBStatusGroupRev3 = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 9, 9, 599, 2, 2, 13)
)
ciscoLwappDot11ClientMIBStatusGroupRev3.setObjects(
      *(("CISCO-LWAPP-DOT11-CLIENT-MIB", "cldcMaxThresholdReachedClear"),
        ("CISCO-LWAPP-DOT11-CLIENT-MIB", "cldcMaxClientsCount"))
)
if mibBuilder.loadTexts:
    ciscoLwappDot11ClientMIBStatusGroupRev3.setStatus("current")
...
ciscoLwappDot11ClientMaxClientsReached = NotificationType(
    (1, 3, 6, 1, 4, 1, 9, 9, 599, 0, 13)
)
ciscoLwappDot11ClientMaxClientsReached.setObjects(
      *(("CISCO-LWAPP-DOT11-CLIENT-MIB", "cldcMaxClientsTrapThreshold"),
        ("CISCO-LWAPP-DOT11-CLIENT-MIB", "cldcMaxClientsCount"),
        ("CISCO-LWAPP-DOT11-CLIENT-MIB", "cldcMaxThresholdReachedClear"))
)
if mibBuilder.loadTexts:
    ciscoLwappDot11ClientMaxClientsReached.setStatus(
        "current"
    )
...
ciscoLwappDot11ClientMIBNotifsGroupRev2.setObjects(
      *(("CISCO-LWAPP-DOT11-CLIENT-MIB", "ciscoLwappDot11ClientAssocNacAlert"),
        ...
        ("CISCO-LWAPP-DOT11-CLIENT-MIB", "ciscoLwappDot11ClientStaticIpFailTrap"),
        ("CISCO-LWAPP-DOT11-CLIENT-MIB", "ciscoLwappDot11ClientDisassocDataStatsTrap"),
        ("CISCO-LWAPP-DOT11-CLIENT-MIB", "ciscoLwappDot11ClientAssocDataStatsTrap"),
        ("CISCO-LWAPP-DOT11-CLIENT-MIB", "ciscoLwappDot11ClientSessionTrap"),
        ("CISCO-LWAPP-DOT11-CLIENT-MIB", "ciscoLwappDot11ClientAssocTrap"),
        ("CISCO-LWAPP-DOT11-CLIENT-MIB", "ciscoLwappDot11ClientDeAuthenticatedTrap"),
        ("CISCO-LWAPP-DOT11-CLIENT-MIB", "ciscoLwappDot11ClientMovedToRunStateNewTrap"),
        ("CISCO-LWAPP-DOT11-CLIENT-MIB", "ciscoLwappDot11ClientMobilityTrap"))
)
if mibBuilder.loadTexts:
...
ciscoLwappDot11ClientMIBNotifsGroupRev3 = NotificationGroup(
    (1, 3, 6, 1, 4, 1, 9, 9, 599, 2, 2, 11)
)
ciscoLwappDot11ClientMIBNotifsGroupRev3.setObjects(
    ("CISCO-LWAPP-DOT11-CLIENT-MIB", "ciscoLwappDot11ClientMaxClientsReached")
)
if mibBuilder.loadTexts:
    ciscoLwappDot11ClientMIBNotifsGroupRev3.setStatus(
        "current"
    )
...
ciscoLwappDot11ClientMIBCompliance.setObjects(
      *(("CISCO-LWAPP-DOT11-CLIENT-MIB", "ciscoLwappDot11ClientMIBConfigGroup"),
        ("CISCO-LWAPP-DOT11-CLIENT-MIB", "ciscoLwappDot11ClientMIBNotifsGroup"),
...
ciscoLwappDot11ClientMIBComplianceRev2.setObjects(
      *(("CISCO-LWAPP-DOT11-CLIENT-MIB", "ciscoLwappDot11ClientMIBConfigGroup"),
        ("CISCO-LWAPP-DOT11-CLIENT-MIB", "ciscoLwappDot11ClientMIBNotifsGroup"),
        ("CISCO-LWAPP-DOT11-CLIENT-MIB", "ciscoLwappDot11ClientMIBStatusGroup"),
...
ciscoLwappDot11ClientMIBComplianceRev3 = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 9, 9, 599, 2, 1, 3)
)
ciscoLwappDot11ClientMIBComplianceRev3.setObjects(
      *(("CISCO-LWAPP-DOT11-CLIENT-MIB", "ciscoLwappDot11ClientMIBConfigGroup"),
        ("CISCO-LWAPP-DOT11-CLIENT-MIB", "ciscoLwappDot11ClientMIBNotifsGroup"),
        ("CISCO-LWAPP-DOT11-CLIENT-MIB", "ciscoLwappDot11ClientMIBStatusGroup"),
        ("CISCO-LWAPP-DOT11-CLIENT-MIB", "ciscoLwappDot11ClientMIBStatusGroupRev2"),
        ("CISCO-LWAPP-DOT11-CLIENT-MIB", "ciscoLwappDot11ClientMIBNotifsGroupRev2"),
        ("CISCO-LWAPP-DOT11-CLIENT-MIB", "ciscoLwappDot11ClientMIBNotifControlGroup"),
        ("CISCO-LWAPP-DOT11-CLIENT-MIB", "ciscoLwappDot11ClientMIBStatusGroupRev2Sup"),
        ("CISCO-LWAPP-DOT11-CLIENT-MIB", "ciscoLwappDot11ClientMIBCcxGroup"))
)
if mibBuilder.loadTexts:
    ciscoLwappDot11ClientMIBComplianceRev3.setStatus(
        "deprecated"
    )

ciscoLwappDot11ClientMIBComplianceRev4 = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 9, 9, 599, 2, 1, 4)
)
ciscoLwappDot11ClientMIBComplianceRev4.setObjects(
      *(("CISCO-LWAPP-DOT11-CLIENT-MIB", "ciscoLwappDot11ClientMIBConfigGroup"),
        ("CISCO-LWAPP-DOT11-CLIENT-MIB", "ciscoLwappDot11ClientMIBNotifsGroup"),
        ("CISCO-LWAPP-DOT11-CLIENT-MIB", "ciscoLwappDot11ClientMIBStatusGroup"),
        ("CISCO-LWAPP-DOT11-CLIENT-MIB", "ciscoLwappDot11ClientMIBStatusGroupRev2"),
        ...
        ("CISCO-LWAPP-DOT11-CLIENT-MIB", "ciscoLwappDot11ClientMIBStatusGroupRev2Sup"),
        ("CISCO-LWAPP-DOT11-CLIENT-MIB", "ciscoLwappDot11ClientMIBCcxGroup"),
        ("CISCO-LWAPP-DOT11-CLIENT-MIB", "ciscoLwappDot11ClientMIBSup1Group"))
)
if mibBuilder.loadTexts:
    ciscoLwappDot11ClientMIBComplianceRev4.setStatus(
        "deprecated"
    )

ciscoLwappDot11ClientMIBComplianceRev5 = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 9, 9, 599, 2, 1, 5)
)
ciscoLwappDot11ClientMIBComplianceRev5.setObjects(
      *(("CISCO-LWAPP-DOT11-CLIENT-MIB", "ciscoLwappDot11ClientMIBConfigGroup"),
        ("CISCO-LWAPP-DOT11-CLIENT-MIB", "ciscoLwappDot11ClientMIBNotifsGroup"),
        ("CISCO-LWAPP-DOT11-CLIENT-MIB", "ciscoLwappDot11ClientMIBStatusGroup"),
        ("CISCO-LWAPP-DOT11-CLIENT-MIB", "ciscoLwappDot11ClientMIBStatusGroupRev2"),
        ...
        ("CISCO-LWAPP-DOT11-CLIENT-MIB", "ciscoLwappDot11ClientMIBCcxGroup"),
        ("CISCO-LWAPP-DOT11-CLIENT-MIB", "ciscoLwappDot11ClientMIBSup1Group"),
        ("CISCO-LWAPP-DOT11-CLIENT-MIB", "ciscoLwappDot11ClientMIBConfigGroupRev2"),
        ("CISCO-LWAPP-DOT11-CLIENT-MIB", "ciscoLwappDot11ClientMIBNotifsGroupRev3"),
        ("CISCO-LWAPP-DOT11-CLIENT-MIB", "ciscoLwappDot11ClientMIBNotifControlGroupRev2"),
        ("CISCO-LWAPP-DOT11-CLIENT-MIB", "ciscoLwappDot11ClientMIBStatusGroupRev3"))
)
if mibBuilder.loadTexts:
    ciscoLwappDot11ClientMIBComplianceRev5.setStatus(
        "current"
    )
...
mibBuilder.exportSymbols(
    ...
    **{"ciscoLwappDot11ClientMIB": ciscoLwappDot11ClientMIB,
       ...
       "ciscoLwappDot11ClientMaxClientsReached": ciscoLwappDot11ClientMaxClientsReached,
       ...
       "cldcMaxClientsTrapEnabled": cldcMaxClientsTrapEnabled,
       "cldcMaxClientsTrapThreshold": cldcMaxClientsTrapThreshold,
       "cldcMaxClientsTrapPeriod": cldcMaxClientsTrapPeriod,
       ...
       "cldcClientEncryptionCipher": cldcClientEncryptionCipher,
       ...
       "cldcMaxClientsCount": cldcMaxClientsCount,
       "cldcMaxThresholdReachedClear": cldcMaxThresholdReachedClear,
       ...
       "cldcClientTunnelType": cldcClientTunnelType,
       "cldcClientMaxDataRate": cldcClientMaxDataRate,
       "cldcClientHtCapable": cldcClientHtCapable,
       "cldcClientVhtCapable": cldcClientVhtCapable,
       "cldcClientCurrentTxRate": cldcClientCurrentTxRate,
       "cldcClientiPSKTag": cldcClientiPSKTag,
       "cldcClientMobileStPolicyType": cldcClientMobileStPolicyType,
       ...
       "ciscoLwappDot11ClientMIBComplianceRev3": ciscoLwappDot11ClientMIBComplianceRev3,
       "ciscoLwappDot11ClientMIBComplianceRev4": ciscoLwappDot11ClientMIBComplianceRev4,
       "ciscoLwappDot11ClientMIBComplianceRev5": ciscoLwappDot11ClientMIBComplianceRev5,
       ...
       "ciscoLwappDot11ClientMIBStatusGroupRev2Sup": ciscoLwappDot11ClientMIBStatusGroupRev2Sup,
       "ciscoLwappDot11ClientMIBCcxGroup": ciscoLwappDot11ClientMIBCcxGroup,
       "ciscoLwappDot11ClientMIBSup1Group": ciscoLwappDot11ClientMIBSup1Group,
       "ciscoLwappDot11ClientMIBConfigGroupRev2": ciscoLwappDot11ClientMIBConfigGroupRev2,
       "ciscoLwappDot11ClientMIBNotifsGroupRev3": ciscoLwappDot11ClientMIBNotifsGroupRev3,
       "ciscoLwappDot11ClientMIBNotifControlGroupRev2": ciscoLwappDot11ClientMIBNotifControlGroupRev2,
       "ciscoLwappDot11ClientMIBStatusGroupRev3": ciscoLwappDot11ClientMIBStatusGroupRev3,
       "ciscoLwappDot11CCXClientMIBConform": ciscoLwappDot11CCXClientMIBConform,
