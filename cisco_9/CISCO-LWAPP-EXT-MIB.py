# SNMP MIB module (CISCO-LWAPP-EXT-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/rob/MIBs/cisco_9/CISCO-LWAPP-EXT-MIB.mib
...
ciscoLwappExtMIB = ModuleIdentity(
    (1, 3, 6, 1, 4, 1, 9, 9, 9998)
)
if mibBuilder.loadTexts:
    ciscoLwappExtMIB.setRevisions(
        ("2013-05-14 00:00",)
    )
...
_CiscoLwappExtMIBNotifs_ObjectIdentity = ObjectIdentity
ciscoLwappExtMIBNotifs = _CiscoLwappExtMIBNotifs_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 9, 9, 9998, 0)
)
_CiscoLwappExtMIBObjects_ObjectIdentity = ObjectIdentity
ciscoLwappExtMIBObjects = _CiscoLwappExtMIBObjects_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 9, 9, 9998, 1)
)
_CiscoLwappExtConfig_ObjectIdentity = ObjectIdentity
ciscoLwappExtConfig = _CiscoLwappExtConfig_ObjectIdentity(
...
class _ClExtAgentClearConfig_Type(Integer32):
    """Custom type clExtAgentClearConfig based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_ClExtAgentClearConfig_Type.__name__ = "Integer32"
...
_ClExtApSysManufacture_Type = SnmpAdminString
_ClExtApSysManufacture_Object = MibTableColumn
clExtApSysManufacture = _ClExtApSysManufacture_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 9998, 1, 1, 3, 1, 1, 3),
    _ClExtApSysManufacture_Type()
)
clExtApSysManufacture.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    clExtApSysManufacture.setStatus("current")
...
cLApOperationInfoEntry.setIndexNames(
    (0, "CISCO-LWAPP-EXT-MIB", "cLApOperationSysMacAddress"),
)
if mibBuilder.loadTexts:
...
clExtWepCipherKeyIndex.setMaxAccess("read-write")
if mibBuilder.loadTexts:
...
clExtWepCipherKeyValue.setMaxAccess("read-write")
if mibBuilder.loadTexts:
...
clExtWepCipherKeyCharType.setMaxAccess("read-write")
if mibBuilder.loadTexts:
...
_ClExtClientAuthFailReason_Type = DisplayString
...
clExtClientTxThroughput = _ClExtClientTxThroughput_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 9998, 1, 1, 5, 1, 1, 7),
...
_ClExtAbnormalOfflineClientOnSecurityTypeTable_Object = MibTable
clExtAbnormalOfflineClientOnSecurityTypeTable = _ClExtAbnormalOfflineClientOnSecurityTypeTable_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 9998, 1, 1, 8, 1)
)
if mibBuilder.loadTexts:
    clExtAbnormalOfflineClientOnSecurityTypeTable.setStatus("current")
_ClExtAbnormalOfflineClientOnSecurityTypeEntry_Object = MibTableRow
clExtAbnormalOfflineClientOnSecurityTypeEntry = _ClExtAbnormalOfflineClientOnSecurityTypeEntry_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 9998, 1, 1, 8, 1, 1)
)
clExtAbnormalOfflineClientOnSecurityTypeEntry.setIndexNames(
    (0, "CISCO-LWAPP-EXT-MIB", "clExtSecurityType"),
)
if mibBuilder.loadTexts:
    clExtAbnormalOfflineClientOnSecurityTypeEntry.setStatus("current")
...
_CiscoLwappExtStats_ObjectIdentity = ObjectIdentity
ciscoLwappExtStats = _CiscoLwappExtStats_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 9, 9, 9998, 1, 2)
)
_CiscoLwappExtMIBConform_ObjectIdentity = ObjectIdentity
ciscoLwappExtMIBConform = _CiscoLwappExtMIBConform_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 9, 9, 9998, 2)
)
_CiscoLwappExtMIBNotifObjects_ObjectIdentity = ObjectIdentity
ciscoLwappExtMIBNotifObjects = _CiscoLwappExtMIBNotifObjects_ObjectIdentity(
...
ciscoLwappApDisassociated.setObjects(
      *(("CISCO-LWAPP-AP-MIB", "cLApName"),
        ("CISCO-LWAPP-AP-MIB", "cLApSysMacAddress"),
        ("CISCO-LWAPP-EXT-MIB", "cLExtApDisassocReason"))
)
if mibBuilder.loadTexts:
...
ciscoLwappExtDot11ClientAuthenticationFailTrap.setObjects(
      *(("CISCO-LWAPP-DOT11-CLIENT-MIB", "cldcClientMacAddress"),
        ...
        ("CISCO-LWAPP-EXT-MIB", "clExtClientAuthFailReason"))
)
if mibBuilder.loadTexts:
...
ciscoLwappExtDot11ClientAssocFailTrap.setObjects(
      *(("CISCO-LWAPP-DOT11-CLIENT-MIB", "cldcClientMacAddress"),
        ...
        ("CISCO-LWAPP-AP-MIB", "cLApIfSmtDot11Bssid"),
        ("CISCO-LWAPP-EXT-MIB", "cLExtDot11ClientAssocFailReason"))
)
if mibBuilder.loadTexts:
...
ciscoLwappExtAdjChannelOverRssiDetected.setObjects(
      *(("CISCO-LWAPP-AP-MIB", "cLApSysMacAddress"),
        ("CISCO-LWAPP-EXT-MIB", "cLExtApDetectedMacAddress"),
        ("CISCO-LWAPP-EXT-MIB", "cLExtApDetectedChannel"),
...
mibBuilder.exportSymbols(
    ...
    **{"CLSwitch": CLSwitch,
       ...
       "ciscoLwappExtMIB": ciscoLwappExtMIB,
       "ciscoLwappExtMIBNotifs": ciscoLwappExtMIBNotifs,
       ...
       "ciscoLwappExtMIBObjects": ciscoLwappExtMIBObjects,
       "ciscoLwappExtConfig": ciscoLwappExtConfig,
       "clExtSys": clExtSys,
       ...
       "clExtApSysManufacture": clExtApSysManufacture,
       ...
       "clExtAbnormalOfflineClientOnSecurityTypeTable": clExtAbnormalOfflineClientOnSecurityTypeTable,
       "clExtAbnormalOfflineClientOnSecurityTypeEntry": clExtAbnormalOfflineClientOnSecurityTypeEntry,
       "clExtSecurityType": clExtSecurityType,
       "clExtAbnormalOfflineClientCount": clExtAbnormalOfflineClientCount,
       "ciscoLwappExtStats": ciscoLwappExtStats,
       "ciscoLwappExtMIBConform": ciscoLwappExtMIBConform,
       "ciscoLwappExtMIBNotifObjects": ciscoLwappExtMIBNotifObjects,
       "cLExtApDisassocReason": cLExtApDisassocReason,
