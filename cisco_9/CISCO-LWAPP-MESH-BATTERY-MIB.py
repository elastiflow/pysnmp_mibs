...
# Notes
# -----
# ASN.1 source file:///Users/rob/MIBs/cisco_9/CISCO-LWAPP-MESH-BATTERY-MIB.mib
...
_ClMeshBatteryAlarmEnabled_Type.__name__ = "TruthValue"
...
ciscoLwappMeshBatteryMIBCompliance.setObjects(
      *(("CISCO-LWAPP-MESH-BATTERY-MIB", "ciscoLwappMeshBatteryInfoGroup"),
        ("CISCO-LWAPP-MESH-BATTERY-MIB", "ciscoLwappMeshBatteryNotifsConfigGroup"),
        ("CISCO-LWAPP-MESH-BATTERY-MIB", "ciscoLwappMeshBatteryNotifsGroup"))
)
if mibBuilder.loadTexts:
...
ciscoLwappMeshBatteryMIBComplianceRev1.setObjects(
      *(("CISCO-LWAPP-MESH-BATTERY-MIB", "ciscoLwappMeshBatteryNotifsConfigGroup"),
        ("CISCO-LWAPP-MESH-BATTERY-MIB", "ciscoLwappMeshBatteryNotifsGroup"),
        ("CISCO-LWAPP-MESH-BATTERY-MIB", "ciscoLwappMeshBatteryInfoGroupRev1"))
)
if mibBuilder.loadTexts:
...
ciscoLwappMeshBatteryMIBComplianceRev2.setObjects(
      *(("CISCO-LWAPP-MESH-BATTERY-MIB", "ciscoLwappMeshBatteryNotifsConfigGroup"),
        ("CISCO-LWAPP-MESH-BATTERY-MIB", "ciscoLwappMeshBatteryNotifsGroup"),
        ("CISCO-LWAPP-MESH-BATTERY-MIB", "ciscoLwappMeshBatteryInfoGroupRev2"))
)
if mibBuilder.loadTexts:
