...
# Notes
# -----
# ASN.1 source file:///Users/rob/MIBs/cisco_9/CISCO-LWAPP-MESH-STATS-MIB.mib
...
_ClMeshNodeQueueOverflowNotifEnabled_Type.__name__ = "TruthValue"
...
_ClMeshNodeSecBackhaulChangeNotifEnabled_Type.__name__ = "TruthValue"
...
_ClMeshNodeExcessiveAssociationNotifEnabled_Type.__name__ = "TruthValue"
...
ciscoLwappMeshRadioRoleChange = NotificationType(
    (1, 3, 6, 1, 4, 1, 9, 9, 617, 0, 4)
)
ciscoLwappMeshRadioRoleChange.setObjects(
      *(("CISCO-LWAPP-AP-MIB", "cLApName"),
        ("CISCO-LWAPP-AP-MIB", "cLApDot11RadioRole"))
)
if mibBuilder.loadTexts:
    ciscoLwappMeshRadioRoleChange.setStatus(
        "current"
    )
...
ciscoLwappMeshStatsMIBCompliance.setObjects(
      *(("CISCO-LWAPP-MESH-STATS-MIB", "ciscoLwappMeshNodeStatsGroup"),
        ("CISCO-LWAPP-MESH-STATS-MIB", "ciscoLwappMeshNodePktQueueStatsGroup"),
        ("CISCO-LWAPP-MESH-STATS-MIB", "ciscoLwappMeshNodeSecStatsGroup"),
        ("CISCO-LWAPP-MESH-STATS-MIB", "ciscoLwappMeshStatsConfigObjsGroup"),
        ("CISCO-LWAPP-MESH-STATS-MIB", "ciscoLwappMeshStatsNotifsGroup"),
        ("CISCO-LWAPP-MESH-STATS-MIB", "ciscoLwappMeshNeighStatsGroup"),
        ("CISCO-LWAPP-MESH-STATS-MIB", "ciscoLwappMeshStatsNotifObjsGroup"))
)
if mibBuilder.loadTexts:
...
ciscoLwappMeshStatsMIBComplianceR01.setObjects(
      *(("CISCO-LWAPP-MESH-STATS-MIB", "ciscoLwappMeshNodeStatsGroup"),
        ("CISCO-LWAPP-MESH-STATS-MIB", "ciscoLwappMeshNodePktQueueStatsGroup"),
        ("CISCO-LWAPP-MESH-STATS-MIB", "ciscoLwappMeshNodeSecStatsGroup"),
        ("CISCO-LWAPP-MESH-STATS-MIB", "ciscoLwappMeshStatsConfigObjsGroup"),
        ...
        ("CISCO-LWAPP-MESH-STATS-MIB", "ciscoLwappMeshNeighStatsGroup"),
        ("CISCO-LWAPP-MESH-STATS-MIB", "ciscoLwappMeshStatsNotifObjsGroup"),
        ("CISCO-LWAPP-MESH-STATS-MIB", "ciscoLwappMeshAccessClassGroup"),
        ("CISCO-LWAPP-MESH-STATS-MIB", "ciscoLwappMeshDataRateStatsGroup"),
        ("CISCO-LWAPP-MESH-STATS-MIB", "ciscoLwappMeshNodeStatsGroupSup1"),
        ("CISCO-LWAPP-MESH-STATS-MIB", "ciscoLwappMeshStatsConfigObjsGroupSup1"),
        ("CISCO-LWAPP-MESH-STATS-MIB", "ciscoLwappMeshStatsNotifsGroupSup1"))
)
if mibBuilder.loadTexts:
...
mibBuilder.exportSymbols(
    ...
    **{"ciscoLwappMeshStatsMIB": ciscoLwappMeshStatsMIB,
       ...
       "ciscoLwappMeshRadioRoleChange": ciscoLwappMeshRadioRoleChange,
