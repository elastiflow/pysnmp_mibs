...
# Notes
# -----
# ASN.1 source file:///Users/rob/MIBs/cisco_9/CISCO-LWAPP-MOBILITY-EXT-MIB.mib
...
cLMobilityExtWlanPolicyNameGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 9, 9, 846, 2, 2, 8)
)
cLMobilityExtWlanPolicyNameGroup.setObjects(
    ("CISCO-LWAPP-MOBILITY-EXT-MIB", "cLMobilityExtWlanPolicyName")
)
if mibBuilder.loadTexts:
    cLMobilityExtWlanPolicyNameGroup.setStatus("current")
...
mibBuilder.exportSymbols(
    ...
    **{"CiscoAbsZeroBasedCounter64": CiscoAbsZeroBasedCounter64,
       ...
       "cLMobilityExtWlanPolicyNameGroup": cLMobilityExtWlanPolicyNameGroup,
