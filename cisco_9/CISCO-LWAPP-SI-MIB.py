...
# Notes
# -----
# ASN.1 source file:///Users/rob/MIBs/cisco_9/CISCO-LWAPP-SI-MIB.mib
...
_CLSiAqChannelNumber_Type = Unsigned32
...
_CLSiAqInterferenceClassReportClass_Type = Unsigned32
_CLSiAqInterferenceClassReportClass_Object = MibTableColumn
cLSiAqInterferenceClassReportClass = _CLSiAqInterferenceClassReportClass_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 513, 1, 6, 1, 1, 1, 2, 1, 2),
    _CLSiAqInterferenceClassReportClass_Type()
)
cLSiAqInterferenceClassReportClass.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cLSiAqInterferenceClassReportClass.setStatus("current")
_CLSiAqInterferenceClassReportSeverityIndex_Type = Unsigned32
...
_CLSiIdrDeviceType_Type = Unsigned32
...
_CLSiIdrSeverity_Type = Unsigned32
...
cLSiIdrClusterDeviceId.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
...
_CLSiIdrClusterDeviceType_Type = Unsigned32
...
_CLSiIdrClusterSeverity_Type = Unsigned32
...
_CLSiIdrClusterType_Type = Unsigned32
...
_CLSiChannelPropagationFlag_Type = TruthValue
_CLSiChannelPropagationFlag_Object = MibTableColumn
cLSiChannelPropagationFlag = _CLSiChannelPropagationFlag_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 513, 1, 6, 1, 1, 2, 4, 1, 5),
    _CLSiChannelPropagationFlag_Type()
)
cLSiChannelPropagationFlag.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cLSiChannelPropagationFlag.setStatus("current")
...
_CLSiD11SpectrumIntelligenceEnable_Type.__name__ = "TruthValue"
...
_CLSiD11IdrReportingEnable_Type.__name__ = "TruthValue"
...
_CLSiD11AqiTrapEnable_Type.__name__ = "TruthValue"
...
_CLSiD11IdrTrapEnable_Type.__name__ = "TruthValue"
...
class _CLSiD11IdrPersistentDevicePropagation_Type(TruthValue):
    """Custom type cLSiD11IdrPersistentDevicePropagation based on TruthValue"""
    defaultValue = 1


_CLSiD11IdrPersistentDevicePropagation_Type.__name__ = "TruthValue"
...
class _CLSiD11IdrUnclassifiedTrapEnable_Type(TruthValue):
    """Custom type cLSiD11IdrUnclassifiedTrapEnable based on TruthValue"""
    defaultValue = 1


_CLSiD11IdrUnclassifiedTrapEnable_Type.__name__ = "TruthValue"
...
_CLSiD11SIEnable_Type = TruthValue
_CLSiD11SIEnable_Object = MibTableColumn
cLSiD11SIEnable = _CLSiD11SIEnable_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 513, 1, 6, 1, 1, 3, 1, 1, 14),
    _CLSiD11SIEnable_Type()
)
cLSiD11SIEnable.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    cLSiD11SIEnable.setStatus("current")
...
_CLSiD11EventDrivenRrmEnable_Type.__name__ = "TruthValue"
...
class _CLSiD11EventDrivenRrmRogueEnable_Type(TruthValue):
    """Custom type cLSiD11EventDrivenRrmRogueEnable based on TruthValue"""
    defaultValue = 2


_CLSiD11EventDrivenRrmRogueEnable_Type.__name__ = "TruthValue"
_CLSiD11EventDrivenRrmRogueEnable_Object = MibTableColumn
cLSiD11EventDrivenRrmRogueEnable = _CLSiD11EventDrivenRrmRogueEnable_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 513, 1, 6, 1, 1, 3, 2, 1, 4),
    _CLSiD11EventDrivenRrmRogueEnable_Type()
)
cLSiD11EventDrivenRrmRogueEnable.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    cLSiD11EventDrivenRrmRogueEnable.setStatus("current")


class _CLSiD11EventDrivenRrmRogueDutyCycle_Type(Unsigned32):
    """Custom type cLSiD11EventDrivenRrmRogueDutyCycle based on Unsigned32"""
    defaultValue = 80
...
_CLSiD11EventDrivenRrmRogueDutyCycle_Type.__name__ = "Unsigned32"
_CLSiD11EventDrivenRrmRogueDutyCycle_Object = MibTableColumn
cLSiD11EventDrivenRrmRogueDutyCycle = _CLSiD11EventDrivenRrmRogueDutyCycle_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 513, 1, 6, 1, 1, 3, 2, 1, 5),
    _CLSiD11EventDrivenRrmRogueDutyCycle_Type()
)
cLSiD11EventDrivenRrmRogueDutyCycle.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    cLSiD11EventDrivenRrmRogueDutyCycle.setStatus("current")
...
_CLSiApIfSpectrumIntelligenceEnable_Type.__name__ = "TruthValue"
...
if mibBuilder.loadTexts:
    cLSiApIfSpectrumIntelligenceEnable.setStatus("deprecated")
...
_CLSiApIfRapidUpdateEnable_Type.__name__ = "TruthValue"
...
_CLSiApIfDetailSpectrumModeEnable_Type.__name__ = "TruthValue"
...
if mibBuilder.loadTexts:
    cLSiApIfSensordOperationalStatus.setStatus("deprecated")
...
_CLSiApIfBandTable_Object = MibTable
cLSiApIfBandTable = _CLSiApIfBandTable_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 513, 1, 6, 1, 1, 4, 2)
)
if mibBuilder.loadTexts:
    cLSiApIfBandTable.setStatus("current")
_CLSiApIfBandEntry_Object = MibTableRow
cLSiApIfBandEntry = _CLSiApIfBandEntry_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 513, 1, 6, 1, 1, 4, 2, 1)
)
cLSiApIfBandEntry.setIndexNames(
    (0, "CISCO-LWAPP-AP-MIB", "cLApSysMacAddress"),
    (0, "CISCO-LWAPP-AP-MIB", "cLApDot11IfSlotId"),
    (0, "CISCO-LWAPP-SI-MIB", "cLSiApIfBandId"),
)
if mibBuilder.loadTexts:
    cLSiApIfBandEntry.setStatus("current")
_CLSiApIfBandId_Type = Unsigned32
_CLSiApIfBandId_Object = MibTableColumn
cLSiApIfBandId = _CLSiApIfBandId_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 513, 1, 6, 1, 1, 4, 2, 1, 1),
    _CLSiApIfBandId_Type()
)
cLSiApIfBandId.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    cLSiApIfBandId.setStatus("current")


class _CLSiApIfBandSpectrumIntelligenceEnable_Type(TruthValue):
    """Custom type cLSiApIfBandSpectrumIntelligenceEnable based on TruthValue"""
    defaultValue = 1


_CLSiApIfBandSpectrumIntelligenceEnable_Type.__name__ = "TruthValue"
_CLSiApIfBandSpectrumIntelligenceEnable_Object = MibTableColumn
cLSiApIfBandSpectrumIntelligenceEnable = _CLSiApIfBandSpectrumIntelligenceEnable_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 513, 1, 6, 1, 1, 4, 2, 1, 2),
    _CLSiApIfBandSpectrumIntelligenceEnable_Type()
)
cLSiApIfBandSpectrumIntelligenceEnable.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    cLSiApIfBandSpectrumIntelligenceEnable.setStatus("current")


class _CLSiApIfBandSensordOperationalStatus_Type(Integer32):
    """Custom type cLSiApIfBandSensordOperationalStatus based on Integer32"""
    defaultValue = 3
...
_CLSiApIfBandSensordOperationalStatus_Type.__name__ = "Integer32"
_CLSiApIfBandSensordOperationalStatus_Object = MibTableColumn
cLSiApIfBandSensordOperationalStatus = _CLSiApIfBandSensordOperationalStatus_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 513, 1, 6, 1, 1, 4, 2, 1, 3),
    _CLSiApIfBandSensordOperationalStatus_Type()
)
cLSiApIfBandSensordOperationalStatus.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cLSiApIfBandSensordOperationalStatus.setStatus("current")
...
cLSiAqInterferenceClassReportStatusGroup.setObjects(
      *(("CISCO-LWAPP-SI-MIB", "cLSiAqInterferenceClassReportClass"),
...
cLSiD11ConfigSup1Group.setObjects(
      *(("CISCO-LWAPP-SI-MIB", "cLSiD11IdrPersistentDevicePropagation"),
        ...
        ("CISCO-LWAPP-SI-MIB", "cLSiD11SIEnable"))
)
if mibBuilder.loadTexts:
...
ciscoLwappApSiMIBCompliance.setObjects(
      *(("CISCO-LWAPP-SI-MIB", "cLSiApIfConfigGroup"),
        ("CISCO-LWAPP-SI-MIB", "cLSiApIfStatusGroup"),
        ("CISCO-LWAPP-SI-MIB", "cLSiD11ConfigGroup"),
        ("CISCO-LWAPP-SI-MIB", "cLSiAqChannelStatusGroup"),
        ("CISCO-LWAPP-SI-MIB", "cLSiAqInterferenceClassReportStatusGroup"),
        ("CISCO-LWAPP-SI-MIB", "cLSiIdrStatusGroup"),
        ("CISCO-LWAPP-SI-MIB", "cLSiIdrClusterStatusGroup"),
        ("CISCO-LWAPP-SI-MIB", "cLSiD11EventDrivenRrmConfigGroup"),
        ("CISCO-LWAPP-SI-MIB", "cLSiPersistentDeviceStatusGroup"),
        ("CISCO-LWAPP-SI-MIB", "cLSiPersistentDeviceChanStatusGroup"))
)
if mibBuilder.loadTexts:
...
ciscoLwappApSiMIBComplianceRev1.setObjects(
      *(("CISCO-LWAPP-SI-MIB", "cLSiApIfConfigGroup"),
        ("CISCO-LWAPP-SI-MIB", "cLSiApIfStatusGroup"),
        ("CISCO-LWAPP-SI-MIB", "cLSiD11ConfigGroup"),
        ("CISCO-LWAPP-SI-MIB", "cLSiD11ConfigSup1Group"),
        ("CISCO-LWAPP-SI-MIB", "cLSiAqChannelStatusGroup"),
        ("CISCO-LWAPP-SI-MIB", "cLSiAqInterferenceClassReportStatusGroup"),
        ("CISCO-LWAPP-SI-MIB", "cLSiIdrStatusGroup"),
        ("CISCO-LWAPP-SI-MIB", "cLSiIdrClusterStatusGroup"),
        ("CISCO-LWAPP-SI-MIB", "cLSiD11EventDrivenRrmConfigGroup"),
        ("CISCO-LWAPP-SI-MIB", "cLSiD11EventDrivenRrmConfigSup1Group"),
        ("CISCO-LWAPP-SI-MIB", "cLSiPersistentDeviceStatusGroup"),
        ("CISCO-LWAPP-SI-MIB", "cLSiPersistentDeviceChanStatusGroup"),
        ("CISCO-LWAPP-SI-MIB", "ciscoLwappSiMIBNotifGroup"),
        ("CISCO-LWAPP-SI-MIB", "ciscoLwappSiMIBNotifVariableGroup"))
)
if mibBuilder.loadTexts:
...
mibBuilder.exportSymbols(
    ...
    **{"ciscoLwappSiMIB": ciscoLwappSiMIB,
       ...
       "cLSiAqInterferenceClassReportClass": cLSiAqInterferenceClassReportClass,
       ...
       "cLSiChannelPropagationFlag": cLSiChannelPropagationFlag,
       ...
       "cLSiD11SIEnable": cLSiD11SIEnable,
       ...
       "cLSiD11EventDrivenRrmRogueEnable": cLSiD11EventDrivenRrmRogueEnable,
       "cLSiD11EventDrivenRrmRogueDutyCycle": cLSiD11EventDrivenRrmRogueDutyCycle,
       ...
       "cLSiApIfBandTable": cLSiApIfBandTable,
       "cLSiApIfBandEntry": cLSiApIfBandEntry,
       "cLSiApIfBandId": cLSiApIfBandId,
       "cLSiApIfBandSpectrumIntelligenceEnable": cLSiApIfBandSpectrumIntelligenceEnable,
       "cLSiApIfBandSensordOperationalStatus": cLSiApIfBandSensordOperationalStatus,
