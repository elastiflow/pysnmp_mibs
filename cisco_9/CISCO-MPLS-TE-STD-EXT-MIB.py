...
# Notes
# -----
# ASN.1 source file:///Users/rob/MIBs/cisco_9/CISCO-MPLS-TE-STD-EXT-MIB.mib
...
_CmplsTunnelAutoBWMin_Type.__name__ = "Unsigned32"
...
_CmplsTunnelAutoBWMax_Type.__name__ = "Unsigned32"
...
_CmplsTunnelAutoBWAdjThreshPercs_Type.__name__ = "CmplsTunnelBWPercent"
...
_CmplsTunnelAutoBWAdjThreshBW_Type.__name__ = "Unsigned32"
...
_CmplsTunnelAutoBWOverflowThreshPercs_Type.__name__ = "CmplsTunnelBWPercent"
...
_CmplsTunnelAutoBWOverflowThreshBW_Type.__name__ = "Unsigned32"
...
_CmplsTunnelAutoBWOverflowLimit_Type.__name__ = "Unsigned32"
...
_CmplsTunnelAutoBWUnderflowThreshPercs_Type.__name__ = "CmplsTunnelBWPercent"
...
_CmplsTunnelAutoBWUnderflowThreshBW_Type.__name__ = "Unsigned32"
...
_CmplsTunnelAutoBWUnderflowLimit_Type.__name__ = "Unsigned32"
...
_CmplsTunnelAutoBWApplicationFrequency_Type.__name__ = "Unsigned32"
...
_CmplsTunnelAutoBWCollectionFrequency_Type.__name__ = "Unsigned32"
...
_CmplsTunnelAutoBWJitter_Type.__name__ = "Unsigned32"
...
_CmplsTunnelLoadShare_Type.__name__ = "Unsigned32"
...
cmplsTeStdExtMIBCompliance.setObjects(
      *(("CISCO-MPLS-TE-STD-EXT-MIB", "cmplsTeStdExtMIBAutoBWOptionalGroup"),
        ("CISCO-MPLS-TE-STD-EXT-MIB", "cmplsTeStdExtMIBAutoBWObjectGroup"))
)
if mibBuilder.loadTexts:
...
cmplsTeStdExtMIBCompliancesRev1.setObjects(
      *(("CISCO-MPLS-TE-STD-EXT-MIB", "cmplsTeStdExtMIBAutoBWOptionalGroup"),
        ("CISCO-MPLS-TE-STD-EXT-MIB", "cmplsTeStdExtMIBAutoBWObjectGroup"),
        ("CISCO-MPLS-TE-STD-EXT-MIB", "cmplsTeStdExtMIBTrapGroup"),
        ("CISCO-MPLS-TE-STD-EXT-MIB", "cmplsTeStdExtMIBTrapObjectsGroup"))
)
if mibBuilder.loadTexts:
...
cmplsTeStdExtMIBComplianceRev2.setObjects(
      *(("CISCO-MPLS-TE-STD-EXT-MIB", "cmplsTeStdExtMIBAutoBWOptionalGroup"),
        ("CISCO-MPLS-TE-STD-EXT-MIB", "cmplsTeStdExtMIBAutoBWObjectGroup"),
        ("CISCO-MPLS-TE-STD-EXT-MIB", "cmplsTeStdExtMIBTrapGroup"),
        ("CISCO-MPLS-TE-STD-EXT-MIB", "cmplsTeStdExtMIBTrapObjectsGroupRev1"))
)
if mibBuilder.loadTexts:
...
cmplsTeStdExtMIBComplianceRev3.setObjects(
      *(("CISCO-MPLS-TE-STD-EXT-MIB", "cmplsTeStdExtMIBAutoBWOptionalGroup"),
        ("CISCO-MPLS-TE-STD-EXT-MIB", "cmplsTeStdExtMIBAutoBWObjectGroup"),
        ("CISCO-MPLS-TE-STD-EXT-MIB", "cmplsTeStdExtMIBTrapGroup"),
        ("CISCO-MPLS-TE-STD-EXT-MIB", "cmplsTeStdExtMIBTrapObjectsGroupRev1"),
        ("CISCO-MPLS-TE-STD-EXT-MIB", "cmplsTeStdExtMIBFailTeTrapGroup"),
...
cmplsTeStdExtMIBComplianceRev4.setObjects(
      *(("CISCO-MPLS-TE-STD-EXT-MIB", "cmplsTeStdExtMIBAutoBWOptionalGroup"),
        ("CISCO-MPLS-TE-STD-EXT-MIB", "cmplsTeStdExtMIBAutoBWObjectGroup"),
        ("CISCO-MPLS-TE-STD-EXT-MIB", "cmplsTeStdExtMIBTrapGroup"),
        ("CISCO-MPLS-TE-STD-EXT-MIB", "cmplsTeStdExtMIBTrapObjectsGroupRev1"),
