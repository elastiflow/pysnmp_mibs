...
# Notes
# -----
# ASN.1 source file:///Users/rob/MIBs/cisco_9/CISCO-SECURE-SHELL-MIB.mib
...
_CssKeyLastCreationTimeStamp_Type = DateAndTime
_CssKeyLastCreationTimeStamp_Object = MibTableColumn
cssKeyLastCreationTimeStamp = _CssKeyLastCreationTimeStamp_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 339, 1, 1, 2, 1, 7),
    _CssKeyLastCreationTimeStamp_Type()
)
cssKeyLastCreationTimeStamp.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cssKeyLastCreationTimeStamp.setStatus("current")
...
cssConfigurationGroupSupp2 = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 9, 9, 339, 2, 2, 6)
)
cssConfigurationGroupSupp2.setObjects(
    ("CISCO-SECURE-SHELL-MIB", "cssKeyLastCreationTimeStamp")
)
if mibBuilder.loadTexts:
    cssConfigurationGroupSupp2.setStatus("current")
...
ciscoSecureShellMIBComplianceRv4 = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 9, 9, 339, 2, 1, 5)
)
ciscoSecureShellMIBComplianceRv4.setObjects(
      *(("CISCO-SECURE-SHELL-MIB", "cssConfigurationGroupRev1"),
        ("CISCO-SECURE-SHELL-MIB", "cssConfigurationGroupSupp1"),
        ("CISCO-SECURE-SHELL-MIB", "cssConfigurationGroupSupp2"))
)
if mibBuilder.loadTexts:
    ciscoSecureShellMIBComplianceRv4.setStatus(
        "current"
    )
...
mibBuilder.exportSymbols(
    ...
    **{"CssVersions": CssVersions,
       ...
       "cssKeyLastCreationTimeStamp": cssKeyLastCreationTimeStamp,
       ...
       "ciscoSecureShellMIBComplianceRv4": ciscoSecureShellMIBComplianceRv4,
       ...
       "cssConfigurationGroupSupp2": cssConfigurationGroupSupp2}
)
