...
# Notes
# -----
# ASN.1 source file:///Users/rob/MIBs/cisco_9/CISCO-SLB-EXT-MIB.mib
...
class SlbDwsCfgState(TextualConvention, Integer32):
    status = "current"
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
...
class SlbDwsOpState(TextualConvention, Integer32):
    status = "current"
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
    ...
    namedValues = NamedValues(
        *(("dwsLbNotApplicable", 1),
          ("dwsLbLocalVm", 2),
          ("dwsLbLocalAndRemoteVm", 3))
    )
...
_CslbxServerFarmStateChangeDescr_Type = SnmpAdminString
_CslbxServerFarmStateChangeDescr_Object = MibTableColumn
cslbxServerFarmStateChangeDescr = _CslbxServerFarmStateChangeDescr_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 254, 1, 2, 1, 1, 17),
    _CslbxServerFarmStateChangeDescr_Type()
)
cslbxServerFarmStateChangeDescr.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cslbxServerFarmStateChangeDescr.setStatus("current")
_CslbxServerFarmDwsCfgState_Type = SlbDwsCfgState
_CslbxServerFarmDwsCfgState_Object = MibTableColumn
cslbxServerFarmDwsCfgState = _CslbxServerFarmDwsCfgState_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 254, 1, 2, 1, 1, 18),
    _CslbxServerFarmDwsCfgState_Type()
)
cslbxServerFarmDwsCfgState.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cslbxServerFarmDwsCfgState.setStatus("current")
_CslbxServerFarmDwsOpState_Type = SlbDwsOpState
_CslbxServerFarmDwsOpState_Object = MibTableColumn
cslbxServerFarmDwsOpState = _CslbxServerFarmDwsOpState_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 254, 1, 2, 1, 1, 19),
    _CslbxServerFarmDwsOpState_Type()
)
cslbxServerFarmDwsOpState.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cslbxServerFarmDwsOpState.setStatus("current")
...
_CslbxVServerInfoTable_Object = MibTable
cslbxVServerInfoTable = _CslbxVServerInfoTable_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 254, 1, 8, 3)
)
if mibBuilder.loadTexts:
    cslbxVServerInfoTable.setStatus("current")
_CslbxVServerInfoTableEntry_Object = MibTableRow
cslbxVServerInfoTableEntry = _CslbxVServerInfoTableEntry_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 254, 1, 8, 3, 1)
)
if mibBuilder.loadTexts:
    cslbxVServerInfoTableEntry.setStatus("current")
_CslbxVServerDwsCfgState_Type = SlbDwsCfgState
_CslbxVServerDwsCfgState_Object = MibTableColumn
cslbxVServerDwsCfgState = _CslbxVServerDwsCfgState_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 254, 1, 8, 3, 1, 1),
    _CslbxVServerDwsCfgState_Type()
)
cslbxVServerDwsCfgState.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cslbxVServerDwsCfgState.setStatus("current")
_CslbxVServerDwsOpState_Type = SlbDwsOpState
_CslbxVServerDwsOpState_Object = MibTableColumn
cslbxVServerDwsOpState = _CslbxVServerDwsOpState_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 254, 1, 8, 3, 1, 2),
    _CslbxVServerDwsOpState_Type()
)
cslbxVServerDwsOpState.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cslbxVServerDwsOpState.setStatus("current")
...
class _CslbxSfarmStateChangeNotifEnabled_Type(TruthValue):
    """Custom type cslbxSfarmStateChangeNotifEnabled based on TruthValue"""
    defaultValue = 2


_CslbxSfarmStateChangeNotifEnabled_Type.__name__ = "TruthValue"
_CslbxSfarmStateChangeNotifEnabled_Object = MibScalar
cslbxSfarmStateChangeNotifEnabled = _CslbxSfarmStateChangeNotifEnabled_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 254, 1, 13, 2),
    _CslbxSfarmStateChangeNotifEnabled_Type()
)
cslbxSfarmStateChangeNotifEnabled.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    cslbxSfarmStateChangeNotifEnabled.setStatus("current")


class _CslbxServerFarmName_Type(SnmpAdminString):
    """Custom type cslbxServerFarmName based on SnmpAdminString"""
    subtypeSpec = SnmpAdminString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 64),
    )
...
_CslbxServerFarmName_Type.__name__ = "SnmpAdminString"
_CslbxServerFarmName_Object = MibScalar
cslbxServerFarmName = _CslbxServerFarmName_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 254, 1, 13, 3),
    _CslbxServerFarmName_Type()
)
cslbxServerFarmName.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    cslbxServerFarmName.setStatus("current")
...
slbVServerInfoTableEntry.registerAugmentions(
    ("CISCO-SLB-EXT-MIB",
     "cslbxVServerInfoTableEntry")
)
cslbxVServerInfoTableEntry.setIndexNames(*slbVServerInfoTableEntry.getIndexNames())
...
if mibBuilder.loadTexts:
    cslbxNotifControlGroup.setStatus("deprecated")
...
if mibBuilder.loadTexts:
    cslbxServerFarmsExtGroupRev1.setStatus("deprecated")

cslbxServerFarmsExtGroupRev2 = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 9, 9, 254, 2, 2, 38)
)
cslbxServerFarmsExtGroupRev2.setObjects(
      *(("CISCO-SLB-EXT-MIB", "cslbxServerFarmTransparent"),
        ("CISCO-SLB-EXT-MIB", "cslbxServerFarmSlowStart"),
        ("CISCO-SLB-EXT-MIB", "cslbxServerFarmHashHeaderName"),
        ("CISCO-SLB-EXT-MIB", "cslbxServerFarmHashCookieName"),
        ...
        ("CISCO-SLB-EXT-MIB", "cslbxServerFarmType"),
        ("CISCO-SLB-EXT-MIB", "cslbxServerFarmState"),
        ("CISCO-SLB-EXT-MIB", "cslbxServerFarmStateChangeDescr"))
)
if mibBuilder.loadTexts:
    cslbxServerFarmsExtGroupRev2.setStatus("deprecated")

cslbxNotifControlGroupRev1 = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 9, 9, 254, 2, 2, 39)
)
cslbxNotifControlGroupRev1.setObjects(
      *(("CISCO-SLB-EXT-MIB", "cslbxFtStateChangeNotifEnabled"),
        ("CISCO-SLB-EXT-MIB", "cslbxSfarmStateChangeNotifEnabled"))
)
if mibBuilder.loadTexts:
    cslbxNotifControlGroupRev1.setStatus("current")

cslbxNotifObjectGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 9, 9, 254, 2, 2, 41)
)
cslbxNotifObjectGroup.setObjects(
    ("CISCO-SLB-EXT-MIB", "cslbxServerFarmName")
)
if mibBuilder.loadTexts:
    cslbxNotifObjectGroup.setStatus("current")

cslbxServerFarmsExtGroupRev3 = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 9, 9, 254, 2, 2, 43)
)
cslbxServerFarmsExtGroupRev3.setObjects(
      *(("CISCO-SLB-EXT-MIB", "cslbxServerFarmTransparent"),
        ("CISCO-SLB-EXT-MIB", "cslbxServerFarmSlowStart"),
        ("CISCO-SLB-EXT-MIB", "cslbxServerFarmHashHeaderName"),
        ("CISCO-SLB-EXT-MIB", "cslbxServerFarmHashCookieName"),
        ...
        ("CISCO-SLB-EXT-MIB", "cslbxServerFarmState"),
        ("CISCO-SLB-EXT-MIB", "cslbxServerFarmStateChangeDescr"),
        ("CISCO-SLB-EXT-MIB", "cslbxServerFarmDwsCfgState"),
        ("CISCO-SLB-EXT-MIB", "cslbxServerFarmDwsOpState"))
)
if mibBuilder.loadTexts:
    cslbxServerFarmsExtGroupRev3.setStatus("current")

cslbxVServerInfoGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 9, 9, 254, 2, 2, 44)
)
cslbxVServerInfoGroup.setObjects(
      *(("CISCO-SLB-EXT-MIB", "cslbxVServerDwsCfgState"),
        ("CISCO-SLB-EXT-MIB", "cslbxVServerDwsOpState"))
)
if mibBuilder.loadTexts:
    cslbxVServerInfoGroup.setStatus("current")
...
cslbxServerFarmStateChange = NotificationType(
    (1, 3, 6, 1, 4, 1, 9, 9, 254, 0, 2)
)
cslbxServerFarmStateChange.setObjects(
      *(("CISCO-SLB-EXT-MIB", "cslbxServerFarmName"),
        ("CISCO-SLB-EXT-MIB", "cslbxServerFarmState"),
        ("CISCO-SLB-EXT-MIB", "cslbxServerFarmStateChangeDescr"),
        ("CISCO-SLB-EXT-MIB", "cslbxServerFarmNumOfTimeFailOvers"),
...
if mibBuilder.loadTexts:
    cslbxServerFarmStateChange.setStatus(
        "current"
    )

cslbxServerFarmDwsOpStateChange = NotificationType(
    (1, 3, 6, 1, 4, 1, 9, 9, 254, 0, 3)
)
cslbxServerFarmDwsOpStateChange.setObjects(
      *(("CISCO-SLB-EXT-MIB", "cslbxServerFarmName"),
        ("CISCO-SLB-EXT-MIB", "cslbxServerFarmDwsOpState"))
)
if mibBuilder.loadTexts:
    cslbxServerFarmDwsOpStateChange.setStatus(
        "current"
    )
...
cslbxNotifGroupRev1 = NotificationGroup(
    (1, 3, 6, 1, 4, 1, 9, 9, 254, 2, 2, 40)
)
cslbxNotifGroupRev1.setObjects(
      *(("CISCO-SLB-EXT-MIB", "cslbxFtStateChange"),
        ("CISCO-SLB-EXT-MIB", "cslbxServerFarmStateChange"))
)
if mibBuilder.loadTexts:
    cslbxNotifGroupRev1.setStatus(
        "deprecated"
    )

cslbxNotifGroupRev2 = NotificationGroup(
    (1, 3, 6, 1, 4, 1, 9, 9, 254, 2, 2, 42)
)
cslbxNotifGroupRev2.setObjects(
      *(("CISCO-SLB-EXT-MIB", "cslbxFtStateChange"),
        ("CISCO-SLB-EXT-MIB", "cslbxServerFarmStateChange"),
        ("CISCO-SLB-EXT-MIB", "cslbxServerFarmDwsOpStateChange"))
)
if mibBuilder.loadTexts:
    cslbxNotifGroupRev2.setStatus(
        "current"
    )
...
cslbxMIBComplianceRev4 = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 9, 9, 254, 2, 1, 5)
)
cslbxMIBComplianceRev4.setObjects(
      *(("CISCO-SLB-EXT-MIB", "cslbxStatsGroup"),
        ("CISCO-SLB-EXT-MIB", "cslbxServerFarmsGroup"),
        ("CISCO-SLB-EXT-MIB", "cslbxStickyGroupsGroupRev2"),
        ("CISCO-SLB-EXT-MIB", "cslbxMapsGroup"),
        ...
        ("CISCO-SLB-EXT-MIB", "cslbxVlansGroup"),
        ("CISCO-SLB-EXT-MIB", "cslbxFaultToleranceGroup"),
        ("CISCO-SLB-EXT-MIB", "cslbxNotifObjectGroup"),
        ("CISCO-SLB-EXT-MIB", "cslbxNotifControlGroupRev1"),
        ("CISCO-SLB-EXT-MIB", "cslbxNotifGroupRev1"),
        ("CISCO-SLB-EXT-MIB", "cslbxConnsGroup"),
        ("CISCO-SLB-EXT-MIB", "cslbxStickyObjectsGroup"),
        ("CISCO-SLB-EXT-MIB", "cslbxXmlConfigGroup"),
        ("CISCO-SLB-EXT-MIB", "cslbxXmlUserAccessGroup"),
        ...
        ("CISCO-SLB-EXT-MIB", "cslbxVirtualServersExtGroup"),
        ("CISCO-SLB-EXT-MIB", "cslbxMapsRev2Group"),
        ("CISCO-SLB-EXT-MIB", "cslbxServerFarmsExtGroupRev2"),
        ("CISCO-SLB-EXT-MIB", "cslbxCookieStickyGroup"),
        ("CISCO-SLB-EXT-MIB", "cslbxServerFarmsHttpRetCodeGroup"),
        ("CISCO-SLB-EXT-MIB", "cslbxStatsHCGroup"))
)
if mibBuilder.loadTexts:
    cslbxMIBComplianceRev4.setStatus(
        "deprecated"
    )

cslbxMIBComplianceRev5 = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 9, 9, 254, 2, 1, 6)
)
cslbxMIBComplianceRev5.setObjects(
      *(("CISCO-SLB-EXT-MIB", "cslbxStatsGroup"),
        ("CISCO-SLB-EXT-MIB", "cslbxServerFarmsGroup"),
        ("CISCO-SLB-EXT-MIB", "cslbxStickyGroupsGroupRev2"),
        ("CISCO-SLB-EXT-MIB", "cslbxMapsGroup"),
        ...
        ("CISCO-SLB-EXT-MIB", "cslbxNotifObjectGroup"),
        ("CISCO-SLB-EXT-MIB", "cslbxNotifControlGroupRev1"),
        ("CISCO-SLB-EXT-MIB", "cslbxNotifGroupRev2"),
        ("CISCO-SLB-EXT-MIB", "cslbxConnsGroup"),
        ("CISCO-SLB-EXT-MIB", "cslbxStickyObjectsGroup"),
        ("CISCO-SLB-EXT-MIB", "cslbxXmlConfigGroup"),
        ("CISCO-SLB-EXT-MIB", "cslbxXmlUserAccessGroup"),
        ...
        ("CISCO-SLB-EXT-MIB", "cslbxVirtualServersExtGroup"),
        ("CISCO-SLB-EXT-MIB", "cslbxMapsRev2Group"),
        ("CISCO-SLB-EXT-MIB", "cslbxServerFarmsExtGroupRev3"),
        ("CISCO-SLB-EXT-MIB", "cslbxCookieStickyGroup"),
        ("CISCO-SLB-EXT-MIB", "cslbxServerFarmsHttpRetCodeGroup"),
        ("CISCO-SLB-EXT-MIB", "cslbxStatsHCGroup"),
        ("CISCO-SLB-EXT-MIB", "cslbxVServerInfoGroup"))
)
if mibBuilder.loadTexts:
    cslbxMIBComplianceRev5.setStatus(
        "current"
    )
...
mibBuilder.exportSymbols(
    ...
    **{"SlbObjectNameString": SlbObjectNameString,
       ...
       "SlbDwsCfgState": SlbDwsCfgState,
       "SlbDwsOpState": SlbDwsOpState,
       "ciscoSlbExtMIB": ciscoSlbExtMIB,
       "ciscoSlbExtMIBNotifs": ciscoSlbExtMIBNotifs,
       "cslbxFtStateChange": cslbxFtStateChange,
       "cslbxServerFarmStateChange": cslbxServerFarmStateChange,
       "cslbxServerFarmDwsOpStateChange": cslbxServerFarmDwsOpStateChange,
       ...
       "cslbxServerFarmStateChangeDescr": cslbxServerFarmStateChangeDescr,
       "cslbxServerFarmDwsCfgState": cslbxServerFarmDwsCfgState,
       "cslbxServerFarmDwsOpState": cslbxServerFarmDwsOpState,
       ...
       "cslbxVServerInfoTable": cslbxVServerInfoTable,
       "cslbxVServerInfoTableEntry": cslbxVServerInfoTableEntry,
       "cslbxVServerDwsCfgState": cslbxVServerDwsCfgState,
       "cslbxVServerDwsOpState": cslbxVServerDwsOpState,
       ...
       "cslbxSfarmStateChangeNotifEnabled": cslbxSfarmStateChangeNotifEnabled,
       "cslbxServerFarmName": cslbxServerFarmName,
       ...
       "cslbxMIBComplianceRev4": cslbxMIBComplianceRev4,
       "cslbxMIBComplianceRev5": cslbxMIBComplianceRev5,
       ...
       "cslbxServerFarmsExtGroupRev2": cslbxServerFarmsExtGroupRev2,
       "cslbxNotifControlGroupRev1": cslbxNotifControlGroupRev1,
       "cslbxNotifGroupRev1": cslbxNotifGroupRev1,
       "cslbxNotifObjectGroup": cslbxNotifObjectGroup,
       "cslbxNotifGroupRev2": cslbxNotifGroupRev2,
       "cslbxServerFarmsExtGroupRev3": cslbxServerFarmsExtGroupRev3,
       "cslbxVServerInfoGroup": cslbxVServerInfoGroup}
)
