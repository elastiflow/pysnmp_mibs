...
# Notes
# -----
# ASN.1 source file:///Users/rob/MIBs/cisco_9/CISCO-SLB-MIB.mib
...
_SlbVServerConnectionRate_Type = Gauge32
_SlbVServerConnectionRate_Object = MibTableColumn
slbVServerConnectionRate = _SlbVServerConnectionRate_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 161, 1, 4, 2, 1, 20),
    _SlbVServerConnectionRate_Type()
)
slbVServerConnectionRate.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    slbVServerConnectionRate.setStatus("current")
if mibBuilder.loadTexts:
    slbVServerConnectionRate.setUnits("connections per second")
...
_SlbUriConfig_ObjectIdentity = ObjectIdentity
slbUriConfig = _SlbUriConfig_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 9, 9, 161, 1, 17)
)
_SlbUriClassmapTable_Object = MibTable
slbUriClassmapTable = _SlbUriClassmapTable_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 161, 1, 17, 1)
)
if mibBuilder.loadTexts:
    slbUriClassmapTable.setStatus("current")
_SlbUriClassmapTableEntry_Object = MibTableRow
slbUriClassmapTableEntry = _SlbUriClassmapTableEntry_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 161, 1, 17, 1, 1)
)
slbUriClassmapTableEntry.setIndexNames(
    (0, "CISCO-SLB-MIB", "slbEntity"),
    (0, "CISCO-SLB-MIB", "slbClassmapIndex"),
)
if mibBuilder.loadTexts:
    slbUriClassmapTableEntry.setStatus("current")
_SlbClassmapIndex_Type = Unsigned32
_SlbClassmapIndex_Object = MibTableColumn
slbClassmapIndex = _SlbClassmapIndex_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 161, 1, 17, 1, 1, 1),
    _SlbClassmapIndex_Type()
)
slbClassmapIndex.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    slbClassmapIndex.setStatus("current")
_SlbClassmapName_Type = SnmpAdminString
_SlbClassmapName_Object = MibTableColumn
slbClassmapName = _SlbClassmapName_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 161, 1, 17, 1, 1, 2),
    _SlbClassmapName_Type()
)
slbClassmapName.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    slbClassmapName.setStatus("current")
_SlbClassmapStorageType_Type = StorageType
_SlbClassmapStorageType_Object = MibTableColumn
slbClassmapStorageType = _SlbClassmapStorageType_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 161, 1, 17, 1, 1, 3),
    _SlbClassmapStorageType_Type()
)
slbClassmapStorageType.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    slbClassmapStorageType.setStatus("current")
_SlbClassmapRowStatus_Type = RowStatus
_SlbClassmapRowStatus_Object = MibTableColumn
slbClassmapRowStatus = _SlbClassmapRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 161, 1, 17, 1, 1, 4),
    _SlbClassmapRowStatus_Type()
)
slbClassmapRowStatus.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    slbClassmapRowStatus.setStatus("current")
_SlbUriMatchCmdTable_Object = MibTable
slbUriMatchCmdTable = _SlbUriMatchCmdTable_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 161, 1, 17, 2)
)
if mibBuilder.loadTexts:
    slbUriMatchCmdTable.setStatus("current")
_SlbUriMatchCmdTableEntry_Object = MibTableRow
slbUriMatchCmdTableEntry = _SlbUriMatchCmdTableEntry_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 161, 1, 17, 2, 1)
)
slbUriMatchCmdTableEntry.setIndexNames(
    (0, "CISCO-SLB-MIB", "slbEntity"),
    (0, "CISCO-SLB-MIB", "slbMatchCmdIndex"),
)
if mibBuilder.loadTexts:
    slbUriMatchCmdTableEntry.setStatus("current")
_SlbMatchCmdIndex_Type = Unsigned32
_SlbMatchCmdIndex_Object = MibTableColumn
slbMatchCmdIndex = _SlbMatchCmdIndex_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 161, 1, 17, 2, 1, 1),
    _SlbMatchCmdIndex_Type()
)
slbMatchCmdIndex.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    slbMatchCmdIndex.setStatus("current")


class _SlbUrlString_Type(SnmpAdminString):
    """Custom type slbUrlString based on SnmpAdminString"""
...
_SlbUrlString_Type.__name__ = "SnmpAdminString"
_SlbUrlString_Object = MibTableColumn
slbUrlString = _SlbUrlString_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 161, 1, 17, 2, 1, 2),
    _SlbUrlString_Type()
)
slbUrlString.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    slbUrlString.setStatus("current")
_SlbUriMatchCmdStorageType_Type = StorageType
_SlbUriMatchCmdStorageType_Object = MibTableColumn
slbUriMatchCmdStorageType = _SlbUriMatchCmdStorageType_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 161, 1, 17, 2, 1, 3),
    _SlbUriMatchCmdStorageType_Type()
)
slbUriMatchCmdStorageType.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    slbUriMatchCmdStorageType.setStatus("current")
_SlbUriMatchCmdRowStatus_Type = RowStatus
_SlbUriMatchCmdRowStatus_Object = MibTableColumn
slbUriMatchCmdRowStatus = _SlbUriMatchCmdRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 161, 1, 17, 2, 1, 4),
    _SlbUriMatchCmdRowStatus_Type()
)
slbUriMatchCmdRowStatus.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    slbUriMatchCmdRowStatus.setStatus("current")
_SlbUriStats_ObjectIdentity = ObjectIdentity
slbUriStats = _SlbUriStats_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 9, 9, 161, 1, 18)
)
_SlbUriHitCountTable_Object = MibTable
slbUriHitCountTable = _SlbUriHitCountTable_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 161, 1, 18, 1)
)
if mibBuilder.loadTexts:
    slbUriHitCountTable.setStatus("current")
_SlbUriHitCountTableEntry_Object = MibTableRow
slbUriHitCountTableEntry = _SlbUriHitCountTableEntry_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 161, 1, 18, 1, 1)
)
slbUriHitCountTableEntry.setIndexNames(
    (0, "CISCO-SLB-MIB", "slbEntity"),
    (0, "CISCO-SLB-MIB", "slbVServerIndex"),
    (0, "CISCO-SLB-MIB", "slbClassmapIndex"),
    (0, "CISCO-SLB-MIB", "slbMatchCmdIndex"),
...
if mibBuilder.loadTexts:
    slbUriHitCountTableEntry.setStatus("current")
_SlbUriHitCount_Type = Counter32
_SlbUriHitCount_Object = MibTableColumn
slbUriHitCount = _SlbUriHitCount_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 161, 1, 18, 1, 1, 1),
    _SlbUriHitCount_Type()
)
slbUriHitCount.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    slbUriHitCount.setStatus("current")
...
if mibBuilder.loadTexts:
    ciscoSlbVServerInfoGroupRev2.setStatus("deprecated")

ciscoSlbURIConfigGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 9, 9, 161, 3, 2, 30)
)
ciscoSlbURIConfigGroup.setObjects(
      *(("CISCO-SLB-MIB", "slbClassmapName"),
        ("CISCO-SLB-MIB", "slbClassmapStorageType"),
        ("CISCO-SLB-MIB", "slbClassmapRowStatus"),
        ("CISCO-SLB-MIB", "slbUrlString"),
        ("CISCO-SLB-MIB", "slbUriMatchCmdStorageType"),
        ("CISCO-SLB-MIB", "slbUriMatchCmdRowStatus"))
)
if mibBuilder.loadTexts:
    ciscoSlbURIConfigGroup.setStatus("current")

ciscoSlbURIStatsGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 9, 9, 161, 3, 2, 31)
)
ciscoSlbURIStatsGroup.setObjects(
    ("CISCO-SLB-MIB", "slbUriHitCount")
)
if mibBuilder.loadTexts:
    ciscoSlbURIStatsGroup.setStatus("current")

ciscoSlbVServerInfoGroupRev3 = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 9, 9, 161, 3, 2, 32)
)
ciscoSlbVServerInfoGroupRev3.setObjects(
      *(("CISCO-SLB-MIB", "slbVServerClassMap"),
        ("CISCO-SLB-MIB", "slbVServerPolicyMap"),
        ("CISCO-SLB-MIB", "slbVServerState"),
        ("CISCO-SLB-MIB", "slbVServerStateChangeDescr"),
        ...
        ("CISCO-SLB-MIB", "slbVServerL7Decisions"),
        ("CISCO-SLB-MIB", "slbVServerEstablishedConnections"),
        ("CISCO-SLB-MIB", "slbVServerConnectionRate"))
)
if mibBuilder.loadTexts:
    ciscoSlbVServerInfoGroupRev3.setStatus("current")
...
ciscoSlbMIBComplianceRev7 = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 9, 9, 161, 3, 1, 8)
)
ciscoSlbMIBComplianceRev7.setObjects(
      *(("CISCO-SLB-MIB", "ciscoSlbStatsGroup"),
        ("CISCO-SLB-MIB", "ciscoSlbDfpPasswordGroup"),
        ("CISCO-SLB-MIB", "ciscoSlbServerFarmsGroup"),
        ("CISCO-SLB-MIB", "ciscoSlbRealServersGroup"),
        ...
        ("CISCO-SLB-MIB", "ciscoSlbSaspStatsGroup"),
        ("CISCO-SLB-MIB", "ciscoSlbSaspNotifGroup"),
        ("CISCO-SLB-MIB", "ciscoSlbURIConfigGroup"),
        ("CISCO-SLB-MIB", "ciscoSlbURIStatsGroup"),
        ("CISCO-SLB-MIB", "ciscoSlbVirtualServersGroup"),
        ("CISCO-SLB-MIB", "ciscoSlbVirtualClientsGroup"),
        ("CISCO-SLB-MIB", "ciscoSlbVServerInfoGroupRev2"),
        ("CISCO-SLB-MIB", "ciscoSlbVServerIPGroup"),
...
if mibBuilder.loadTexts:
    ciscoSlbMIBComplianceRev7.setStatus(
        "deprecated"
    )

ciscoSlbMIBComplianceRev8 = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 9, 9, 161, 3, 1, 9)
)
ciscoSlbMIBComplianceRev8.setObjects(
      *(("CISCO-SLB-MIB", "ciscoSlbStatsGroup"),
        ("CISCO-SLB-MIB", "ciscoSlbDfpPasswordGroup"),
        ("CISCO-SLB-MIB", "ciscoSlbServerFarmsGroup"),
        ("CISCO-SLB-MIB", "ciscoSlbRealServersGroup"),
        ...
        ("CISCO-SLB-MIB", "ciscoSlbVirtualServersGroup"),
        ("CISCO-SLB-MIB", "ciscoSlbVirtualClientsGroup"),
        ("CISCO-SLB-MIB", "ciscoSlbVServerInfoGroupRev3"),
        ("CISCO-SLB-MIB", "ciscoSlbVServerIPGroup"),
        ("CISCO-SLB-MIB", "ciscoSlbVServerNotifEnabledGroup"),
        ("CISCO-SLB-MIB", "ciscoSlbVServerNotifGroup"),
        ("CISCO-SLB-MIB", "ciscoSlbNotifObjectsGroup"))
...
if mibBuilder.loadTexts:
    ciscoSlbMIBComplianceRev8.setStatus(
        "current"
    )
...
mibBuilder.exportSymbols(
    ...
    **{"SlbServerString": SlbServerString,
       ...
       "slbVServerConnectionRate": slbVServerConnectionRate,
       ...
       "slbUriConfig": slbUriConfig,
       "slbUriClassmapTable": slbUriClassmapTable,
       "slbUriClassmapTableEntry": slbUriClassmapTableEntry,
       "slbClassmapIndex": slbClassmapIndex,
       "slbClassmapName": slbClassmapName,
       "slbClassmapStorageType": slbClassmapStorageType,
       "slbClassmapRowStatus": slbClassmapRowStatus,
       "slbUriMatchCmdTable": slbUriMatchCmdTable,
       "slbUriMatchCmdTableEntry": slbUriMatchCmdTableEntry,
       "slbMatchCmdIndex": slbMatchCmdIndex,
       "slbUrlString": slbUrlString,
       "slbUriMatchCmdStorageType": slbUriMatchCmdStorageType,
       "slbUriMatchCmdRowStatus": slbUriMatchCmdRowStatus,
       "slbUriStats": slbUriStats,
       "slbUriHitCountTable": slbUriHitCountTable,
       "slbUriHitCountTableEntry": slbUriHitCountTableEntry,
       "slbUriHitCount": slbUriHitCount,
       ...
       "ciscoSlbMIBComplianceRev7": ciscoSlbMIBComplianceRev7,
       "ciscoSlbMIBComplianceRev8": ciscoSlbMIBComplianceRev8,
       ...
       "ciscoSlbURIConfigGroup": ciscoSlbURIConfigGroup,
       "ciscoSlbURIStatsGroup": ciscoSlbURIStatsGroup,
       "ciscoSlbVServerInfoGroupRev3": ciscoSlbVServerInfoGroupRev3}
)
