...
# Notes
# -----
# ASN.1 source file:///Users/rob/MIBs/cisco_9/CISCOSB-IpRouter.mib
...
if mibBuilder.loadTexts:
    rsRip2IfConfAutoSend.setStatus("current")
...
class _RlRip2AutoInterfaceCreation_Type(Integer32):
    """Custom type rlRip2AutoInterfaceCreation based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_RlRip2AutoInterfaceCreation_Type.__name__ = "Integer32"
_RlRip2AutoInterfaceCreation_Object = MibScalar
rlRip2AutoInterfaceCreation = _RlRip2AutoInterfaceCreation_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 26, 3, 2),
    _RlRip2AutoInterfaceCreation_Type()
)
rlRip2AutoInterfaceCreation.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    rlRip2AutoInterfaceCreation.setStatus("current")
...
mibBuilder.exportSymbols(
    ...
    **{"rsRip2IfConfTable": rsRip2IfConfTable,
       ...
       "rlRip2AutoInterfaceCreation": rlRip2AutoInterfaceCreation,
