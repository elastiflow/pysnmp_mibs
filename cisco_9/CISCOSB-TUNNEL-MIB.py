...
# Notes
# -----
# ASN.1 source file:///Users/rob/MIBs/cisco_9/CISCOSB-TUNNEL-MIB.mib
...
_RlTunnelIsatapRouterAddress_Type = IpAddress
...
_RlTunnelIsatapLocalIPv4Address_Type = IpAddress
...
_RlTunnelIfLocalAddressInterfaceId_Type.__name__ = "Unsigned32"
...
_RlTunnelIfLocalIPv4Address_Type = IpAddress
...
_RlTunnelIsatapConfDnsName_Type.__name__ = "OctetString"
...
class _RlTunnelIPv6EndConfig_Type(Integer32):
    """Custom type rlTunnelIPv6EndConfig based on Integer32"""
    defaultValue = 1


_RlTunnelIPv6EndConfig_Type.__name__ = "Integer32"
_RlTunnelIPv6EndConfig_Object = MibScalar
rlTunnelIPv6EndConfig = _RlTunnelIPv6EndConfig_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 122, 12, 2),
    _RlTunnelIPv6EndConfig_Type()
)
rlTunnelIPv6EndConfig.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    rlTunnelIPv6EndConfig.setStatus("current")
...
mibBuilder.exportSymbols(
    ...
    **{"rlTunnel": rlTunnel,
       ...
       "rlTunnelIPv6EndConfig": rlTunnelIPv6EndConfig}
)
