# SNMP MIB module (UCS-FLOWCTRL) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/rob/MIBs/cisco_9/UCS-FLOWCTRL.mib
...
cucsFlowctrlDefinitionEntry.setIndexNames(
    (0, "UCS-FLOWCTRL", "cucsFlowctrlDefinitionInstanceId"),
)
if mibBuilder.loadTexts:
...
cucsFlowctrlItemEntry.setIndexNames(
    (0, "UCS-FLOWCTRL", "cucsFlowctrlItemInstanceId"),
)
if mibBuilder.loadTexts:
