...
# Notes
# -----
# ASN.1 source file:///Users/rob/MIBs/dell_674/ArrayManager-MIB.mib
...
_ControllerDriverVer_Type = DisplayString
_ControllerDriverVer_Object = MibTableColumn
controllerDriverVer = _ControllerDriverVer_Object(
    (1, 3, 6, 1, 4, 1, 674, 10893, 1, 1, 130, 1, 1, 37),
    _ControllerDriverVer_Type()
)
controllerDriverVer.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    controllerDriverVer.setStatus("mandatory")
...
if mibBuilder.loadTexts:
    arrayDiskEnclosureID.setStatus("obsolete")
...
_CommErrorTypeEv_Type = DisplayString
_CommErrorTypeEv_Object = MibScalar
commErrorTypeEv = _CommErrorTypeEv_Object(
    (1, 3, 6, 1, 4, 1, 674, 10893, 1, 1, 200, 223),
    _CommErrorTypeEv_Type()
)
commErrorTypeEv.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    commErrorTypeEv.setStatus("mandatory")
_ReturnCodeEv_Type = DisplayString
_ReturnCodeEv_Object = MibScalar
returnCodeEv = _ReturnCodeEv_Object(
    (1, 3, 6, 1, 4, 1, 674, 10893, 1, 1, 200, 224),
    _ReturnCodeEv_Type()
)
returnCodeEv.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    returnCodeEv.setStatus("mandatory")
_ScsiStatusEv_Type = DisplayString
_ScsiStatusEv_Object = MibScalar
scsiStatusEv = _ScsiStatusEv_Object(
    (1, 3, 6, 1, 4, 1, 674, 10893, 1, 1, 200, 225),
    _ScsiStatusEv_Type()
)
scsiStatusEv.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    scsiStatusEv.setStatus("mandatory")
_AdditionalInfoEv_Type = DisplayString
_AdditionalInfoEv_Object = MibScalar
additionalInfoEv = _AdditionalInfoEv_Object(
    (1, 3, 6, 1, 4, 1, 674, 10893, 1, 1, 200, 226),
    _AdditionalInfoEv_Type()
)
additionalInfoEv.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    additionalInfoEv.setStatus("mandatory")
_InstVerEv_Type = DisplayString
_InstVerEv_Object = MibScalar
instVerEv = _InstVerEv_Object(
    (1, 3, 6, 1, 4, 1, 674, 10893, 1, 1, 200, 227),
    _InstVerEv_Type()
)
instVerEv.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    instVerEv.setStatus("mandatory")
_ReqVerEv_Type = DisplayString
_ReqVerEv_Object = MibScalar
reqVerEv = _ReqVerEv_Object(
    (1, 3, 6, 1, 4, 1, 674, 10893, 1, 1, 200, 228),
    _ReqVerEv_Type()
)
reqVerEv.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    reqVerEv.setStatus("mandatory")
...
enclosureGenericCommTimeout = NotificationType(
    (1, 3, 6, 1, 4, 1, 674, 10893, 1, 1, 200, 0, 688)
)
enclosureGenericCommTimeout.setObjects(
      *(("ArrayManager-MIB", "controllerNameEv"),
        ("ArrayManager-MIB", "enclosureNameEv"),
        ("ArrayManager-MIB", "commErrorTypeEv"),
        ("ArrayManager-MIB", "returnCodeEv"),
        ("ArrayManager-MIB", "scsiStatusEv"))
)
if mibBuilder.loadTexts:
    enclosureGenericCommTimeout.setStatus(
        ""
    )

enclosureGenericCommLost = NotificationType(
    (1, 3, 6, 1, 4, 1, 674, 10893, 1, 1, 200, 0, 689)
)
enclosureGenericCommLost.setObjects(
      *(("ArrayManager-MIB", "controllerNameEv"),
        ("ArrayManager-MIB", "enclosureNameEv"),
        ("ArrayManager-MIB", "commErrorTypeEv"),
        ("ArrayManager-MIB", "returnCodeEv"),
...
if mibBuilder.loadTexts:
    enclosureGenericCommLost.setStatus(
        ""
    )

alertCompWithErrDiskRebuild = NotificationType(
    (1, 3, 6, 1, 4, 1, 674, 10893, 1, 1, 200, 0, 690)
)
alertCompWithErrDiskRebuild.setObjects(
      *(("ArrayManager-MIB", "controllerNameEv"),
        ("ArrayManager-MIB", "arrayDiskNameEv"))
)
if mibBuilder.loadTexts:
    alertCompWithErrDiskRebuild.setStatus(
        ""
    )

alertControllerMiscError = NotificationType(
    (1, 3, 6, 1, 4, 1, 674, 10893, 1, 1, 200, 0, 691)
)
alertControllerMiscError.setObjects(
      *(("ArrayManager-MIB", "controllerNameEv"),
        ("ArrayManager-MIB", "additionalInfoEv"))
)
if mibBuilder.loadTexts:
    alertControllerMiscError.setStatus(
        ""
    )

installedDriverVerUnsupported = NotificationType(
    (1, 3, 6, 1, 4, 1, 674, 10893, 1, 1, 200, 0, 692)
)
installedDriverVerUnsupported.setObjects(
      *(("ArrayManager-MIB", "controllerNameEv"),
        ("ArrayManager-MIB", "instVerEv"),
        ("ArrayManager-MIB", "reqVerEv"))
)
if mibBuilder.loadTexts:
    installedDriverVerUnsupported.setStatus(
        ""
    )

installedFirmwareVerUnsupported = NotificationType(
    (1, 3, 6, 1, 4, 1, 674, 10893, 1, 1, 200, 0, 693)
)
installedFirmwareVerUnsupported.setObjects(
      *(("ArrayManager-MIB", "controllerNameEv"),
        ("ArrayManager-MIB", "instVerEv"),
        ("ArrayManager-MIB", "reqVerEv"))
)
if mibBuilder.loadTexts:
    installedFirmwareVerUnsupported.setStatus(
        ""
    )

unsupportedConfig = NotificationType(
    (1, 3, 6, 1, 4, 1, 674, 10893, 1, 1, 200, 0, 694)
)
unsupportedConfig.setObjects(
      *(("ArrayManager-MIB", "controllerNameEv"),
        ("ArrayManager-MIB", "instVerEv"))
)
if mibBuilder.loadTexts:
    unsupportedConfig.setStatus(
        ""
    )
...
mibBuilder.exportSymbols(
    ...
    **{"dell": dell,
       ...
       "controllerDriverVer": controllerDriverVer,
       ...
       "enclosureGenericCommTimeout": enclosureGenericCommTimeout,
       "enclosureGenericCommLost": enclosureGenericCommLost,
       "alertCompWithErrDiskRebuild": alertCompWithErrDiskRebuild,
       "alertControllerMiscError": alertControllerMiscError,
       "installedDriverVerUnsupported": installedDriverVerUnsupported,
       "installedFirmwareVerUnsupported": installedFirmwareVerUnsupported,
       ...
       "commErrorTypeEv": commErrorTypeEv,
       "returnCodeEv": returnCodeEv,
       "scsiStatusEv": scsiStatusEv,
       "additionalInfoEv": additionalInfoEv,
       "instVerEv": instVerEv,
       "reqVerEv": reqVerEv}
)
