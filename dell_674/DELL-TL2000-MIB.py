# SNMP MIB module (DELL-TL2000-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/rob/MIBs/dell_674/DELL-TL2000-MIB.mib
...
_TL2000_ObjectIdentity = ObjectIdentity
TL2000 = _TL2000_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 674, 10893, 2, 102)
)
_TL2000Id_ObjectIdentity = ObjectIdentity
TL2000Id = _TL2000Id_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 674, 10893, 2, 102, 1)
)
_TL2000IdDisplayName_Type = DisplayString
_TL2000IdDisplayName_Object = MibScalar
tL2000IdDisplayName = _TL2000IdDisplayName_Object(
    (1, 3, 6, 1, 4, 1, 674, 10893, 2, 102, 1, 1),
    _TL2000IdDisplayName_Type()
)
tL2000IdDisplayName.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tL2000IdDisplayName.setStatus("mandatory")
_TL2000IdDescription_Type = DisplayString
_TL2000IdDescription_Object = MibScalar
tL2000IdDescription = _TL2000IdDescription_Object(
    (1, 3, 6, 1, 4, 1, 674, 10893, 2, 102, 1, 2),
    _TL2000IdDescription_Type()
)
tL2000IdDescription.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tL2000IdDescription.setStatus("mandatory")
_TL2000AgentVendor_Type = DisplayString
_TL2000AgentVendor_Object = MibScalar
tL2000AgentVendor = _TL2000AgentVendor_Object(
    (1, 3, 6, 1, 4, 1, 674, 10893, 2, 102, 1, 3),
    _TL2000AgentVendor_Type()
)
tL2000AgentVendor.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tL2000AgentVendor.setStatus("mandatory")
_TL2000IdAgentVersion_Type = DisplayString
_TL2000IdAgentVersion_Object = MibScalar
tL2000IdAgentVersion = _TL2000IdAgentVersion_Object(
    (1, 3, 6, 1, 4, 1, 674, 10893, 2, 102, 1, 4),
    _TL2000IdAgentVersion_Type()
)
tL2000IdAgentVersion.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tL2000IdAgentVersion.setStatus("mandatory")
_TL2000IdBuildNumber_Type = DisplayString
_TL2000IdBuildNumber_Object = MibScalar
tL2000IdBuildNumber = _TL2000IdBuildNumber_Object(
    (1, 3, 6, 1, 4, 1, 674, 10893, 2, 102, 1, 5),
    _TL2000IdBuildNumber_Type()
)
tL2000IdBuildNumber.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tL2000IdBuildNumber.setStatus("mandatory")
_TL2000IdURL_Type = DisplayString
_TL2000IdURL_Object = MibScalar
tL2000IdURL = _TL2000IdURL_Object(
    (1, 3, 6, 1, 4, 1, 674, 10893, 2, 102, 1, 6),
    _TL2000IdURL_Type()
)
tL2000IdURL.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tL2000IdURL.setStatus("mandatory")
_TL2000Status_ObjectIdentity = ObjectIdentity
TL2000Status = _TL2000Status_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 674, 10893, 2, 102, 2)
)


class _TL2000StatusGlobalStatus_Type(Integer32):
    """Custom type tL2000StatusGlobalStatus based on Integer32"""
...
_TL2000StatusGlobalStatus_Type.__name__ = "Integer32"
_TL2000StatusGlobalStatus_Object = MibScalar
tL2000StatusGlobalStatus = _TL2000StatusGlobalStatus_Object(
    (1, 3, 6, 1, 4, 1, 674, 10893, 2, 102, 2, 1),
    _TL2000StatusGlobalStatus_Type()
)
tL2000StatusGlobalStatus.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tL2000StatusGlobalStatus.setStatus("mandatory")


class _TL2000StatusLastGlobalStatus_Type(Integer32):
    """Custom type tL2000StatusLastGlobalStatus based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_TL2000StatusLastGlobalStatus_Type.__name__ = "Integer32"
_TL2000StatusLastGlobalStatus_Object = MibScalar
tL2000StatusLastGlobalStatus = _TL2000StatusLastGlobalStatus_Object(
    (1, 3, 6, 1, 4, 1, 674, 10893, 2, 102, 2, 2),
    _TL2000StatusLastGlobalStatus_Type()
)
tL2000StatusLastGlobalStatus.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tL2000StatusLastGlobalStatus.setStatus("mandatory")
_TL2000StatusTimeStamp_Type = Integer32
_TL2000StatusTimeStamp_Object = MibScalar
tL2000StatusTimeStamp = _TL2000StatusTimeStamp_Object(
    (1, 3, 6, 1, 4, 1, 674, 10893, 2, 102, 2, 3),
    _TL2000StatusTimeStamp_Type()
)
tL2000StatusTimeStamp.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tL2000StatusTimeStamp.setStatus("mandatory")


class _TL2000StatusGetTimeOut_Type(Integer32):
    """Custom type tL2000StatusGetTimeOut based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_TL2000StatusGetTimeOut_Type.__name__ = "Integer32"
_TL2000StatusGetTimeOut_Object = MibScalar
tL2000StatusGetTimeOut = _TL2000StatusGetTimeOut_Object(
    (1, 3, 6, 1, 4, 1, 674, 10893, 2, 102, 2, 4),
    _TL2000StatusGetTimeOut_Type()
)
tL2000StatusGetTimeOut.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tL2000StatusGetTimeOut.setStatus("mandatory")


class _TL2000StatusRefreshRate_Type(Integer32):
    """Custom type tL2000StatusRefreshRate based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_TL2000StatusRefreshRate_Type.__name__ = "Integer32"
_TL2000StatusRefreshRate_Object = MibScalar
tL2000StatusRefreshRate = _TL2000StatusRefreshRate_Object(
    (1, 3, 6, 1, 4, 1, 674, 10893, 2, 102, 2, 5),
    _TL2000StatusRefreshRate_Type()
)
tL2000StatusRefreshRate.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tL2000StatusRefreshRate.setStatus("mandatory")


class _TL2000StatusGeneratingTrapFlag_Type(Integer32):
    """Custom type tL2000StatusGeneratingTrapFlag based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_TL2000StatusGeneratingTrapFlag_Type.__name__ = "Integer32"
_TL2000StatusGeneratingTrapFlag_Object = MibScalar
tL2000StatusGeneratingTrapFlag = _TL2000StatusGeneratingTrapFlag_Object(
    (1, 3, 6, 1, 4, 1, 674, 10893, 2, 102, 2, 6),
    _TL2000StatusGeneratingTrapFlag_Type()
)
tL2000StatusGeneratingTrapFlag.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tL2000StatusGeneratingTrapFlag.setStatus("mandatory")
_TL2000Physical_ObjectIdentity = ObjectIdentity
TL2000Physical = _TL2000Physical_ObjectIdentity(
...
libraryEntry.setIndexNames(
    (0, "DELL-TL2000-MIB", "libraryEntryId"),
)
if mibBuilder.loadTexts:
...
driveEntry.setIndexNames(
    (0, "DELL-TL2000-MIB", "driveEntryId"),
)
if mibBuilder.loadTexts:
...
_TL2000Event_ObjectIdentity = ObjectIdentity
TL2000Event = _TL2000Event_ObjectIdentity(
...
eventStatusChange.setObjects(
      *(("DELL-TL2000-MIB", "libraryProductId"),
        ("DELL-TL2000-MIB", "librarySerNum"),
        ("DELL-TL2000-MIB", "TL2000StatusLastGlobalStatus"),
        ("DELL-TL2000-MIB", "TL2000StatusGlobalStatus"))
)
if mibBuilder.loadTexts:
...
eventFaultPosted.setObjects(
      *(("DELL-TL2000-MIB", "libraryProductId"),
        ("DELL-TL2000-MIB", "librarySerNum"),
        ("DELL-TL2000-MIB", "libraryFaultSev"),
        ("DELL-TL2000-MIB", "libraryFaultFSC"),
        ("DELL-TL2000-MIB", "libraryFaultDescr"))
)
if mibBuilder.loadTexts:
...
mibBuilder.exportSymbols(
    ...
    **{"dell": dell,
       ...
       "TL2000": TL2000,
       "TL2000Id": TL2000Id,
       "tL2000IdDisplayName": tL2000IdDisplayName,
       "tL2000IdDescription": tL2000IdDescription,
       "tL2000AgentVendor": tL2000AgentVendor,
       "tL2000IdAgentVersion": tL2000IdAgentVersion,
       "tL2000IdBuildNumber": tL2000IdBuildNumber,
       "tL2000IdURL": tL2000IdURL,
       "TL2000Status": TL2000Status,
       "tL2000StatusGlobalStatus": tL2000StatusGlobalStatus,
       "tL2000StatusLastGlobalStatus": tL2000StatusLastGlobalStatus,
       "tL2000StatusTimeStamp": tL2000StatusTimeStamp,
       "tL2000StatusGetTimeOut": tL2000StatusGetTimeOut,
       "tL2000StatusRefreshRate": tL2000StatusRefreshRate,
       "tL2000StatusGeneratingTrapFlag": tL2000StatusGeneratingTrapFlag,
       "TL2000Physical": TL2000Physical,
