# SNMP MIB module (DESCH-PSC3-BASE-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/rob/MIBs/delta_20246/DESCH-PSC3-BASE-MIB.mib
...
(deschModules,
 deschPsc3) = mibBuilder.importSymbols(
    "DESCH-GLOBAL-REG",
    "deschModules",
    "deschPsc3")
...
deschPsc3BaseMibModule = ModuleIdentity(
    (1, 3, 6, 1, 4, 1, 20246, 2, 1, 1, 2)
)
if mibBuilder.loadTexts:
    deschPsc3BaseMibModule.setRevisions(
        ("2010-06-16 10:27",
         "2010-02-24 10:46",
         "2009-09-04 09:52",
         "2008-02-21 14:39",
...
_DeschPsc3BaseMib_ObjectIdentity = ObjectIdentity
deschPsc3BaseMib = _DeschPsc3BaseMib_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 20246, 2, 3, 1, 1, 1)
)
_DeschControllerConfs_ObjectIdentity = ObjectIdentity
deschControllerConfs = _DeschControllerConfs_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 20246, 2, 3, 1, 1, 1, 1)
)
_DeschControllerGroups_ObjectIdentity = ObjectIdentity
deschControllerGroups = _DeschControllerGroups_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 20246, 2, 3, 1, 1, 1, 1, 1)
)
_DeschControllerCompl_ObjectIdentity = ObjectIdentity
deschControllerCompl = _DeschControllerCompl_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 20246, 2, 3, 1, 1, 1, 1, 2)
)
_DeschControllerObjects_ObjectIdentity = ObjectIdentity
deschControllerObjects = _DeschControllerObjects_ObjectIdentity(
...
dcEventHistoryEntry.setIndexNames(
    (0, "DESCH-PSC3-BASE-MIB", "dcEventHistoryIndex"),
)
if mibBuilder.loadTexts:
...
dcAlarmEntry.setIndexNames(
    (0, "DESCH-PSC3-BASE-MIB", "dcAlarmIndex"),
)
if mibBuilder.loadTexts:
...
dcGenericAlarmEntry.setIndexNames(
    (0, "DESCH-PSC3-BASE-MIB", "dcGenericAlarmIndex"),
)
if mibBuilder.loadTexts:
...
dcRectifierEntry.setIndexNames(
    (0, "DESCH-PSC3-BASE-MIB", "dcRectifierIndex"),
)
if mibBuilder.loadTexts:
...
dcRectifierGroupEntry.setIndexNames(
    (0, "DESCH-PSC3-BASE-MIB", "dcRectifierGroupIndex"),
)
if mibBuilder.loadTexts:
...
if mibBuilder.loadTexts:
    dcRectifierGroupStartupTimeLimit.setUnits("seconds")
...
if mibBuilder.loadTexts:
    dcRectifierGroupPowerupDelay.setUnits("seconds")
...
if mibBuilder.loadTexts:
    dcRectifierGroupPowerupTime.setUnits("seconds")
...
dcPowerLimitationEntry.setIndexNames(
    (0, "DESCH-PSC3-BASE-MIB", "dcPowerLimitationIndex"),
)
if mibBuilder.loadTexts:
...
_DcTcoeff_Type = Integer32
_DcTcoeff_Object = MibScalar
dcTcoeff = _DcTcoeff_Object(
    (1, 3, 6, 1, 4, 1, 20246, 2, 3, 1, 1, 1, 2, 5, 1, 2),
    _DcTcoeff_Type()
)
dcTcoeff.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    dcTcoeff.setStatus("current")
if mibBuilder.loadTexts:
    dcTcoeff.setUnits("-1 mV/C")
_DcTcLow_Type = Integer32
_DcTcLow_Object = MibScalar
dcTcLow = _DcTcLow_Object(
    (1, 3, 6, 1, 4, 1, 20246, 2, 3, 1, 1, 1, 2, 5, 1, 3),
    _DcTcLow_Type()
)
dcTcLow.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    dcTcLow.setStatus("current")
if mibBuilder.loadTexts:
    dcTcLow.setUnits("0.1 C")
_DcTcHigh_Type = Integer32
_DcTcHigh_Object = MibScalar
dcTcHigh = _DcTcHigh_Object(
    (1, 3, 6, 1, 4, 1, 20246, 2, 3, 1, 1, 1, 2, 5, 1, 4),
    _DcTcHigh_Type()
)
dcTcHigh.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    dcTcHigh.setStatus("current")
if mibBuilder.loadTexts:
    dcTcHigh.setUnits("0.1 C")
_DcUtcHigh_Type = Integer32
_DcUtcHigh_Object = MibScalar
dcUtcHigh = _DcUtcHigh_Object(
    (1, 3, 6, 1, 4, 1, 20246, 2, 3, 1, 1, 1, 2, 5, 1, 5),
    _DcUtcHigh_Type()
)
dcUtcHigh.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    dcUtcHigh.setStatus("current")
if mibBuilder.loadTexts:
    dcUtcHigh.setUnits("10 mV")


class _DcBattTempCompEnabled_Type(Integer32):
    """Custom type dcBattTempCompEnabled based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_DcBattTempCompEnabled_Type.__name__ = "Integer32"
_DcBattTempCompEnabled_Object = MibScalar
dcBattTempCompEnabled = _DcBattTempCompEnabled_Object(
    (1, 3, 6, 1, 4, 1, 20246, 2, 3, 1, 1, 1, 2, 5, 1, 6),
    _DcBattTempCompEnabled_Type()
)
dcBattTempCompEnabled.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    dcBattTempCompEnabled.setStatus("current")
...
dcBatteryStringEntry.setIndexNames(
    (0, "DESCH-PSC3-BASE-MIB", "dcBatteryStringIndex"),
)
if mibBuilder.loadTexts:
...
dcControlEventEntry.setIndexNames(
    (0, "DESCH-PSC3-BASE-MIB", "dcControlEventIndex"),
)
if mibBuilder.loadTexts:
...
dcTrapDestinationEntry.setIndexNames(
    (0, "DESCH-PSC3-BASE-MIB", "dcTrapDestinationIndex"),
)
if mibBuilder.loadTexts:
...
class _DcSetupConfiguration_Type(Integer32):
    """Custom type dcSetupConfiguration based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            1
...
_DcSetupConfiguration_Type.__name__ = "Integer32"
_DcSetupConfiguration_Object = MibScalar
dcSetupConfiguration = _DcSetupConfiguration_Object(
    (1, 3, 6, 1, 4, 1, 20246, 2, 3, 1, 1, 1, 2, 7, 3),
    _DcSetupConfiguration_Type()
)
dcSetupConfiguration.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    dcSetupConfiguration.setStatus("current")
...
dcDefaultLogEventEntry.setIndexNames(
    (0, "DESCH-PSC3-BASE-MIB", "dcDefaultLogEventIndex"),
)
if mibBuilder.loadTexts:
    dcDefaultLogEventEntry.setStatus("current")
_DcDefaultLogEventIndex_Type = Integer32
...
dcEventProcessingEventEntry.setIndexNames(
    (0, "DESCH-PSC3-BASE-MIB", "dcEventProcessingEventIndex"),
)
if mibBuilder.loadTexts:
    dcEventProcessingEventEntry.setStatus("current")
_DcEventProcessingEventIndex_Type = Integer32
...
dcLvdEntry.setIndexNames(
    (0, "DESCH-PSC3-BASE-MIB", "dcLvdIndex"),
)
if mibBuilder.loadTexts:
...
dcMeasurementEntry.setIndexNames(
    (0, "DESCH-PSC3-BASE-MIB", "dcMeasurementIndex"),
)
if mibBuilder.loadTexts:
...
_DeschControllerEvents_ObjectIdentity = ObjectIdentity
deschControllerEvents = _DeschControllerEvents_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 20246, 2, 3, 1, 1, 1, 3)
)
_DeschControllerEventObjects_ObjectIdentity = ObjectIdentity
deschControllerEventObjects = _DeschControllerEventObjects_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 20246, 2, 3, 1, 1, 1, 3, 1)
)
_DeschControllerEventsV2_ObjectIdentity = ObjectIdentity
deschControllerEventsV2 = _DeschControllerEventsV2_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 20246, 2, 3, 1, 1, 1, 3, 1, 0)
)

# Managed Objects groups

deschSystemInfoGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 20246, 2, 3, 1, 1, 1, 1, 1, 1)
)
deschSystemInfoGroup.setObjects(
      *(("DESCH-PSC3-BASE-MIB", "dcSiteName"),
        ("DESCH-PSC3-BASE-MIB", "dcSystemName"),
        ("DESCH-PSC3-BASE-MIB", "dcSystemDateTime"),
        ("DESCH-PSC3-BASE-MIB", "dcSoftwareVersion"))
)
if mibBuilder.loadTexts:
    deschSystemInfoGroup.setStatus("current")

deschSystemAlarmGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 20246, 2, 3, 1, 1, 1, 1, 1, 2)
)
deschSystemAlarmGroup.setObjects(
      *(("DESCH-PSC3-BASE-MIB", "dcNumberUrgentAlarms"),
        ("DESCH-PSC3-BASE-MIB", "dcNumberNonUrgentAlarms"),
        ("DESCH-PSC3-BASE-MIB", "dcMainsFailureAlarm"),
        ("DESCH-PSC3-BASE-MIB", "dcUrgentAlarmIdentifier"),
        ("DESCH-PSC3-BASE-MIB", "dcUrgentAlarmValue"),
        ("DESCH-PSC3-BASE-MIB", "dcNonUrgentAlarmIdentifier"),
        ("DESCH-PSC3-BASE-MIB", "dcNonUrgentAlarmValue"),
        ("DESCH-PSC3-BASE-MIB", "dcUrgentAlarmName"),
        ("DESCH-PSC3-BASE-MIB", "dcNonUrgentAlarmName"),
        ("DESCH-PSC3-BASE-MIB", "dcNumberCriticalAlarms"),
        ("DESCH-PSC3-BASE-MIB", "dcCriticalAlarmIdentifier"),
        ("DESCH-PSC3-BASE-MIB", "dcCriticalAlarmValue"),
        ("DESCH-PSC3-BASE-MIB", "dcCriticalAlarmName"))
)
if mibBuilder.loadTexts:
    deschSystemAlarmGroup.setStatus("current")

deschSystemMonitorGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 20246, 2, 3, 1, 1, 1, 1, 1, 3)
)
deschSystemMonitorGroup.setObjects(
      *(("DESCH-PSC3-BASE-MIB", "dcSystemVoltage"),
        ("DESCH-PSC3-BASE-MIB", "dcLoadCurrent"),
        ("DESCH-PSC3-BASE-MIB", "dcBatteryCurrent"),
        ("DESCH-PSC3-BASE-MIB", "dcBatteryTemperature"),
        ("DESCH-PSC3-BASE-MIB", "dcChargeState"),
        ("DESCH-PSC3-BASE-MIB", "dcCurrentLimit"),
        ("DESCH-PSC3-BASE-MIB", "dcRectifierCurrent"),
        ("DESCH-PSC3-BASE-MIB", "dcSystemPower"))
)
if mibBuilder.loadTexts:
    deschSystemMonitorGroup.setStatus("current")

deschRectifierGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 20246, 2, 3, 1, 1, 1, 1, 1, 4)
)
deschRectifierGroup.setObjects(
      *(("DESCH-PSC3-BASE-MIB", "dcNumberRectifiers"),
        ("DESCH-PSC3-BASE-MIB", "dcNumberRectifiersFailure"),
        ("DESCH-PSC3-BASE-MIB", "dcNumberRectifiersOkay"),
        ("DESCH-PSC3-BASE-MIB", "dcEfficiencyCyclingEnabled"),
        ("DESCH-PSC3-BASE-MIB", "dcLimitSwitchingTimes"),
        ("DESCH-PSC3-BASE-MIB", "dcForceSwitchingOncePerMonth"),
        ("DESCH-PSC3-BASE-MIB", "dcMaximumLoadStep"),
        ("DESCH-PSC3-BASE-MIB", "dcMinimumLoadStep"))
)
if mibBuilder.loadTexts:
    deschRectifierGroup.setStatus("current")

deschEventHistoryTableGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 20246, 2, 3, 1, 1, 1, 1, 1, 5)
)
deschEventHistoryTableGroup.setObjects(
      *(("DESCH-PSC3-BASE-MIB", "dcEventHistoryTimestamp"),
        ("DESCH-PSC3-BASE-MIB", "dcEventHistoryMessage"))
)
if mibBuilder.loadTexts:
    deschEventHistoryTableGroup.setStatus("current")

deschAlarmTableGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 20246, 2, 3, 1, 1, 1, 1, 1, 6)
)
deschAlarmTableGroup.setObjects(
      *(("DESCH-PSC3-BASE-MIB", "dcAlarmEventCategory"),
        ("DESCH-PSC3-BASE-MIB", "dcAlarmEventName"),
        ("DESCH-PSC3-BASE-MIB", "dcAlarmEventIdentifier"),
        ("DESCH-PSC3-BASE-MIB", "dcAlarmEventValue"))
)
if mibBuilder.loadTexts:
    deschAlarmTableGroup.setStatus("current")

deschRectifierTableGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 20246, 2, 3, 1, 1, 1, 1, 1, 7)
)
deschRectifierTableGroup.setObjects(
      *(("DESCH-PSC3-BASE-MIB", "dcRectifierIdentifier"),
        ("DESCH-PSC3-BASE-MIB", "dcRectifierStatus"))
)
if mibBuilder.loadTexts:
    deschRectifierTableGroup.setStatus("current")

deschGenericAlarmTableGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 20246, 2, 3, 1, 1, 1, 1, 1, 9)
)
deschGenericAlarmTableGroup.setObjects(
      *(("DESCH-PSC3-BASE-MIB", "dcGenericAlarmEventIdentifier"),
        ("DESCH-PSC3-BASE-MIB", "dcGenericAlarmEventName"),
        ("DESCH-PSC3-BASE-MIB", "dcGenericAlarmEventValue"))
)
if mibBuilder.loadTexts:
    deschGenericAlarmTableGroup.setStatus("current")

deschBatteryGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 20246, 2, 3, 1, 1, 1, 1, 1, 10)
)
deschBatteryGroup.setObjects(
      *(("DESCH-PSC3-BASE-MIB", "dcUsys20"),
        ("DESCH-PSC3-BASE-MIB", "dcTcoeff"),
        ("DESCH-PSC3-BASE-MIB", "dcTcLow"),
        ("DESCH-PSC3-BASE-MIB", "dcTcHigh"),
        ("DESCH-PSC3-BASE-MIB", "dcUtcHigh"),
        ("DESCH-PSC3-BASE-MIB", "dcBattTempCompEnabled"),
        ("DESCH-PSC3-BASE-MIB", "dcBatteryTestUsupport"),
        ("DESCH-PSC3-BASE-MIB", "dcBatteryTestDuration"),
        ("DESCH-PSC3-BASE-MIB", "dcBatteryTestInterval"),
        ("DESCH-PSC3-BASE-MIB", "dcBatteryTestDischargeCurrent"),
        ("DESCH-PSC3-BASE-MIB", "dcBatteryTestMinDuration"),
        ("DESCH-PSC3-BASE-MIB", "dcBatteryTestVoltageWithinUfloat"),
        ("DESCH-PSC3-BASE-MIB", "dcBatteryTestVoltageWithinUfloatPeriod"),
        ("DESCH-PSC3-BASE-MIB", "dcBatteryTestTempFrom"),
        ("DESCH-PSC3-BASE-MIB", "dcBatteryTestTempTo"),
        ("DESCH-PSC3-BASE-MIB", "dcBatteryTestIntervalEnabled"),
        ("DESCH-PSC3-BASE-MIB", "dcBatteryTestStartTimeFrom"),
        ("DESCH-PSC3-BASE-MIB", "dcBatteryTestStartTimeTo"),
        ("DESCH-PSC3-BASE-MIB", "dcBatteryTestDateTime"),
        ("DESCH-PSC3-BASE-MIB", "dcBatteryTestResult"),
        ("DESCH-PSC3-BASE-MIB", "dcBatteryTestEndVoltage"),
        ("DESCH-PSC3-BASE-MIB", "dcBatteryTestControl"),
        ("DESCH-PSC3-BASE-MIB", "dcBatteryTestStatus"),
        ("DESCH-PSC3-BASE-MIB", "dcBatteryTestFailureEvent"),
        ("DESCH-PSC3-BASE-MIB", "dcBatteryTestType"),
        ("DESCH-PSC3-BASE-MIB", "dcTotalBatteryCapacity"),
        ("DESCH-PSC3-BASE-MIB", "dcLossOfBackupTimeEnabled"),
        ("DESCH-PSC3-BASE-MIB", "dcLossOfBackupTimeStatus"),
        ("DESCH-PSC3-BASE-MIB", "dcExpectedBackupTime"),
        ("DESCH-PSC3-BASE-MIB", "dcEqualizeControl"),
        ("DESCH-PSC3-BASE-MIB", "dcEqualizeStatus"),
        ("DESCH-PSC3-BASE-MIB", "dcEqualizeEnabled"),
        ("DESCH-PSC3-BASE-MIB", "dcEqualizeVoltage"),
        ("DESCH-PSC3-BASE-MIB", "dcEqualizeDuration"),
        ("DESCH-PSC3-BASE-MIB", "dcEqualizeUseBattRoomFanEnabled"),
        ("DESCH-PSC3-BASE-MIB", "dcEqualizeLeadTime"),
        ("DESCH-PSC3-BASE-MIB", "dcEqualizeTimeLag"),
        ("DESCH-PSC3-BASE-MIB", "dcEqualizeInterval"),
        ("DESCH-PSC3-BASE-MIB", "dcEqualizeStartTimeIntervalFrom"),
        ("DESCH-PSC3-BASE-MIB", "dcEqualizeStartTimeIntervalTo"),
        ("DESCH-PSC3-BASE-MIB", "dcEqualizeInhibitAfterBoost"),
        ("DESCH-PSC3-BASE-MIB", "dcBoostChargeControl"),
        ("DESCH-PSC3-BASE-MIB", "dcBoostChargeStatus"),
        ("DESCH-PSC3-BASE-MIB", "dcBoostChargeType"),
        ("DESCH-PSC3-BASE-MIB", "dcBoostChargeVoltage"),
        ("DESCH-PSC3-BASE-MIB", "dcBoostChargeMaxDuration"),
        ("DESCH-PSC3-BASE-MIB", "dcBoostChargeUseBattRoomFanEnabled"),
        ("DESCH-PSC3-BASE-MIB", "dcBoostChargeTimeLag"),
        ("DESCH-PSC3-BASE-MIB", "dcBoostChargeIstart"),
        ("DESCH-PSC3-BASE-MIB", "dcBoostChargeIstop"),
        ("DESCH-PSC3-BASE-MIB", "dcBoostChargeInhibitTime"),
        ("DESCH-PSC3-BASE-MIB", "dcUaMax"),
        ("DESCH-PSC3-BASE-MIB", "dcUaMin"),
        ("DESCH-PSC3-BASE-MIB", "dcUsMax"),
        ("DESCH-PSC3-BASE-MIB", "dcUsMin"),
        ("DESCH-PSC3-BASE-MIB", "dcHysteresis"),
        ("DESCH-PSC3-BASE-MIB", "dcSuppressUaLowEnabled"),
        ("DESCH-PSC3-BASE-MIB", "dcSuppressUsLowEnabled"),
        ("DESCH-PSC3-BASE-MIB", "dcEvtCtrlChargeStatus"),
        ("DESCH-PSC3-BASE-MIB", "dcEvtCtrlChargeType"),
        ("DESCH-PSC3-BASE-MIB", "dcEvtCtrlChargeVoltage"),
        ("DESCH-PSC3-BASE-MIB", "dcEvtCtrlChargeTempCompEnabled"),
        ("DESCH-PSC3-BASE-MIB", "dcEvtCtrlChargeMaxIBatt"))
)
if mibBuilder.loadTexts:
    deschBatteryGroup.setStatus("current")

deschControlEventTableGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 20246, 2, 3, 1, 1, 1, 1, 1, 11)
)
deschControlEventTableGroup.setObjects(
      *(("DESCH-PSC3-BASE-MIB", "dcControlEventName"),
        ("DESCH-PSC3-BASE-MIB", "dcControlEventIdentifier"),
        ("DESCH-PSC3-BASE-MIB", "dcControlEventValue"))
)
if mibBuilder.loadTexts:
    deschControlEventTableGroup.setStatus("current")

deschTrapDestinationTableGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 20246, 2, 3, 1, 1, 1, 1, 1, 12)
)
deschTrapDestinationTableGroup.setObjects(
      *(("DESCH-PSC3-BASE-MIB", "dcTrapDestinationIp"),
        ("DESCH-PSC3-BASE-MIB", "dcTrapDestinationPort"))
)
if mibBuilder.loadTexts:
    deschTrapDestinationTableGroup.setStatus("current")

deschMiscGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 20246, 2, 3, 1, 1, 1, 1, 1, 13)
)
deschMiscGroup.setObjects(
      *(("DESCH-PSC3-BASE-MIB", "dcFileProcessingStatus"),
        ("DESCH-PSC3-BASE-MIB", "dcSetupConfiguration"))
)
if mibBuilder.loadTexts:
    deschMiscGroup.setStatus("current")

deschRectifierGroupTableGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 20246, 2, 3, 1, 1, 1, 1, 1, 14)
)
deschRectifierGroupTableGroup.setObjects(
      *(("DESCH-PSC3-BASE-MIB", "dcRectifierGroupName"),
        ("DESCH-PSC3-BASE-MIB", "dcRectifierGroupRectifierType"),
        ("DESCH-PSC3-BASE-MIB", "dcRectifierGroupDefaultVoltage"),
        ("DESCH-PSC3-BASE-MIB", "dcRectifierGroupDefaultCurrentLimit"),
        ("DESCH-PSC3-BASE-MIB", "dcRectifierGroupDefaultPowerLimit"),
        ("DESCH-PSC3-BASE-MIB", "dcRectifierGroupInputLowOff"),
        ("DESCH-PSC3-BASE-MIB", "dcRectifierGroupInputLowOn"),
        ("DESCH-PSC3-BASE-MIB", "dcRectifierGroupStartupVoltage"),
        ("DESCH-PSC3-BASE-MIB", "dcRectifierGroupStartupCurrentLimit"),
        ("DESCH-PSC3-BASE-MIB", "dcRectifierGroupStartupPowerLimit"),
        ("DESCH-PSC3-BASE-MIB", "dcRectifierGroupStartupTimeLimit"),
        ("DESCH-PSC3-BASE-MIB", "dcRectifierGroupPowerupDelay"),
        ("DESCH-PSC3-BASE-MIB", "dcRectifierGroupPowerupTime"),
        ("DESCH-PSC3-BASE-MIB", "dcRectifierGroupUmaxOff"))
)
if mibBuilder.loadTexts:
    deschRectifierGroupTableGroup.setStatus("current")

deschBatteryStringTableGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 20246, 2, 3, 1, 1, 1, 1, 1, 15)
)
deschBatteryStringTableGroup.setObjects(
      *(("DESCH-PSC3-BASE-MIB", "dcBatteryStringName"),
        ("DESCH-PSC3-BASE-MIB", "dcBatteryStringMaxIBatt"),
        ("DESCH-PSC3-BASE-MIB", "dcBatteryStringCapacity"))
)
if mibBuilder.loadTexts:
    deschBatteryStringTableGroup.setStatus("current")

deschDefaultLogEventTableGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 20246, 2, 3, 1, 1, 1, 1, 1, 16)
)
deschDefaultLogEventTableGroup.setObjects(
      *(("DESCH-PSC3-BASE-MIB", "dcDefaultLogEventName"),
        ("DESCH-PSC3-BASE-MIB", "dcDefaultLogEventLogged"))
)
if mibBuilder.loadTexts:
    deschDefaultLogEventTableGroup.setStatus("current")

deschEventProcessingEventTableGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 20246, 2, 3, 1, 1, 1, 1, 1, 17)
)
deschEventProcessingEventTableGroup.setObjects(
      *(("DESCH-PSC3-BASE-MIB", "dcEventProcessingEventName"),
        ("DESCH-PSC3-BASE-MIB", "dcEventProcessingEventAssigned"),
        ("DESCH-PSC3-BASE-MIB", "dcEventProcessingEventType"),
        ("DESCH-PSC3-BASE-MIB", "dcEventProcessingEventSelected"))
)
if mibBuilder.loadTexts:
    deschEventProcessingEventTableGroup.setStatus("current")

deschLvdTableGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 20246, 2, 3, 1, 1, 1, 1, 1, 18)
)
deschLvdTableGroup.setObjects(
      *(("DESCH-PSC3-BASE-MIB", "dcLvdName"),
        ("DESCH-PSC3-BASE-MIB", "dcLvdDisconnectDelay"))
)
if mibBuilder.loadTexts:
    deschLvdTableGroup.setStatus("current")

deschPowerLimitationTableGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 20246, 2, 3, 1, 1, 1, 1, 1, 19)
)
deschPowerLimitationTableGroup.setObjects(
      *(("DESCH-PSC3-BASE-MIB", "dcPowerLimitationEventName"),
        ("DESCH-PSC3-BASE-MIB", "dcPowerLimitationStatus"),
        ("DESCH-PSC3-BASE-MIB", "dcPowerLimitationType"),
        ("DESCH-PSC3-BASE-MIB", "dcPowerLimitationLimit"),
        ("DESCH-PSC3-BASE-MIB", "dcPowerLimitationNoBatteryDischarge"))
)
if mibBuilder.loadTexts:
    deschPowerLimitationTableGroup.setStatus("current")

deschMeasurementTableGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 20246, 2, 3, 1, 1, 1, 1, 1, 20)
)
deschMeasurementTableGroup.setObjects(
      *(("DESCH-PSC3-BASE-MIB", "dcMeasurementName"),
        ("DESCH-PSC3-BASE-MIB", "dcMeasurementValue"),
        ("DESCH-PSC3-BASE-MIB", "dcMeasurementScaleFactor"),
        ("DESCH-PSC3-BASE-MIB", "dcMeasurementUnit"))
)
if mibBuilder.loadTexts:
    deschMeasurementTableGroup.setStatus("current")
...
deschNotificationsGroup = NotificationGroup(
    (1, 3, 6, 1, 4, 1, 20246, 2, 3, 1, 1, 1, 1, 1, 8)
)
deschNotificationsGroup.setObjects(
      *(("DESCH-PSC3-BASE-MIB", "systemNonUrgentAlarm"),
        ("DESCH-PSC3-BASE-MIB", "systemUrgentAlarm"),
        ("DESCH-PSC3-BASE-MIB", "systemCriticalAlarm"))
)
if mibBuilder.loadTexts:
    deschNotificationsGroup.setStatus(
        "current"
    )
...
deschControllerBasicCompl = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 20246, 2, 3, 1, 1, 1, 1, 2, 1)
)
deschControllerBasicCompl.setObjects(
      *(("DESCH-PSC3-BASE-MIB", "deschSystemInfoGroup"),
        ("DESCH-PSC3-BASE-MIB", "deschSystemAlarmGroup"),
        ("DESCH-PSC3-BASE-MIB", "deschSystemMonitorGroup"),
        ("DESCH-PSC3-BASE-MIB", "deschAlarmTableGroup"),
        ("DESCH-PSC3-BASE-MIB", "deschNotificationsGroup"))
)
if mibBuilder.loadTexts:
    deschControllerBasicCompl.setStatus(
        "current"
    )
...
mibBuilder.exportSymbols(
    "DESCH-PSC3-BASE-MIB",
    **{"deschPsc3BaseMibModule": deschPsc3BaseMibModule,
       "deschPsc3BaseMib": deschPsc3BaseMib,
       "deschControllerConfs": deschControllerConfs,
       "deschControllerGroups": deschControllerGroups,
       "deschSystemInfoGroup": deschSystemInfoGroup,
       "deschSystemAlarmGroup": deschSystemAlarmGroup,
       "deschSystemMonitorGroup": deschSystemMonitorGroup,
       "deschRectifierGroup": deschRectifierGroup,
       "deschEventHistoryTableGroup": deschEventHistoryTableGroup,
       "deschAlarmTableGroup": deschAlarmTableGroup,
       "deschRectifierTableGroup": deschRectifierTableGroup,
       "deschNotificationsGroup": deschNotificationsGroup,
       "deschGenericAlarmTableGroup": deschGenericAlarmTableGroup,
       "deschBatteryGroup": deschBatteryGroup,
       "deschControlEventTableGroup": deschControlEventTableGroup,
       "deschTrapDestinationTableGroup": deschTrapDestinationTableGroup,
       "deschMiscGroup": deschMiscGroup,
       "deschRectifierGroupTableGroup": deschRectifierGroupTableGroup,
       "deschBatteryStringTableGroup": deschBatteryStringTableGroup,
       "deschDefaultLogEventTableGroup": deschDefaultLogEventTableGroup,
       "deschEventProcessingEventTableGroup": deschEventProcessingEventTableGroup,
       "deschLvdTableGroup": deschLvdTableGroup,
       "deschPowerLimitationTableGroup": deschPowerLimitationTableGroup,
       "deschMeasurementTableGroup": deschMeasurementTableGroup,
       "deschControllerCompl": deschControllerCompl,
       "deschControllerBasicCompl": deschControllerBasicCompl,
       "deschControllerObjects": deschControllerObjects,
       ...
       "dcTcHigh": dcTcHigh,
       "dcUtcHigh": dcUtcHigh,
       "dcBattTempCompEnabled": dcBattTempCompEnabled,
       ...
       "dcSetupConfiguration": dcSetupConfiguration,
       ...
       "deschControllerEvents": deschControllerEvents,
       "deschControllerEventObjects": deschControllerEventObjects,
       "deschControllerEventsV2": deschControllerEventsV2,
