# SNMP MIB module (UPSD-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/rob/MIBs/delta_2254/UPSD-MIB.mib
...
_Upsd_ObjectIdentity = ObjectIdentity
upsd = _Upsd_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 2254)
)
...
_DupsShutdownRestart_Type = Integer32
_DupsShutdownRestart_Object = MibScalar
dupsShutdownRestart = _DupsShutdownRestart_Object(
    (1, 3, 6, 1, 4, 1, 2254, 2, 4, 2, 4),
    _DupsShutdownRestart_Type()
)
dupsShutdownRestart.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    dupsShutdownRestart.setStatus("mandatory")
...
_DupsBypassLoad1_Type = Integer32
_DupsBypassLoad1_Object = MibScalar
dupsBypassLoad1 = _DupsBypassLoad1_Object(
    (1, 3, 6, 1, 4, 1, 2254, 2, 4, 6, 6),
    _DupsBypassLoad1_Type()
)
dupsBypassLoad1.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    dupsBypassLoad1.setStatus("mandatory")
_DupsBypasstVoltage2_Type = Integer32
_DupsBypasstVoltage2_Object = MibScalar
dupsBypasstVoltage2 = _DupsBypasstVoltage2_Object(
    (1, 3, 6, 1, 4, 1, 2254, 2, 4, 6, 7),
    _DupsBypasstVoltage2_Type()
)
dupsBypasstVoltage2.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    dupsBypasstVoltage2.setStatus("mandatory")
...
_DupsBypassLoad2_Type = Integer32
_DupsBypassLoad2_Object = MibScalar
dupsBypassLoad2 = _DupsBypassLoad2_Object(
    (1, 3, 6, 1, 4, 1, 2254, 2, 4, 6, 10),
    _DupsBypassLoad2_Type()
)
dupsBypassLoad2.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    dupsBypassLoad2.setStatus("mandatory")
...
dupsBypassPower3 = _DupsBypassPower3_Object(
    (1, 3, 6, 1, 4, 1, 2254, 2, 4, 6, 13),
    _DupsBypassPower3_Type()
)
dupsBypassPower3.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    dupsBypassPower3.setStatus("mandatory")
_DupsBypassLoad3_Type = Integer32
_DupsBypassLoad3_Object = MibScalar
dupsBypassLoad3 = _DupsBypassLoad3_Object(
    (1, 3, 6, 1, 4, 1, 2254, 2, 4, 6, 14),
    _DupsBypassLoad3_Type()
)
dupsBypassLoad3.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    dupsBypassLoad3.setStatus("mandatory")
...
dupsEPO_ON = NotificationType(
    (1, 3, 6, 1, 4, 1, 2254, 0, 48)
)
if mibBuilder.loadTexts:
    dupsEPO_ON.setStatus(
        ""
    )

dupsEPO_OFF = NotificationType(
    (1, 3, 6, 1, 4, 1, 2254, 0, 49)
)
if mibBuilder.loadTexts:
    dupsEPO_OFF.setStatus(
        ""
    )
...
mibBuilder.exportSymbols(
    ...
    **{"upsd": upsd,
       ...
       "dupsEPO_ON": dupsEPO_ON,
       "dupsEPO_OFF": dupsEPO_OFF,
       "ups": ups,
       "upsv4": upsv4,
       "dupsIdent": dupsIdent,
       ...
       "dupsShutdownRestart": dupsShutdownRestart,
