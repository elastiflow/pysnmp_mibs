# SNMP MIB module (DIGI-PASSPORT-FIPS-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/rob/MIBs/digi_332/DIGI-PASSPORT-FIPS-MIB.mib
...
(digiPassportFips,) = mibBuilder.importSymbols(
    "DIGI-SMI",
    "digiPassportFips")
...
portManageIndex = _PortManageIndex_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 11, 1, 11),
...
portsEnable = _PortsEnable_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 11, 1, 12),
    _PortsEnable_Type()
)
...
portsRealPortEnable = _PortsRealPortEnable_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 11, 1, 13),
...
portsResetProcess = _PortsResetProcess_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 11, 1, 14),
...
portsResetToFactoryDefault = _PortsResetToFactoryDefault_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 11, 1, 15),
...
portsAddRow = _PortsAddRow_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 11, 1, 16),
    _PortsAddRow_Type()
)
...
portsDelRow = _PortsDelRow_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 11, 1, 17),
    _PortsDelRow_Type()
)
...
portsGroupName = _PortsGroupName_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 11, 1, 18),
...
portApplyAllPortsEntry = _PortApplyAllPortsEntry_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 12, 1)
)
portApplyAllPortsEntry.setIndexNames(
    (0, "DIGI-PASSPORT-FIPS-MIB", "portApplyAllPortsIndex"),
)
if mibBuilder.loadTexts:
...
portApplyAllPortsIndex = _PortApplyAllPortsIndex_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 12, 1, 11),
...
portsApplyAllPorts = _PortsApplyAllPorts_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 12, 1, 12),
...
detectIndex = _DetectIndex_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 13, 1, 11),
    _DetectIndex_Type()
)
...
detectMethod = _DetectMethod_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 13, 1, 21),
    _DetectMethod_Type()
)
...
detectInitDelay = _DetectInitDelay_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 13, 1, 22),
...
detectInterval = _DetectInterval_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 13, 1, 23),
...
detectTime = _DetectTime_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 13, 1, 24),
    _DetectTime_Type()
)
...
detectProbeStr = _DetectProbeStr_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 13, 1, 25),
...
detectedOS = _DetectedOS_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 13, 1, 26),
    _DetectedOS_Type()
)
...
useDetectedTitle = _UseDetectedTitle_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 13, 1, 27),
...
titleNamingRule = _TitleNamingRule_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 13, 1, 28),
...
useDetectedTypeOfCS = _UseDetectedTypeOfCS_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 13, 1, 29),
...
useDetectedFreeKVM = _UseDetectedFreeKVM_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 13, 1, 30),
...
useDetectedSerialParams = _UseDetectedSerialParams_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 13, 1, 31),
...
detectDeviceVia = _DetectDeviceVia_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 13, 1, 32),
...
portTitleIndex = _PortTitleIndex_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 14, 1, 11),
...
portTitle = _PortTitle_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 14, 1, 14),
    _PortTitle_Type()
)
...
hostmodeIndex = _HostmodeIndex_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 15, 1, 11),
    _HostmodeIndex_Type()
)
...
hostMode = _HostMode_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 15, 1, 12),
    _HostMode_Type()
)
...
hostTypeCS = _HostTypeCS_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 15, 1, 13),
    _HostTypeCS_Type()
)
...
hostEnableRackableCard = _HostEnableRackableCard_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 15, 1, 14),
...
hostEnableAssignedIP = _HostEnableAssignedIP_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 15, 1, 15),
...
hostAssignedIP = _HostAssignedIP_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 15, 1, 16),
...
hostLocalPort = _HostLocalPort_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 15, 1, 17),
    _HostLocalPort_Type()
)
...
hostProtocol = _HostProtocol_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 15, 1, 18),
    _HostProtocol_Type()
)
...
hostInactivity = _HostInactivity_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 15, 1, 19),
...
hostEnableEscapeChar = _HostEnableEscapeChar_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 15, 1, 20),
...
hostEscapeChar = _HostEscapeChar_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 15, 1, 21),
...
hostBreakSeq = _HostBreakSeq_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 15, 1, 22),
    _HostBreakSeq_Type()
)
...
hostUseComment = _HostUseComment_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 15, 1, 23),
...
hostQuickConnect = _HostQuickConnect_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 15, 1, 24),
...
hostAppletEncode = _HostAppletEncode_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 15, 1, 25),
...
hostTSOption = _HostTSOption_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 15, 1, 26),
    _HostTSOption_Type()
)
...
hostDestIP = _HostDestIP_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 15, 1, 27),
    _HostDestIP_Type()
)
...
hostDestPort = _HostDestPort_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 15, 1, 28),
    _HostDestPort_Type()
)
...
hostTSShellProgramPath = _HostTSShellProgramPath_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 15, 1, 29),
...
hostModemInitStr = _HostModemInitStr_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 15, 1, 30),
...
hostEnableCallback = _HostEnableCallback_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 15, 1, 31),
...
hostCallbackNumber = _HostCallbackNumber_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 15, 1, 32),
...
hostEnableModemTest = _HostEnableModemTest_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 15, 1, 33),
...
hostModemTestNumber = _HostModemTestNumber_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 15, 1, 34),
...
hostModemTestInterval = _HostModemTestInterval_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 15, 1, 35),
...
hostServiceProcessor = _HostServiceProcessor_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 15, 1, 36),
...
hostEnableCallbackLogin = _HostEnableCallbackLogin_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 15, 1, 37),
...
hostEnableCallbackNumberChange = _HostEnableCallbackNumberChange_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 15, 1, 38),
...
hostEnableAppletColumns = _HostEnableAppletColumns_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 15, 1, 39),
...
hostEnableAppletRows = _HostEnableAppletRows_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 15, 1, 40),
...
hostEnableDisPortInfo = _HostEnableDisPortInfo_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 15, 1, 41),
...
hostEnableEscapeOption = _HostEnableEscapeOption_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 15, 1, 42),
...
paramIndex = _ParamIndex_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 16, 1, 11),
    _ParamIndex_Type()
)
...
paramType = _ParamType_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 16, 1, 12),
    _ParamType_Type()
)
...
paramBaud = _ParamBaud_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 16, 1, 13),
    _ParamBaud_Type()
)
paramBaud.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
paramDatabits = _ParamDatabits_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 16, 1, 14),
    _ParamDatabits_Type()
)
paramDatabits.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
paramParity = _ParamParity_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 16, 1, 15),
    _ParamParity_Type()
)
paramParity.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
paramStopbits = _ParamStopbits_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 16, 1, 16),
    _ParamStopbits_Type()
)
paramStopbits.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
paramFlowctrl = _ParamFlowctrl_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 16, 1, 17),
    _ParamFlowctrl_Type()
)
paramFlowctrl.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
paramDTROpt = _ParamDTROpt_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 16, 1, 18),
    _ParamDTROpt_Type()
)
paramDTROpt.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
paramEnableDelimiter = _ParamEnableDelimiter_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 16, 1, 19),
    _ParamEnableDelimiter_Type()
)
paramEnableDelimiter.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
paramDelimiter = _ParamDelimiter_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 16, 1, 20),
    _ParamDelimiter_Type()
)
paramDelimiter.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
paramDeilmiterOption = _ParamDeilmiterOption_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 16, 1, 21),
    _ParamDeilmiterOption_Type()
)
paramDeilmiterOption.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
paramInterCharTimeout = _ParamInterCharTimeout_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 16, 1, 22),
    _ParamInterCharTimeout_Type()
)
paramInterCharTimeout.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
paramRemoteDestIP = _ParamRemoteDestIP_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 16, 1, 23),
    _ParamRemoteDestIP_Type()
)
paramRemoteDestIP.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
paramRemoteDestPort = _ParamRemoteDestPort_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 16, 1, 24),
    _ParamRemoteDestPort_Type()
)
paramRemoteDestPort.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
paramRemoteProtocol = _ParamRemoteProtocol_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 16, 1, 25),
    _ParamRemoteProtocol_Type()
)
paramRemoteProtocol.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
paramRemoteContinuousConnect = _ParamRemoteContinuousConnect_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 16, 1, 26),
    _ParamRemoteContinuousConnect_Type()
)
paramRemoteContinuousConnect.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
paramRemoteEstablishInterval = _ParamRemoteEstablishInterval_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 16, 1, 27),
    _ParamRemoteEstablishInterval_Type()
)
paramRemoteEstablishInterval.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
paramRemoteOEMType = _ParamRemoteOEMType_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 16, 1, 28),
    _ParamRemoteOEMType_Type()
)
paramRemoteOEMType.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
paramRemoteUsername = _ParamRemoteUsername_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 16, 1, 29),
    _ParamRemoteUsername_Type()
)
paramRemoteUsername.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
paramRemotePassword = _ParamRemotePassword_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 16, 1, 30),
    _ParamRemotePassword_Type()
)
paramRemotePassword.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
paramRemoteSupportProtocol = _ParamRemoteSupportProtocol_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 16, 1, 31),
    _ParamRemoteSupportProtocol_Type()
)
paramRemoteSupportProtocol.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
paramRemoteAutomaticLogin = _ParamRemoteAutomaticLogin_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 16, 1, 32),
    _ParamRemoteAutomaticLogin_Type()
)
paramRemoteAutomaticLogin.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
loggingIndex = _LoggingIndex_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 17, 1, 11),
    _LoggingIndex_Type()
)
...
loggingEnablePortLogging = _LoggingEnablePortLogging_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 17, 1, 12),
...
loggingOption = _LoggingOption_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 17, 1, 13),
    _LoggingOption_Type()
)
...
loggingStoLoc = _LoggingStoLoc_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 17, 1, 14),
    _LoggingStoLoc_Type()
)
...
loggingSyslog = _LoggingSyslog_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 17, 1, 15),
    _LoggingSyslog_Type()
)
...
loggingBufferSize = _LoggingBufferSize_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 17, 1, 16),
...
loggingFileByTitle = _LoggingFileByTitle_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 17, 1, 17),
...
loggingFilename = _LoggingFilename_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 17, 1, 18),
...
loggingTimeStamp = _LoggingTimeStamp_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 17, 1, 19),
...
loggingShowOnConn = _LoggingShowOnConn_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 17, 1, 20),
...
loggingStringM = _LoggingStringM_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 17, 1, 21),
...
loggingBackupOnMount = _LoggingBackupOnMount_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 17, 1, 22),
...
loggingFacility = _LoggingFacility_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 17, 1, 23),
...
loggingCharLength = _LoggingCharLength_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 17, 1, 24),
...
backupfileNumber = _BackupfileNumber_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 17, 1, 25),
...
keywordsTable = _KeywordsTable_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 18)
)
if mibBuilder.loadTexts:
    keywordsTable.setStatus("mandatory")
_KeywordsEntry_Object = MibTableRow
keywordsEntry = _KeywordsEntry_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 18, 1)
)
keywordsEntry.setIndexNames(
    (0, "DIGI-PASSPORT-FIPS-MIB", "keywordsPortIndex"),
    (0, "DIGI-PASSPORT-FIPS-MIB", "keywordIndex"),
)
if mibBuilder.loadTexts:
...
keywordsPortIndex = _KeywordsPortIndex_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 18, 1, 11),
    _KeywordsPortIndex_Type()
)
keywordsPortIndex.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
keywordIndex = _KeywordIndex_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 18, 1, 12),
    _KeywordIndex_Type()
)
...
keywordString = _KeywordString_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 18, 1, 13),
    _KeywordString_Type()
)
keywordString.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
keywordMailEnable = _KeywordMailEnable_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 18, 1, 14),
    _KeywordMailEnable_Type()
)
keywordMailEnable.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
keywordMailTitle = _KeywordMailTitle_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 18, 1, 15),
    _KeywordMailTitle_Type()
)
keywordMailTitle.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
keywordMailto = _KeywordMailto_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 18, 1, 16),
    _KeywordMailto_Type()
)
keywordMailto.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
keywordTrapEnable = _KeywordTrapEnable_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 18, 1, 17),
    _KeywordTrapEnable_Type()
)
keywordTrapEnable.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
keywordTrapMsgTitle = _KeywordTrapMsgTitle_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 18, 1, 18),
    _KeywordTrapMsgTitle_Type()
)
keywordTrapMsgTitle.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
keywordTrapToGlobal = _KeywordTrapToGlobal_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 18, 1, 19),
    _KeywordTrapToGlobal_Type()
)
keywordTrapToGlobal.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
keyword1stTrapDest = _Keyword1stTrapDest_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 18, 1, 20),
    _Keyword1stTrapDest_Type()
)
keyword1stTrapDest.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
keyword1stTrapDestComm = _Keyword1stTrapDestComm_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 18, 1, 21),
    _Keyword1stTrapDestComm_Type()
)
keyword1stTrapDestComm.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
keyword1stTrapDestVer = _Keyword1stTrapDestVer_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 18, 1, 22),
    _Keyword1stTrapDestVer_Type()
)
keyword1stTrapDestVer.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
keyword1stTrapUserName = _Keyword1stTrapUserName_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 18, 1, 23),
    _Keyword1stTrapUserName_Type()
)
keyword1stTrapUserName.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
keyword1stTrapSecurityLevel = _Keyword1stTrapSecurityLevel_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 18, 1, 24),
    _Keyword1stTrapSecurityLevel_Type()
)
keyword1stTrapSecurityLevel.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
keyword1stTrapAuthProto = _Keyword1stTrapAuthProto_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 18, 1, 25),
    _Keyword1stTrapAuthProto_Type()
)
keyword1stTrapAuthProto.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
keyword1stTrapAuthPasswd = _Keyword1stTrapAuthPasswd_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 18, 1, 26),
    _Keyword1stTrapAuthPasswd_Type()
)
keyword1stTrapAuthPasswd.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
keyword1stTrapPrivProto = _Keyword1stTrapPrivProto_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 18, 1, 27),
    _Keyword1stTrapPrivProto_Type()
)
keyword1stTrapPrivProto.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
keyword1stTrapPrivPasswd = _Keyword1stTrapPrivPasswd_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 18, 1, 28),
    _Keyword1stTrapPrivPasswd_Type()
)
keyword1stTrapPrivPasswd.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
keyword1stTrapEngineID = _Keyword1stTrapEngineID_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 18, 1, 29),
    _Keyword1stTrapEngineID_Type()
)
keyword1stTrapEngineID.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
keyword2ndTrapDest = _Keyword2ndTrapDest_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 18, 1, 30),
    _Keyword2ndTrapDest_Type()
)
keyword2ndTrapDest.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
keyword2ndTrapDestComm = _Keyword2ndTrapDestComm_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 18, 1, 31),
    _Keyword2ndTrapDestComm_Type()
)
keyword2ndTrapDestComm.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
keyword2ndTrapDestVer = _Keyword2ndTrapDestVer_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 18, 1, 32),
    _Keyword2ndTrapDestVer_Type()
)
keyword2ndTrapDestVer.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
keyword2ndTrapUserName = _Keyword2ndTrapUserName_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 18, 1, 33),
    _Keyword2ndTrapUserName_Type()
)
keyword2ndTrapUserName.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
keyword2ndTrapSecurityLevel = _Keyword2ndTrapSecurityLevel_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 18, 1, 34),
    _Keyword2ndTrapSecurityLevel_Type()
)
keyword2ndTrapSecurityLevel.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
keyword2ndTrapAuthProto = _Keyword2ndTrapAuthProto_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 18, 1, 35),
    _Keyword2ndTrapAuthProto_Type()
)
keyword2ndTrapAuthProto.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
keyword2ndTrapAuthPasswd = _Keyword2ndTrapAuthPasswd_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 18, 1, 36),
    _Keyword2ndTrapAuthPasswd_Type()
)
keyword2ndTrapAuthPasswd.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
keyword2ndTrapPrivProto = _Keyword2ndTrapPrivProto_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 18, 1, 37),
    _Keyword2ndTrapPrivProto_Type()
)
keyword2ndTrapPrivProto.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
keyword2ndTrapPrivPasswd = _Keyword2ndTrapPrivPasswd_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 18, 1, 38),
    _Keyword2ndTrapPrivPasswd_Type()
)
keyword2ndTrapPrivPasswd.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
keyword2ndTrapEngineID = _Keyword2ndTrapEngineID_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 18, 1, 39),
    _Keyword2ndTrapEngineID_Type()
)
keyword2ndTrapEngineID.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
keywordCaseSensitive = _KeywordCaseSensitive_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 18, 1, 40),
    _KeywordCaseSensitive_Type()
)
keywordCaseSensitive.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
keywordAddRow = _KeywordAddRow_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 18, 1, 41),
    _KeywordAddRow_Type()
)
keywordAddRow.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
authIndex = _AuthIndex_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 19, 1, 11),
    _AuthIndex_Type()
)
...
authMethod = _AuthMethod_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 19, 1, 12),
    _AuthMethod_Type()
)
...
authPrimaryIPAddress = _AuthPrimaryIPAddress_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 19, 1, 13),
...
authSecondaryIPAddress = _AuthSecondaryIPAddress_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 19, 1, 14),
...
authPrimaryAcctIPAddress = _AuthPrimaryAcctIPAddress_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 19, 1, 15),
...
authSecondaryAcctIPAddress = _AuthSecondaryAcctIPAddress_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 19, 1, 16),
...
authSecret = _AuthSecret_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 19, 1, 17),
    _AuthSecret_Type()
)
...
authTimeout = _AuthTimeout_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 19, 1, 18),
    _AuthTimeout_Type()
)
...
authRetries = _AuthRetries_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 19, 1, 19),
    _AuthRetries_Type()
)
...
authKRBPrimaryRealm = _AuthKRBPrimaryRealm_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 19, 1, 22),
...
authKRBSecondaryRealm = _AuthKRBSecondaryRealm_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 19, 1, 23),
...
authAuthorService = _AuthAuthorService_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 19, 1, 24),
...
usracctlIndex = _UsracctlIndex_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 20, 1, 11),
    _UsracctlIndex_Type()
)
...
usracctlEveryonePortPerm = _UsracctlEveryonePortPerm_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 20, 1, 12),
...
usracctlPortPermittedUsers = _UsracctlPortPermittedUsers_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 20, 1, 13),
...
usracctlPortRestrictedUsers = _UsracctlPortRestrictedUsers_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 20, 1, 14),
...
usracctlPortPermittedLists = _UsracctlPortPermittedLists_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 20, 1, 15),
...
usracctlPortRestrictedLists = _UsracctlPortRestrictedLists_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 20, 1, 16),
...
usracctlEveryoneMonitorPerm = _UsracctlEveryoneMonitorPerm_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 20, 1, 17),
...
usracctlMonitorPermittedUsers = _UsracctlMonitorPermittedUsers_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 20, 1, 18),
...
usracctlMonitorRestrictedUsers = _UsracctlMonitorRestrictedUsers_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 20, 1, 19),
...
usracctlMonitorPermittedLists = _UsracctlMonitorPermittedLists_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 20, 1, 20),
...
usracctlMonitorRestrictedLists = _UsracctlMonitorRestrictedLists_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 20, 1, 21),
...
usracctlEveryonePowerPerm = _UsracctlEveryonePowerPerm_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 20, 1, 22),
...
usracctlPowerPermittedUsers = _UsracctlPowerPermittedUsers_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 20, 1, 23),
...
usracctlPowerRestrictedUsers = _UsracctlPowerRestrictedUsers_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 20, 1, 24),
...
usracctlPowerPermittedLists = _UsracctlPowerPermittedLists_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 20, 1, 25),
...
usracctlPowerRestrictedLists = _UsracctlPowerRestrictedLists_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 20, 1, 26),
...
usracctlEnableMultipleSession = _UsracctlEnableMultipleSession_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 20, 1, 27),
...
usracctlSessionDisplayMode = _UsracctlSessionDisplayMode_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 20, 1, 28),
...
usracctlSniffDisplayDirectionArrow = _UsracctlSniffDisplayDirectionArrow_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 20, 1, 29),
...
usracctlEveryoneLogPerm = _UsracctlEveryoneLogPerm_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 20, 1, 30),
...
usracctlLogPermittedUsers = _UsracctlLogPermittedUsers_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 20, 1, 31),
...
usracctlLogRestrictedUsers = _UsracctlLogRestrictedUsers_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 20, 1, 32),
...
usracctlLogPermittedLists = _UsracctlLogPermittedLists_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 20, 1, 33),
...
usracctlLogRestrictedLists = _UsracctlLogRestrictedLists_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 20, 1, 34),
...
usracctlEveryoneBreakPerm = _UsracctlEveryoneBreakPerm_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 20, 1, 35),
...
usracctlBreakPermittedUsers = _UsracctlBreakPermittedUsers_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 20, 1, 36),
...
usracctlBreakRestrictedUsers = _UsracctlBreakRestrictedUsers_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 20, 1, 37),
...
usracctlBreakPermittedLists = _UsracctlBreakPermittedLists_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 20, 1, 38),
...
usracctlBreakRestrictedLists = _UsracctlBreakRestrictedLists_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 20, 1, 39),
...
alertIndex = _AlertIndex_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 21, 1, 11),
    _AlertIndex_Type()
)
...
alertLoginMail = _AlertLoginMail_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 21, 1, 12),
    _AlertLoginMail_Type()
)
alertLoginMail.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
alertLoginMailTitle = _AlertLoginMailTitle_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 21, 1, 13),
    _AlertLoginMailTitle_Type()
)
alertLoginMailTitle.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
alertLoginMailto = _AlertLoginMailto_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 21, 1, 14),
    _AlertLoginMailto_Type()
)
alertLoginMailto.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
alertDevConnMail = _AlertDevConnMail_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 21, 1, 15),
    _AlertDevConnMail_Type()
)
alertDevConnMail.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
alertDevConnMailTitle = _AlertDevConnMailTitle_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 21, 1, 16),
    _AlertDevConnMailTitle_Type()
)
alertDevConnMailTitle.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
alertDevConnMailto = _AlertDevConnMailto_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 21, 1, 17),
    _AlertDevConnMailto_Type()
)
alertDevConnMailto.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
alertDetectionMail = _AlertDetectionMail_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 21, 1, 18),
    _AlertDetectionMail_Type()
)
alertDetectionMail.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
alertDetectionMailTitle = _AlertDetectionMailTitle_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 21, 1, 19),
    _AlertDetectionMailTitle_Type()
)
alertDetectionMailTitle.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
alertDetectionMailto = _AlertDetectionMailto_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 21, 1, 20),
    _AlertDetectionMailto_Type()
)
alertDetectionMailto.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
alertModemTestMail = _AlertModemTestMail_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 21, 1, 21),
    _AlertModemTestMail_Type()
)
alertModemTestMail.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
alertModemTestMailTitle = _AlertModemTestMailTitle_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 21, 1, 22),
    _AlertModemTestMailTitle_Type()
)
alertModemTestMailTitle.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
alertModemTestMailto = _AlertModemTestMailto_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 21, 1, 23),
    _AlertModemTestMailto_Type()
)
alertModemTestMailto.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
alertIPMIMail = _AlertIPMIMail_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 21, 1, 24),
    _AlertIPMIMail_Type()
)
alertIPMIMail.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
alertIPMIMailTitle = _AlertIPMIMailTitle_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 21, 1, 25),
    _AlertIPMIMailTitle_Type()
)
alertIPMIMailTitle.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
alertIPMIMailto = _AlertIPMIMailto_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 21, 1, 26),
    _AlertIPMIMailto_Type()
)
alertIPMIMailto.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
alertLoginTrap = _AlertLoginTrap_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 21, 1, 27),
    _AlertLoginTrap_Type()
)
alertLoginTrap.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
alertDevConnTrap = _AlertDevConnTrap_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 21, 1, 28),
    _AlertDevConnTrap_Type()
)
alertDevConnTrap.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
alertDetectionTrap = _AlertDetectionTrap_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 21, 1, 29),
    _AlertDetectionTrap_Type()
)
alertDetectionTrap.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
alertModemTestTrap = _AlertModemTestTrap_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 21, 1, 30),
    _AlertModemTestTrap_Type()
)
alertModemTestTrap.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
alertIPMITrap = _AlertIPMITrap_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 21, 1, 31),
    _AlertIPMITrap_Type()
)
alertIPMITrap.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
alertToGlobalSNMP = _AlertToGlobalSNMP_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 21, 1, 32),
    _AlertToGlobalSNMP_Type()
)
alertToGlobalSNMP.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
alert1stTrapRcvIP = _Alert1stTrapRcvIP_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 21, 1, 33),
    _Alert1stTrapRcvIP_Type()
)
alert1stTrapRcvIP.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
alert1stTrapRcvComm = _Alert1stTrapRcvComm_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 21, 1, 34),
    _Alert1stTrapRcvComm_Type()
)
alert1stTrapRcvComm.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
alert1stTrapRcvVer = _Alert1stTrapRcvVer_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 21, 1, 35),
    _Alert1stTrapRcvVer_Type()
)
alert1stTrapRcvVer.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
alert1stTrapRcvUserName = _Alert1stTrapRcvUserName_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 21, 1, 36),
    _Alert1stTrapRcvUserName_Type()
)
alert1stTrapRcvUserName.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
alert1stTrapRcvSecurityLevel = _Alert1stTrapRcvSecurityLevel_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 21, 1, 37),
    _Alert1stTrapRcvSecurityLevel_Type()
)
alert1stTrapRcvSecurityLevel.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
alert1stTrapRcvAuthProto = _Alert1stTrapRcvAuthProto_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 21, 1, 38),
    _Alert1stTrapRcvAuthProto_Type()
)
alert1stTrapRcvAuthProto.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
alert1stTrapRcvAuthPasswd = _Alert1stTrapRcvAuthPasswd_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 21, 1, 39),
    _Alert1stTrapRcvAuthPasswd_Type()
)
alert1stTrapRcvAuthPasswd.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
alert1stTrapRcvPrivProto = _Alert1stTrapRcvPrivProto_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 21, 1, 40),
    _Alert1stTrapRcvPrivProto_Type()
)
alert1stTrapRcvPrivProto.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
alert1stTrapRcvPrivPasswd = _Alert1stTrapRcvPrivPasswd_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 21, 1, 41),
    _Alert1stTrapRcvPrivPasswd_Type()
)
alert1stTrapRcvPrivPasswd.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
alert1stTrapRcvEngineID = _Alert1stTrapRcvEngineID_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 21, 1, 42),
    _Alert1stTrapRcvEngineID_Type()
)
alert1stTrapRcvEngineID.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
alert2ndTrapRcvIP = _Alert2ndTrapRcvIP_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 21, 1, 43),
    _Alert2ndTrapRcvIP_Type()
)
alert2ndTrapRcvIP.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
alert2ndTrapRcvComm = _Alert2ndTrapRcvComm_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 21, 1, 44),
    _Alert2ndTrapRcvComm_Type()
)
alert2ndTrapRcvComm.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
alert2ndTrapRcvVer = _Alert2ndTrapRcvVer_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 21, 1, 45),
    _Alert2ndTrapRcvVer_Type()
)
alert2ndTrapRcvVer.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
alert2ndTrapRcvUserName = _Alert2ndTrapRcvUserName_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 21, 1, 46),
    _Alert2ndTrapRcvUserName_Type()
)
alert2ndTrapRcvUserName.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
alert2ndTrapRcvSecurityLevel = _Alert2ndTrapRcvSecurityLevel_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 21, 1, 47),
    _Alert2ndTrapRcvSecurityLevel_Type()
)
alert2ndTrapRcvSecurityLevel.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
alert2ndTrapRcvAuthProto = _Alert2ndTrapRcvAuthProto_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 21, 1, 48),
    _Alert2ndTrapRcvAuthProto_Type()
)
alert2ndTrapRcvAuthProto.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
alert2ndTrapRcvAuthPasswd = _Alert2ndTrapRcvAuthPasswd_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 21, 1, 49),
    _Alert2ndTrapRcvAuthPasswd_Type()
)
alert2ndTrapRcvAuthPasswd.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
alert2ndTrapRcvPrivProto = _Alert2ndTrapRcvPrivProto_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 21, 1, 50),
    _Alert2ndTrapRcvPrivProto_Type()
)
alert2ndTrapRcvPrivProto.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
alert2ndTrapRcvPrivPasswd = _Alert2ndTrapRcvPrivPasswd_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 21, 1, 51),
    _Alert2ndTrapRcvPrivPasswd_Type()
)
alert2ndTrapRcvPrivPasswd.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
powerIndex = _PowerIndex_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 22, 1, 11),
    _PowerIndex_Type()
)
...
powerStatus = _PowerStatus_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 22, 1, 12),
    _PowerStatus_Type()
)
...
powerControl = _PowerControl_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 22, 1, 13),
    _PowerControl_Type()
)
...
ipmiConfigIndex = _IpmiConfigIndex_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 23, 1, 11),
...
ipmiConfigUserName = _IpmiConfigUserName_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 23, 1, 12),
    _IpmiConfigUserName_Type()
)
ipmiConfigUserName.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
ipmiConfigPassword = _IpmiConfigPassword_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 23, 1, 13),
    _IpmiConfigPassword_Type()
)
ipmiConfigPassword.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
ipmiConfigOEMType = _IpmiConfigOEMType_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 23, 1, 14),
...
ipmiPortIndex = _IpmiPortIndex_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 24, 1, 11),
    _IpmiPortIndex_Type()
)
...
ipmiSensorIndex = _IpmiSensorIndex_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 24, 1, 12),
...
ipmiSensorType = _IpmiSensorType_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 24, 1, 13),
...
ipmiSensorEmailAlert = _IpmiSensorEmailAlert_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 24, 1, 14),
...
ipmiSensorSNMPAlert = _IpmiSensorSNMPAlert_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 24, 1, 15),
...
ipmiSensorAddRow = _IpmiSensorAddRow_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 24, 1, 16),
...
ipmiSensorDeleteRow = _IpmiSensorDeleteRow_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 24, 1, 17),
...
portsStatIndex = _PortsStatIndex_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 25, 1, 11),
...
portsStatBaudRate = _PortsStatBaudRate_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 25, 1, 12),
...
portsStatTx = _PortsStatTx_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 25, 1, 13),
    _PortsStatTx_Type()
)
...
portsStatRx = _PortsStatRx_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 25, 1, 14),
    _PortsStatRx_Type()
)
...
portsStatRTS = _PortsStatRTS_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 25, 1, 15),
    _PortsStatRTS_Type()
)
...
portsStatCTS = _PortsStatCTS_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 25, 1, 16),
    _PortsStatCTS_Type()
)
...
portsStatDTR = _PortsStatDTR_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 25, 1, 17),
    _PortsStatDTR_Type()
)
...
portsStatDSR = _PortsStatDSR_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 25, 1, 18),
    _PortsStatDSR_Type()
)
...
portsStatCD = _PortsStatCD_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 25, 1, 19),
    _PortsStatCD_Type()
)
...
portsStatOper = _PortsStatOper_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 25, 1, 20),
    _PortsStatOper_Type()
)
...
instantPortsParamEntry = _InstantPortsParamEntry_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 26, 1)
)
instantPortsParamEntry.setIndexNames(
    (0, "DIGI-PASSPORT-FIPS-MIB", "instantPortsParamIndex"),
)
if mibBuilder.loadTexts:
...
instantPortsParamIndex = _InstantPortsParamIndex_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 26, 1, 11),
...
instantPortsParamString = _InstantPortsParamString_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 25, 26, 1, 12),
...
modemInitString = _ModemInitString_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 26, 12, 12),
...
modemEnableCallback = _ModemEnableCallback_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 26, 12, 13),
...
modemCallbackNumber = _ModemCallbackNumber_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 26, 12, 14),
...
modemEnableModemTest = _ModemEnableModemTest_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 26, 12, 15),
...
modemTestNumber = _ModemTestNumber_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 26, 12, 16),
...
modemTestInterval = _ModemTestInterval_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 26, 12, 17),
...
modemTestMail = _ModemTestMail_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 26, 12, 18),
    _ModemTestMail_Type()
)
...
modemTestMailTitle = _ModemTestMailTitle_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 26, 12, 19),
...
modemTestMailto = _ModemTestMailto_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 26, 12, 20),
...
modemTestTrap = _ModemTestTrap_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 26, 12, 21),
    _ModemTestTrap_Type()
)
...
modemTrapToGlobalSNMP = _ModemTrapToGlobalSNMP_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 26, 12, 22),
...
modemTrapRcvIndex = _ModemTrapRcvIndex_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 26, 12, 23, 1, 11),
...
modemTrapRcvIP = _ModemTrapRcvIP_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 26, 12, 23, 1, 12),
    _ModemTrapRcvIP_Type()
)
modemTrapRcvIP.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
modemTrapRcvComm = _ModemTrapRcvComm_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 26, 12, 23, 1, 13),
    _ModemTrapRcvComm_Type()
)
modemTrapRcvComm.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
modemTrapRcvVer = _ModemTrapRcvVer_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 26, 12, 23, 1, 14),
    _ModemTrapRcvVer_Type()
)
modemTrapRcvVer.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
modemTrapRcvUserName = _ModemTrapRcvUserName_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 26, 12, 23, 1, 15),
    _ModemTrapRcvUserName_Type()
)
modemTrapRcvUserName.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
modemTrapRcvSecurityLevel = _ModemTrapRcvSecurityLevel_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 26, 12, 23, 1, 16),
    _ModemTrapRcvSecurityLevel_Type()
)
modemTrapRcvSecurityLevel.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
modemTrapRcvAuthProto = _ModemTrapRcvAuthProto_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 26, 12, 23, 1, 17),
    _ModemTrapRcvAuthProto_Type()
)
modemTrapRcvAuthProto.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
modemTrapRcvAuthPasswd = _ModemTrapRcvAuthPasswd_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 26, 12, 23, 1, 18),
    _ModemTrapRcvAuthPasswd_Type()
)
modemTrapRcvAuthPasswd.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
modemTrapRcvPrivProto = _ModemTrapRcvPrivProto_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 26, 12, 23, 1, 19),
    _ModemTrapRcvPrivProto_Type()
)
modemTrapRcvPrivProto.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
modemTrapRcvPrivPasswd = _ModemTrapRcvPrivPasswd_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 26, 12, 23, 1, 20),
    _ModemTrapRcvPrivPasswd_Type()
)
modemTrapRcvPrivPasswd.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
modemTrapRcvEngineID = _ModemTrapRcvEngineID_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 26, 12, 23, 1, 21),
    _ModemTrapRcvEngineID_Type()
)
modemTrapRcvEngineID.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
modemEnableCallbackLogin = _ModemEnableCallbackLogin_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 26, 12, 24),
...
modemEnableCallbackNumberChange = _ModemEnableCallbackNumberChange_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 26, 12, 25),
...
modemSecondaryCallbackNumber = _ModemSecondaryCallbackNumber_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 26, 12, 26),
...
modemAuthMethod = _ModemAuthMethod_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 26, 12, 27),
...
usbIndex = _UsbIndex_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 26, 13, 11, 1, 11),
    _UsbIndex_Type()
)
...
usbType = _UsbType_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 26, 13, 11, 1, 12),
    _UsbType_Type()
)
...
usbModel = _UsbModel_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 26, 13, 11, 1, 13),
    _UsbModel_Type()
)
...
usbSize = _UsbSize_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 26, 13, 11, 1, 14),
    _UsbSize_Type()
)
...
usbFileSystem = _UsbFileSystem_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 26, 13, 11, 1, 15),
    _UsbFileSystem_Type()
)
...
usbTotalSize = _UsbTotalSize_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 26, 13, 11, 1, 16),
    _UsbTotalSize_Type()
)
...
usbIpmode = _UsbIpmode_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 26, 13, 11, 1, 17),
    _UsbIpmode_Type()
)
...
usbIpAddress = _UsbIpAddress_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 26, 13, 11, 1, 18),
    _UsbIpAddress_Type()
)
...
usbSubnet = _UsbSubnet_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 26, 13, 11, 1, 19),
    _UsbSubnet_Type()
)
...
usbGateway = _UsbGateway_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 26, 13, 11, 1, 20),
    _UsbGateway_Type()
)
...
usbSSID = _UsbSSID_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 26, 13, 11, 1, 21),
    _UsbSSID_Type()
)
...
usbWEPEnable = _UsbWEPEnable_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 26, 13, 11, 1, 22),
    _UsbWEPEnable_Type()
)
...
usbWEPMode = _UsbWEPMode_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 26, 13, 11, 1, 23),
    _UsbWEPMode_Type()
)
...
usbWEPLength = _UsbWEPLength_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 26, 13, 11, 1, 24),
    _UsbWEPLength_Type()
)
...
usbWEPKeyStr = _UsbWEPKeyStr_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 26, 13, 11, 1, 25),
    _UsbWEPKeyStr_Type()
)
...
firstIPv4Mode = _FirstIPv4Mode_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 27, 11, 11, 11, 11),
    _FirstIPv4Mode_Type()
)
...
firstIPv4PrimaryIPAddress = _FirstIPv4PrimaryIPAddress_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 27, 11, 11, 11, 12),
...
firstIPv4PrimarySubMask = _FirstIPv4PrimarySubMask_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 27, 11, 11, 11, 13),
...
firstIPv4PrimaryGateway = _FirstIPv4PrimaryGateway_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 27, 11, 11, 11, 14),
...
firstIPv4EnableSecondaryIP = _FirstIPv4EnableSecondaryIP_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 27, 11, 11, 11, 15),
...
firstIPv4SecondaryIPAddress = _FirstIPv4SecondaryIPAddress_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 27, 11, 11, 11, 16),
...
firstIPv4SecondarySubMask = _FirstIPv4SecondarySubMask_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 27, 11, 11, 11, 17),
...
firstIPv4SecondaryGateway = _FirstIPv4SecondaryGateway_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 27, 11, 11, 11, 18),
...
firstIPv6Config = _FirstIPv6Config_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 27, 11, 11, 12)
)
...
firstIPv6Mode = _FirstIPv6Mode_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 27, 11, 11, 12, 11),
    _FirstIPv6Mode_Type()
)
...
firstIPv6Address = _FirstIPv6Address_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 27, 11, 11, 12, 12),
...
firstIPv6Gateway = _FirstIPv6Gateway_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 27, 11, 11, 12, 13),
...
firstIPv6SecondaryIPAddress = _FirstIPv6SecondaryIPAddress_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 27, 11, 11, 12, 14),
...
firstIPv6Enable6to4tunneling = _FirstIPv6Enable6to4tunneling_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 27, 11, 11, 12, 15),
...
firstIPv6To4Relay = _FirstIPv6To4Relay_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 27, 11, 11, 12, 16),
...
firstIPv6OverwriteLocalIPV4 = _FirstIPv6OverwriteLocalIPV4_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 27, 11, 11, 12, 17),
...
secondIPv4Mode = _SecondIPv4Mode_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 27, 11, 12, 11, 11),
...
secondIPv4PrimaryIPAddress = _SecondIPv4PrimaryIPAddress_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 27, 11, 12, 11, 12),
...
secondIPv4PrimarySubMask = _SecondIPv4PrimarySubMask_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 27, 11, 12, 11, 13),
...
secondIPv4PrimaryGateway = _SecondIPv4PrimaryGateway_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 27, 11, 12, 11, 14),
...
secondIPv4EnableSecondaryIP = _SecondIPv4EnableSecondaryIP_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 27, 11, 12, 11, 15),
...
secondIPv4SecondaryIPAddress = _SecondIPv4SecondaryIPAddress_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 27, 11, 12, 11, 16),
...
secondIPv4SecondarySubMask = _SecondIPv4SecondarySubMask_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 27, 11, 12, 11, 17),
...
secondIPv4SecondaryGateway = _SecondIPv4SecondaryGateway_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 27, 11, 12, 11, 18),
...
secondIPv6Config = _SecondIPv6Config_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 27, 11, 12, 12)
)
...
secondIPv6Mode = _SecondIPv6Mode_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 27, 11, 12, 12, 11),
...
secondIPv6Address = _SecondIPv6Address_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 27, 11, 12, 12, 12),
...
secondIPv6Gateway = _SecondIPv6Gateway_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 27, 11, 12, 12, 13),
...
secondIPv6SecondaryIPAddress = _SecondIPv6SecondaryIPAddress_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 27, 11, 12, 12, 14),
...
secondIPv6Enable6to4tunneling = _SecondIPv6Enable6to4tunneling_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 27, 11, 12, 12, 15),
...
secondIPv6To4Relay = _SecondIPv6To4Relay_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 27, 11, 12, 12, 16),
...
secondIPv6OverwriteLocalIPV4 = _SecondIPv6OverwriteLocalIPV4_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 27, 11, 12, 12, 17),
...
netipUseOldIPOnDHCPFailure = _NetipUseOldIPOnDHCPFailure_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 27, 11, 13),
...
netipUseManualDNS = _NetipUseManualDNS_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 27, 11, 14),
...
netipPrimaryNameServer = _NetipPrimaryNameServer_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 27, 11, 15),
...
netipSecondaryNameServer = _NetipSecondaryNameServer_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 27, 11, 16),
...
sourceBasedRouting = _SourceBasedRouting_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 27, 11, 17),
...
snmpOther = _SnmpOther_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 27, 12)
)
_SnmpColdStartTraps_Type = Switch
_SnmpColdStartTraps_Object = MibScalar
snmpColdStartTraps = _SnmpColdStartTraps_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 27, 12, 11),
    _SnmpColdStartTraps_Type()
)
snmpColdStartTraps.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    snmpColdStartTraps.setStatus("mandatory")
_SnmpColdStartEmails_Type = Switch
_SnmpColdStartEmails_Object = MibScalar
snmpColdStartEmails = _SnmpColdStartEmails_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 27, 12, 12),
    _SnmpColdStartEmails_Type()
)
snmpColdStartEmails.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    snmpColdStartEmails.setStatus("mandatory")
_SnmpAuthenTraps_Type = Switch
_SnmpAuthenTraps_Object = MibScalar
snmpAuthenTraps = _SnmpAuthenTraps_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 27, 12, 13),
...
snmpAuthenEmails = _SnmpAuthenEmails_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 27, 12, 14),
...
snmpLinkUpTraps = _SnmpLinkUpTraps_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 27, 12, 15),
...
snmpLinkUpEmails = _SnmpLinkUpEmails_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 27, 12, 16),
...
snmpLinkDownTraps = _SnmpLinkDownTraps_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 27, 12, 17),
...
snmpLinkDownEmails = _SnmpLinkDownEmails_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 27, 12, 18),
...
snmpLoginTraps = _SnmpLoginTraps_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 27, 12, 19),
...
snmpLoginEmails = _SnmpLoginEmails_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 27, 12, 20),
...
snmpMailto = _SnmpMailto_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 27, 12, 21),
    _SnmpMailto_Type()
)
...
snmpTrapRcvIndex = _SnmpTrapRcvIndex_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 27, 12, 22, 1, 11),
...
snmpTrapRcvIP = _SnmpTrapRcvIP_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 27, 12, 22, 1, 12),
    _SnmpTrapRcvIP_Type()
)
snmpTrapRcvIP.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
snmpTrapRcvComm = _SnmpTrapRcvComm_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 27, 12, 22, 1, 13),
    _SnmpTrapRcvComm_Type()
)
snmpTrapRcvComm.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
snmpTrapRcvVer = _SnmpTrapRcvVer_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 27, 12, 22, 1, 14),
    _SnmpTrapRcvVer_Type()
)
snmpTrapRcvVer.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
snmpTrapRcvUserName = _SnmpTrapRcvUserName_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 27, 12, 22, 1, 15),
    _SnmpTrapRcvUserName_Type()
)
snmpTrapRcvUserName.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
snmpTrapRcvSecurityLevel = _SnmpTrapRcvSecurityLevel_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 27, 12, 22, 1, 16),
    _SnmpTrapRcvSecurityLevel_Type()
)
snmpTrapRcvSecurityLevel.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
snmpTrapRcvAuthProto = _SnmpTrapRcvAuthProto_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 27, 12, 22, 1, 17),
    _SnmpTrapRcvAuthProto_Type()
)
snmpTrapRcvAuthProto.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
snmpTrapRcvAuthPasswd = _SnmpTrapRcvAuthPasswd_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 27, 12, 22, 1, 18),
    _SnmpTrapRcvAuthPasswd_Type()
)
snmpTrapRcvAuthPasswd.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
snmpTrapRcvPrivProto = _SnmpTrapRcvPrivProto_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 27, 12, 22, 1, 19),
    _SnmpTrapRcvPrivProto_Type()
)
snmpTrapRcvPrivProto.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
snmpTrapRcvPrivPasswd = _SnmpTrapRcvPrivPasswd_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 27, 12, 22, 1, 20),
    _SnmpTrapRcvPrivPasswd_Type()
)
snmpTrapRcvPrivPasswd.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
ipfilterIndex = _IpfilterIndex_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 27, 15, 14, 1, 11),
    _IpfilterIndex_Type()
)
...
ipfilterIface = _IpfilterIface_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 27, 15, 14, 1, 12),
    _IpfilterIface_Type()
)
...
ipfilterOpt = _IpfilterOpt_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 27, 15, 14, 1, 13),
    _IpfilterOpt_Type()
)
...
ipfilterIPMask = _IpfilterIPMask_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 27, 15, 14, 1, 14),
...
ipfilterPort = _IpfilterPort_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 27, 15, 14, 1, 15),
    _IpfilterPort_Type()
)
...
ipfilterRule = _IpfilterRule_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 27, 15, 14, 1, 16),
    _IpfilterRule_Type()
)
...
ipfilterProtocol = _IpfilterProtocol_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 27, 15, 14, 1, 17),
...
ipfilterAddRow = _IpfilterAddRow_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 27, 15, 14, 1, 18),
...
ipfilterDeleteRow = _IpfilterDeleteRow_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 27, 15, 14, 1, 19),
...
nfsPrimaryAddress = _NfsPrimaryAddress_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 27, 17, 12),
    _NfsPrimaryAddress_Type()
)
nfsPrimaryAddress.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
nfsPrimaryExported = _NfsPrimaryExported_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 27, 17, 13),
    _NfsPrimaryExported_Type()
)
nfsPrimaryExported.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
nfsPrimaryTimeout = _NfsPrimaryTimeout_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 27, 17, 14),
    _NfsPrimaryTimeout_Type()
)
nfsPrimaryTimeout.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
nfsPrimaryRetryInterval = _NfsPrimaryRetryInterval_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 27, 17, 15),
    _NfsPrimaryRetryInterval_Type()
)
nfsPrimaryRetryInterval.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    nfsPrimaryRetryInterval.setStatus("mandatory")


class _NfsPrimaryEnableEncrypt_Type(Integer32):
    """Custom type nfsPrimaryEnableEncrypt based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            1
...
nfsPrimaryUser = _NfsPrimaryUser_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 27, 17, 17),
    _NfsPrimaryUser_Type()
)
nfsPrimaryUser.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
nfsPrimaryPassword = _NfsPrimaryPassword_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 27, 17, 18),
    _NfsPrimaryPassword_Type()
)
nfsPrimaryPassword.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
nfsSecondaryEnable = _NfsSecondaryEnable_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 27, 17, 19),
    _NfsSecondaryEnable_Type()
)
nfsSecondaryEnable.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
nfsSecondaryAddress = _NfsSecondaryAddress_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 27, 17, 20),
    _NfsSecondaryAddress_Type()
)
nfsSecondaryAddress.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
nfsSecondaryExported = _NfsSecondaryExported_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 27, 17, 21),
    _NfsSecondaryExported_Type()
)
nfsSecondaryExported.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
nfsSecondaryTimeout = _NfsSecondaryTimeout_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 27, 17, 22),
    _NfsSecondaryTimeout_Type()
)
nfsSecondaryTimeout.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
nfsSecondaryRetryInterval = _NfsSecondaryRetryInterval_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 27, 17, 23),
    _NfsSecondaryRetryInterval_Type()
)
nfsSecondaryRetryInterval.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    nfsSecondaryRetryInterval.setStatus("mandatory")


class _NfsSecondaryEnableEncrypt_Type(Integer32):
    """Custom type nfsSecondaryEnableEncrypt based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            1
...
nfsSecondaryUser = _NfsSecondaryUser_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 27, 17, 25),
    _NfsSecondaryUser_Type()
)
nfsSecondaryUser.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
nfsSecondaryPassword = _NfsSecondaryPassword_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 27, 17, 26),
    _NfsSecondaryPassword_Type()
)
nfsSecondaryPassword.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
nfsMailEnable = _NfsMailEnable_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 27, 17, 27),
    _NfsMailEnable_Type()
)
nfsMailEnable.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
nfsMailTitle = _NfsMailTitle_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 27, 17, 28),
    _NfsMailTitle_Type()
)
nfsMailTitle.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    nfsMailTitle.setStatus("mandatory")
_NfsMailto_Type = DisplayString
_NfsMailto_Object = MibScalar
nfsMailto = _NfsMailto_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 27, 17, 29),
    _NfsMailto_Type()
)
nfsMailto.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
nfsTrapEnable = _NfsTrapEnable_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 27, 17, 30),
    _NfsTrapEnable_Type()
)
nfsTrapEnable.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
nfsTrapRcvIndex = _NfsTrapRcvIndex_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 27, 17, 32, 1, 11),
...
nfsTrapRcvIP = _NfsTrapRcvIP_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 27, 17, 32, 1, 12),
    _NfsTrapRcvIP_Type()
)
nfsTrapRcvIP.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
nfsTrapRcvComm = _NfsTrapRcvComm_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 27, 17, 32, 1, 13),
    _NfsTrapRcvComm_Type()
)
nfsTrapRcvComm.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
nfsTrapRcvVer = _NfsTrapRcvVer_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 27, 17, 32, 1, 14),
    _NfsTrapRcvVer_Type()
)
nfsTrapRcvVer.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
nfsTrapRcvUserName = _NfsTrapRcvUserName_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 27, 17, 32, 1, 15),
    _NfsTrapRcvUserName_Type()
)
nfsTrapRcvUserName.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
nfsTrapRcvSecurityLevel = _NfsTrapRcvSecurityLevel_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 27, 17, 32, 1, 16),
    _NfsTrapRcvSecurityLevel_Type()
)
nfsTrapRcvSecurityLevel.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
nfsTrapRcvAuthProto = _NfsTrapRcvAuthProto_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 27, 17, 32, 1, 17),
    _NfsTrapRcvAuthProto_Type()
)
nfsTrapRcvAuthProto.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
nfsTrapRcvAuthPasswd = _NfsTrapRcvAuthPasswd_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 27, 17, 32, 1, 18),
    _NfsTrapRcvAuthPasswd_Type()
)
nfsTrapRcvAuthPasswd.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
nfsTrapRcvPrivProto = _NfsTrapRcvPrivProto_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 27, 17, 32, 1, 19),
    _NfsTrapRcvPrivProto_Type()
)
nfsTrapRcvPrivProto.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
nfsTrapRcvPrivPasswd = _NfsTrapRcvPrivPasswd_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 27, 17, 32, 1, 20),
    _NfsTrapRcvPrivPasswd_Type()
)
nfsTrapRcvPrivPasswd.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
webLoginTimeout = _WebLoginTimeout_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 27, 18, 12),
...
webAuthMethod = _WebAuthMethod_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 27, 18, 13),
    _WebAuthMethod_Type()
)
...
webAuthPrimaryIPAddress = _WebAuthPrimaryIPAddress_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 27, 18, 14),
...
webAuthSecondaryIPAddress = _WebAuthSecondaryIPAddress_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 27, 18, 15),
...
webAuthSecret = _WebAuthSecret_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 27, 18, 16),
    _WebAuthSecret_Type()
)
...
webAuthTimeout = _WebAuthTimeout_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 27, 18, 17),
...
webAuthRetries = _WebAuthRetries_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 27, 18, 18),
...
webAuthKRBPrimaryRealm = _WebAuthKRBPrimaryRealm_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 27, 18, 21),
...
webAuthKRBSecondaryRealm = _WebAuthKRBSecondaryRealm_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 27, 18, 22),
...
webRootAccessEnable = _WebRootAccessEnable_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 27, 18, 23),
...
webSerialPortsCountsOnConnectionPage = _WebSerialPortsCountsOnConnectionPage_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 27, 18, 24),
...
webAppletOption = _WebAppletOption_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 27, 18, 25),
...
webHttpsPort = _WebHttpsPort_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 27, 18, 27),
    _WebHttpsPort_Type()
)
...
webBlockingTime = _WebBlockingTime_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 27, 18, 28),
...
webAuthAuthorService = _WebAuthAuthorService_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 27, 18, 29),
...
tcpOtherKeepAliveIdle = _TcpOtherKeepAliveIdle_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 27, 20, 11),
...
tcpOtherKeepAliveProbe = _TcpOtherKeepAliveProbe_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 27, 20, 12),
...
tcpOtherKeepAliveInterval = _TcpOtherKeepAliveInterval_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 27, 20, 13),
...
tcpOtherReverseDNSLookup = _TcpOtherReverseDNSLookup_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 27, 20, 14),
...
tcpOtherIPv4Forward = _TcpOtherIPv4Forward_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 27, 20, 15),
...
pppIpAddr = _PppIpAddr_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 27, 21, 12),
    _PppIpAddr_Type()
)
...
pppNumOfAddr = _PppNumOfAddr_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 27, 21, 13),
    _PppNumOfAddr_Type()
)
...
pppIncommingIndex = _PppIncommingIndex_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 27, 21, 14, 1, 11),
...
pppUsername = _PppUsername_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 27, 21, 14, 1, 12),
    _PppUsername_Type()
)
pppUsername.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
pppPassword = _PppPassword_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 27, 21, 14, 1, 13),
    _PppPassword_Type()
)
pppPassword.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
pppAuthentication = _PppAuthentication_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 27, 21, 14, 1, 14),
    _PppAuthentication_Type()
)
pppAuthentication.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
class _PppPeerOpt_Type(Integer32):
    ...
    namedValues = NamedValues(
        *(("automatically_assign_remote_IP-address_from_IP_address_pool", 0),
          ("allow_remote_peer_to_specify_remote_IP_address", 1),
          ("assign_static_remote_IP_address", 2))
    )
...
pppPeerOpt = _PppPeerOpt_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 27, 21, 14, 1, 15),
    _PppPeerOpt_Type()
)
pppPeerOpt.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
pppRemoteIP = _PppRemoteIP_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 27, 21, 14, 1, 16),
    _PppRemoteIP_Type()
)
pppRemoteIP.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
pppAllowClientAccess = _PppAllowClientAccess_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 27, 21, 14, 1, 17),
    _PppAllowClientAccess_Type()
)
pppAllowClientAccess.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
class _PppLocalPeerOpt_Type(Integer32):
    ...
    namedValues = NamedValues(
        *(("automatically_assign_local_ip_address_from_ip_address_pool", 0),
          ("assign_static_local_ip_address", 1))
    )
...
pppLocalPeerOpt = _PppLocalPeerOpt_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 27, 21, 14, 1, 18),
    _PppLocalPeerOpt_Type()
)
pppLocalPeerOpt.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
pppLocalIP = _PppLocalIP_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 27, 21, 14, 1, 19),
    _PppLocalIP_Type()
)
pppLocalIP.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
pppEnableIdleTimeout = _PppEnableIdleTimeout_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 27, 21, 14, 1, 20),
    _PppEnableIdleTimeout_Type()
)
pppEnableIdleTimeout.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
pppProccessArpRequest = _PppProccessArpRequest_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 27, 21, 15),
...
class _SecurityProfDiscoverEnable_Type(Integer32):
    """Custom type securityProfDiscoverEnable based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            0
...
class _SecurityProfTelnetEnable_Type(Integer32):
    """Custom type securityProfTelnetEnable based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            0
...
class _SecurityProfPasswordComplexity_Type(Integer32):
    """Custom type securityProfPasswordComplexity based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            1
...
class _SecurityProfSnmpv1v2cEnable_Type(Integer32):
    """Custom type securityProfSnmpv1v2cEnable based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            0
...
_SecurityProfSnmpv1v2cEnable_Type.__name__ = "Integer32"
_SecurityProfSnmpv1v2cEnable_Object = MibScalar
securityProfSnmpv1v2cEnable = _SecurityProfSnmpv1v2cEnable_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 31, 25),
    _SecurityProfSnmpv1v2cEnable_Type()
)
securityProfSnmpv1v2cEnable.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    securityProfSnmpv1v2cEnable.setStatus("mandatory")
_AutoBackup_ObjectIdentity = ObjectIdentity
autoBackup = _AutoBackup_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 32)
)
...
powerUnitStatusEntry = _PowerUnitStatusEntry_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 34, 1, 1)
)
powerUnitStatusEntry.setIndexNames(
    (0, "DIGI-PASSPORT-FIPS-MIB", "powerUnitStatusIndex"),
)
if mibBuilder.loadTexts:
...
powerUnitStatusIndex = _PowerUnitStatusIndex_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 34, 1, 1, 11),
...
powerUnitStatusModel = _PowerUnitStatusModel_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 34, 1, 1, 12),
...
powerUnitStatusAlarm = _PowerUnitStatusAlarm_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 34, 1, 1, 13),
...
powerUnitStatusTemperature = _PowerUnitStatusTemperature_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 34, 1, 1, 14),
...
powerUnitStatusCircuitBreaker = _PowerUnitStatusCircuitBreaker_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 34, 1, 1, 15),
...
powerUnitStatusRMSVoltage = _PowerUnitStatusRMSVoltage_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 34, 1, 1, 16),
...
powerUnitStatusRMSCurrent = _PowerUnitStatusRMSCurrent_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 34, 1, 1, 17),
...
powerUnitStatusRMSMax = _PowerUnitStatusRMSMax_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 34, 1, 1, 18),
...
powerUnitOutletEntry = _PowerUnitOutletEntry_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 34, 2, 1)
)
powerUnitOutletEntry.setIndexNames(
    (0, "DIGI-PASSPORT-FIPS-MIB", "powerUnitOutletIndex"),
)
if mibBuilder.loadTexts:
...
powerUnitIndex = _PowerUnitIndex_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 34, 2, 1, 11),
...
powerUnitOutletIndex = _PowerUnitOutletIndex_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 34, 2, 1, 12),
...
powerUnitOutletStatus = _PowerUnitOutletStatus_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 34, 2, 1, 13),
...
powerUnitOutletControl = _PowerUnitOutletControl_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 34, 2, 1, 14),
...
portAutomaticDetectionEntry = _PortAutomaticDetectionEntry_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 36, 1)
)
portAutomaticDetectionEntry.setIndexNames(
    (0, "DIGI-PASSPORT-FIPS-MIB", "portAutomaticDetectionIndex"),
)
if mibBuilder.loadTexts:
...
exportLocation = _ExportLocation_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 37, 11, 11),
...
exportEncrypted = _ExportEncrypted_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 37, 11, 12),
...
exportFilename = _ExportFilename_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 37, 11, 13),
...
exportExecute = _ExportExecute_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 37, 11, 14),
    _ExportExecute_Type()
)
...
importLocation = _ImportLocation_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 37, 12, 11),
...
importSelectAll = _ImportSelectAll_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 37, 12, 12),
...
importNetworkConf = _ImportNetworkConf_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 37, 12, 13),
...
importIncludeIpConf = _ImportIncludeIpConf_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 37, 12, 14),
...
importSerialPortConf = _ImportSerialPortConf_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 37, 12, 15),
...
importClusterConf = _ImportClusterConf_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 37, 12, 16),
...
importCustomMenuConf = _ImportCustomMenuConf_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 37, 12, 17),
...
importSystemUserConf = _ImportSystemUserConf_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 37, 12, 18),
...
importPowerControlConf = _ImportPowerControlConf_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 37, 12, 19),
...
importUsbConf = _ImportUsbConf_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 37, 12, 21),
    _ImportUsbConf_Type()
)
...
importSystemConf = _ImportSystemConf_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 37, 12, 22),
...
importEncrypted = _ImportEncrypted_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 37, 12, 24),
...
importFilename = _ImportFilename_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 37, 12, 25),
...
importExecute = _ImportExecute_Object(
    (1, 3, 6, 1, 4, 1, 332, 11, 10, 37, 12, 26),
    _ImportExecute_Type()
)
...
mibBuilder.exportSymbols(
    ...
    **{"DisplayString": DisplayString,
       ...
       "snmpColdStartEmails": snmpColdStartEmails,
       ...
       "securityProfSnmpv1v2cEnable": securityProfSnmpv1v2cEnable,
