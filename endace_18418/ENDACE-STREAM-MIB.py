...
# Notes
# -----
# ASN.1 source file:///Users/rob/MIBs/endace_18418/ENDACE-STREAM-MIB.mib
...
class _StreamDropModIndex_Type(ModuleIndex):
    """Custom type streamDropModIndex based on ModuleIndex"""
...
_StreamDropModIndex_Type.__name__ = "ModuleIndex"
...
if mibBuilder.loadTexts:
    streamInAdminStatus.setStatus("current")
...
if mibBuilder.loadTexts:
    streamInMemBytes.setStatus("current")
...
if mibBuilder.loadTexts:
    streamInSnapLen.setStatus("current")
...
if mibBuilder.loadTexts:
    streamInPackets.setStatus("current")
...
if mibBuilder.loadTexts:
    streamInOctets.setStatus("current")
...
if mibBuilder.loadTexts:
    streamInHCPackets.setStatus("current")
...
if mibBuilder.loadTexts:
    streamInHCOctets.setStatus("current")
