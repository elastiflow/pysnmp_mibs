# SNMP MIB module (MGF-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/rob/MIBs/esa_162/MGF-MIB.mib
...
elemConfigParamEntry = _ElemConfigParamEntry_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 5, 4, 1, 1, 1)
)
elemConfigParamEntry.setIndexNames(
    (0, "MGF-MIB", "elemConfigParamId"),
    (0, "MGF-MIB", "elemConfigParamInstance"),
)
if mibBuilder.loadTexts:
...
elemConfigParamInstance = _ElemConfigParamInstance_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 5, 4, 1, 1, 1, 1),
...
elemConfigParamId = _ElemConfigParamId_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 5, 4, 1, 1, 1, 2),
...
elemConfigParamValue = _ElemConfigParamValue_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 5, 4, 1, 1, 1, 4),
...
elemComponentInfoEntry = _ElemComponentInfoEntry_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 5, 4, 2, 1, 1)
)
elemComponentInfoEntry.setIndexNames(
    (0, "MGF-MIB", "elemComponentId"),
    (0, "MGF-MIB", "elemComponentInstance"),
)
if mibBuilder.loadTexts:
...
elemComponentInstance = _ElemComponentInstance_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 5, 4, 2, 1, 1, 1),
...
elemComponentId = _ElemComponentId_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 5, 4, 2, 1, 1, 2),
...
elemComponentState = _ElemComponentState_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 5, 4, 2, 1, 1, 3),
...
elemComponentLastStateChange = _ElemComponentLastStateChange_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 5, 4, 2, 1, 1, 4),
...
elemComponentMode = _ElemComponentMode_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 5, 4, 2, 1, 1, 5),
...
elemComponentLastModeChange = _ElemComponentLastModeChange_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 5, 4, 2, 1, 1, 6),
...
elemComponentVersion = _ElemComponentVersion_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 5, 4, 2, 1, 1, 7),
...
elemSWRUActiveEntry = _ElemSWRUActiveEntry_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 5, 4, 3, 1, 1)
)
elemSWRUActiveEntry.setIndexNames(
    (0, "MGF-MIB", "elemSWRUActiveId"),
    (0, "MGF-MIB", "elemSWRUActiveInstance"),
)
if mibBuilder.loadTexts:
...
elemSWRUActiveInstance = _ElemSWRUActiveInstance_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 5, 4, 3, 1, 1, 1),
...
elemSWRUActiveId = _ElemSWRUActiveId_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 5, 4, 3, 1, 1, 2),
...
elemSWRUActiveVersion = _ElemSWRUActiveVersion_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 5, 4, 3, 1, 1, 3),
...
elemSWRUActiveUpTime = _ElemSWRUActiveUpTime_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 5, 4, 3, 1, 1, 4),
...
elemSWRUActiveType = _ElemSWRUActiveType_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 5, 4, 3, 1, 1, 5),
...
elemSWRUActiveStatus = _ElemSWRUActiveStatus_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 5, 4, 3, 1, 1, 6),
...
elemSWRUAvailableEntry = _ElemSWRUAvailableEntry_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 5, 4, 4, 1, 1)
)
elemSWRUAvailableEntry.setIndexNames(
    (0, "MGF-MIB", "elemSWRUAvailableId"),
    (0, "MGF-MIB", "elemSWRUAvailableVersion"),
    (0, "MGF-MIB", "elemSWRUAvailableInstance"),
)
if mibBuilder.loadTexts:
...
elemSWRUAvailableId = _ElemSWRUAvailableId_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 5, 4, 4, 1, 1, 1),
...
elemSWRUAvailableVersion = _ElemSWRUAvailableVersion_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 5, 4, 4, 1, 1, 2),
...
elemSWRUAvailableInstance = _ElemSWRUAvailableInstance_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 5, 4, 4, 1, 1, 3),
...
elemSWRUAvailableType = _ElemSWRUAvailableType_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 5, 4, 4, 1, 1, 4),
...
elemConnectionsEntry = _ElemConnectionsEntry_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 5, 4, 5, 1)
)
elemConnectionsEntry.setIndexNames(
    (0, "MGF-MIB", "elemConnectionId"),
    (0, "MGF-MIB", "elemConnectionInstance"),
)
if mibBuilder.loadTexts:
...
elemHwPlatCpuNice = _ElemHwPlatCpuNice_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 5, 5, 1, 1, 10),
...
elemHwPlatCpuSystem = _ElemHwPlatCpuSystem_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 5, 5, 1, 1, 11),
...
elemHwPlatCpuIdle = _ElemHwPlatCpuIdle_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 5, 5, 1, 1, 12),
...
elemHwPlatMemSize = _ElemHwPlatMemSize_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 5, 5, 1, 1, 13),
...
elemHwPlatMemUsed = _ElemHwPlatMemUsed_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 5, 5, 1, 1, 14),
...
elemHwPlatMemAvail = _ElemHwPlatMemAvail_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 5, 5, 1, 1, 15),
...
elemHwPlatMemUsedPercent = _ElemHwPlatMemUsedPercent_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 5, 5, 1, 1, 16),
...
elemHwPlatMemAvailPercent = _ElemHwPlatMemAvailPercent_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 5, 5, 1, 1, 17),
...
elemHwPlatVirtualMemSize = _ElemHwPlatVirtualMemSize_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 5, 5, 1, 1, 18),
...
elemHwPlatVirtualMemUsed = _ElemHwPlatVirtualMemUsed_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 5, 5, 1, 1, 19),
...
elemHwPlatVirtualMemAvail = _ElemHwPlatVirtualMemAvail_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 5, 5, 1, 1, 20),
...
elemHwPlatVirtualMemUsedPercent = _ElemHwPlatVirtualMemUsedPercent_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 5, 5, 1, 1, 21),
...
elemHwPlatVirtualMemAvailPercent = _ElemHwPlatVirtualMemAvailPercent_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 5, 5, 1, 1, 22),
...
elemHwPlatSystemLoad1 = _ElemHwPlatSystemLoad1_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 5, 5, 1, 1, 23),
...
elemHwPlatSystemLoad2 = _ElemHwPlatSystemLoad2_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 5, 5, 1, 1, 24),
...
elemHwPlatSystemLoad3 = _ElemHwPlatSystemLoad3_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 5, 5, 1, 1, 25),
...
elemHwPlatOsIdentifier = _ElemHwPlatOsIdentifier_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 5, 5, 1, 1, 26),
...
elemHwDskPercentNode = _ElemHwDskPercentNode_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 5, 5, 2, 1, 10),
...
elemHwDskSysName = _ElemHwDskSysName_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 5, 5, 2, 1, 11),
...
elemHwDskFreePercent = _ElemHwDskFreePercent_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 5, 5, 2, 1, 12),
...
elemHwDskBlocks = _ElemHwDskBlocks_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 5, 5, 2, 1, 13),
...
elemHwDskBlocksSize = _ElemHwDskBlocksSize_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 5, 5, 2, 1, 14),
...
elemHwDskUsedBlocks = _ElemHwDskUsedBlocks_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 5, 5, 2, 1, 15),
...
elemHwDskFreeBlocks = _ElemHwDskFreeBlocks_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 5, 5, 2, 1, 16),
...
elemHwDskAllocationFailures = _ElemHwDskAllocationFailures_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 5, 5, 2, 1, 17),
...
elemHwDskErrorFlag = _ElemHwDskErrorFlag_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 5, 5, 2, 1, 100),
...
elemHwDskErrorMsg = _ElemHwDskErrorMsg_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 5, 5, 2, 1, 101),
...
elemActiveCmdSource = _ElemActiveCmdSource_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 5, 6, 1, 1, 1, 1),
...
elemActiveCmdType = _ElemActiveCmdType_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 5, 6, 1, 1, 1, 3),
...
elemActiveCmdId = _ElemActiveCmdId_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 5, 6, 1, 1, 1, 4),
...
elemActiveCmdState = _ElemActiveCmdState_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 5, 6, 1, 1, 1, 5),
...
elemActiveCmdChallenge = _ElemActiveCmdChallenge_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 5, 6, 1, 1, 1, 6),
...
elemActiveCmdProgressCounter = _ElemActiveCmdProgressCounter_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 5, 6, 1, 1, 1, 7),
...
elemActiveCmdInfo = _ElemActiveCmdInfo_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 5, 6, 1, 1, 1, 8),
...
elemActiveCmdRemoveFlag = _ElemActiveCmdRemoveFlag_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 5, 6, 1, 1, 1, 9),
...
elemActiveCmdInterruptFlag = _ElemActiveCmdInterruptFlag_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 5, 6, 1, 1, 1, 10),
...
elemCommandingTableEntry = _ElemCommandingTableEntry_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 5, 6, 2, 1, 1)
)
elemCommandingTableEntry.setIndexNames(
    (0, "MGF-MIB", "elemCommandSource"),
    (0, "MGF-MIB", "elemCommandType"),
)
if mibBuilder.loadTexts:
...
elemCommandSource = _ElemCommandSource_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 5, 6, 2, 1, 1, 1),
...
elemCommandType = _ElemCommandType_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 5, 6, 2, 1, 1, 2),
...
elemCommandId = _ElemCommandId_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 5, 6, 2, 1, 1, 3),
    _ElemCommandId_Type()
)
...
elemCommandChallenge = _ElemCommandChallenge_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 5, 6, 2, 1, 1, 4),
...
elemCommandParameterEntry = _ElemCommandParameterEntry_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 5, 6, 2, 2, 1)
)
elemCommandParameterEntry.setIndexNames(
    (0, "MGF-MIB", "elemCommandParameterSource"),
    (0, "MGF-MIB", "elemCommandParameterCmdId"),
    (0, "MGF-MIB", "elemCommandParameterIndex"),
)
if mibBuilder.loadTexts:
...
elemCommandParameterSource = _ElemCommandParameterSource_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 5, 6, 2, 2, 1, 1),
...
elemCommandParameterIndex = _ElemCommandParameterIndex_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 5, 6, 2, 2, 1, 2),
...
elemCommandParameterRowStatus = _ElemCommandParameterRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 5, 6, 2, 2, 1, 3),
...
elemCommandParameterKey = _ElemCommandParameterKey_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 5, 6, 2, 2, 1, 4),
...
elemCommandParameterValue = _ElemCommandParameterValue_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 5, 6, 2, 2, 1, 5),
...
elemCommandParameterCmdId = _ElemCommandParameterCmdId_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 5, 6, 2, 2, 1, 6),
...
elemAlertsTransient = _ElemAlertsTransient_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 5, 7, 2, 1, 10),
...
elemAlertsArguments = _ElemAlertsArguments_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 5, 7, 2, 1, 11),
...
elemBITResultsEntry = _ElemBITResultsEntry_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 5, 8, 1, 1)
)
elemBITResultsEntry.setIndexNames(
    (0, "MGF-MIB", "elemBITResultsIndex"),
)
if mibBuilder.loadTexts:
...
elemSpecific = _ElemSpecific_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 5, 98)
)
_ElemTraps_ObjectIdentity = ObjectIdentity
elemTraps = _ElemTraps_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 5, 99)
)
_ElementMIBConformance_ObjectIdentity = ObjectIdentity
elementMIBConformance = _ElementMIBConformance_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 5, 100)
)
_ElementMIBCompliances_ObjectIdentity = ObjectIdentity
elementMIBCompliances = _ElementMIBCompliances_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 5, 100, 1)
)
_ElementMIBGroups_ObjectIdentity = ObjectIdentity
elementMIBGroups = _ElementMIBGroups_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 5, 100, 2)
)

# Managed Objects groups

elementMIBBasicGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 5, 100, 2, 1)
)
elementMIBBasicGroup.setObjects(
      *(("MGF-MIB", "elemMibVersion"),
        ("MGF-MIB", "elemMibVersionSpecific"),
        ("MGF-MIB", "elemStatusState"),
        ("MGF-MIB", "elemStatusMode"),
        ("MGF-MIB", "elemStatusIntegrity"),
        ("MGF-MIB", "elemStatusLastIntegrityCheck"),
        ("MGF-MIB", "elemStatusLastStateChange"),
        ("MGF-MIB", "elemStatusLastModeChange"),
        ("MGF-MIB", "elemStatusIntegrityLowLevel"),
        ("MGF-MIB", "elemStatusLastIntegrityLowLevelCheck"),
        ("MGF-MIB", "elemInfoSite"),
        ("MGF-MIB", "elemInfoInstance"),
        ("MGF-MIB", "elemInfoName"),
        ("MGF-MIB", "elemHwPlatHrSystemUptime"),
        ("MGF-MIB", "elemHwPlatHrSystemDate"),
        ("MGF-MIB", "elemHwPlatHrSystemNumUsers"),
        ("MGF-MIB", "elemHwPlatHrSystemProcesses"),
        ("MGF-MIB", "elemHwPlatSysName"),
        ("MGF-MIB", "elemHwPlatSysContact"),
        ("MGF-MIB", "elemHwPlatHrLastReachable"),
        ("MGF-MIB", "elemHwPlatCpuUser"),
        ("MGF-MIB", "elemHwPlatCpuNice"),
        ("MGF-MIB", "elemHwPlatCpuSystem"),
        ("MGF-MIB", "elemHwPlatCpuIdle"),
        ("MGF-MIB", "elemHwPlatMemSize"),
        ("MGF-MIB", "elemHwPlatMemUsed"),
        ("MGF-MIB", "elemHwPlatMemAvail"),
        ("MGF-MIB", "elemHwPlatMemUsedPercent"),
        ("MGF-MIB", "elemHwPlatMemAvailPercent"),
        ("MGF-MIB", "elemHwPlatVirtualMemSize"),
        ("MGF-MIB", "elemHwPlatVirtualMemUsed"),
        ("MGF-MIB", "elemHwPlatVirtualMemAvail"),
        ("MGF-MIB", "elemHwPlatVirtualMemUsedPercent"),
        ("MGF-MIB", "elemHwPlatVirtualMemAvailPercent"),
        ("MGF-MIB", "elemHwPlatSystemLoad1"),
        ("MGF-MIB", "elemHwPlatSystemLoad2"),
        ("MGF-MIB", "elemHwPlatSystemLoad3"),
        ("MGF-MIB", "elemHwPlatOsIdentifier"),
        ("MGF-MIB", "elemConfigParamValue"),
        ("MGF-MIB", "elemComponentState"),
        ("MGF-MIB", "elemComponentMode"),
        ("MGF-MIB", "elemSWRUActiveVersion"),
        ("MGF-MIB", "elemSWRUActiveUpTime"),
        ("MGF-MIB", "elemSWRUActiveType"),
        ("MGF-MIB", "elemSWRUActiveStatus"),
        ("MGF-MIB", "elemSWRUAvailableType"),
        ("MGF-MIB", "elemConnectionState"),
        ("MGF-MIB", "elemConnectionMode"),
        ("MGF-MIB", "elemConnectionUpTime"),
        ("MGF-MIB", "elemConnectionDataRate"),
        ("MGF-MIB", "elemHwDskPath"),
        ("MGF-MIB", "elemHwDskDevice"),
        ("MGF-MIB", "elemHwDskMinPercent"),
        ("MGF-MIB", "elemHwDskTotal"),
        ("MGF-MIB", "elemHwDskAvail"),
        ("MGF-MIB", "elemHwDskUsed"),
        ("MGF-MIB", "elemHwDskPercent"),
        ("MGF-MIB", "elemHwDskPercentNode"),
        ("MGF-MIB", "elemHwDskSysName"),
        ("MGF-MIB", "elemHwDskFreePercent"),
        ("MGF-MIB", "elemHwDskBlocks"),
        ("MGF-MIB", "elemHwDskBlocksSize"),
        ("MGF-MIB", "elemHwDskUsedBlocks"),
        ("MGF-MIB", "elemHwDskFreeBlocks"),
        ("MGF-MIB", "elemHwDskAllocationFailures"),
        ("MGF-MIB", "elemHwDskErrorFlag"),
        ("MGF-MIB", "elemHwDskErrorMsg"),
        ("MGF-MIB", "elemActiveCmdState"),
        ("MGF-MIB", "elemActiveCmdChallenge"),
        ("MGF-MIB", "elemActiveCmdProgressCounter"),
        ("MGF-MIB", "elemActiveCmdInfo"),
        ("MGF-MIB", "elemActiveCmdRemoveFlag"),
        ("MGF-MIB", "elemActiveCmdInterruptFlag"),
        ("MGF-MIB", "elemCommandId"),
        ("MGF-MIB", "elemCommandChallenge"),
        ("MGF-MIB", "elemCommandParameterRowStatus"),
        ("MGF-MIB", "elemCommandParameterKey"),
        ("MGF-MIB", "elemCommandParameterValue"),
        ("MGF-MIB", "elemAlertsLastAdded"),
        ("MGF-MIB", "elemAlertsLastNtRemoved"),
        ("MGF-MIB", "elemAlertsUnitIdentifier"),
        ("MGF-MIB", "elemAlertsLocalisation"),
        ("MGF-MIB", "elemAlertsCriticality"),
        ("MGF-MIB", "elemAlertsTimestamp"),
        ("MGF-MIB", "elemAlertsIdentifier"),
        ("MGF-MIB", "elemAlertsTransient"),
        ("MGF-MIB", "elemAlertsArguments"),
        ("MGF-MIB", "elemComponentLastStateChange"),
        ("MGF-MIB", "elemComponentLastModeChange"),
        ("MGF-MIB", "elemComponentVersion"),
        ("MGF-MIB", "elemDoorsRackId"),
        ("MGF-MIB", "elemDoorsFrontDoorStatus"),
        ("MGF-MIB", "elemDoorsFrontDoorLastChange"),
        ("MGF-MIB", "elemDoorsBackDoorStatus"),
        ("MGF-MIB", "elemDoorsBackDoorLastChange"))
)
if mibBuilder.loadTexts:
    elementMIBBasicGroup.setStatus("current")

elementBITTestGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 5, 100, 2, 3)
)
elementBITTestGroup.setObjects(
      *(("MGF-MIB", "elemBITResultsId"),
        ("MGF-MIB", "elemBITResultsType"),
        ("MGF-MIB", "elemBITResultsLocation"),
        ("MGF-MIB", "elemBITResultsResult"),
        ("MGF-MIB", "elemBITResultsResultType"))
)
if mibBuilder.loadTexts:
...
elementMIBBasicNotificationsGroup = NotificationGroup(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 5, 100, 2, 4)
)
elementMIBBasicNotificationsGroup.setObjects(
      *(("MGF-MIB", "elemCommandChange"),
        ("MGF-MIB", "elemAlert"))
)
if mibBuilder.loadTexts:
...
elementMIBBasicCompliance = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 5, 100, 1, 1)
)
elementMIBBasicCompliance.setObjects(
      *(("MGF-MIB", "elementMIBBasicGroup"),
        ("MGF-MIB", "elementMIBBasicNotificationsGroup"),
        ("MGF-MIB", "elementBITTestGroup"))
)
if mibBuilder.loadTexts:
