# SNMP MIB module (MSF-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/rob/MIBs/esa_162/MSF-MIB.mib
...
class RackDoorStatusType(TextualConvention, Integer32):
    status = "current"
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
...
elemConfigParamEntry = _ElemConfigParamEntry_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 7, 4, 1, 1, 1)
)
elemConfigParamEntry.setIndexNames(
    (0, "MSF-MIB", "elemConfigParamId"),
    (0, "MSF-MIB", "elemConfigParamInstance"),
)
if mibBuilder.loadTexts:
...
elemConfigParamInstance = _ElemConfigParamInstance_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 7, 4, 1, 1, 1, 1),
...
elemConfigParamId = _ElemConfigParamId_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 7, 4, 1, 1, 1, 2),
...
elemConfigParamValue = _ElemConfigParamValue_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 7, 4, 1, 1, 1, 4),
...
elemComponentInfoEntry = _ElemComponentInfoEntry_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 7, 4, 2, 1, 1)
)
elemComponentInfoEntry.setIndexNames(
    (0, "MSF-MIB", "elemComponentId"),
    (0, "MSF-MIB", "elemComponentInstance"),
)
if mibBuilder.loadTexts:
...
elemComponentInstance = _ElemComponentInstance_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 7, 4, 2, 1, 1, 1),
...
elemComponentId = _ElemComponentId_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 7, 4, 2, 1, 1, 2),
...
elemComponentState = _ElemComponentState_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 7, 4, 2, 1, 1, 3),
...
elemComponentLastStateChange = _ElemComponentLastStateChange_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 7, 4, 2, 1, 1, 4),
...
elemComponentMode = _ElemComponentMode_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 7, 4, 2, 1, 1, 5),
...
elemComponentLastModeChange = _ElemComponentLastModeChange_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 7, 4, 2, 1, 1, 6),
...
elemComponentVersion = _ElemComponentVersion_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 7, 4, 2, 1, 1, 7),
...
elemSWRUActiveEntry = _ElemSWRUActiveEntry_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 7, 4, 3, 1, 1)
)
elemSWRUActiveEntry.setIndexNames(
    (0, "MSF-MIB", "elemSWRUActiveId"),
    (0, "MSF-MIB", "elemSWRUActiveInstance"),
)
if mibBuilder.loadTexts:
...
elemSWRUActiveInstance = _ElemSWRUActiveInstance_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 7, 4, 3, 1, 1, 1),
...
elemSWRUActiveId = _ElemSWRUActiveId_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 7, 4, 3, 1, 1, 2),
...
elemSWRUActiveVersion = _ElemSWRUActiveVersion_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 7, 4, 3, 1, 1, 3),
...
elemSWRUActiveUpTime = _ElemSWRUActiveUpTime_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 7, 4, 3, 1, 1, 4),
...
elemSWRUActiveType = _ElemSWRUActiveType_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 7, 4, 3, 1, 1, 5),
...
elemSWRUActiveStatus = _ElemSWRUActiveStatus_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 7, 4, 3, 1, 1, 6),
...
elemSWRUAvailableEntry = _ElemSWRUAvailableEntry_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 7, 4, 4, 1, 1)
)
elemSWRUAvailableEntry.setIndexNames(
    (0, "MSF-MIB", "elemSWRUAvailableId"),
    (0, "MSF-MIB", "elemSWRUAvailableVersion"),
    (0, "MSF-MIB", "elemSWRUAvailableInstance"),
)
if mibBuilder.loadTexts:
...
elemSWRUAvailableId = _ElemSWRUAvailableId_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 7, 4, 4, 1, 1, 1),
...
elemSWRUAvailableVersion = _ElemSWRUAvailableVersion_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 7, 4, 4, 1, 1, 2),
...
elemSWRUAvailableInstance = _ElemSWRUAvailableInstance_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 7, 4, 4, 1, 1, 3),
...
elemSWRUAvailableType = _ElemSWRUAvailableType_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 7, 4, 4, 1, 1, 4),
...
elemConnectionsEntry = _ElemConnectionsEntry_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 7, 4, 5, 1)
)
elemConnectionsEntry.setIndexNames(
    (0, "MSF-MIB", "elemConnectionId"),
    (0, "MSF-MIB", "elemConnectionInstance"),
)
if mibBuilder.loadTexts:
...
elemHwPlatCpuNice = _ElemHwPlatCpuNice_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 7, 5, 1, 1, 10),
...
elemHwPlatCpuSystem = _ElemHwPlatCpuSystem_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 7, 5, 1, 1, 11),
...
elemHwPlatCpuIdle = _ElemHwPlatCpuIdle_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 7, 5, 1, 1, 12),
...
elemHwPlatMemSize = _ElemHwPlatMemSize_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 7, 5, 1, 1, 13),
...
elemHwPlatMemUsed = _ElemHwPlatMemUsed_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 7, 5, 1, 1, 14),
...
elemHwPlatMemAvail = _ElemHwPlatMemAvail_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 7, 5, 1, 1, 15),
...
elemHwPlatMemUsedPercent = _ElemHwPlatMemUsedPercent_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 7, 5, 1, 1, 16),
...
elemHwPlatMemAvailPercent = _ElemHwPlatMemAvailPercent_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 7, 5, 1, 1, 17),
...
elemHwPlatVirtualMemSize = _ElemHwPlatVirtualMemSize_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 7, 5, 1, 1, 18),
...
elemHwPlatVirtualMemUsed = _ElemHwPlatVirtualMemUsed_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 7, 5, 1, 1, 19),
...
elemHwPlatVirtualMemAvail = _ElemHwPlatVirtualMemAvail_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 7, 5, 1, 1, 20),
...
elemHwPlatVirtualMemUsedPercent = _ElemHwPlatVirtualMemUsedPercent_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 7, 5, 1, 1, 21),
...
elemHwPlatVirtualMemAvailPercent = _ElemHwPlatVirtualMemAvailPercent_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 7, 5, 1, 1, 22),
...
elemHwPlatSystemLoad1 = _ElemHwPlatSystemLoad1_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 7, 5, 1, 1, 23),
...
elemHwPlatSystemLoad2 = _ElemHwPlatSystemLoad2_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 7, 5, 1, 1, 24),
...
elemHwPlatSystemLoad3 = _ElemHwPlatSystemLoad3_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 7, 5, 1, 1, 25),
...
elemHwPlatOsIdentifier = _ElemHwPlatOsIdentifier_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 7, 5, 1, 1, 26),
...
elemHwDskPercentNode = _ElemHwDskPercentNode_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 7, 5, 2, 1, 10),
...
elemHwDskSysName = _ElemHwDskSysName_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 7, 5, 2, 1, 11),
...
elemHwDskFreePercent = _ElemHwDskFreePercent_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 7, 5, 2, 1, 12),
...
elemHwDskBlocks = _ElemHwDskBlocks_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 7, 5, 2, 1, 13),
...
elemHwDskBlocksSize = _ElemHwDskBlocksSize_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 7, 5, 2, 1, 14),
...
elemHwDskUsedBlocks = _ElemHwDskUsedBlocks_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 7, 5, 2, 1, 15),
...
elemHwDskFreeBlocks = _ElemHwDskFreeBlocks_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 7, 5, 2, 1, 16),
...
elemHwDskAllocationFailures = _ElemHwDskAllocationFailures_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 7, 5, 2, 1, 17),
...
elemHwDskErrorFlag = _ElemHwDskErrorFlag_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 7, 5, 2, 1, 100),
...
elemHwDskErrorMsg = _ElemHwDskErrorMsg_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 7, 5, 2, 1, 101),
    _ElemHwDskErrorMsg_Type()
)
elemHwDskErrorMsg.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    elemHwDskErrorMsg.setStatus("current")
_ElemDoorsTable_Object = MibTable
elemDoorsTable = _ElemDoorsTable_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 7, 5, 3)
)
if mibBuilder.loadTexts:
    elemDoorsTable.setStatus("current")
_ElemDoorsEntry_Object = MibTableRow
elemDoorsEntry = _ElemDoorsEntry_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 7, 5, 3, 1)
)
elemDoorsEntry.setIndexNames(
    (0, "MSF-MIB", "elemDoorsIndex"),
)
if mibBuilder.loadTexts:
    elemDoorsEntry.setStatus("current")


class _ElemDoorsIndex_Type(Integer32):
    """Custom type elemDoorsIndex based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_ElemDoorsIndex_Type.__name__ = "Integer32"
_ElemDoorsIndex_Object = MibTableColumn
elemDoorsIndex = _ElemDoorsIndex_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 7, 5, 3, 1, 1),
    _ElemDoorsIndex_Type()
)
elemDoorsIndex.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    elemDoorsIndex.setStatus("current")


class _ElemDoorsRackId_Type(DisplayString):
    """Custom type elemDoorsRackId based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_ElemDoorsRackId_Type.__name__ = "DisplayString"
_ElemDoorsRackId_Object = MibTableColumn
elemDoorsRackId = _ElemDoorsRackId_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 7, 5, 3, 1, 2),
    _ElemDoorsRackId_Type()
)
elemDoorsRackId.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    elemDoorsRackId.setStatus("current")
_ElemDoorsFrontDoorStatus_Type = RackDoorStatusType
_ElemDoorsFrontDoorStatus_Object = MibTableColumn
elemDoorsFrontDoorStatus = _ElemDoorsFrontDoorStatus_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 7, 5, 3, 1, 3),
    _ElemDoorsFrontDoorStatus_Type()
)
elemDoorsFrontDoorStatus.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    elemDoorsFrontDoorStatus.setStatus("current")
_ElemDoorsFrontDoorLastChange_Type = DateAndTime
_ElemDoorsFrontDoorLastChange_Object = MibTableColumn
elemDoorsFrontDoorLastChange = _ElemDoorsFrontDoorLastChange_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 7, 5, 3, 1, 4),
    _ElemDoorsFrontDoorLastChange_Type()
)
elemDoorsFrontDoorLastChange.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    elemDoorsFrontDoorLastChange.setStatus("current")
_ElemDoorsBackDoorStatus_Type = RackDoorStatusType
_ElemDoorsBackDoorStatus_Object = MibTableColumn
elemDoorsBackDoorStatus = _ElemDoorsBackDoorStatus_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 7, 5, 3, 1, 5),
    _ElemDoorsBackDoorStatus_Type()
)
elemDoorsBackDoorStatus.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    elemDoorsBackDoorStatus.setStatus("current")
_ElemDoorsBackDoorLastChange_Type = DateAndTime
_ElemDoorsBackDoorLastChange_Object = MibTableColumn
elemDoorsBackDoorLastChange = _ElemDoorsBackDoorLastChange_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 7, 5, 3, 1, 6),
    _ElemDoorsBackDoorLastChange_Type()
)
elemDoorsBackDoorLastChange.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    elemDoorsBackDoorLastChange.setStatus("current")
_ElemCommands_ObjectIdentity = ObjectIdentity
elemCommands = _ElemCommands_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 7, 6)
)
_ElemActiveCommands_ObjectIdentity = ObjectIdentity
elemActiveCommands = _ElemActiveCommands_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 7, 6, 1)
)
_ElemActiveCmdTable_Object = MibTable
elemActiveCmdTable = _ElemActiveCmdTable_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 7, 6, 1, 1)
)
if mibBuilder.loadTexts:
    elemActiveCmdTable.setStatus("current")
_ElemActiveCmdEntry_Object = MibTableRow
elemActiveCmdEntry = _ElemActiveCmdEntry_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 7, 6, 1, 1, 1)
)
elemActiveCmdEntry.setIndexNames(
    (0, "MSF-MIB", "elemActiveCmdSource"),
    (0, "MSF-MIB", "elemActiveCmdType"),
    (0, "MSF-MIB", "elemActiveCmdId"),
)
if mibBuilder.loadTexts:
...
elemActiveCmdSource = _ElemActiveCmdSource_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 7, 6, 1, 1, 1, 1),
...
elemActiveCmdType = _ElemActiveCmdType_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 7, 6, 1, 1, 1, 3),
...
elemActiveCmdId = _ElemActiveCmdId_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 7, 6, 1, 1, 1, 4),
...
elemActiveCmdState = _ElemActiveCmdState_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 7, 6, 1, 1, 1, 5),
...
elemActiveCmdChallenge = _ElemActiveCmdChallenge_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 7, 6, 1, 1, 1, 6),
...
elemActiveCmdProgressCounter = _ElemActiveCmdProgressCounter_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 7, 6, 1, 1, 1, 7),
...
elemActiveCmdInfo = _ElemActiveCmdInfo_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 7, 6, 1, 1, 1, 8),
...
elemActiveCmdRemoveFlag = _ElemActiveCmdRemoveFlag_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 7, 6, 1, 1, 1, 9),
...
elemActiveCmdInterruptFlag = _ElemActiveCmdInterruptFlag_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 7, 6, 1, 1, 1, 10),
...
elemCommandingTableEntry = _ElemCommandingTableEntry_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 7, 6, 2, 1, 1)
)
elemCommandingTableEntry.setIndexNames(
    (0, "MSF-MIB", "elemCommandSource"),
    (0, "MSF-MIB", "elemCommandType"),
)
if mibBuilder.loadTexts:
...
elemCommandSource = _ElemCommandSource_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 7, 6, 2, 1, 1, 1),
...
elemCommandType = _ElemCommandType_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 7, 6, 2, 1, 1, 2),
...
elemCommandId = _ElemCommandId_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 7, 6, 2, 1, 1, 3),
    _ElemCommandId_Type()
)
...
elemCommandChallenge = _ElemCommandChallenge_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 7, 6, 2, 1, 1, 4),
...
elemCommandParameterEntry = _ElemCommandParameterEntry_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 7, 6, 2, 2, 1)
)
elemCommandParameterEntry.setIndexNames(
    (0, "MSF-MIB", "elemCommandParameterSource"),
    (0, "MSF-MIB", "elemCommandParameterCmdId"),
    (0, "MSF-MIB", "elemCommandParameterIndex"),
)
if mibBuilder.loadTexts:
...
elemCommandParameterSource = _ElemCommandParameterSource_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 7, 6, 2, 2, 1, 1),
...
elemCommandParameterIndex = _ElemCommandParameterIndex_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 7, 6, 2, 2, 1, 2),
...
elemCommandParameterRowStatus = _ElemCommandParameterRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 7, 6, 2, 2, 1, 3),
...
elemCommandParameterKey = _ElemCommandParameterKey_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 7, 6, 2, 2, 1, 4),
...
elemCommandParameterValue = _ElemCommandParameterValue_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 7, 6, 2, 2, 1, 5),
...
elemCommandParameterCmdId = _ElemCommandParameterCmdId_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 7, 6, 2, 2, 1, 6),
...
elemAlertsTransient = _ElemAlertsTransient_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 7, 7, 2, 1, 10),
...
elemAlertsArguments = _ElemAlertsArguments_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 7, 7, 2, 1, 11),
...
elemBITResultsEntry = _ElemBITResultsEntry_Object(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 7, 8, 1, 1)
)
elemBITResultsEntry.setIndexNames(
    (0, "MSF-MIB", "elemBITResultsIndex"),
)
if mibBuilder.loadTexts:
...
elemSpecific = _ElemSpecific_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 7, 98)
)
_ElemTraps_ObjectIdentity = ObjectIdentity
elemTraps = _ElemTraps_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 7, 99)
)
_ElementMIBConformance_ObjectIdentity = ObjectIdentity
elementMIBConformance = _ElementMIBConformance_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 7, 100)
)
_ElementMIBCompliances_ObjectIdentity = ObjectIdentity
elementMIBCompliances = _ElementMIBCompliances_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 7, 100, 1)
)
_ElementMIBGroups_ObjectIdentity = ObjectIdentity
elementMIBGroups = _ElementMIBGroups_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 7, 100, 2)
)

# Managed Objects groups

elementMIBBasicGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 7, 100, 2, 1)
)
elementMIBBasicGroup.setObjects(
      *(("MSF-MIB", "elemMibVersion"),
        ("MSF-MIB", "elemMibVersionSpecific"),
        ("MSF-MIB", "elemStatusState"),
        ("MSF-MIB", "elemStatusMode"),
        ("MSF-MIB", "elemStatusIntegrity"),
        ("MSF-MIB", "elemStatusLastIntegrityCheck"),
        ("MSF-MIB", "elemStatusLastStateChange"),
        ("MSF-MIB", "elemStatusLastModeChange"),
        ("MSF-MIB", "elemStatusIntegrityLowLevel"),
        ("MSF-MIB", "elemStatusLastIntegrityLowLevelCheck"),
        ("MSF-MIB", "elemInfoSite"),
        ("MSF-MIB", "elemInfoInstance"),
        ("MSF-MIB", "elemInfoName"),
        ("MSF-MIB", "elemHwPlatHrSystemUptime"),
        ("MSF-MIB", "elemHwPlatHrSystemDate"),
        ("MSF-MIB", "elemHwPlatHrSystemNumUsers"),
        ("MSF-MIB", "elemHwPlatHrSystemProcesses"),
        ("MSF-MIB", "elemHwPlatSysName"),
        ("MSF-MIB", "elemHwPlatSysContact"),
        ("MSF-MIB", "elemHwPlatHrLastReachable"),
        ("MSF-MIB", "elemHwPlatCpuUser"),
        ("MSF-MIB", "elemHwPlatCpuNice"),
        ("MSF-MIB", "elemHwPlatCpuSystem"),
        ("MSF-MIB", "elemHwPlatCpuIdle"),
        ("MSF-MIB", "elemHwPlatMemSize"),
        ("MSF-MIB", "elemHwPlatMemUsed"),
        ("MSF-MIB", "elemHwPlatMemAvail"),
        ("MSF-MIB", "elemHwPlatMemUsedPercent"),
        ("MSF-MIB", "elemHwPlatMemAvailPercent"),
        ("MSF-MIB", "elemHwPlatVirtualMemSize"),
        ("MSF-MIB", "elemHwPlatVirtualMemUsed"),
        ("MSF-MIB", "elemHwPlatVirtualMemAvail"),
        ("MSF-MIB", "elemHwPlatVirtualMemUsedPercent"),
        ("MSF-MIB", "elemHwPlatVirtualMemAvailPercent"),
        ("MSF-MIB", "elemHwPlatSystemLoad1"),
        ("MSF-MIB", "elemHwPlatSystemLoad2"),
        ("MSF-MIB", "elemHwPlatSystemLoad3"),
        ("MSF-MIB", "elemHwPlatOsIdentifier"),
        ("MSF-MIB", "elemConfigParamValue"),
        ("MSF-MIB", "elemComponentState"),
        ("MSF-MIB", "elemComponentMode"),
        ("MSF-MIB", "elemSWRUActiveVersion"),
        ("MSF-MIB", "elemSWRUActiveUpTime"),
        ("MSF-MIB", "elemSWRUActiveType"),
        ("MSF-MIB", "elemSWRUActiveStatus"),
        ("MSF-MIB", "elemSWRUAvailableType"),
        ("MSF-MIB", "elemConnectionState"),
        ("MSF-MIB", "elemConnectionMode"),
        ("MSF-MIB", "elemConnectionUpTime"),
        ("MSF-MIB", "elemConnectionDataRate"),
        ("MSF-MIB", "elemHwDskPath"),
        ("MSF-MIB", "elemHwDskDevice"),
        ("MSF-MIB", "elemHwDskMinPercent"),
        ("MSF-MIB", "elemHwDskTotal"),
        ("MSF-MIB", "elemHwDskAvail"),
        ("MSF-MIB", "elemHwDskUsed"),
        ("MSF-MIB", "elemHwDskPercent"),
        ("MSF-MIB", "elemHwDskPercentNode"),
        ("MSF-MIB", "elemHwDskSysName"),
        ("MSF-MIB", "elemHwDskFreePercent"),
        ("MSF-MIB", "elemHwDskBlocks"),
        ("MSF-MIB", "elemHwDskBlocksSize"),
        ("MSF-MIB", "elemHwDskUsedBlocks"),
        ("MSF-MIB", "elemHwDskFreeBlocks"),
        ("MSF-MIB", "elemHwDskAllocationFailures"),
        ("MSF-MIB", "elemHwDskErrorFlag"),
        ("MSF-MIB", "elemHwDskErrorMsg"),
        ("MSF-MIB", "elemActiveCmdState"),
        ("MSF-MIB", "elemActiveCmdChallenge"),
        ("MSF-MIB", "elemActiveCmdProgressCounter"),
        ("MSF-MIB", "elemActiveCmdInfo"),
        ("MSF-MIB", "elemActiveCmdRemoveFlag"),
        ("MSF-MIB", "elemActiveCmdInterruptFlag"),
        ("MSF-MIB", "elemCommandId"),
        ("MSF-MIB", "elemCommandChallenge"),
        ("MSF-MIB", "elemCommandParameterRowStatus"),
        ("MSF-MIB", "elemCommandParameterKey"),
        ("MSF-MIB", "elemCommandParameterValue"),
        ("MSF-MIB", "elemAlertsLastAdded"),
        ("MSF-MIB", "elemAlertsLastNtRemoved"),
        ("MSF-MIB", "elemAlertsUnitIdentifier"),
        ("MSF-MIB", "elemAlertsLocalisation"),
        ("MSF-MIB", "elemAlertsCriticality"),
        ("MSF-MIB", "elemAlertsTimestamp"),
        ("MSF-MIB", "elemAlertsIdentifier"),
        ("MSF-MIB", "elemAlertsTransient"),
        ("MSF-MIB", "elemAlertsArguments"),
        ("MSF-MIB", "elemComponentLastStateChange"),
        ("MSF-MIB", "elemComponentLastModeChange"),
        ("MSF-MIB", "elemComponentVersion"),
        ("MSF-MIB", "elemDoorsRackId"),
        ("MSF-MIB", "elemDoorsFrontDoorStatus"),
        ("MSF-MIB", "elemDoorsFrontDoorLastChange"),
        ("MSF-MIB", "elemDoorsBackDoorStatus"),
        ("MSF-MIB", "elemDoorsBackDoorLastChange"))
)
if mibBuilder.loadTexts:
...
elementBITTestGroup.setObjects(
      *(("MSF-MIB", "elemBITResultsId"),
        ("MSF-MIB", "elemBITResultsType"),
        ("MSF-MIB", "elemBITResultsLocation"),
        ("MSF-MIB", "elemBITResultsResult"),
        ("MSF-MIB", "elemBITResultsResultType"))
)
if mibBuilder.loadTexts:
...
elementMIBBasicNotificationsGroup = NotificationGroup(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 7, 100, 2, 4)
)
elementMIBBasicNotificationsGroup.setObjects(
      *(("MSF-MIB", "elemCommandChange"),
        ("MSF-MIB", "elemAlert"))
)
if mibBuilder.loadTexts:
...
elementMIBBasicCompliance = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 162, 1, 1, 7, 100, 1, 1)
)
elementMIBBasicCompliance.setObjects(
      *(("MSF-MIB", "elementMIBBasicGroup"),
        ("MSF-MIB", "elementMIBBasicNotificationsGroup"),
        ("MSF-MIB", "elementBITTestGroup"))
)
if mibBuilder.loadTexts:
...
mibBuilder.exportSymbols(
    ...
    **{"CommandId": CommandId,
       ...
       "RackDoorStatusType": RackDoorStatusType,
       "msf": msf,
       ...
       "elemDoorsTable": elemDoorsTable,
       "elemDoorsEntry": elemDoorsEntry,
       "elemDoorsIndex": elemDoorsIndex,
       "elemDoorsRackId": elemDoorsRackId,
       "elemDoorsFrontDoorStatus": elemDoorsFrontDoorStatus,
       "elemDoorsFrontDoorLastChange": elemDoorsFrontDoorLastChange,
       "elemDoorsBackDoorStatus": elemDoorsBackDoorStatus,
       "elemDoorsBackDoorLastChange": elemDoorsBackDoorLastChange,
