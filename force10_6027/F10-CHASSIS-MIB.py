...
# Notes
# -----
# ASN.1 source file:///Users/rob/MIBs/force10_6027/F10-CHASSIS-MIB.mib
...
chSysCardPiecePartID = _ChSysCardPiecePartID_Object(
    (1, 3, 6, 1, 4, 1, 6027, 3, 1, 1, 2, 3, 1, 25),
...
chSysCardPPIDRevision = _ChSysCardPPIDRevision_Object(
    (1, 3, 6, 1, 4, 1, 6027, 3, 1, 1, 2, 3, 1, 26),
...
chSysCardServiceTag = _ChSysCardServiceTag_Object(
    (1, 3, 6, 1, 4, 1, 6027, 3, 1, 1, 2, 3, 1, 27),
...
chSysCardExpressServiceCode = _ChSysCardExpressServiceCode_Object(
    (1, 3, 6, 1, 4, 1, 6027, 3, 1, 1, 2, 3, 1, 28),
...
class _ChSysSfmPiecePartID_Type(DisplayString):
    """Custom type chSysSfmPiecePartID based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 24),
    )
...
_ChSysSfmPiecePartID_Type.__name__ = "DisplayString"
_ChSysSfmPiecePartID_Object = MibTableColumn
chSysSfmPiecePartID = _ChSysSfmPiecePartID_Object(
    (1, 3, 6, 1, 4, 1, 6027, 3, 1, 1, 2, 8, 1, 13),
    _ChSysSfmPiecePartID_Type()
)
chSysSfmPiecePartID.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    chSysSfmPiecePartID.setStatus("current")


class _ChSysSfmPPIDRevision_Type(DisplayString):
    """Custom type chSysSfmPPIDRevision based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 3),
    )
...
_ChSysSfmPPIDRevision_Type.__name__ = "DisplayString"
_ChSysSfmPPIDRevision_Object = MibTableColumn
chSysSfmPPIDRevision = _ChSysSfmPPIDRevision_Object(
    (1, 3, 6, 1, 4, 1, 6027, 3, 1, 1, 2, 8, 1, 14),
    _ChSysSfmPPIDRevision_Type()
)
chSysSfmPPIDRevision.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    chSysSfmPPIDRevision.setStatus("current")


class _ChSysSfmServiceTag_Type(DisplayString):
    """Custom type chSysSfmServiceTag based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 7),
    )
...
_ChSysSfmServiceTag_Type.__name__ = "DisplayString"
_ChSysSfmServiceTag_Object = MibTableColumn
chSysSfmServiceTag = _ChSysSfmServiceTag_Object(
    (1, 3, 6, 1, 4, 1, 6027, 3, 1, 1, 2, 8, 1, 15),
    _ChSysSfmServiceTag_Type()
)
chSysSfmServiceTag.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    chSysSfmServiceTag.setStatus("current")


class _ChSysSfmExpressServiceCode_Type(DisplayString):
    """Custom type chSysSfmExpressServiceCode based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 14),
    )
...
_ChSysSfmExpressServiceCode_Type.__name__ = "DisplayString"
_ChSysSfmExpressServiceCode_Object = MibTableColumn
chSysSfmExpressServiceCode = _ChSysSfmExpressServiceCode_Object(
    (1, 3, 6, 1, 4, 1, 6027, 3, 1, 1, 2, 8, 1, 16),
    _ChSysSfmExpressServiceCode_Type()
)
chSysSfmExpressServiceCode.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    chSysSfmExpressServiceCode.setStatus("current")
...
f10ComponentGroup.setObjects(
      *(("F10-CHASSIS-MIB", "chType"),
        ...
        ("F10-CHASSIS-MIB", "chPiecePartID"),
        ("F10-CHASSIS-MIB", "chPPIDRevision"),
        ("F10-CHASSIS-MIB", "chServiceTag"),
        ("F10-CHASSIS-MIB", "chExpressServiceCode"))
)
if mibBuilder.loadTexts:
...
f10SystemGroup.setObjects(
      *(("F10-CHASSIS-MIB", "chSysPowerSupplyOperStatus"),
        ...
        ("F10-CHASSIS-MIB", "chSysCardPiecePartID"),
        ("F10-CHASSIS-MIB", "chSysCardPPIDRevision"),
        ("F10-CHASSIS-MIB", "chSysCardServiceTag"),
        ("F10-CHASSIS-MIB", "chSysCardExpressServiceCode"),
        ...
        ("F10-CHASSIS-MIB", "chSysSfmPiecePartID"),
        ("F10-CHASSIS-MIB", "chSysSfmPPIDRevision"),
        ("F10-CHASSIS-MIB", "chSysSfmServiceTag"),
        ("F10-CHASSIS-MIB", "chSysSfmExpressServiceCode"))
)
if mibBuilder.loadTexts:
...
chAlarmAcDcMixedPowerSupplyClear = NotificationType(
    (1, 3, 6, 1, 4, 1, 6027, 3, 1, 1, 4, 0, 57)
)
chAlarmAcDcMixedPowerSupplyClear.setObjects(
      *(("F10-CHASSIS-MIB", "chAlarmVarInteger"),
        ("F10-CHASSIS-MIB", "chAlarmVarString"),
        ("F10-CHASSIS-MIB", "chAlarmVarSlot"),
        ("F10-CHASSIS-MIB", "chAlarmVarPort"))
...
if mibBuilder.loadTexts:
    chAlarmAcDcMixedPowerSupplyClear.setStatus(
        "current"
    )

chAlarmAcV1V2MixedPowerSupplyDetect = NotificationType(
    (1, 3, 6, 1, 4, 1, 6027, 3, 1, 1, 4, 0, 58)
)
chAlarmAcV1V2MixedPowerSupplyDetect.setObjects(
      *(("F10-CHASSIS-MIB", "chAlarmVarInteger"),
        ("F10-CHASSIS-MIB", "chAlarmVarString"),
        ("F10-CHASSIS-MIB", "chAlarmVarSlot"),
        ("F10-CHASSIS-MIB", "chAlarmVarPort"))
...
if mibBuilder.loadTexts:
    chAlarmAcV1V2MixedPowerSupplyDetect.setStatus(
        "current"
    )

chAlarmAcV1V2MixedPowerSupplyClear = NotificationType(
    (1, 3, 6, 1, 4, 1, 6027, 3, 1, 1, 4, 0, 59)
)
chAlarmAcV1V2MixedPowerSupplyClear.setObjects(
      *(("F10-CHASSIS-MIB", "chAlarmVarInteger"),
        ("F10-CHASSIS-MIB", "chAlarmVarString"),
        ("F10-CHASSIS-MIB", "chAlarmVarSlot"),
        ("F10-CHASSIS-MIB", "chAlarmVarPort"))
...
if mibBuilder.loadTexts:
    chAlarmAcV1V2MixedPowerSupplyClear.setStatus(
        "current"
    )
...
f10ChassisNotificationGroup.setObjects(
      *(("F10-CHASSIS-MIB", "chAlarmCardDown"),
        ...
        ("F10-CHASSIS-MIB", "chAlarmAcDcMixedPowerSupplyClear"),
        ("F10-CHASSIS-MIB", "chAlarmAcV1V2MixedPowerSupplyDetect"),
        ("F10-CHASSIS-MIB", "chAlarmAcV1V2MixedPowerSupplyClear"))
)
if mibBuilder.loadTexts:
...
mibBuilder.exportSymbols(
    ...
    **{"f10ChassisMib": f10ChassisMib,
       ...
       "chSysSfmPiecePartID": chSysSfmPiecePartID,
       "chSysSfmPPIDRevision": chSysSfmPPIDRevision,
       "chSysSfmServiceTag": chSysSfmServiceTag,
       "chSysSfmExpressServiceCode": chSysSfmExpressServiceCode,
       ...
       "chAlarmAcDcMixedPowerSupplyClear": chAlarmAcDcMixedPowerSupplyClear,
       "chAlarmAcV1V2MixedPowerSupplyDetect": chAlarmAcV1V2MixedPowerSupplyDetect,
       "chAlarmAcV1V2MixedPowerSupplyClear": chAlarmAcV1V2MixedPowerSupplyClear,
