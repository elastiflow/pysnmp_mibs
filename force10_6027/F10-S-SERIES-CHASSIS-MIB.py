...
# Notes
# -----
# ASN.1 source file:///Users/rob/MIBs/force10_6027/F10-S-SERIES-CHASSIS-MIB.mib
...
class _ChStackUnitAlarmLEDStatus_Type(Integer32):
    """Custom type chStackUnitAlarmLEDStatus based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_ChStackUnitAlarmLEDStatus_Type.__name__ = "Integer32"
_ChStackUnitAlarmLEDStatus_Object = MibTableColumn
chStackUnitAlarmLEDStatus = _ChStackUnitAlarmLEDStatus_Object(
    (1, 3, 6, 1, 4, 1, 6027, 3, 10, 1, 2, 2, 1, 35),
    _ChStackUnitAlarmLEDStatus_Type()
)
chStackUnitAlarmLEDStatus.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    chStackUnitAlarmLEDStatus.setStatus("current")
...
f10sSeriesSystemGroup.setObjects(
      *(("F10-S-SERIES-CHASSIS-MIB", "chSwitchTypeSID"),
        ...
        ("F10-S-SERIES-CHASSIS-MIB", "chStackUnitAlarmLEDStatus"),
...
mibBuilder.exportSymbols(
    ...
    **{"CodeType": CodeType,
       ...
       "chStackUnitAlarmLEDStatus": chStackUnitAlarmLEDStatus,
