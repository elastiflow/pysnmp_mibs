# SNMP MIB module (F10OS-INVENTORY-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/rob/MIBs/force10_6027/F10OS-INVENTORY-MIB.mib
...
f10OSInventory = ModuleIdentity(
    (1, 3, 6, 1, 4, 1, 6027, 1, 3, 1, 13)
)
if mibBuilder.loadTexts:
    f10OSInventory.setRevisions(
        ("2005-02-18 20:37",
         "2005-01-17 00:00")
    )
...
agentInventorySupportedUnitEntry.setIndexNames(
    (0, "F10OS-INVENTORY-MIB", "agentInventorySupportedUnitIndex"),
)
if mibBuilder.loadTexts:
...
agentInventoryUnitEntry.setIndexNames(
    (0, "F10OS-INVENTORY-MIB", "agentInventoryUnitNumber"),
)
if mibBuilder.loadTexts:
...
agentInventorySlotEntry.setIndexNames(
    (0, "F10OS-INVENTORY-MIB", "agentInventoryUnitNumber"),
    (0, "F10OS-INVENTORY-MIB", "agentInventorySlotNumber"),
)
if mibBuilder.loadTexts:
...
agentInventoryCardTypeEntry.setIndexNames(
    (0, "F10OS-INVENTORY-MIB", "agentInventoryCardIndex"),
)
if mibBuilder.loadTexts:
...
agentInventoryComponentEntry.setIndexNames(
    (0, "F10OS-INVENTORY-MIB", "agentInventoryComponentIndex"),
)
if mibBuilder.loadTexts:
...
_F10OSInventoryConformance_ObjectIdentity = ObjectIdentity
f10OSInventoryConformance = _F10OSInventoryConformance_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 6027, 1, 3, 1, 13, 6)
)
_F10OSInventoryCompliances_ObjectIdentity = ObjectIdentity
f10OSInventoryCompliances = _F10OSInventoryCompliances_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 6027, 1, 3, 1, 13, 6, 1)
)
_F10OSInventoryGroups_ObjectIdentity = ObjectIdentity
f10OSInventoryGroups = _F10OSInventoryGroups_ObjectIdentity(
...
agentInventoryStackPortEntry.setIndexNames(
    (0, "F10OS-INVENTORY-MIB", "agentInventoryStackPortIndex"),
)
if mibBuilder.loadTexts:
...
f10OSInventorySupportedUnitGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 6027, 1, 3, 1, 13, 6, 2, 1)
)
f10OSInventorySupportedUnitGroup.setObjects(
      *(("F10OS-INVENTORY-MIB", "agentInventorySupportedUnitIndex"),
        ("F10OS-INVENTORY-MIB", "agentInventorySupportedUnitModelIdentifier"),
        ("F10OS-INVENTORY-MIB", "agentInventorySupportedUnitDescription"),
        ("F10OS-INVENTORY-MIB", "agentInventorySupportedUnitExpectedCodeVer"))
)
if mibBuilder.loadTexts:
    f10OSInventorySupportedUnitGroup.setStatus("current")

f10OSInventoryUnitGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 6027, 1, 3, 1, 13, 6, 2, 2)
)
f10OSInventoryUnitGroup.setObjects(
      *(("F10OS-INVENTORY-MIB", "agentInventoryUnitNumber"),
        ("F10OS-INVENTORY-MIB", "agentInventoryUnitAssignNumber"),
        ("F10OS-INVENTORY-MIB", "agentInventoryUnitType"),
        ("F10OS-INVENTORY-MIB", "agentInventoryUnitMgmtAdmin"),
        ("F10OS-INVENTORY-MIB", "agentInventoryUnitHWMgmtPref"),
        ("F10OS-INVENTORY-MIB", "agentInventoryUnitAdminMgmtPref"),
        ("F10OS-INVENTORY-MIB", "agentInventoryUnitStatus"),
        ("F10OS-INVENTORY-MIB", "agentInventoryUnitDetectedCodeVer"),
        ("F10OS-INVENTORY-MIB", "agentInventoryUnitDetectedCodeInFlashVer"),
        ("F10OS-INVENTORY-MIB", "agentInventoryUnitUpTime"),
        ("F10OS-INVENTORY-MIB", "agentInventoryUnitDescription"),
        ("F10OS-INVENTORY-MIB", "agentInventoryUnitReplicateSTK"),
        ("F10OS-INVENTORY-MIB", "agentInventoryUnitRowStatus"))
)
if mibBuilder.loadTexts:
    f10OSInventoryUnitGroup.setStatus("current")

f10OSInventorySlotGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 6027, 1, 3, 1, 13, 6, 2, 3)
)
f10OSInventorySlotGroup.setObjects(
      *(("F10OS-INVENTORY-MIB", "agentInventorySlotNumber"),
        ("F10OS-INVENTORY-MIB", "agentInventorySlotStatus"),
        ("F10OS-INVENTORY-MIB", "agentInventorySlotPowerMode"),
        ("F10OS-INVENTORY-MIB", "agentInventorySlotAdminMode"),
        ("F10OS-INVENTORY-MIB", "agentInventorySlotInsertedCardType"),
        ("F10OS-INVENTORY-MIB", "agentInventorySlotConfiguredCardType"))
)
if mibBuilder.loadTexts:
    f10OSInventorySlotGroup.setStatus("current")

f10OSInventoryCardGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 6027, 1, 3, 1, 13, 6, 2, 4)
)
f10OSInventoryCardGroup.setObjects(
      *(("F10OS-INVENTORY-MIB", "agentInventoryCardIndex"),
        ("F10OS-INVENTORY-MIB", "agentInventoryCardType"),
        ("F10OS-INVENTORY-MIB", "agentInventoryCardModelIdentifier"),
        ("F10OS-INVENTORY-MIB", "agentInventoryCardDescription"))
)
if mibBuilder.loadTexts:
    f10OSInventoryCardGroup.setStatus("current")
...
agentInventoryStackPortLinkUp.setObjects(
      *(("F10OS-INVENTORY-MIB", "agentInventoryStackPortUnit"),
        ("F10OS-INVENTORY-MIB", "agentInventoryStackPortTag"))
)
if mibBuilder.loadTexts:
...
f10OSInventoryNotificationsGroup = NotificationGroup(
    (1, 3, 6, 1, 4, 1, 6027, 1, 3, 1, 13, 6, 2, 5)
)
f10OSInventoryNotificationsGroup.setObjects(
      *(("F10OS-INVENTORY-MIB", "agentInventoryCardMismatch"),
        ("F10OS-INVENTORY-MIB", "agentInventoryCardUnsupported"))
)
if mibBuilder.loadTexts:
    f10OSInventoryNotificationsGroup.setStatus(
        "current"
    )
...
f10OSInventoryCompliance = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 6027, 1, 3, 1, 13, 6, 1, 1)
)
f10OSInventoryCompliance.setObjects(
      *(("F10OS-INVENTORY-MIB", "f10OSInventorySlotGroup"),
        ("F10OS-INVENTORY-MIB", "f10OSInventoryCardGroup"),
        ("F10OS-INVENTORY-MIB", "f10OSInventoryCardGroup"),
        ("F10OS-INVENTORY-MIB", "f10OSInventoryUnitGroup"))
)
if mibBuilder.loadTexts:
    f10OSInventoryCompliance.setStatus(
        "obsolete"
    )

f10OSInventoryCompliance2 = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 6027, 1, 3, 1, 13, 6, 1, 2)
)
f10OSInventoryCompliance2.setObjects(
      *(("F10OS-INVENTORY-MIB", "f10OSInventorySlotGroup"),
        ("F10OS-INVENTORY-MIB", "f10OSInventoryCardGroup"),
        ("F10OS-INVENTORY-MIB", "f10OSInventoryCardGroup"),
        ("F10OS-INVENTORY-MIB", "f10OSInventoryUnitGroup"))
...
if mibBuilder.loadTexts:
    f10OSInventoryCompliance2.setStatus(
        "current"
    )
...
mibBuilder.exportSymbols(
    ...
    **{"AgentInventoryUnitPreference": AgentInventoryUnitPreference,
       ...
       "f10OSInventoryConformance": f10OSInventoryConformance,
       "f10OSInventoryCompliances": f10OSInventoryCompliances,
       "f10OSInventoryCompliance": f10OSInventoryCompliance,
       "f10OSInventoryCompliance2": f10OSInventoryCompliance2,
       "f10OSInventoryGroups": f10OSInventoryGroups,
       "f10OSInventorySupportedUnitGroup": f10OSInventorySupportedUnitGroup,
       "f10OSInventoryUnitGroup": f10OSInventoryUnitGroup,
       "f10OSInventorySlotGroup": f10OSInventorySlotGroup,
       "f10OSInventoryCardGroup": f10OSInventoryCardGroup,
       "f10OSInventoryNotificationsGroup": f10OSInventoryNotificationsGroup,
