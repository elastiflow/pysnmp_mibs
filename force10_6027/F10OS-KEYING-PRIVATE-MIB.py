# SNMP MIB module (F10OS-KEYING-PRIVATE-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/rob/MIBs/force10_6027/F10OS-KEYING-PRIVATE-MIB.mib
...
sFTOSKeyingPrivate = ModuleIdentity(
    (1, 3, 6, 1, 4, 1, 6027, 1, 3, 1, 24)
)
if mibBuilder.loadTexts:
    sFTOSKeyingPrivate.setRevisions(
        ("2005-02-18 00:00",)
    )
...
agentFeatureKeyingEntry = _AgentFeatureKeyingEntry_Object(
    (1, 3, 6, 1, 4, 1, 6027, 1, 3, 1, 24, 1, 3, 1)
)
agentFeatureKeyingEntry.setIndexNames(
    (0, "F10OS-KEYING-PRIVATE-MIB", "agentFeatureKeyingIndex"),
)
if mibBuilder.loadTexts:
...
agentFeatureKeyingIndex = _AgentFeatureKeyingIndex_Object(
    (1, 3, 6, 1, 4, 1, 6027, 1, 3, 1, 24, 1, 3, 1, 1),
...
agentFeatureKeyingName = _AgentFeatureKeyingName_Object(
    (1, 3, 6, 1, 4, 1, 6027, 1, 3, 1, 24, 1, 3, 1, 2),
...
agentFeatureKeyingStatus = _AgentFeatureKeyingStatus_Object(
    (1, 3, 6, 1, 4, 1, 6027, 1, 3, 1, 24, 1, 3, 1, 3),
...
mibBuilder.exportSymbols(
    "F10OS-KEYING-PRIVATE-MIB",
    **{"sFTOSKeyingPrivate": sFTOSKeyingPrivate,
