# SNMP MIB module (F10OS-MGMT-SECURITY-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/rob/MIBs/force10_6027/F10OS-MGMT-SECURITY-MIB.mib
...
f10OSMgmtSecurity = ModuleIdentity(
    (1, 3, 6, 1, 4, 1, 6027, 1, 3, 1, 11)
)
if mibBuilder.loadTexts:
    f10OSMgmtSecurity.setRevisions(
        ("2005-01-18 00:00",)
    )
...
mibBuilder.exportSymbols(
    "F10OS-MGMT-SECURITY-MIB",
    **{"f10OSMgmtSecurity": f10OSMgmtSecurity,
