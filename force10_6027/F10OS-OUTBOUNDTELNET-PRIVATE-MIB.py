# SNMP MIB module (F10OS-OUTBOUNDTELNET-PRIVATE-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/rob/MIBs/force10_6027/F10OS-OUTBOUNDTELNET-PRIVATE-MIB.mib
...
sFTOSOutboundTelnetPrivate = ModuleIdentity(
    (1, 3, 6, 1, 4, 1, 6027, 1, 3, 1, 19)
)
if mibBuilder.loadTexts:
    sFTOSOutboundTelnetPrivate.setRevisions(
        ("2005-02-18 12:00",)
    )
...
mibBuilder.exportSymbols(
    "F10OS-OUTBOUNDTELNET-PRIVATE-MIB",
    **{"sFTOSOutboundTelnetPrivate": sFTOSOutboundTelnetPrivate,
