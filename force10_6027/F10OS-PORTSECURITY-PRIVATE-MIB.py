# SNMP MIB module (F10OS-PORTSECURITY-PRIVATE-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/rob/MIBs/force10_6027/F10OS-PORTSECURITY-PRIVATE-MIB.mib
...
f10OSPortSecurity = ModuleIdentity(
    (1, 3, 6, 1, 4, 1, 6027, 1, 3, 1, 20)
)
if mibBuilder.loadTexts:
    f10OSPortSecurity.setRevisions(
        ("2005-02-18 00:00",)
    )
...
agentPortSecurityDynamicEntry.setIndexNames(
    (0, "IF-MIB", "ifIndex"),
    (0, "F10OS-PORTSECURITY-PRIVATE-MIB", "agentPortSecurityDynamicVLANId"),
    (0, "F10OS-PORTSECURITY-PRIVATE-MIB", "agentPortSecurityDynamicMACAddress"),
)
if mibBuilder.loadTexts:
...
agentPortSecurityViolation.setObjects(
      *(("IF-MIB", "ifIndex"),
        ("F10OS-PORTSECURITY-PRIVATE-MIB", "agentPortSecurityLastDiscardedMAC"))
)
if mibBuilder.loadTexts:
...
mibBuilder.exportSymbols(
    "F10OS-PORTSECURITY-PRIVATE-MIB",
    **{"f10OSPortSecurity": f10OSPortSecurity,
