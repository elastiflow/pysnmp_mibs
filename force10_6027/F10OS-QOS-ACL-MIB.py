# SNMP MIB module (F10OS-QOS-ACL-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/rob/MIBs/force10_6027/F10OS-QOS-ACL-MIB.mib
...
f10OSQOSACL = ModuleIdentity(
    (1, 3, 6, 1, 4, 1, 6027, 1, 3, 1, 3, 2)
)
if mibBuilder.loadTexts:
    f10OSQOSACL.setRevisions(
        ("2005-02-18 00:00",)
    )
...
aclRuleEntry.setIndexNames(
    (0, "F10OS-QOS-ACL-MIB", "aclIndex"),
    (0, "F10OS-QOS-ACL-MIB", "aclRuleIndex"),
)
if mibBuilder.loadTexts:
...
aclMacEntry.setIndexNames(
    (0, "F10OS-QOS-ACL-MIB", "aclMacIndex"),
)
if mibBuilder.loadTexts:
...
aclMacRuleEntry.setIndexNames(
    (0, "F10OS-QOS-ACL-MIB", "aclMacIndex"),
    (0, "F10OS-QOS-ACL-MIB", "aclMacRuleIndex"),
)
if mibBuilder.loadTexts:
...
aclIfEntry.setIndexNames(
    (0, "F10OS-QOS-ACL-MIB", "aclIfIndex"),
    (0, "F10OS-QOS-ACL-MIB", "aclIfDirection"),
    (0, "F10OS-QOS-ACL-MIB", "aclIfSequence"),
    (0, "F10OS-QOS-ACL-MIB", "aclIfAclType"),
    (0, "F10OS-QOS-ACL-MIB", "aclIfAclId"),
)
if mibBuilder.loadTexts:
