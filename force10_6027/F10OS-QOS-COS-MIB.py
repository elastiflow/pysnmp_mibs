# SNMP MIB module (F10OS-QOS-COS-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/rob/MIBs/force10_6027/F10OS-QOS-COS-MIB.mib
...
f10OSQOSCOS = ModuleIdentity(
    (1, 3, 6, 1, 4, 1, 6027, 1, 3, 1, 3, 3)
)
if mibBuilder.loadTexts:
    f10OSQOSCOS.setRevisions(
        ("2005-02-18 00:00",)
    )
...
agentCosMapIpPrecEntry.setIndexNames(
    (0, "F10OS-QOS-COS-MIB", "agentCosMapIpPrecIntfIndex"),
    (0, "F10OS-QOS-COS-MIB", "agentCosMapIpPrecValue"),
)
if mibBuilder.loadTexts:
...
agentCosMapIpDscpEntry.setIndexNames(
    (0, "F10OS-QOS-COS-MIB", "agentCosMapIpDscpIntfIndex"),
    (0, "F10OS-QOS-COS-MIB", "agentCosMapIpDscpValue"),
)
if mibBuilder.loadTexts:
...
agentCosMapIntfTrustEntry.setIndexNames(
    (0, "F10OS-QOS-COS-MIB", "agentCosMapIntfTrustIntfIndex"),
)
if mibBuilder.loadTexts:
...
agentCosQueueControlEntry.setIndexNames(
    (0, "F10OS-QOS-COS-MIB", "agentCosQueueIntfIndex"),
)
if mibBuilder.loadTexts:
...
agentCosQueueEntry.setIndexNames(
    (0, "F10OS-QOS-COS-MIB", "agentCosQueueIntfIndex"),
    (0, "F10OS-QOS-COS-MIB", "agentCosQueueIndex"),
)
if mibBuilder.loadTexts:
...
agentCosQueueMgmtEntry.setIndexNames(
    (0, "F10OS-QOS-COS-MIB", "agentCosQueueIntfIndex"),
    (0, "F10OS-QOS-COS-MIB", "agentCosQueueIndex"),
    (0, "F10OS-QOS-COS-MIB", "agentCosQueueDropPrecIndex"),
)
if mibBuilder.loadTexts:
