# SNMP MIB module (F10OS-QOS-DIFFSERV-EXTENSIONS-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/rob/MIBs/force10_6027/F10OS-QOS-DIFFSERV-EXTENSIONS-MIB.mib
...
f10OSQOSDiffServExtensions = ModuleIdentity(
    (1, 3, 6, 1, 4, 1, 6027, 1, 3, 1, 6)
)
if mibBuilder.loadTexts:
    f10OSQOSDiffServExtensions.setRevisions(
        ("2005-01-18 00:00",)
    )
...
agentDiffServAuxMfClfrEntry.setIndexNames(
    (0, "F10OS-QOS-DIFFSERV-EXTENSIONS-MIB", "agentDiffServAuxMfClfrId"),
)
if mibBuilder.loadTexts:
...
agentDiffServCosMarkActEntry.setIndexNames(
    (0, "F10OS-QOS-DIFFSERV-EXTENSIONS-MIB", "agentDiffServCosMarkActCos"),
)
if mibBuilder.loadTexts:
...
agentDiffServIpPrecMarkActEntry.setIndexNames(
    (0, "F10OS-QOS-DIFFSERV-EXTENSIONS-MIB", "agentDiffServIpPrecMarkActPrecedence"),
)
if mibBuilder.loadTexts:
...
agentDiffServCos2MarkActEntry.setIndexNames(
    (0, "F10OS-QOS-DIFFSERV-EXTENSIONS-MIB", "agentDiffServCos2MarkActCos"),
)
if mibBuilder.loadTexts:
...
agentDiffServAssignQueueEntry.setIndexNames(
    (0, "F10OS-QOS-DIFFSERV-EXTENSIONS-MIB", "agentDiffServAssignQueueIndex"),
)
if mibBuilder.loadTexts:
...
agentDiffServRedirectEntry.setIndexNames(
    (0, "F10OS-QOS-DIFFSERV-EXTENSIONS-MIB", "agentDiffServRedirectId"),
)
if mibBuilder.loadTexts:
...
diffServMeterEntry.registerAugmentions(
    ("F10OS-QOS-DIFFSERV-EXTENSIONS-MIB",
...
mibBuilder.exportSymbols(
    ...
    **{"IpPrecedence": IpPrecedence,
       ...
       "f10OSQOSDiffServExtensions": f10OSQOSDiffServExtensions,
