# SNMP MIB module (F10OS-QOS-DIFFSERV-PRIVATE-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/rob/MIBs/force10_6027/F10OS-QOS-DIFFSERV-PRIVATE-MIB.mib
...
f10OSQOSDiffServPrivate = ModuleIdentity(
    (1, 3, 6, 1, 4, 1, 6027, 1, 3, 1, 7)
)
if mibBuilder.loadTexts:
    f10OSQOSDiffServPrivate.setRevisions(
        ("2004-10-06 00:00",
         "2005-01-18 00:00")
    )
...
agentDiffServClassEntry.setIndexNames(
    (0, "F10OS-QOS-DIFFSERV-PRIVATE-MIB", "agentDiffServClassIndex"),
)
if mibBuilder.loadTexts:
...
agentDiffServClassRuleEntry.setIndexNames(
    (0, "F10OS-QOS-DIFFSERV-PRIVATE-MIB", "agentDiffServClassIndex"),
    (0, "F10OS-QOS-DIFFSERV-PRIVATE-MIB", "agentDiffServClassRuleIndex"),
)
if mibBuilder.loadTexts:
...
agentDiffServPolicyEntry.setIndexNames(
    (0, "F10OS-QOS-DIFFSERV-PRIVATE-MIB", "agentDiffServPolicyIndex"),
)
if mibBuilder.loadTexts:
...
agentDiffServPolicyInstEntry.setIndexNames(
    (0, "F10OS-QOS-DIFFSERV-PRIVATE-MIB", "agentDiffServPolicyIndex"),
    (0, "F10OS-QOS-DIFFSERV-PRIVATE-MIB", "agentDiffServPolicyInstIndex"),
)
if mibBuilder.loadTexts:
...
agentDiffServPolicyAttrEntry.setIndexNames(
    (0, "F10OS-QOS-DIFFSERV-PRIVATE-MIB", "agentDiffServPolicyIndex"),
    (0, "F10OS-QOS-DIFFSERV-PRIVATE-MIB", "agentDiffServPolicyInstIndex"),
    (0, "F10OS-QOS-DIFFSERV-PRIVATE-MIB", "agentDiffServPolicyAttrIndex"),
)
if mibBuilder.loadTexts:
...
agentDiffServServiceEntry.setIndexNames(
    (0, "F10OS-QOS-DIFFSERV-PRIVATE-MIB", "agentDiffServServiceIfIndex"),
    (0, "F10OS-QOS-DIFFSERV-PRIVATE-MIB", "agentDiffServServiceIfDirection"),
)
if mibBuilder.loadTexts:
...
agentDiffServServiceEntry.registerAugmentions(
    ("F10OS-QOS-DIFFSERV-PRIVATE-MIB",
...
mibBuilder.exportSymbols(
    ...
    **{"QosBurstSize": QosBurstSize,
       ...
       "f10OSQOSDiffServPrivate": f10OSQOSDiffServPrivate,
