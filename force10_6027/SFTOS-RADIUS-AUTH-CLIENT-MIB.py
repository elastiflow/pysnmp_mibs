# SNMP MIB module (SFTOS-RADIUS-AUTH-CLIENT-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/rob/MIBs/force10_6027/SFTOS-RADIUS-AUTH-CLIENT-MIB.mib
...
sFTOSRadius = ModuleIdentity(
    (1, 3, 6, 1, 4, 1, 6027, 1, 3, 1, 8)
)
if mibBuilder.loadTexts:
    sFTOSRadius.setRevisions(
        ("2005-02-18 12:00",)
    )
...
agentRadiusAccountingConfigEntry.setIndexNames(
    (0, "SFTOS-RADIUS-AUTH-CLIENT-MIB", "agentRadiusAccountingServerIndex"),
)
if mibBuilder.loadTexts:
...
agentRadiusServerConfigEntry.setIndexNames(
    (0, "SFTOS-RADIUS-AUTH-CLIENT-MIB", "agentRadiusServerIndex"),
)
if mibBuilder.loadTexts:
...
mibBuilder.exportSymbols(
    "SFTOS-RADIUS-AUTH-CLIENT-MIB",
    **{"sFTOSRadius": sFTOSRadius,
