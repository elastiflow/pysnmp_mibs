...
# Notes
# -----
# ASN.1 source file:///Users/rob/MIBs/isilon_12124/ISILON-TRAP-MIB.mib
...
_EventKbUrl_Type = OctetString
_EventKbUrl_Object = MibScalar
eventKbUrl = _EventKbUrl_Object(
    (1, 3, 6, 1, 4, 1, 12124, 250, 50, 17),
    _EventKbUrl_Type()
)
eventKbUrl.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    eventKbUrl.setStatus("current")
