...
# Notes
# -----
# ASN.1 source file:///Users/rob/MIBs/juniper_2636/JUNIPER-IPSEC-FLOW-MON-MIB.mib
...
class JnxIpSecTsType(TextualConvention, Integer32):
    status = "current"
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
...
class _JnxIkePeerAddrIndex_Type(Unsigned32):
    """Custom type jnxIkePeerAddrIndex based on Unsigned32"""
    subtypeSpec = Unsigned32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_JnxIkePeerAddrIndex_Type.__name__ = "Unsigned32"
...
class _JnxIkePeerIdIndex_Type(Unsigned32):
    """Custom type jnxIkePeerIdIndex based on Unsigned32"""
    subtypeSpec = Unsigned32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(1, 4294967295),
    )
...
_JnxIkePeerIdIndex_Type.__name__ = "Unsigned32"
...
class _JnxIkePeerStatsIndex_Type(Unsigned32):
    """Custom type jnxIkePeerStatsIndex based on Unsigned32"""
    subtypeSpec = Unsigned32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(1, 4294967295),
    )
...
_JnxIkePeerStatsIndex_Type.__name__ = "Unsigned32"
...
class _JnxPeerIkeSaCorrIkeTunMonIndex_Type(Unsigned32):
    """Custom type jnxPeerIkeSaCorrIkeTunMonIndex based on Unsigned32"""
    subtypeSpec = Unsigned32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(1, 4294967295),
    )
...
_JnxPeerIkeSaCorrIkeTunMonIndex_Type.__name__ = "Unsigned32"
...
if mibBuilder.loadTexts:
    jnxIpSecTunMonLocalProxyId.setStatus("deprecated")
...
if mibBuilder.loadTexts:
    jnxIpSecTunMonRemoteProxyId.setStatus("deprecated")
...
_JnxIpSecTunMonTsType_Type = JnxIpSecTsType
_JnxIpSecTunMonTsType_Object = MibTableColumn
jnxIpSecTunMonTsType = _JnxIpSecTunMonTsType_Object(
    (1, 3, 6, 1, 4, 1, 2636, 3, 52, 1, 2, 2, 1, 34),
    _JnxIpSecTunMonTsType_Type()
)
jnxIpSecTunMonTsType.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    jnxIpSecTunMonTsType.setStatus("current")
_JnxIpSecTunMonTSi_Type = DisplayString
_JnxIpSecTunMonTSi_Object = MibTableColumn
jnxIpSecTunMonTSi = _JnxIpSecTunMonTSi_Object(
    (1, 3, 6, 1, 4, 1, 2636, 3, 52, 1, 2, 2, 1, 35),
    _JnxIpSecTunMonTSi_Type()
)
jnxIpSecTunMonTSi.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    jnxIpSecTunMonTSi.setStatus("current")
_JnxIpSecTunMonTSr_Type = DisplayString
_JnxIpSecTunMonTSr_Object = MibTableColumn
jnxIpSecTunMonTSr = _JnxIpSecTunMonTSr_Object(
    (1, 3, 6, 1, 4, 1, 2636, 3, 52, 1, 2, 2, 1, 36),
    _JnxIpSecTunMonTSr_Type()
)
jnxIpSecTunMonTSr.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    jnxIpSecTunMonTSr.setStatus("current")


class _JnxIpSecTunMonTunMtu_Type(Integer32):
    """Custom type jnxIpSecTunMonTunMtu based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 9192),
    )


_JnxIpSecTunMonTunMtu_Type.__name__ = "Integer32"
_JnxIpSecTunMonTunMtu_Object = MibTableColumn
jnxIpSecTunMonTunMtu = _JnxIpSecTunMonTunMtu_Object(
    (1, 3, 6, 1, 4, 1, 2636, 3, 52, 1, 2, 2, 1, 37),
    _JnxIpSecTunMonTunMtu_Type()
)
jnxIpSecTunMonTunMtu.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    jnxIpSecTunMonTunMtu.setStatus("current")
_JnxIpSecTunMonExceedsTunMtu_Type = Counter64
_JnxIpSecTunMonExceedsTunMtu_Object = MibTableColumn
jnxIpSecTunMonExceedsTunMtu = _JnxIpSecTunMonExceedsTunMtu_Object(
    (1, 3, 6, 1, 4, 1, 2636, 3, 52, 1, 2, 2, 1, 38),
    _JnxIpSecTunMonExceedsTunMtu_Type()
)
jnxIpSecTunMonExceedsTunMtu.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    jnxIpSecTunMonExceedsTunMtu.setStatus("current")
if mibBuilder.loadTexts:
    jnxIpSecTunMonExceedsTunMtu.setUnits("Packets")
...
_JnxIpSecGlobalExceedsTunMtu_Type = Counter64
_JnxIpSecGlobalExceedsTunMtu_Object = MibScalar
jnxIpSecGlobalExceedsTunMtu = _JnxIpSecGlobalExceedsTunMtu_Object(
    (1, 3, 6, 1, 4, 1, 2636, 3, 52, 1, 2, 4, 18),
    _JnxIpSecGlobalExceedsTunMtu_Type()
)
jnxIpSecGlobalExceedsTunMtu.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    jnxIpSecGlobalExceedsTunMtu.setStatus("current")
if mibBuilder.loadTexts:
    jnxIpSecGlobalExceedsTunMtu.setUnits("Packets")
...
_JnxIpSecHaLinkGlobalExceedsTunMtu_Type = Counter64
_JnxIpSecHaLinkGlobalExceedsTunMtu_Object = MibScalar
jnxIpSecHaLinkGlobalExceedsTunMtu = _JnxIpSecHaLinkGlobalExceedsTunMtu_Object(
    (1, 3, 6, 1, 4, 1, 2636, 3, 52, 1, 2, 5, 18),
    _JnxIpSecHaLinkGlobalExceedsTunMtu_Type()
)
jnxIpSecHaLinkGlobalExceedsTunMtu.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    jnxIpSecHaLinkGlobalExceedsTunMtu.setStatus("current")
if mibBuilder.loadTexts:
    jnxIpSecHaLinkGlobalExceedsTunMtu.setUnits("Packets")
...
mibBuilder.exportSymbols(
    ...
    **{"JnxIkePeerType": JnxIkePeerType,
       ...
       "jnxIpSecTunMonTsType": jnxIpSecTunMonTsType,
       "jnxIpSecTunMonTSi": jnxIpSecTunMonTSi,
       "jnxIpSecTunMonTSr": jnxIpSecTunMonTSr,
       "jnxIpSecTunMonTunMtu": jnxIpSecTunMonTunMtu,
       "jnxIpSecTunMonExceedsTunMtu": jnxIpSecTunMonExceedsTunMtu,
       ...
       "jnxIpSecGlobalExceedsTunMtu": jnxIpSecGlobalExceedsTunMtu,
       ...
       "jnxIpSecHaLinkGlobalExceedsTunMtu": jnxIpSecHaLinkGlobalExceedsTunMtu}
)
