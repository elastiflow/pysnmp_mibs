...
# Notes
# -----
# ASN.1 source file:///Users/rob/MIBs/juniper_2636/JUNIPER-JS-NAT-MIB.mib
...
_JnxJsNatSrcNumAddressMapped_Type = Counter32
_JnxJsNatSrcNumAddressMapped_Object = MibTableColumn
jnxJsNatSrcNumAddressMapped = _JnxJsNatSrcNumAddressMapped_Object(
    (1, 3, 6, 1, 4, 1, 2636, 3, 39, 1, 7, 1, 1, 4, 1, 10),
    _JnxJsNatSrcNumAddressMapped_Type()
)
jnxJsNatSrcNumAddressMapped.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    jnxJsNatSrcNumAddressMapped.setStatus("current")
...
_JnxJsNatPbaStatsTable_Object = MibTable
jnxJsNatPbaStatsTable = _JnxJsNatPbaStatsTable_Object(
    (1, 3, 6, 1, 4, 1, 2636, 3, 39, 1, 7, 1, 1, 7)
)
if mibBuilder.loadTexts:
    jnxJsNatPbaStatsTable.setStatus("current")
_JnxJsNatPbaStatsEntry_Object = MibTableRow
jnxJsNatPbaStatsEntry = _JnxJsNatPbaStatsEntry_Object(
    (1, 3, 6, 1, 4, 1, 2636, 3, 39, 1, 7, 1, 1, 7, 1)
)
jnxJsNatPbaStatsEntry.setIndexNames(
    (0, "JUNIPER-JS-NAT-MIB", "jnxJsNatPbaPoolName"),
)
if mibBuilder.loadTexts:
    jnxJsNatPbaStatsEntry.setStatus("current")


class _JnxJsNatPbaPoolName_Type(DisplayString):
    """Custom type jnxJsNatPbaPoolName based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(1, 64),
    )
...
_JnxJsNatPbaPoolName_Type.__name__ = "DisplayString"
_JnxJsNatPbaPoolName_Object = MibTableColumn
jnxJsNatPbaPoolName = _JnxJsNatPbaPoolName_Object(
    (1, 3, 6, 1, 4, 1, 2636, 3, 39, 1, 7, 1, 1, 7, 1, 1),
    _JnxJsNatPbaPoolName_Type()
)
jnxJsNatPbaPoolName.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    jnxJsNatPbaPoolName.setStatus("current")
_JnxJsNatPbaOutOfPortError_Type = Counter32
_JnxJsNatPbaOutOfPortError_Object = MibTableColumn
jnxJsNatPbaOutOfPortError = _JnxJsNatPbaOutOfPortError_Object(
    (1, 3, 6, 1, 4, 1, 2636, 3, 39, 1, 7, 1, 1, 7, 1, 2),
    _JnxJsNatPbaOutOfPortError_Type()
)
jnxJsNatPbaOutOfPortError.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    jnxJsNatPbaOutOfPortError.setStatus("current")
_JnxJsNatPbaMaxNumberOfPortBlocksUsed_Type = Counter32
_JnxJsNatPbaMaxNumberOfPortBlocksUsed_Object = MibTableColumn
jnxJsNatPbaMaxNumberOfPortBlocksUsed = _JnxJsNatPbaMaxNumberOfPortBlocksUsed_Object(
    (1, 3, 6, 1, 4, 1, 2636, 3, 39, 1, 7, 1, 1, 7, 1, 3),
    _JnxJsNatPbaMaxNumberOfPortBlocksUsed_Type()
)
jnxJsNatPbaMaxNumberOfPortBlocksUsed.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    jnxJsNatPbaMaxNumberOfPortBlocksUsed.setStatus("current")
_JnxJsNatPbaCurrentNumberOfPortBlocksInUse_Type = Counter32
_JnxJsNatPbaCurrentNumberOfPortBlocksInUse_Object = MibTableColumn
jnxJsNatPbaCurrentNumberOfPortBlocksInUse = _JnxJsNatPbaCurrentNumberOfPortBlocksInUse_Object(
    (1, 3, 6, 1, 4, 1, 2636, 3, 39, 1, 7, 1, 1, 7, 1, 4),
    _JnxJsNatPbaCurrentNumberOfPortBlocksInUse_Type()
)
jnxJsNatPbaCurrentNumberOfPortBlocksInUse.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    jnxJsNatPbaCurrentNumberOfPortBlocksInUse.setStatus("current")
_JnxJsNatPbaPortBlockAllocErrors_Type = Counter32
_JnxJsNatPbaPortBlockAllocErrors_Object = MibTableColumn
jnxJsNatPbaPortBlockAllocErrors = _JnxJsNatPbaPortBlockAllocErrors_Object(
    (1, 3, 6, 1, 4, 1, 2636, 3, 39, 1, 7, 1, 1, 7, 1, 5),
    _JnxJsNatPbaPortBlockAllocErrors_Type()
)
jnxJsNatPbaPortBlockAllocErrors.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    jnxJsNatPbaPortBlockAllocErrors.setStatus("current")
_JnxJsNatPbaPortBlockMemAllocErrors_Type = Counter32
_JnxJsNatPbaPortBlockMemAllocErrors_Object = MibTableColumn
jnxJsNatPbaPortBlockMemAllocErrors = _JnxJsNatPbaPortBlockMemAllocErrors_Object(
    (1, 3, 6, 1, 4, 1, 2636, 3, 39, 1, 7, 1, 1, 7, 1, 6),
    _JnxJsNatPbaPortBlockMemAllocErrors_Type()
)
jnxJsNatPbaPortBlockMemAllocErrors.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    jnxJsNatPbaPortBlockMemAllocErrors.setStatus("current")
_JnxJsNatPbaPortBlockLimitExeededErrors_Type = Counter32
_JnxJsNatPbaPortBlockLimitExeededErrors_Object = MibTableColumn
jnxJsNatPbaPortBlockLimitExeededErrors = _JnxJsNatPbaPortBlockLimitExeededErrors_Object(
    (1, 3, 6, 1, 4, 1, 2636, 3, 39, 1, 7, 1, 1, 7, 1, 7),
    _JnxJsNatPbaPortBlockLimitExeededErrors_Type()
)
jnxJsNatPbaPortBlockLimitExeededErrors.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    jnxJsNatPbaPortBlockLimitExeededErrors.setStatus("current")
...
mibBuilder.exportSymbols(
    ...
    **{"jnxJsNatMIB": jnxJsNatMIB,
       ...
       "jnxJsNatSrcNumAddressMapped": jnxJsNatSrcNumAddressMapped,
       ...
       "jnxJsNatPbaStatsTable": jnxJsNatPbaStatsTable,
       "jnxJsNatPbaStatsEntry": jnxJsNatPbaStatsEntry,
       "jnxJsNatPbaPoolName": jnxJsNatPbaPoolName,
       "jnxJsNatPbaOutOfPortError": jnxJsNatPbaOutOfPortError,
       "jnxJsNatPbaMaxNumberOfPortBlocksUsed": jnxJsNatPbaMaxNumberOfPortBlocksUsed,
       "jnxJsNatPbaCurrentNumberOfPortBlocksInUse": jnxJsNatPbaCurrentNumberOfPortBlocksInUse,
       "jnxJsNatPbaPortBlockAllocErrors": jnxJsNatPbaPortBlockAllocErrors,
       "jnxJsNatPbaPortBlockMemAllocErrors": jnxJsNatPbaPortBlockMemAllocErrors,
       "jnxJsNatPbaPortBlockLimitExeededErrors": jnxJsNatPbaPortBlockLimitExeededErrors,
