# SNMP MIB module (IPES2208C) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/rob/MIBs/lantech_37072/IPES2208C.mib
...
swUnitIndex = _SwUnitIndex_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 1, 1, 1, 1, 1),
    _SwUnitIndex_Type()
)
...
swHwVer = _SwHwVer_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 1, 1, 1, 1, 2),
    _SwHwVer_Type()
)
...
swFwVer = _SwFwVer_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 1, 1, 1, 1, 3),
    _SwFwVer_Type()
)
...
swPortNumber = _SwPortNumber_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 1, 1, 1, 1, 4),
    _SwPortNumber_Type()
)
...
swMacAddress = _SwMacAddress_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 1, 1, 1, 1, 5),
    _SwMacAddress_Type()
)
...
swsysName = _SwsysName_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 1, 1, 1, 1, 6),
    _SwsysName_Type()
)
...
swsysLocation = _SwsysLocation_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 1, 1, 1, 1, 7),
    _SwsysLocation_Type()
)
...
swsysDescr = _SwsysDescr_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 1, 1, 1, 1, 8),
    _SwsysDescr_Type()
)
...
swsysContact = _SwsysContact_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 1, 1, 1, 1, 9),
    _SwsysContact_Type()
)
...
class _SwKnlVer_Type(DisplayString):
    """Custom type swKnlVer based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 20),
    )
...
_SwKnlVer_Type.__name__ = "DisplayString"
_SwKnlVer_Object = MibTableColumn
swKnlVer = _SwKnlVer_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 1, 1, 1, 1, 10),
    _SwKnlVer_Type()
)
swKnlVer.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    swKnlVer.setStatus("current")
_SwitchCurrentPortNameListTable_Object = MibTable
switchCurrentPortNameListTable = _SwitchCurrentPortNameListTable_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 1, 1, 2)
)
if mibBuilder.loadTexts:
...
switchCurrentPortNameListEntry = _SwitchCurrentPortNameListEntry_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 1, 1, 2, 1)
)
switchCurrentPortNameListEntry.setIndexNames(
    (0, "IPES2208C", "swCurrentPortNameListIndex"),
)
if mibBuilder.loadTexts:
...
swCurrentPortNameListIndex = _SwCurrentPortNameListIndex_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 1, 1, 2, 1, 1),
...
swCurrentPortNameListPortName = _SwCurrentPortNameListPortName_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 1, 1, 2, 1, 2),
...
swCurrentPortNameListPortNumber = _SwCurrentPortNameListPortNumber_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 1, 1, 2, 1, 3),
...
swIpCfgIndex = _SwIpCfgIndex_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 1, 2, 1, 1, 1),
    _SwIpCfgIndex_Type()
)
...
swIpCfgDHCPStatus = _SwIpCfgDHCPStatus_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 1, 2, 1, 1, 2),
...
swIpCfgAddress = _SwIpCfgAddress_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 1, 2, 1, 1, 3),
...
swIpCfgSubMask = _SwIpCfgSubMask_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 1, 2, 1, 1, 4),
...
swIpCfgGateway = _SwIpCfgGateway_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 1, 2, 1, 1, 5),
...
swIpCfgDNS1 = _SwIpCfgDNS1_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 1, 2, 1, 1, 6),
    _SwIpCfgDNS1_Type()
)
...
swIpCfgDNS2 = _SwIpCfgDNS2_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 1, 2, 1, 1, 7),
    _SwIpCfgDNS2_Type()
)
...
class _SwIpv6cfgglobal_Type(DisplayString):
    """Custom type swIpv6cfgglobal based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 64),
    )
...
_SwIpv6cfgglobal_Type.__name__ = "DisplayString"
_SwIpv6cfgglobal_Object = MibTableColumn
swIpv6cfgglobal = _SwIpv6cfgglobal_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 1, 2, 1, 1, 8),
    _SwIpv6cfgglobal_Type()
)
swIpv6cfgglobal.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    swIpv6cfgglobal.setStatus("current")


class _SwIpv6cfglink_Type(DisplayString):
    """Custom type swIpv6cfglink based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 64),
    )
...
_SwIpv6cfglink_Type.__name__ = "DisplayString"
_SwIpv6cfglink_Object = MibTableColumn
swIpv6cfglink = _SwIpv6cfglink_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 1, 2, 1, 1, 9),
    _SwIpv6cfglink_Type()
)
swIpv6cfglink.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    swIpv6cfglink.setStatus("current")
_SwitchndcacheCfgTable_Object = MibTable
switchndcacheCfgTable = _SwitchndcacheCfgTable_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 1, 2, 2)
)
if mibBuilder.loadTexts:
    switchndcacheCfgTable.setStatus("current")
_SwitchndcacheCfgEntry_Object = MibTableRow
switchndcacheCfgEntry = _SwitchndcacheCfgEntry_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 1, 2, 2, 1)
)
switchndcacheCfgEntry.setIndexNames(
    (0, "IPES2208C", "ndcacheindex"),
)
if mibBuilder.loadTexts:
    switchndcacheCfgEntry.setStatus("current")
_Ndcacheindex_Type = Integer32
_Ndcacheindex_Object = MibTableColumn
ndcacheindex = _Ndcacheindex_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 1, 2, 2, 1, 1),
    _Ndcacheindex_Type()
)
ndcacheindex.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    ndcacheindex.setStatus("current")


class _Ndipv6address_Type(DisplayString):
    """Custom type ndipv6address based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 64),
    )
...
_Ndipv6address_Type.__name__ = "DisplayString"
_Ndipv6address_Object = MibTableColumn
ndipv6address = _Ndipv6address_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 1, 2, 2, 1, 2),
    _Ndipv6address_Type()
)
ndipv6address.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    ndipv6address.setStatus("current")


class _Ndipv6macaddress_Type(DisplayString):
    """Custom type ndipv6macaddress based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 20),
    )
...
_Ndipv6macaddress_Type.__name__ = "DisplayString"
_Ndipv6macaddress_Object = MibTableColumn
ndipv6macaddress = _Ndipv6macaddress_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 1, 2, 2, 1, 3),
    _Ndipv6macaddress_Type()
)
ndipv6macaddress.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    ndipv6macaddress.setStatus("current")


class _Ndstate_Type(DisplayString):
    """Custom type ndstate based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_Ndstate_Type.__name__ = "DisplayString"
_Ndstate_Object = MibTableColumn
ndstate = _Ndstate_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 1, 2, 2, 1, 4),
    _Ndstate_Type()
)
ndstate.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    ndstate.setStatus("current")
_SwitchDHCPServerMgt_ObjectIdentity = ObjectIdentity
switchDHCPServerMgt = _SwitchDHCPServerMgt_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 1, 3)
)
_SwitchDHCPServerCfgTable_Object = MibTable
switchDHCPServerCfgTable = _SwitchDHCPServerCfgTable_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 1, 3, 1)
)
if mibBuilder.loadTexts:
...
switchDHCPServerCfgEntry = _SwitchDHCPServerCfgEntry_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 1, 3, 1, 1)
)
switchDHCPServerCfgEntry.setIndexNames(
    (0, "IPES2208C", "swDHCPServerCfgIndex"),
)
if mibBuilder.loadTexts:
...
swDHCPServerCfgIndex = _SwDHCPServerCfgIndex_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 1, 3, 1, 1, 1),
...
swDHCPServerCfgStatus = _SwDHCPServerCfgStatus_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 1, 3, 1, 1, 2),
...
swDHCPServerCfgLowIPAddr = _SwDHCPServerCfgLowIPAddr_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 1, 3, 1, 1, 3),
...
swDHCPServerCfgHighIPAddr = _SwDHCPServerCfgHighIPAddr_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 1, 3, 1, 1, 4),
...
swDHCPServerCfgSubMask = _SwDHCPServerCfgSubMask_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 1, 3, 1, 1, 5),
...
swDHCPServerCfgGateway = _SwDHCPServerCfgGateway_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 1, 3, 1, 1, 6),
...
swDHCPServerCfgDNS = _SwDHCPServerCfgDNS_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 1, 3, 1, 1, 7),
...
swDHCPServerCfgLeaseTime = _SwDHCPServerCfgLeaseTime_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 1, 3, 1, 1, 8),
...
switchDHCPServerClientInfoTable = _SwitchDHCPServerClientInfoTable_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 1, 3, 2)
)
if mibBuilder.loadTexts:
...
switchDHCPServerClientInfoEntry = _SwitchDHCPServerClientInfoEntry_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 1, 3, 2, 1)
)
switchDHCPServerClientInfoEntry.setIndexNames(
    (0, "IPES2208C", "swDHCPServerClientInfoIndex"),
)
if mibBuilder.loadTexts:
...
swDHCPServerClientInfoIndex = _SwDHCPServerClientInfoIndex_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 1, 3, 2, 1, 1),
...
swDHCPServerClientInfoIPAddr = _SwDHCPServerClientInfoIPAddr_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 1, 3, 2, 1, 2),
...
swDHCPServerClientInfoID = _SwDHCPServerClientInfoID_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 1, 3, 2, 1, 3),
...
swDHCPServerClientInfoType = _SwDHCPServerClientInfoType_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 1, 3, 2, 1, 4),
...
swDHCPServerClientInfoStatus = _SwDHCPServerClientInfoStatus_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 1, 3, 2, 1, 5),
...
swDHCPServerClientInfoLease = _SwDHCPServerClientInfoLease_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 1, 3, 2, 1, 6),
...
switchDHCPServerIPBindingTable = _SwitchDHCPServerIPBindingTable_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 1, 3, 3)
)
if mibBuilder.loadTexts:
...
switchDHCPServerIPBindingEntry = _SwitchDHCPServerIPBindingEntry_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 1, 3, 3, 1)
)
switchDHCPServerIPBindingEntry.setIndexNames(
    (0, "IPES2208C", "swDHCPServerIPBindingPortNum"),
)
if mibBuilder.loadTexts:
...
swDHCPServerIPBindingPortNum = _SwDHCPServerIPBindingPortNum_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 1, 3, 3, 1, 1),
...
swDHCPServerIPBindingAddr = _SwDHCPServerIPBindingAddr_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 1, 3, 3, 1, 2),
...
switchSyslogMgt = _SwitchSyslogMgt_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 1, 4)
)
...
swSyslogStatus = _SwSyslogStatus_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 1, 4, 1),
...
swSyslogServerAddr = _SwSyslogServerAddr_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 1, 4, 2),
...
swSyslogEmailAlertStatus = _SwSyslogEmailAlertStatus_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 1, 4, 3),
...
swSyslogEmailAlertAddr = _SwSyslogEmailAlertAddr_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 1, 4, 4),
...
swSyslogEmailAlertSender = _SwSyslogEmailAlertSender_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 1, 4, 5),
...
swSyslogEmailAlertAuthentication = _SwSyslogEmailAlertAuthentication_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 1, 4, 6),
...
swSyslogEmailAlertAccount = _SwSyslogEmailAlertAccount_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 1, 4, 7),
...
swSyslogEmailAlertPassword = _SwSyslogEmailAlertPassword_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 1, 4, 8),
...
switchSyslogEmailAlertRcptTable = _SwitchSyslogEmailAlertRcptTable_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 1, 4, 9)
)
if mibBuilder.loadTexts:
...
switchSyslogEmailAlertRcptEntry = _SwitchSyslogEmailAlertRcptEntry_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 1, 4, 9, 1)
)
switchSyslogEmailAlertRcptEntry.setIndexNames(
    (0, "IPES2208C", "swSyslogEmailAlertRcptIndex"),
)
if mibBuilder.loadTexts:
...
swSyslogEmailAlertRcptIndex = _SwSyslogEmailAlertRcptIndex_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 1, 4, 9, 1, 1),
...
swSyslogEmailAlertRcptEmailAddr = _SwSyslogEmailAlertRcptEmailAddr_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 1, 4, 9, 1, 2),
...
switchSyslogSystemEventsTable = _SwitchSyslogSystemEventsTable_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 1, 4, 10)
)
if mibBuilder.loadTexts:
...
switchSyslogSystemEventsEntry = _SwitchSyslogSystemEventsEntry_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 1, 4, 10, 1)
)
switchSyslogSystemEventsEntry.setIndexNames(
    (0, "IPES2208C", "swSyslogSystemEventsIndex"),
)
if mibBuilder.loadTexts:
...
swSyslogSystemEventsIndex = _SwSyslogSystemEventsIndex_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 1, 4, 10, 1, 1),
...
swSyslogDeviceColdStartEvent = _SwSyslogDeviceColdStartEvent_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 1, 4, 10, 1, 2),
...
swSyslogAuthenticationFailureEvent = _SwSyslogAuthenticationFailureEvent_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 1, 4, 10, 1, 4),
...
class _SwSyslogMacViolationEvent_Type(Integer32):
    """Custom type swSyslogMacViolationEvent based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_SwSyslogMacViolationEvent_Type.__name__ = "Integer32"
_SwSyslogMacViolationEvent_Object = MibTableColumn
swSyslogMacViolationEvent = _SwSyslogMacViolationEvent_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 1, 4, 10, 1, 7),
    _SwSyslogMacViolationEvent_Type()
)
swSyslogMacViolationEvent.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    swSyslogMacViolationEvent.setStatus("current")
_SwitchSyslogPortEventsTable_Object = MibTable
switchSyslogPortEventsTable = _SwitchSyslogPortEventsTable_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 1, 4, 11)
)
if mibBuilder.loadTexts:
...
switchSyslogPortEventsEntry = _SwitchSyslogPortEventsEntry_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 1, 4, 11, 1)
)
switchSyslogPortEventsEntry.setIndexNames(
    (0, "IPES2208C", "swSyslogPortNumber"),
)
if mibBuilder.loadTexts:
...
swSyslogPortNumber = _SwSyslogPortNumber_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 1, 4, 11, 1, 1),
...
swSyslogPortEventLog = _SwSyslogPortEventLog_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 1, 4, 11, 1, 2),
...
swSyslogPortEventSMTP = _SwSyslogPortEventSMTP_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 1, 4, 11, 1, 3),
...
switchSyslogLogTable = _SwitchSyslogLogTable_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 1, 4, 12)
)
if mibBuilder.loadTexts:
...
switchSyslogLogEntry = _SwitchSyslogLogEntry_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 1, 4, 12, 1)
)
switchSyslogLogEntry.setIndexNames(
    (0, "IPES2208C", "swSyslogLogIndex"),
)
if mibBuilder.loadTexts:
...
swSyslogLogIndex = _SwSyslogLogIndex_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 1, 4, 12, 1, 1),
...
swSyslogLogDescription = _SwSyslogLogDescription_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 1, 4, 12, 1, 2),
...
swSyslogClearLogTable = _SwSyslogClearLogTable_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 1, 4, 13),
    _SwSyslogClearLogTable_Type()
)
swSyslogClearLogTable.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    swSyslogClearLogTable.setStatus("current")
_SwitchFaultRelayMgt_ObjectIdentity = ObjectIdentity
switchFaultRelayMgt = _SwitchFaultRelayMgt_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 1, 5)
)
_SwitchPowerFailureTable_Object = MibTable
switchPowerFailureTable = _SwitchPowerFailureTable_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 1, 5, 1)
)
if mibBuilder.loadTexts:
    switchPowerFailureTable.setStatus("current")
_SwitchPowerFailureEntry_Object = MibTableRow
switchPowerFailureEntry = _SwitchPowerFailureEntry_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 1, 5, 1, 1)
)
switchPowerFailureEntry.setIndexNames(
    (0, "IPES2208C", "swPowerIndex"),
)
if mibBuilder.loadTexts:
    switchPowerFailureEntry.setStatus("current")
_SwPowerIndex_Type = Integer32
_SwPowerIndex_Object = MibTableColumn
swPowerIndex = _SwPowerIndex_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 1, 5, 1, 1, 1),
    _SwPowerIndex_Type()
)
swPowerIndex.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    swPowerIndex.setStatus("current")


class _SwPower1_Type(Integer32):
    """Custom type swPower1 based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_SwPower1_Type.__name__ = "Integer32"
_SwPower1_Object = MibTableColumn
swPower1 = _SwPower1_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 1, 5, 1, 1, 2),
    _SwPower1_Type()
)
swPower1.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    swPower1.setStatus("current")


class _SwPower2_Type(Integer32):
    """Custom type swPower2 based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_SwPower2_Type.__name__ = "Integer32"
_SwPower2_Object = MibTableColumn
swPower2 = _SwPower2_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 1, 5, 1, 1, 3),
    _SwPower2_Type()
)
swPower2.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    swPower2.setStatus("current")
_SwitchPortFailureTable_Object = MibTable
switchPortFailureTable = _SwitchPortFailureTable_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 1, 5, 2)
)
if mibBuilder.loadTexts:
    switchPortFailureTable.setStatus("current")
_SwitchPortFailureEntry_Object = MibTableRow
switchPortFailureEntry = _SwitchPortFailureEntry_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 1, 5, 2, 1)
)
switchPortFailureEntry.setIndexNames(
    (0, "IPES2208C", "swPortIndex"),
)
if mibBuilder.loadTexts:
    switchPortFailureEntry.setStatus("current")
_SwPortIndex_Type = Integer32
_SwPortIndex_Object = MibTableColumn
swPortIndex = _SwPortIndex_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 1, 5, 2, 1, 1),
    _SwPortIndex_Type()
)
swPortIndex.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    swPortIndex.setStatus("current")
...
swPortName = _SwPortName_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 1, 5, 2, 1, 2),
    _SwPortName_Type()
)
swPortName.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    swPortName.setStatus("current")


class _SwPortAlarm_Type(Integer32):
    """Custom type swPortAlarm based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_SwPortAlarm_Type.__name__ = "Integer32"
_SwPortAlarm_Object = MibTableColumn
swPortAlarm = _SwPortAlarm_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 1, 5, 2, 1, 3),
    _SwPortAlarm_Type()
)
swPortAlarm.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    swPortAlarm.setStatus("current")


class _SwMACViolationFailure_Type(Integer32):
    """Custom type swMACViolationFailure based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_SwMACViolationFailure_Type.__name__ = "Integer32"
_SwMACViolationFailure_Object = MibScalar
swMACViolationFailure = _SwMACViolationFailure_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 1, 5, 3),
    _SwMACViolationFailure_Type()
)
swMACViolationFailure.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    swMACViolationFailure.setStatus("current")
_SwitchUserAuthMgt_ObjectIdentity = ObjectIdentity
switchUserAuthMgt = _SwitchUserAuthMgt_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 1, 6)
)
_SwitchUserAuthTable_Object = MibTable
switchUserAuthTable = _SwitchUserAuthTable_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 1, 6, 1)
)
if mibBuilder.loadTexts:
    switchUserAuthTable.setStatus("current")
_SwitchUserAuthEntry_Object = MibTableRow
switchUserAuthEntry = _SwitchUserAuthEntry_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 1, 6, 1, 1)
)
switchUserAuthEntry.setIndexNames(
    (0, "IPES2208C", "swUserAuthIndex"),
)
if mibBuilder.loadTexts:
    switchUserAuthEntry.setStatus("current")
_SwUserAuthIndex_Type = Integer32
_SwUserAuthIndex_Object = MibTableColumn
swUserAuthIndex = _SwUserAuthIndex_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 1, 6, 1, 1, 1),
    _SwUserAuthIndex_Type()
)
swUserAuthIndex.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    swUserAuthIndex.setStatus("current")


class _SwUserName_Type(DisplayString):
    """Custom type swUserName based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_SwUserName_Type.__name__ = "DisplayString"
_SwUserName_Object = MibTableColumn
swUserName = _SwUserName_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 1, 6, 1, 1, 2),
    _SwUserName_Type()
)
swUserName.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    swUserName.setStatus("current")


class _SwNewPassword_Type(DisplayString):
    """Custom type swNewPassword based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 9),
    )
...
_SwNewPassword_Type.__name__ = "DisplayString"
_SwNewPassword_Object = MibTableColumn
swNewPassword = _SwNewPassword_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 1, 6, 1, 1, 3),
    _SwNewPassword_Type()
)
swNewPassword.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    swNewPassword.setStatus("current")


class _SwConfirmPassword_Type(DisplayString):
    """Custom type swConfirmPassword based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 9),
    )
...
_SwConfirmPassword_Type.__name__ = "DisplayString"
_SwConfirmPassword_Object = MibTableColumn
swConfirmPassword = _SwConfirmPassword_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 1, 6, 1, 1, 4),
    _SwConfirmPassword_Type()
)
swConfirmPassword.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    swConfirmPassword.setStatus("current")
_SwitchPortMgt_ObjectIdentity = ObjectIdentity
switchPortMgt = _SwitchPortMgt_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 2)
)
_SwitchPortMgtTable_Object = MibTable
switchPortMgtTable = _SwitchPortMgtTable_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 2, 1)
)
if mibBuilder.loadTexts:
    switchPortMgtTable.setStatus("current")
_SwitchPortMgtEntry_Object = MibTableRow
switchPortMgtEntry = _SwitchPortMgtEntry_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 2, 1, 1)
)
switchPortMgtEntry.setIndexNames(
    (0, "IPES2208C", "swPortMgtIndex"),
)
if mibBuilder.loadTexts:
...
swPortMgtIndex = _SwPortMgtIndex_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 2, 1, 1, 1),
...
swPortMgtPortName = _SwPortMgtPortName_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 2, 1, 1, 2),
...
swPortMgtPortStatus = _SwPortMgtPortStatus_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 2, 1, 1, 3),
...
swPortMgtNegotiation = _SwPortMgtNegotiation_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 2, 1, 1, 4),
...
swPortMgtSpeed = _SwPortMgtSpeed_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 2, 1, 1, 5),
...
swPortMgtSpeedActual = _SwPortMgtSpeedActual_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 2, 1, 1, 6),
...
swPortMgtDuplex = _SwPortMgtDuplex_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 2, 1, 1, 7),
...
swPortMgtDuplexActual = _SwPortMgtDuplexActual_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 2, 1, 1, 8),
...
swPortMgtFlowControl = _SwPortMgtFlowControl_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 2, 1, 1, 9),
...
swPortMgtFlowControlActual = _SwPortMgtFlowControlActual_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 2, 1, 1, 10),
...
swPortMgtSecurity = _SwPortMgtSecurity_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 2, 1, 1, 11),
...
switchPortStatMgt = _SwitchPortStatMgt_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 2, 2)
)
...
switchPortStatClearTable = _SwitchPortStatClearTable_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 2, 2, 1),
...
switchPortStatTable = _SwitchPortStatTable_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 2, 2, 2)
)
if mibBuilder.loadTexts:
...
switchPortStatEntry = _SwitchPortStatEntry_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 2, 2, 2, 1)
)
switchPortStatEntry.setIndexNames(
    (0, "IPES2208C", "swPortStatIndex"),
)
if mibBuilder.loadTexts:
...
swPortStatIndex = _SwPortStatIndex_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 2, 2, 2, 1, 1),
...
swPortStatType = _SwPortStatType_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 2, 2, 2, 1, 2),
...
swPortStatLink = _SwPortStatLink_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 2, 2, 2, 1, 3),
...
swPortStatState = _SwPortStatState_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 2, 2, 2, 1, 4),
...
swPortStatTXGoodPkt = _SwPortStatTXGoodPkt_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 2, 2, 2, 1, 5),
...
swPortStatTXBadPkt = _SwPortStatTXBadPkt_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 2, 2, 2, 1, 6),
...
swPortStatRXGoodPkt = _SwPortStatRXGoodPkt_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 2, 2, 2, 1, 7),
...
swPortStatRXBadPkt = _SwPortStatRXBadPkt_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 2, 2, 2, 1, 8),
...
swPortStatTXAbortPkt = _SwPortStatTXAbortPkt_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 2, 2, 2, 1, 9),
...
swPortStatPacketCollision = _SwPortStatPacketCollision_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 2, 2, 2, 1, 10),
...
swPortStatPacketDropped = _SwPortStatPacketDropped_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 2, 2, 2, 1, 11),
...
swPortStatRXBcastPkt = _SwPortStatRXBcastPkt_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 2, 2, 2, 1, 12),
...
swPortStatRXMcastPkt = _SwPortStatRXMcastPkt_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 2, 2, 2, 1, 13),
...
switchPortTrunkAggregatorTable = _SwitchPortTrunkAggregatorTable_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 2, 3, 2)
)
if mibBuilder.loadTexts:
...
switchPortTrunkAggregatorEntry = _SwitchPortTrunkAggregatorEntry_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 2, 3, 2, 1)
)
switchPortTrunkAggregatorEntry.setIndexNames(
    (0, "IPES2208C", "swPortTrunkAggregatorIndex"),
)
if mibBuilder.loadTexts:
...
swPortTrunkAggregatorIndex = _SwPortTrunkAggregatorIndex_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 2, 3, 2, 1, 1),
...
swPortTrunkAggregatorGroupName = _SwPortTrunkAggregatorGroupName_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 2, 3, 2, 1, 2),
...
swPortTrunkAggregatorMemberPorts = _SwPortTrunkAggregatorMemberPorts_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 2, 3, 2, 1, 3),
...
swPortTrunkAggregatorLACPStatus = _SwPortTrunkAggregatorLACPStatus_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 2, 3, 2, 1, 4),
...
swPortTrunkAggregatorWorkPorts = _SwPortTrunkAggregatorWorkPorts_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 2, 3, 2, 1, 5),
...
switchPortTrunkLACPStateActTable = _SwitchPortTrunkLACPStateActTable_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 2, 3, 3)
)
if mibBuilder.loadTexts:
...
switchPortTrunkLACPStateActEntry = _SwitchPortTrunkLACPStateActEntry_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 2, 3, 3, 1)
)
switchPortTrunkLACPStateActEntry.setIndexNames(
    (0, "IPES2208C", "swPortTrunkLACPStateActPortNum"),
)
if mibBuilder.loadTexts:
...
swPortTrunkLACPStateActPortNum = _SwPortTrunkLACPStateActPortNum_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 2, 3, 3, 1, 1),
...
swPortTrunkLACPStateActStatus = _SwPortTrunkLACPStateActStatus_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 2, 3, 3, 1, 2),
...
switchPortTrunkAggregatorInfoTable = _SwitchPortTrunkAggregatorInfoTable_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 2, 3, 4)
)
if mibBuilder.loadTexts:
...
switchPortTrunkAggregatorInfoEntry = _SwitchPortTrunkAggregatorInfoEntry_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 2, 3, 4, 1)
)
switchPortTrunkAggregatorInfoEntry.setIndexNames(
    (0, "IPES2208C", "swPortTrunkAggregatorInfoIndex"),
)
if mibBuilder.loadTexts:
...
swPortTrunkAggregatorInfoIndex = _SwPortTrunkAggregatorInfoIndex_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 2, 3, 4, 1, 1),
...
swPortTrunkAggregatorInfoGroupName = _SwPortTrunkAggregatorInfoGroupName_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 2, 3, 4, 1, 2),
...
swPortTrunkAggregatorInfoDescription = _SwPortTrunkAggregatorInfoDescription_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 2, 3, 4, 1, 3),
...
switchPortMirrorMgt = _SwitchPortMirrorMgt_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 2, 4)
)
...
swPortMirrorDestinationPortTX = _SwPortMirrorDestinationPortTX_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 2, 4, 1),
...
swPortMirrorDestinationPortRX = _SwPortMirrorDestinationPortRX_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 2, 4, 2),
...
switchPortMirrorSourceTable = _SwitchPortMirrorSourceTable_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 2, 4, 3)
)
if mibBuilder.loadTexts:
...
switchPortMirrorSourceEntry = _SwitchPortMirrorSourceEntry_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 2, 4, 3, 1)
)
switchPortMirrorSourceEntry.setIndexNames(
    (0, "IPES2208C", "swPortMirrorPortNum"),
)
if mibBuilder.loadTexts:
...
swPortMirrorPortNum = _SwPortMirrorPortNum_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 2, 4, 3, 1, 1),
...
swPortMirrorSourcePort = _SwPortMirrorSourcePort_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 2, 4, 3, 1, 2),
...
switchPortRateLimitingEntry = _SwitchPortRateLimitingEntry_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 2, 5, 1, 1)
)
switchPortRateLimitingEntry.setIndexNames(
    (0, "IPES2208C", "swPortRateLimitingPortNum"),
)
if mibBuilder.loadTexts:
...
swPortRateLimitingPortNum = _SwPortRateLimitingPortNum_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 2, 5, 1, 1, 1),
...
swPortRateLimitingPortType = _SwPortRateLimitingPortType_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 2, 5, 1, 1, 2),
...
class _SwPortRateLimitingIngressRate_Type(Integer32):
    """Custom type swPortRateLimitingIngressRate based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
class _SwPortRateLimitingEgressRate_Type(Integer32):
    """Custom type swPortRateLimitingEgressRate based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_SwitchPortDmiTable_Object = MibTable
switchPortDmiTable = _SwitchPortDmiTable_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 2, 6)
)
if mibBuilder.loadTexts:
    switchPortDmiTable.setStatus("current")
_SwitchPortDmiEntry_Object = MibTableRow
switchPortDmiEntry = _SwitchPortDmiEntry_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 2, 6, 1)
)
switchPortDmiEntry.setIndexNames(
    (0, "IPES2208C", "swPortDmiIndex"),
)
if mibBuilder.loadTexts:
    switchPortDmiEntry.setStatus("current")
_SwPortDmiIndex_Type = Integer32
_SwPortDmiIndex_Object = MibTableColumn
swPortDmiIndex = _SwPortDmiIndex_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 2, 6, 1, 1),
    _SwPortDmiIndex_Type()
)
swPortDmiIndex.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    swPortDmiIndex.setStatus("current")


class _SwPortDmiPortProperty_Type(DisplayString):
    """Custom type swPortDmiPortProperty based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 20),
    )
...
_SwPortDmiPortProperty_Type.__name__ = "DisplayString"
_SwPortDmiPortProperty_Object = MibTableColumn
swPortDmiPortProperty = _SwPortDmiPortProperty_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 2, 6, 1, 2),
    _SwPortDmiPortProperty_Type()
)
swPortDmiPortProperty.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    swPortDmiPortProperty.setStatus("current")


class _SwPortDmiHighAlarm_Type(Integer32):
    """Custom type swPortDmiHighAlarm based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_SwPortDmiHighAlarm_Type.__name__ = "Integer32"
_SwPortDmiHighAlarm_Object = MibTableColumn
swPortDmiHighAlarm = _SwPortDmiHighAlarm_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 2, 6, 1, 3),
    _SwPortDmiHighAlarm_Type()
)
swPortDmiHighAlarm.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    swPortDmiHighAlarm.setStatus("current")


class _SwPortDmiHighAlarmThreshold_Type(DisplayString):
    """Custom type swPortDmiHighAlarmThreshold based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 20),
    )
...
_SwPortDmiHighAlarmThreshold_Type.__name__ = "DisplayString"
_SwPortDmiHighAlarmThreshold_Object = MibTableColumn
swPortDmiHighAlarmThreshold = _SwPortDmiHighAlarmThreshold_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 2, 6, 1, 4),
    _SwPortDmiHighAlarmThreshold_Type()
)
swPortDmiHighAlarmThreshold.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    swPortDmiHighAlarmThreshold.setStatus("current")


class _SwPortDmiHighWarning_Type(Integer32):
    """Custom type swPortDmiHighWarning based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_SwPortDmiHighWarning_Type.__name__ = "Integer32"
_SwPortDmiHighWarning_Object = MibTableColumn
swPortDmiHighWarning = _SwPortDmiHighWarning_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 2, 6, 1, 5),
    _SwPortDmiHighWarning_Type()
)
swPortDmiHighWarning.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    swPortDmiHighWarning.setStatus("current")


class _SwPortDmiHighWarningThreshold_Type(DisplayString):
    """Custom type swPortDmiHighWarningThreshold based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 20),
    )
...
_SwPortDmiHighWarningThreshold_Type.__name__ = "DisplayString"
_SwPortDmiHighWarningThreshold_Object = MibTableColumn
swPortDmiHighWarningThreshold = _SwPortDmiHighWarningThreshold_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 2, 6, 1, 6),
    _SwPortDmiHighWarningThreshold_Type()
)
swPortDmiHighWarningThreshold.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    swPortDmiHighWarningThreshold.setStatus("current")


class _SwPortDmiStatus_Type(DisplayString):
    """Custom type swPortDmiStatus based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 20),
    )
...
_SwPortDmiStatus_Type.__name__ = "DisplayString"
_SwPortDmiStatus_Object = MibTableColumn
swPortDmiStatus = _SwPortDmiStatus_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 2, 6, 1, 7),
    _SwPortDmiStatus_Type()
)
swPortDmiStatus.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    swPortDmiStatus.setStatus("current")


class _SwPortDmiLowWarning_Type(Integer32):
    """Custom type swPortDmiLowWarning based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_SwPortDmiLowWarning_Type.__name__ = "Integer32"
_SwPortDmiLowWarning_Object = MibTableColumn
swPortDmiLowWarning = _SwPortDmiLowWarning_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 2, 6, 1, 8),
    _SwPortDmiLowWarning_Type()
)
swPortDmiLowWarning.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    swPortDmiLowWarning.setStatus("current")


class _SwPortDmiLowWarningThreshold_Type(DisplayString):
    """Custom type swPortDmiLowWarningThreshold based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 20),
    )
...
_SwPortDmiLowWarningThreshold_Type.__name__ = "DisplayString"
_SwPortDmiLowWarningThreshold_Object = MibTableColumn
swPortDmiLowWarningThreshold = _SwPortDmiLowWarningThreshold_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 2, 6, 1, 9),
    _SwPortDmiLowWarningThreshold_Type()
)
swPortDmiLowWarningThreshold.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    swPortDmiLowWarningThreshold.setStatus("current")


class _SwPortDmiLowAlarm_Type(Integer32):
    """Custom type swPortDmiLowAlarm based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_SwPortDmiLowAlarm_Type.__name__ = "Integer32"
_SwPortDmiLowAlarm_Object = MibTableColumn
swPortDmiLowAlarm = _SwPortDmiLowAlarm_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 2, 6, 1, 10),
    _SwPortDmiLowAlarm_Type()
)
swPortDmiLowAlarm.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    swPortDmiLowAlarm.setStatus("current")


class _SwPortDmiLowAlarmThreshold_Type(DisplayString):
    """Custom type swPortDmiLowAlarmThreshold based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 20),
    )
...
_SwPortDmiLowAlarmThreshold_Type.__name__ = "DisplayString"
_SwPortDmiLowAlarmThreshold_Object = MibTableColumn
swPortDmiLowAlarmThreshold = _SwPortDmiLowAlarmThreshold_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 2, 6, 1, 11),
    _SwPortDmiLowAlarmThreshold_Type()
)
swPortDmiLowAlarmThreshold.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    swPortDmiLowAlarmThreshold.setStatus("current")
_SwitchProtocolMgt_ObjectIdentity = ObjectIdentity
switchProtocolMgt = _SwitchProtocolMgt_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3)
)
_VlanMgt_ObjectIdentity = ObjectIdentity
vlanMgt = _VlanMgt_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 1)
)
...
vlanOperationMode = _VlanOperationMode_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 1, 1),
...
vlanGVRP = _VlanGVRP_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 1, 2),
    _VlanGVRP_Type()
)
...
vlanMgtVID = _VlanMgtVID_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 1, 3),
    _VlanMgtVID_Type()
)
...
vlanPortBasedIndex = _VlanPortBasedIndex_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 1, 4, 1, 1),
...
vlanPortBasedGroupName = _VlanPortBasedGroupName_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 1, 4, 1, 2),
...
vlanPortBasedVid = _VlanPortBasedVid_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 1, 4, 1, 3),
...
vlanPortBasedMembers = _VlanPortBasedMembers_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 1, 4, 1, 4),
...
vlanPortBasedStatus = _VlanPortBasedStatus_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 1, 4, 1, 5),
...
vlanIEEE8021QIndex = _VlanIEEE8021QIndex_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 1, 5, 1, 1),
...
vlanIEEE8021QPortName = _VlanIEEE8021QPortName_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 1, 5, 1, 2),
...
vlanIEEE8021QLinkType = _VlanIEEE8021QLinkType_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 1, 5, 1, 3),
...
vlanIEEE8021QUntaggedVid = _VlanIEEE8021QUntaggedVid_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 1, 5, 1, 4),
...
vlanIEEE8021QTaggedVids = _VlanIEEE8021QTaggedVids_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 1, 5, 1, 5),
...
vlanIEEE8021QGroupTable = _VlanIEEE8021QGroupTable_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 1, 6)
)
if mibBuilder.loadTexts:
...
vlanIEEE8021QGroupEntry = _VlanIEEE8021QGroupEntry_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 1, 6, 1)
)
vlanIEEE8021QGroupEntry.setIndexNames(
    (0, "IPES2208C", "vlanIEEE8021QGroupVid"),
)
if mibBuilder.loadTexts:
...
vlanIEEE8021QGroupVid = _VlanIEEE8021QGroupVid_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 1, 6, 1, 1),
...
vlanIEEE8021QGroupName = _VlanIEEE8021QGroupName_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 1, 6, 1, 2),
...
vlanIEEE8021QGroupStatus = _VlanIEEE8021QGroupStatus_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 1, 6, 1, 3),
...
rstpMgt = _RstpMgt_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 2)
)
...
rstpStatus = _RstpStatus_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 2, 1),
    _RstpStatus_Type()
)
...
rstpPriority = _RstpPriority_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 2, 2),
    _RstpPriority_Type()
)
...
rstpMaxAge = _RstpMaxAge_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 2, 3),
    _RstpMaxAge_Type()
)
...
rstpHelloTime = _RstpHelloTime_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 2, 4),
    _RstpHelloTime_Type()
)
...
rstpForwardDelayTime = _RstpForwardDelayTime_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 2, 5),
...
rstpRootBridgeInformationTable = _RstpRootBridgeInformationTable_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 2, 6)
)
if mibBuilder.loadTexts:
...
rstpRootBridgeInformationEntry = _RstpRootBridgeInformationEntry_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 2, 6, 1)
)
rstpRootBridgeInformationEntry.setIndexNames(
    (0, "IPES2208C", "rstpRootBridgeInformationIndex"),
)
if mibBuilder.loadTexts:
...
rstpRootBridgeInformationIndex = _RstpRootBridgeInformationIndex_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 2, 6, 1, 1),
...
rstpRootBridgeInformationBridgeID = _RstpRootBridgeInformationBridgeID_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 2, 6, 1, 2),
...
rstpRootBridgeInformationRootPriority = _RstpRootBridgeInformationRootPriority_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 2, 6, 1, 3),
...
rstpRootBridgeInformationRootPort = _RstpRootBridgeInformationRootPort_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 2, 6, 1, 4),
...
rstpRootBridgeInformationRootPathCost = _RstpRootBridgeInformationRootPathCost_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 2, 6, 1, 5),
...
rstpRootBridgeInformationMaxAge = _RstpRootBridgeInformationMaxAge_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 2, 6, 1, 6),
...
rstpRootBridgeInformationHelloTime = _RstpRootBridgeInformationHelloTime_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 2, 6, 1, 7),
...
rstpRootBridgeInformationForwardDelay = _RstpRootBridgeInformationForwardDelay_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 2, 6, 1, 8),
...
rstpPerPortCfgTable = _RstpPerPortCfgTable_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 2, 7)
)
if mibBuilder.loadTexts:
...
rstpPerPortCfgEntry = _RstpPerPortCfgEntry_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 2, 7, 1)
)
rstpPerPortCfgEntry.setIndexNames(
    (0, "IPES2208C", "rstpPerPortCfgPortNum"),
)
if mibBuilder.loadTexts:
...
rstpPerPortCfgPortNum = _RstpPerPortCfgPortNum_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 2, 7, 1, 1),
...
rstpPerPortCfgPathCost = _RstpPerPortCfgPathCost_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 2, 7, 1, 2),
...
rstpPerPortCfgPriority = _RstpPerPortCfgPriority_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 2, 7, 1, 3),
...
rstpPerPortCfgAdminP2P = _RstpPerPortCfgAdminP2P_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 2, 7, 1, 4),
...
rstpPerPortCfgAdminEdge = _RstpPerPortCfgAdminEdge_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 2, 7, 1, 5),
...
rstpPerPortCfgAdminNonStp = _RstpPerPortCfgAdminNonStp_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 2, 7, 1, 6),
...
rstpPerPortInfoTable = _RstpPerPortInfoTable_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 2, 8)
)
if mibBuilder.loadTexts:
...
rstpPerPortInfoEntry = _RstpPerPortInfoEntry_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 2, 8, 1)
)
rstpPerPortInfoEntry.setIndexNames(
    (0, "IPES2208C", "rstpPerPortInfoPortNum"),
)
if mibBuilder.loadTexts:
...
rstpPerPortInfoPortNum = _RstpPerPortInfoPortNum_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 2, 8, 1, 1),
...
rstpPerPortInfoPathCost = _RstpPerPortInfoPathCost_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 2, 8, 1, 2),
...
rstpPerPortInfoPriority = _RstpPerPortInfoPriority_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 2, 8, 1, 3),
...
rstpPerPortInfoAdminP2P = _RstpPerPortInfoAdminP2P_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 2, 8, 1, 4),
...
rstpPerPortInfoAdminEdge = _RstpPerPortInfoAdminEdge_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 2, 8, 1, 5),
...
rstpPerPortInfoStpNeighbor = _RstpPerPortInfoStpNeighbor_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 2, 8, 1, 6),
...
rstpPerPortInfoState = _RstpPerPortInfoState_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 2, 8, 1, 7),
...
rstpPerPortInfoRole = _RstpPerPortInfoRole_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 2, 8, 1, 8),
...
qosMgt = _QosMgt_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 3)
)
...
qosPolicy = _QosPolicy_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 3, 1),
    _QosPolicy_Type()
)
...
qosPriorityType = _QosPriorityType_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 3, 2),
...
qosPortBasedPriorityTable = _QosPortBasedPriorityTable_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 3, 3)
)
if mibBuilder.loadTexts:
...
qosPortBasedPriorityEntry = _QosPortBasedPriorityEntry_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 3, 3, 1)
)
qosPortBasedPriorityEntry.setIndexNames(
    (0, "IPES2208C", "qosPortBasedPriorityPortNum"),
)
if mibBuilder.loadTexts:
...
qosPortBasedPriorityPortNum = _QosPortBasedPriorityPortNum_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 3, 3, 1, 1),
...
qosPortBasedPriority = _QosPortBasedPriority_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 3, 3, 1, 2),
...
qosCOSPriority = _QosCOSPriority_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 3, 4, 1, 1),
...
qosCOS = _QosCOS_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 3, 4, 1, 2),
    _QosCOS_Type()
)
...
qosTOSPriority = _QosTOSPriority_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 3, 5, 1, 1),
...
qosTOS = _QosTOS_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 3, 5, 1, 2),
    _QosTOS_Type()
)
...
sntpMgt = _SntpMgt_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 4)
)
...
sntpClientStatus = _SntpClientStatus_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 4, 1),
...
sntpDaylightSavingTime = _SntpDaylightSavingTime_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 4, 2),
...
sntpUTCTimezone = _SntpUTCTimezone_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 4, 3),
...
sntpServerIP = _SntpServerIP_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 4, 4),
    _SntpServerIP_Type()
)
...
sntpSwitchTimer = _SntpSwitchTimer_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 4, 5),
...
sntpDaylightSavingPeriodStart = _SntpDaylightSavingPeriodStart_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 4, 6),
...
sntpDaylightSavingPeriodEnd = _SntpDaylightSavingPeriodEnd_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 4, 7),
...
sntpDaylightSavingOffset = _SntpDaylightSavingOffset_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 4, 8),
    _SntpDaylightSavingOffset_Type()
)
sntpDaylightSavingOffset.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    sntpDaylightSavingOffset.setStatus("current")
_SntpSynchronizationInterval_Type = Integer32
_SntpSynchronizationInterval_Object = MibScalar
sntpSynchronizationInterval = _SntpSynchronizationInterval_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 4, 9),
    _SntpSynchronizationInterval_Type()
)
sntpSynchronizationInterval.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    sntpSynchronizationInterval.setStatus("current")
_IgmpMgt_ObjectIdentity = ObjectIdentity
igmpMgt = _IgmpMgt_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 5)
)
...
igmpStatus = _IgmpStatus_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 5, 1),
    _IgmpStatus_Type()
)
...
igmpQuery = _IgmpQuery_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 5, 2),
    _IgmpQuery_Type()
)
...
igmpEntriesEntryIndex = _IgmpEntriesEntryIndex_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 5, 3, 1, 1),
...
igmpEntriesEntryIPAddr = _IgmpEntriesEntryIPAddr_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 5, 3, 1, 2),
...
igmpEntriesEntryVID = _IgmpEntriesEntryVID_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 5, 3, 1, 3),
...
igmpEntriesEntryMembers = _IgmpEntriesEntryMembers_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 5, 3, 1, 4),
...
snmpMgt = _SnmpMgt_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 7)
)
...
snmpAgentMode = _SnmpAgentMode_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 7, 1),
    _SnmpAgentMode_Type()
)
...
snmpSystemName = _SnmpSystemName_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 7, 2),
...
snmpSystemLocation = _SnmpSystemLocation_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 7, 3),
...
snmpSystemContact = _SnmpSystemContact_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 7, 4),
...
snmpCommunityStringTable = _SnmpCommunityStringTable_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 7, 5)
)
if mibBuilder.loadTexts:
...
snmpCommunityStringEntry = _SnmpCommunityStringEntry_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 7, 5, 1)
)
snmpCommunityStringEntry.setIndexNames(
    (0, "IPES2208C", "snmpCommunityStringIndex"),
)
if mibBuilder.loadTexts:
...
snmpCommunityStringIndex = _SnmpCommunityStringIndex_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 7, 5, 1, 1),
...
snmpCommunityStringName = _SnmpCommunityStringName_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 7, 5, 1, 2),
...
snmpCommunityStringAttribute = _SnmpCommunityStringAttribute_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 7, 5, 1, 3),
...
snmpCommunityStringStatus = _SnmpCommunityStringStatus_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 7, 5, 1, 4),
...
snmpTrapServerTable = _SnmpTrapServerTable_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 7, 6)
)
if mibBuilder.loadTexts:
...
snmpTrapServerEntry = _SnmpTrapServerEntry_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 7, 6, 1)
)
snmpTrapServerEntry.setIndexNames(
    (0, "IPES2208C", "snmpTrapServerIndex"),
)
if mibBuilder.loadTexts:
...
snmpTrapServerIndex = _SnmpTrapServerIndex_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 7, 6, 1, 1),
...
snmpTrapServerIPAddr = _SnmpTrapServerIPAddr_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 7, 6, 1, 2),
...
snmpTrapServerTrapComm = _SnmpTrapServerTrapComm_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 7, 6, 1, 3),
...
snmpTrapServerTrapVer = _SnmpTrapServerTrapVer_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 7, 6, 1, 4),
...
snmpTrapServerStatus = _SnmpTrapServerStatus_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 7, 6, 1, 5),
...
snmpV3ContextName = _SnmpV3ContextName_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 7, 7),
...
snmpV3UsrPrfIndex = _SnmpV3UsrPrfIndex_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 7, 8, 1, 1),
...
snmpV3UsrPrfUserID = _SnmpV3UsrPrfUserID_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 7, 8, 1, 2),
...
snmpV3UsrPrfAuthPw = _SnmpV3UsrPrfAuthPw_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 7, 8, 1, 3),
...
snmpV3UsrPrfPrivacyPw = _SnmpV3UsrPrfPrivacyPw_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 7, 8, 1, 4),
...
snmpV3UsrPrfOperation = _SnmpV3UsrPrfOperation_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 7, 8, 1, 5),
...
snmpV3GroupContentTable = _SnmpV3GroupContentTable_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 7, 9)
)
if mibBuilder.loadTexts:
...
snmpV3GroupContentEntry = _SnmpV3GroupContentEntry_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 7, 9, 1)
)
snmpV3GroupContentEntry.setIndexNames(
    (0, "IPES2208C", "snmpV3GroupContentIndex"),
)
if mibBuilder.loadTexts:
...
snmpV3GroupContentIndex = _SnmpV3GroupContentIndex_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 7, 9, 1, 1),
...
snmpV3GroupContentSecurityName = _SnmpV3GroupContentSecurityName_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 7, 9, 1, 2),
...
snmpV3GroupContentGroupName = _SnmpV3GroupContentGroupName_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 7, 9, 1, 3),
...
snmpV3GroupContentOperation = _SnmpV3GroupContentOperation_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 7, 9, 1, 4),
...
snmpV3AccessIndex = _SnmpV3AccessIndex_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 7, 10, 1, 1),
...
snmpV3AccessContextPrefix = _SnmpV3AccessContextPrefix_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 7, 10, 1, 2),
...
snmpV3AccessGroupName = _SnmpV3AccessGroupName_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 7, 10, 1, 3),
...
snmpV3AccessSecurityLevel = _SnmpV3AccessSecurityLevel_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 7, 10, 1, 4),
...
snmpV3AccessContextMatchRule = _SnmpV3AccessContextMatchRule_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 7, 10, 1, 5),
...
snmpV3AccessReadViewName = _SnmpV3AccessReadViewName_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 7, 10, 1, 6),
...
snmpV3AccessWriteViewName = _SnmpV3AccessWriteViewName_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 7, 10, 1, 7),
...
snmpV3AccessNotifyViewName = _SnmpV3AccessNotifyViewName_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 7, 10, 1, 8),
...
snmpV3AccessOperation = _SnmpV3AccessOperation_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 7, 10, 1, 9),
...
snmpV3MIBViewIndex = _SnmpV3MIBViewIndex_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 7, 11, 1, 1),
...
snmpV3MIBViewName = _SnmpV3MIBViewName_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 7, 11, 1, 2),
...
snmpV3MIBViewSubOidTree = _SnmpV3MIBViewSubOidTree_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 7, 11, 1, 3),
...
snmpV3MIBViewType = _SnmpV3MIBViewType_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 7, 11, 1, 4),
...
snmpV3MIBViewOperation = _SnmpV3MIBViewOperation_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 7, 11, 1, 5),
...
class _SnmpV3EngineID_Type(DisplayString):
    """Custom type snmpV3EngineID based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 64),
    )
...
_SnmpV3EngineID_Type.__name__ = "DisplayString"
_SnmpV3EngineID_Object = MibScalar
snmpV3EngineID = _SnmpV3EngineID_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 7, 12),
...
lldpMgt = _LldpMgt_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 8)
)
...
lldpStatus = _LldpStatus_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 8, 1),
    _LldpStatus_Type()
)
...
lldpInterval = _LldpInterval_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 8, 2),
    _LldpInterval_Type()
)
lldpInterval.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    lldpInterval.setStatus("current")
_XRing2Mgt_ObjectIdentity = ObjectIdentity
xRing2Mgt = _XRing2Mgt_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 10)
)


class _XRing2OperMode_Type(Integer32):
    """Custom type xRing2OperMode based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_XRing2OperMode_Type.__name__ = "Integer32"
_XRing2OperMode_Object = MibScalar
xRing2OperMode = _XRing2OperMode_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 10, 1),
    _XRing2OperMode_Type()
)
xRing2OperMode.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    xRing2OperMode.setStatus("current")
_XRing2Table_Object = MibTable
xRing2Table = _XRing2Table_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 10, 2)
)
if mibBuilder.loadTexts:
    xRing2Table.setStatus("current")
_XRing2Entry_Object = MibTableRow
xRing2Entry = _XRing2Entry_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 10, 2, 1)
)
xRing2Entry.setIndexNames(
    (0, "IPES2208C", "xRing2Index"),
)
if mibBuilder.loadTexts:
    xRing2Entry.setStatus("current")
_XRing2Index_Type = Integer32
_XRing2Index_Object = MibTableColumn
xRing2Index = _XRing2Index_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 10, 2, 1, 1),
    _XRing2Index_Type()
)
xRing2Index.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    xRing2Index.setStatus("current")
_XRing2RingID_Type = Integer32
_XRing2RingID_Object = MibTableColumn
xRing2RingID = _XRing2RingID_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 10, 2, 1, 2),
    _XRing2RingID_Type()
)
xRing2RingID.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    xRing2RingID.setStatus("current")


class _XRing2_1stRingPortName_Type(DisplayString):
    """Custom type xRing2_1stRingPortName based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 32),
    )
...
_XRing2_1stRingPortName_Type.__name__ = "DisplayString"
_XRing2_1stRingPortName_Object = MibTableColumn
xRing2_1stRingPortName = _XRing2_1stRingPortName_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 10, 2, 1, 3),
    _XRing2_1stRingPortName_Type()
)
xRing2_1stRingPortName.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    xRing2_1stRingPortName.setStatus("current")


class _XRing2_1stRingPortState_Type(Integer32):
    """Custom type xRing2_1stRingPortState based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_XRing2_1stRingPortState_Type.__name__ = "Integer32"
_XRing2_1stRingPortState_Object = MibTableColumn
xRing2_1stRingPortState = _XRing2_1stRingPortState_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 10, 2, 1, 4),
    _XRing2_1stRingPortState_Type()
)
xRing2_1stRingPortState.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    xRing2_1stRingPortState.setStatus("current")


class _XRing2_2ndRingPortName_Type(DisplayString):
    """Custom type xRing2_2ndRingPortName based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 32),
    )
...
_XRing2_2ndRingPortName_Type.__name__ = "DisplayString"
_XRing2_2ndRingPortName_Object = MibTableColumn
xRing2_2ndRingPortName = _XRing2_2ndRingPortName_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 10, 2, 1, 5),
    _XRing2_2ndRingPortName_Type()
)
xRing2_2ndRingPortName.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    xRing2_2ndRingPortName.setStatus("current")


class _XRing2_2ndRingPortState_Type(Integer32):
    """Custom type xRing2_2ndRingPortState based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_XRing2_2ndRingPortState_Type.__name__ = "Integer32"
_XRing2_2ndRingPortState_Object = MibTableColumn
xRing2_2ndRingPortState = _XRing2_2ndRingPortState_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 10, 2, 1, 6),
    _XRing2_2ndRingPortState_Type()
)
xRing2_2ndRingPortState.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    xRing2_2ndRingPortState.setStatus("current")


class _XRing2Mode_Type(Integer32):
    """Custom type xRing2Mode based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_XRing2Mode_Type.__name__ = "Integer32"
_XRing2Mode_Object = MibTableColumn
xRing2Mode = _XRing2Mode_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 10, 2, 1, 7),
    _XRing2Mode_Type()
)
xRing2Mode.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    xRing2Mode.setStatus("current")


class _XRing2_1stRdnPortName_Type(DisplayString):
    """Custom type xRing2_1stRdnPortName based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 32),
    )
...
_XRing2_1stRdnPortName_Type.__name__ = "DisplayString"
_XRing2_1stRdnPortName_Object = MibTableColumn
xRing2_1stRdnPortName = _XRing2_1stRdnPortName_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 10, 2, 1, 8),
    _XRing2_1stRdnPortName_Type()
)
xRing2_1stRdnPortName.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    xRing2_1stRdnPortName.setStatus("current")


class _XRing2_1stRdnPortState_Type(Integer32):
    """Custom type xRing2_1stRdnPortState based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_XRing2_1stRdnPortState_Type.__name__ = "Integer32"
_XRing2_1stRdnPortState_Object = MibTableColumn
xRing2_1stRdnPortState = _XRing2_1stRdnPortState_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 10, 2, 1, 9),
    _XRing2_1stRdnPortState_Type()
)
xRing2_1stRdnPortState.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    xRing2_1stRdnPortState.setStatus("current")
_XRing2_1stRdnPortID_Type = Integer32
_XRing2_1stRdnPortID_Object = MibTableColumn
xRing2_1stRdnPortID = _XRing2_1stRdnPortID_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 10, 2, 1, 10),
    _XRing2_1stRdnPortID_Type()
)
xRing2_1stRdnPortID.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    xRing2_1stRdnPortID.setStatus("current")


class _XRing2_2ndRdnPortName_Type(DisplayString):
    """Custom type xRing2_2ndRdnPortName based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 32),
    )
...
_XRing2_2ndRdnPortName_Type.__name__ = "DisplayString"
_XRing2_2ndRdnPortName_Object = MibTableColumn
xRing2_2ndRdnPortName = _XRing2_2ndRdnPortName_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 10, 2, 1, 11),
    _XRing2_2ndRdnPortName_Type()
)
xRing2_2ndRdnPortName.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    xRing2_2ndRdnPortName.setStatus("current")


class _XRing2_2ndRdnPortState_Type(Integer32):
    """Custom type xRing2_2ndRdnPortState based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_XRing2_2ndRdnPortState_Type.__name__ = "Integer32"
_XRing2_2ndRdnPortState_Object = MibTableColumn
xRing2_2ndRdnPortState = _XRing2_2ndRdnPortState_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 10, 2, 1, 12),
    _XRing2_2ndRdnPortState_Type()
)
xRing2_2ndRdnPortState.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    xRing2_2ndRdnPortState.setStatus("current")
_XRing2_2ndRdnPortID_Type = Integer32
_XRing2_2ndRdnPortID_Object = MibTableColumn
xRing2_2ndRdnPortID = _XRing2_2ndRdnPortID_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 10, 2, 1, 13),
    _XRing2_2ndRdnPortID_Type()
)
xRing2_2ndRdnPortID.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    xRing2_2ndRdnPortID.setStatus("current")


class _XRing2Action_Type(Integer32):
    """Custom type xRing2Action based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_XRing2Action_Type.__name__ = "Integer32"
_XRing2Action_Object = MibTableColumn
xRing2Action = _XRing2Action_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 10, 2, 1, 14),
    _XRing2Action_Type()
)
xRing2Action.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    xRing2Action.setStatus("current")


class _XRing2Legacy_1stPortName_Type(DisplayString):
    """Custom type xRing2Legacy_1stPortName based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 32),
    )
...
_XRing2Legacy_1stPortName_Type.__name__ = "DisplayString"
_XRing2Legacy_1stPortName_Object = MibScalar
xRing2Legacy_1stPortName = _XRing2Legacy_1stPortName_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 10, 3),
    _XRing2Legacy_1stPortName_Type()
)
xRing2Legacy_1stPortName.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    xRing2Legacy_1stPortName.setStatus("current")


class _XRing2Legacy_2ndPortName_Type(DisplayString):
    """Custom type xRing2Legacy_2ndPortName based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 32),
    )
...
_XRing2Legacy_2ndPortName_Type.__name__ = "DisplayString"
_XRing2Legacy_2ndPortName_Object = MibScalar
xRing2Legacy_2ndPortName = _XRing2Legacy_2ndPortName_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 3, 10, 4),
    _XRing2Legacy_2ndPortName_Type()
)
xRing2Legacy_2ndPortName.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    xRing2Legacy_2ndPortName.setStatus("current")
_SwitchSecurityMgt_ObjectIdentity = ObjectIdentity
switchSecurityMgt = _SwitchSecurityMgt_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 4)
)
_RadiusMgt_ObjectIdentity = ObjectIdentity
radiusMgt = _RadiusMgt_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 4, 1)
)
...
radius8021xProtocolStatus = _Radius8021xProtocolStatus_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 4, 1, 1),
...
radiusServerIP = _RadiusServerIP_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 4, 1, 2),
...
radiusServerPort = _RadiusServerPort_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 4, 1, 3),
...
radiusAccountingPort = _RadiusAccountingPort_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 4, 1, 4),
...
radiusSharedKey = _RadiusSharedKey_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 4, 1, 5),
...
radiusNASIdentifier = _RadiusNASIdentifier_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 4, 1, 6),
...
radiusMiscQuietPeriod = _RadiusMiscQuietPeriod_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 4, 1, 7),
...
radiusMiscTxPeriod = _RadiusMiscTxPeriod_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 4, 1, 8),
...
radiusMiscSupplicantTimeout = _RadiusMiscSupplicantTimeout_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 4, 1, 9),
...
radiusMiscServerTimeout = _RadiusMiscServerTimeout_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 4, 1, 10),
...
radiusMiscReAuthMax = _RadiusMiscReAuthMax_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 4, 1, 11),
...
radiusMiscReauthPeriod = _RadiusMiscReauthPeriod_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 4, 1, 12),
...
radiusPerPortCfgTable = _RadiusPerPortCfgTable_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 4, 1, 13)
)
if mibBuilder.loadTexts:
...
radiusPerPortCfgEntry = _RadiusPerPortCfgEntry_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 4, 1, 13, 1)
)
radiusPerPortCfgEntry.setIndexNames(
    (0, "IPES2208C", "radiusPerPortCfgIndex"),
)
if mibBuilder.loadTexts:
...
radiusPerPortCfgIndex = _RadiusPerPortCfgIndex_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 4, 1, 13, 1, 1),
...
radiusPerPortCfgPortName = _RadiusPerPortCfgPortName_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 4, 1, 13, 1, 2),
...
radiusPerPortCfgState = _RadiusPerPortCfgState_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 4, 1, 13, 1, 3),
...
portSecurityStaticMACEntry = _PortSecurityStaticMACEntry_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 4, 2, 1, 1)
)
portSecurityStaticMACEntry.setIndexNames(
    (0, "IPES2208C", "portSecurityStaticMACIndex"),
)
if mibBuilder.loadTexts:
...
portSecurityStaticMACIndex = _PortSecurityStaticMACIndex_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 4, 2, 1, 1, 1),
...
portSecurityStaticMACPortName = _PortSecurityStaticMACPortName_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 4, 2, 1, 1, 2),
...
portSecurityStaticMACAddr = _PortSecurityStaticMACAddr_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 4, 2, 1, 1, 3),
...
portSecurityStaticMACStatus = _PortSecurityStaticMACStatus_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 4, 2, 1, 1, 4),
...
portSecurityMACFilteringTable = _PortSecurityMACFilteringTable_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 4, 2, 2)
)
if mibBuilder.loadTexts:
...
portSecurityMACFilteringEntry = _PortSecurityMACFilteringEntry_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 4, 2, 2, 1)
)
portSecurityMACFilteringEntry.setIndexNames(
    (0, "IPES2208C", "portSecurityMACFilteringIndex"),
)
if mibBuilder.loadTexts:
...
portSecurityMACFilteringIndex = _PortSecurityMACFilteringIndex_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 4, 2, 2, 1, 1),
...
portSecurityMACFilteringAddr = _PortSecurityMACFilteringAddr_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 4, 2, 2, 1, 2),
...
portSecurityMACFilteringStatus = _PortSecurityMACFilteringStatus_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 4, 2, 2, 1, 3),
...
portSecurityAllMACTable = _PortSecurityAllMACTable_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 4, 2, 3)
)
if mibBuilder.loadTexts:
...
portSecurityAllMACEntry = _PortSecurityAllMACEntry_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 4, 2, 3, 1)
)
portSecurityAllMACEntry.setIndexNames(
    (0, "IPES2208C", "portSecurityAllMACIndex"),
)
if mibBuilder.loadTexts:
...
portSecurityAllMACIndex = _PortSecurityAllMACIndex_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 4, 2, 3, 1, 1),
...
portSecurityAllMACPortName = _PortSecurityAllMACPortName_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 4, 2, 3, 1, 2),
...
portSecurityAllMACAddr = _PortSecurityAllMACAddr_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 4, 2, 3, 1, 3),
...
portSecurityAllMACType = _PortSecurityAllMACType_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 4, 2, 3, 1, 4),
...
portSecurityClearMACTable = _PortSecurityClearMACTable_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 4, 2, 4),
...
portSecurityMulticastFilterTable = _PortSecurityMulticastFilterTable_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 4, 2, 5)
)
if mibBuilder.loadTexts:
...
portSecurityMulticastFilterEntry = _PortSecurityMulticastFilterEntry_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 4, 2, 5, 1)
)
portSecurityMulticastFilterEntry.setIndexNames(
    (0, "IPES2208C", "portSecurityMulticastFilterIndex"),
)
if mibBuilder.loadTexts:
...
portSecurityMulticastFilterIndex = _PortSecurityMulticastFilterIndex_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 4, 2, 5, 1, 1),
...
portSecurityMulticastFilterAddr = _PortSecurityMulticastFilterAddr_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 4, 2, 5, 1, 2),
...
portSecurityMulticastFilterMembers = _PortSecurityMulticastFilterMembers_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 4, 2, 5, 1, 3),
...
portSecurityMulticastFilterStatus = _PortSecurityMulticastFilterStatus_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 4, 2, 5, 1, 4),
...
ipSecurityMgt = _IpSecurityMgt_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 4, 3)
)
...
ipSecurityStatus = _IpSecurityStatus_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 4, 3, 1),
...
ipSecurityHTTPServerStatus = _IpSecurityHTTPServerStatus_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 4, 3, 2),
...
ipSecurityTelnetServerStatus = _IpSecurityTelnetServerStatus_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 4, 3, 3),
...
ipSecuritySecurityIP1 = _IpSecuritySecurityIP1_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 4, 3, 4),
...
ipSecuritySecurityIP2 = _IpSecuritySecurityIP2_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 4, 3, 5),
...
ipSecuritySecurityIP3 = _IpSecuritySecurityIP3_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 4, 3, 6),
...
ipSecuritySecurityIP4 = _IpSecuritySecurityIP4_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 4, 3, 7),
...
ipSecuritySecurityIP5 = _IpSecuritySecurityIP5_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 4, 3, 8),
...
ipSecuritySecurityIP6 = _IpSecuritySecurityIP6_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 4, 3, 9),
...
ipSecuritySecurityIP7 = _IpSecuritySecurityIP7_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 4, 3, 10),
...
ipSecuritySecurityIP8 = _IpSecuritySecurityIP8_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 4, 3, 11),
...
ipSecuritySecurityIP9 = _IpSecuritySecurityIP9_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 4, 3, 12),
...
ipSecuritySecurityIP10 = _IpSecuritySecurityIP10_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 4, 3, 13),
...
tftpDownloadServerIP = _TftpDownloadServerIP_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 5, 1),
...
tftpDownloadAgentBoardFwFileName = _TftpDownloadAgentBoardFwFileName_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 5, 2),
...
tftpDownloadAgentBoardFwDownloadFunction = _TftpDownloadAgentBoardFwDownloadFunction_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 5, 3),
...
tftpDownloadStatus = _TftpDownloadStatus_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 5, 4),
...
keepCurrentIPSetting = _KeepCurrentIPSetting_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 6, 1),
...
keepCurrentUsernamePassword = _KeepCurrentUsernamePassword_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 6, 2),
...
loadFactoryDefaultAction = _LoadFactoryDefaultAction_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 6, 3),
...
saveCfgMgtAction = _SaveCfgMgtAction_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 7, 1),
...
restartAction = _RestartAction_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 8, 1),
    _RestartAction_Type()
)
restartAction.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    restartAction.setStatus("current")
_PowerOverEthernetMgt_ObjectIdentity = ObjectIdentity
powerOverEthernetMgt = _PowerOverEthernetMgt_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 9)
)
_PoeSystemTable_Object = MibTable
poeSystemTable = _PoeSystemTable_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 9, 1)
)
if mibBuilder.loadTexts:
    poeSystemTable.setStatus("current")
_PoeSystemEntry_Object = MibTableRow
poeSystemEntry = _PoeSystemEntry_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 9, 1, 1)
)
poeSystemEntry.setIndexNames(
    (0, "IPES2208C", "poeIndex"),
)
if mibBuilder.loadTexts:
    poeSystemEntry.setStatus("current")
_PoeIndex_Type = Integer32
_PoeIndex_Object = MibTableColumn
poeIndex = _PoeIndex_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 9, 1, 1, 1),
    _PoeIndex_Type()
)
...
class _PoeFwVer_Type(DisplayString):
    """Custom type poeFwVer based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 20),
    )
...
_PoeFwVer_Type.__name__ = "DisplayString"
_PoeFwVer_Object = MibTableColumn
poeFwVer = _PoeFwVer_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 9, 1, 1, 2),
    _PoeFwVer_Type()
)
poeFwVer.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    poeFwVer.setStatus("current")
_PoeMaximumPowerAvailable_Type = Integer32
_PoeMaximumPowerAvailable_Object = MibTableColumn
poeMaximumPowerAvailable = _PoeMaximumPowerAvailable_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 9, 1, 1, 3),
    _PoeMaximumPowerAvailable_Type()
)
poeMaximumPowerAvailable.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    poeMaximumPowerAvailable.setStatus("current")
if mibBuilder.loadTexts:
    poeMaximumPowerAvailable.setUnits("Watts")
_PoeActualPowerConsumption_Type = Integer32
_PoeActualPowerConsumption_Object = MibTableColumn
poeActualPowerConsumption = _PoeActualPowerConsumption_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 9, 1, 1, 4),
...
if mibBuilder.loadTexts:
    poeActualPowerConsumption.setUnits("Watts")
_PoePowerSource_Type = Integer32
_PoePowerSource_Object = MibTableColumn
poePowerSource = _PoePowerSource_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 9, 1, 1, 5),
    _PoePowerSource_Type()
)
poePowerSource.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    poePowerSource.setStatus("current")
_PoeMainSupplyVoltage_Type = Integer32
_PoeMainSupplyVoltage_Object = MibTableColumn
poeMainSupplyVoltage = _PoeMainSupplyVoltage_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 9, 1, 1, 6),
    _PoeMainSupplyVoltage_Type()
)
poeMainSupplyVoltage.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    poeMainSupplyVoltage.setStatus("current")
if mibBuilder.loadTexts:
    poeMainSupplyVoltage.setUnits("dVoltage")
_PoePowerSource1_Type = Integer32
_PoePowerSource1_Object = MibTableColumn
poePowerSource1 = _PoePowerSource1_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 9, 1, 1, 7),
    _PoePowerSource1_Type()
)
poePowerSource1.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    poePowerSource1.setStatus("current")
if mibBuilder.loadTexts:
    poePowerSource1.setUnits("Watts")
_PoePowerSource2_Type = Integer32
_PoePowerSource2_Object = MibTableColumn
poePowerSource2 = _PoePowerSource2_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 9, 1, 1, 8),
    _PoePowerSource2_Type()
)
poePowerSource2.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    poePowerSource2.setStatus("current")
if mibBuilder.loadTexts:
    poePowerSource2.setUnits("Watts")


class _PoePortKnockoffDisabled_Type(Integer32):
    """Custom type poePortKnockoffDisabled based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_PoePortKnockoffDisabled_Type.__name__ = "Integer32"
_PoePortKnockoffDisabled_Object = MibTableColumn
poePortKnockoffDisabled = _PoePortKnockoffDisabled_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 9, 1, 1, 9),
    _PoePortKnockoffDisabled_Type()
)
poePortKnockoffDisabled.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    poePortKnockoffDisabled.setStatus("current")


class _PoeACDisconnect_Type(Integer32):
    """Custom type poeACDisconnect based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_PoeACDisconnect_Type.__name__ = "Integer32"
_PoeACDisconnect_Object = MibTableColumn
poeACDisconnect = _PoeACDisconnect_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 9, 1, 1, 10),
    _PoeACDisconnect_Type()
)
poeACDisconnect.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    poeACDisconnect.setStatus("current")


class _PoeCapacitiveDetection_Type(Integer32):
    """Custom type poeCapacitiveDetection based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_PoeCapacitiveDetection_Type.__name__ = "Integer32"
_PoeCapacitiveDetection_Object = MibTableColumn
poeCapacitiveDetection = _PoeCapacitiveDetection_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 9, 1, 1, 11),
    _PoeCapacitiveDetection_Type()
)
poeCapacitiveDetection.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    poeCapacitiveDetection.setStatus("current")
_PoePortMgtTable_Object = MibTable
poePortMgtTable = _PoePortMgtTable_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 9, 2)
)
if mibBuilder.loadTexts:
    poePortMgtTable.setStatus("current")
_PoePortMgtEntry_Object = MibTableRow
poePortMgtEntry = _PoePortMgtEntry_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 9, 2, 1)
)
poePortMgtEntry.setIndexNames(
    (0, "IPES2208C", "poePortMgtPortNum"),
)
if mibBuilder.loadTexts:
    poePortMgtEntry.setStatus("current")
_PoePortMgtPortNum_Type = Integer32
_PoePortMgtPortNum_Object = MibTableColumn
poePortMgtPortNum = _PoePortMgtPortNum_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 9, 2, 1, 1),
    _PoePortMgtPortNum_Type()
)
poePortMgtPortNum.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    poePortMgtPortNum.setStatus("current")


class _PoePortMgtEnableState_Type(Integer32):
    """Custom type poePortMgtEnableState based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_PoePortMgtEnableState_Type.__name__ = "Integer32"
_PoePortMgtEnableState_Object = MibTableColumn
poePortMgtEnableState = _PoePortMgtEnableState_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 9, 2, 1, 2),
    _PoePortMgtEnableState_Type()
)
poePortMgtEnableState.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    poePortMgtEnableState.setStatus("current")


class _PoePortMgtPwrLimFrmClass_Type(Integer32):
    """Custom type poePortMgtPwrLimFrmClass based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_PoePortMgtPwrLimFrmClass_Type.__name__ = "Integer32"
_PoePortMgtPwrLimFrmClass_Object = MibTableColumn
poePortMgtPwrLimFrmClass = _PoePortMgtPwrLimFrmClass_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 9, 2, 1, 3),
    _PoePortMgtPwrLimFrmClass_Type()
)
poePortMgtPwrLimFrmClass.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    poePortMgtPwrLimFrmClass.setStatus("current")


class _PoePortMgtLegacy_Type(Integer32):
    """Custom type poePortMgtLegacy based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_PoePortMgtLegacy_Type.__name__ = "Integer32"
_PoePortMgtLegacy_Object = MibTableColumn
poePortMgtLegacy = _PoePortMgtLegacy_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 9, 2, 1, 4),
    _PoePortMgtLegacy_Type()
)
poePortMgtLegacy.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    poePortMgtLegacy.setStatus("current")


class _PoePortMgtPriority_Type(Integer32):
    """Custom type poePortMgtPriority based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_PoePortMgtPriority_Type.__name__ = "Integer32"
_PoePortMgtPriority_Object = MibTableColumn
poePortMgtPriority = _PoePortMgtPriority_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 9, 2, 1, 5),
    _PoePortMgtPriority_Type()
)
poePortMgtPriority.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    poePortMgtPriority.setStatus("current")
_PoePortMgtPwrLimValue_Type = Integer32
_PoePortMgtPwrLimValue_Object = MibTableColumn
poePortMgtPwrLimValue = _PoePortMgtPwrLimValue_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 9, 2, 1, 6),
    _PoePortMgtPwrLimValue_Type()
)
poePortMgtPwrLimValue.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    poePortMgtPwrLimValue.setStatus("current")
if mibBuilder.loadTexts:
    poePortMgtPwrLimValue.setUnits("Molecular Watts")


class _PoePortMgtMode_Type(Integer32):
    """Custom type poePortMgtMode based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_PoePortMgtMode_Type.__name__ = "Integer32"
_PoePortMgtMode_Object = MibTableColumn
poePortMgtMode = _PoePortMgtMode_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 9, 2, 1, 7),
    _PoePortMgtMode_Type()
)
poePortMgtMode.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    poePortMgtMode.setStatus("current")
_PoePortMgtCurrent_Type = Integer32
_PoePortMgtCurrent_Object = MibTableColumn
poePortMgtCurrent = _PoePortMgtCurrent_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 9, 2, 1, 8),
    _PoePortMgtCurrent_Type()
)
poePortMgtCurrent.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    poePortMgtCurrent.setStatus("current")
_PoePortMgtVoltage_Type = Integer32
_PoePortMgtVoltage_Object = MibTableColumn
poePortMgtVoltage = _PoePortMgtVoltage_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 9, 2, 1, 9),
    _PoePortMgtVoltage_Type()
)
poePortMgtVoltage.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    poePortMgtVoltage.setStatus("current")
_PoePortMgtPower_Type = Integer32
_PoePortMgtPower_Object = MibTableColumn
poePortMgtPower = _PoePortMgtPower_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 9, 2, 1, 10),
    _PoePortMgtPower_Type()
)
poePortMgtPower.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    poePortMgtPower.setStatus("current")


class _PoePortMgtDeterminedClass_Type(Integer32):
    """Custom type poePortMgtDeterminedClass based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_PoePortMgtDeterminedClass_Type.__name__ = "Integer32"
_PoePortMgtDeterminedClass_Object = MibTableColumn
poePortMgtDeterminedClass = _PoePortMgtDeterminedClass_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 9, 2, 1, 11),
    _PoePortMgtDeterminedClass_Type()
)
poePortMgtDeterminedClass.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    poePortMgtDeterminedClass.setStatus("current")


class _PoePortMgtPingEnable_Type(Integer32):
    """Custom type poePortMgtPingEnable based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_PoePortMgtPingEnable_Type.__name__ = "Integer32"
_PoePortMgtPingEnable_Object = MibTableColumn
poePortMgtPingEnable = _PoePortMgtPingEnable_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 9, 2, 1, 12),
    _PoePortMgtPingEnable_Type()
)
poePortMgtPingEnable.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    poePortMgtPingEnable.setStatus("current")
_PoePortMgtPingAddr_Type = IpAddress
_PoePortMgtPingAddr_Object = MibTableColumn
poePortMgtPingAddr = _PoePortMgtPingAddr_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 9, 2, 1, 13),
    _PoePortMgtPingAddr_Type()
)
poePortMgtPingAddr.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    poePortMgtPingAddr.setStatus("current")
_PoePortMgtPingPeriod_Type = Integer32
_PoePortMgtPingPeriod_Object = MibTableColumn
poePortMgtPingPeriod = _PoePortMgtPingPeriod_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 9, 2, 1, 14),
    _PoePortMgtPingPeriod_Type()
)
poePortMgtPingPeriod.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    poePortMgtPingPeriod.setStatus("current")
_TrapSpecificMgt_ObjectIdentity = ObjectIdentity
trapSpecificMgt = _TrapSpecificMgt_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 11)
)
...
specificTrapTopologychange = _SpecificTrapTopologychange_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 11, 1),
...
specificTrapPowerStatus = _SpecificTrapPowerStatus_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 11, 2),
...
class _SpecificTrapMacViolation_Type(Integer32):
    """Custom type specificTrapMacViolation based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            1
...
_SpecificTrapMacViolation_Type.__name__ = "Integer32"
_SpecificTrapMacViolation_Object = MibScalar
specificTrapMacViolation = _SpecificTrapMacViolation_Object(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 11, 4),
    _SpecificTrapMacViolation_Type()
)
specificTrapMacViolation.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    specificTrapMacViolation.setStatus("current")
...
topologyChangeTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 0, 11)
)
topologyChangeTrap.setObjects(
    ("IPES2208C", "specificTrapTopologychange")
)
if mibBuilder.loadTexts:
...
powerTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 0, 12)
)
powerTrap.setObjects(
    ("IPES2208C", "specificTrapPowerStatus")
)
if mibBuilder.loadTexts:
    powerTrap.setStatus(
        ""
...
macViolationTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 37072, 302, 1, 119, 0, 13)
)
macViolationTrap.setObjects(
    ("IPES2208C", "specificTrapMacViolation")
)
if mibBuilder.loadTexts:
    macViolationTrap.setStatus(
        ""
    )
...
mibBuilder.exportSymbols(
    ...
    **{"DisplayString": DisplayString,
       ...
       "powerTrap": powerTrap,
       "macViolationTrap": macViolationTrap,
       "systemMgt": systemMgt,
       ...
       "swIpv6cfgglobal": swIpv6cfgglobal,
       "swIpv6cfglink": swIpv6cfglink,
       "switchndcacheCfgTable": switchndcacheCfgTable,
       "switchndcacheCfgEntry": switchndcacheCfgEntry,
       "ndcacheindex": ndcacheindex,
       "ndipv6address": ndipv6address,
       "ndipv6macaddress": ndipv6macaddress,
       "ndstate": ndstate,
       ...
       "swSyslogMacViolationEvent": swSyslogMacViolationEvent,
       ...
       "switchFaultRelayMgt": switchFaultRelayMgt,
       "switchPowerFailureTable": switchPowerFailureTable,
       "switchPowerFailureEntry": switchPowerFailureEntry,
       "swPowerIndex": swPowerIndex,
       "swPower1": swPower1,
       "swPower2": swPower2,
       "switchPortFailureTable": switchPortFailureTable,
       "switchPortFailureEntry": switchPortFailureEntry,
       "swPortIndex": swPortIndex,
       "swPortName": swPortName,
       "swPortAlarm": swPortAlarm,
       "swMACViolationFailure": swMACViolationFailure,
       "switchUserAuthMgt": switchUserAuthMgt,
       "switchUserAuthTable": switchUserAuthTable,
       "switchUserAuthEntry": switchUserAuthEntry,
       "swUserAuthIndex": swUserAuthIndex,
       "swUserName": swUserName,
       "swNewPassword": swNewPassword,
       "swConfirmPassword": swConfirmPassword,
       ...
       "switchPortDmiTable": switchPortDmiTable,
       "switchPortDmiEntry": switchPortDmiEntry,
       "swPortDmiIndex": swPortDmiIndex,
       "swPortDmiPortProperty": swPortDmiPortProperty,
       "swPortDmiHighAlarm": swPortDmiHighAlarm,
       "swPortDmiHighAlarmThreshold": swPortDmiHighAlarmThreshold,
       "swPortDmiHighWarning": swPortDmiHighWarning,
       "swPortDmiHighWarningThreshold": swPortDmiHighWarningThreshold,
       "swPortDmiStatus": swPortDmiStatus,
       "swPortDmiLowWarning": swPortDmiLowWarning,
       "swPortDmiLowWarningThreshold": swPortDmiLowWarningThreshold,
       "swPortDmiLowAlarm": swPortDmiLowAlarm,
       "swPortDmiLowAlarmThreshold": swPortDmiLowAlarmThreshold,
       ...
       "sntpSynchronizationInterval": sntpSynchronizationInterval,
       "igmpMgt": igmpMgt,
       ...
       "xRing2Mgt": xRing2Mgt,
       "xRing2OperMode": xRing2OperMode,
       "xRing2Table": xRing2Table,
       "xRing2Entry": xRing2Entry,
       "xRing2Index": xRing2Index,
       "xRing2RingID": xRing2RingID,
       "xRing2-1stRingPortName": xRing2_1stRingPortName,
       "xRing2-1stRingPortState": xRing2_1stRingPortState,
       "xRing2-2ndRingPortName": xRing2_2ndRingPortName,
       "xRing2-2ndRingPortState": xRing2_2ndRingPortState,
       "xRing2Mode": xRing2Mode,
       "xRing2-1stRdnPortName": xRing2_1stRdnPortName,
       "xRing2-1stRdnPortState": xRing2_1stRdnPortState,
       "xRing2-1stRdnPortID": xRing2_1stRdnPortID,
       "xRing2-2ndRdnPortName": xRing2_2ndRdnPortName,
       "xRing2-2ndRdnPortState": xRing2_2ndRdnPortState,
       "xRing2-2ndRdnPortID": xRing2_2ndRdnPortID,
       "xRing2Action": xRing2Action,
       "xRing2Legacy-1stPortName": xRing2Legacy_1stPortName,
       "xRing2Legacy-2ndPortName": xRing2Legacy_2ndPortName,
       ...
       "powerOverEthernetMgt": powerOverEthernetMgt,
       "poeSystemTable": poeSystemTable,
       "poeSystemEntry": poeSystemEntry,
       "poeIndex": poeIndex,
       "poeFwVer": poeFwVer,
       "poeMaximumPowerAvailable": poeMaximumPowerAvailable,
       "poeActualPowerConsumption": poeActualPowerConsumption,
       "poePowerSource": poePowerSource,
       "poeMainSupplyVoltage": poeMainSupplyVoltage,
       "poePowerSource1": poePowerSource1,
       "poePowerSource2": poePowerSource2,
       "poePortKnockoffDisabled": poePortKnockoffDisabled,
       "poeACDisconnect": poeACDisconnect,
       "poeCapacitiveDetection": poeCapacitiveDetection,
       "poePortMgtTable": poePortMgtTable,
       "poePortMgtEntry": poePortMgtEntry,
       "poePortMgtPortNum": poePortMgtPortNum,
       "poePortMgtEnableState": poePortMgtEnableState,
       "poePortMgtPwrLimFrmClass": poePortMgtPwrLimFrmClass,
       "poePortMgtLegacy": poePortMgtLegacy,
       "poePortMgtPriority": poePortMgtPriority,
       "poePortMgtPwrLimValue": poePortMgtPwrLimValue,
       "poePortMgtMode": poePortMgtMode,
       "poePortMgtCurrent": poePortMgtCurrent,
       "poePortMgtVoltage": poePortMgtVoltage,
       "poePortMgtPower": poePortMgtPower,
       "poePortMgtDeterminedClass": poePortMgtDeterminedClass,
       "poePortMgtPingEnable": poePortMgtPingEnable,
       "poePortMgtPingAddr": poePortMgtPingAddr,
       "poePortMgtPingPeriod": poePortMgtPingPeriod,
       ...
       "specificTrapMacViolation": specificTrapMacViolation}
)
