# SNMP MIB module (JUNIPER-IVE-MIB2) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/rob/MIBs/neoteris_12532/JUNIPER-IVE-MIB2.mib
# Produced by pysmi-1.6.1 at Sat Jun  7 11:36:24 2025
...
iveLogNearlyFull.setObjects(
      *(("JUNIPER-IVE-MIB2", "logFullPercent"),
        ("JUNIPER-IVE-MIB2", "logName"))
)
if mibBuilder.loadTexts:
...
externalAuthServerUnreachable.setObjects(
    ("JUNIPER-IVE-MIB2", "authServerName")
)
if mibBuilder.loadTexts:
...
meetingUserLimit.setObjects(
    ("JUNIPER-IVE-MIB2", "meetingUserCount")
)
if mibBuilder.loadTexts:
...
iveDiskNearlyFull.setObjects(
    ("JUNIPER-IVE-MIB2", "diskFullPercent")
)
if mibBuilder.loadTexts:
...
logMessageTrap.setObjects(
      *(("JUNIPER-IVE-MIB2", "logID"),
        ("JUNIPER-IVE-MIB2", "logType"),
        ("JUNIPER-IVE-MIB2", "logDescription"))
)
if mibBuilder.loadTexts:
...
memUtilNotify.setObjects(
    ("JUNIPER-IVE-MIB2", "iveMemoryUtil")
)
if mibBuilder.loadTexts:
...
ocspResponderConnectionFailed.setObjects(
    ("JUNIPER-IVE-MIB2", "ocspResponderURL")
)
if mibBuilder.loadTexts:
...
iveFanNotify.setObjects(
    ("JUNIPER-IVE-MIB2", "fanDescription")
)
if mibBuilder.loadTexts:
...
ivePowerSupplyNotify.setObjects(
    ("JUNIPER-IVE-MIB2", "psDescription")
)
if mibBuilder.loadTexts:
...
iveRaidNotify.setObjects(
    ("JUNIPER-IVE-MIB2", "raidDescription")
)
if mibBuilder.loadTexts:
...
iveClusterDisableNodeTrap.setObjects(
      *(("JUNIPER-IVE-MIB2", "clusterName"),
        ("JUNIPER-IVE-MIB2", "nodeList"))
)
if mibBuilder.loadTexts:
...
iveClusterChangedVIPTrap.setObjects(
      *(("JUNIPER-IVE-MIB2", "vipType"),
        ("JUNIPER-IVE-MIB2", "currentVIP"),
        ("JUNIPER-IVE-MIB2", "newVIP"))
)
if mibBuilder.loadTexts:
...
iveTemperatureNotify.setObjects(
    ("JUNIPER-IVE-MIB2", "iveTemperature")
)
if mibBuilder.loadTexts:
...
iveVIPNodeChanged.setObjects(
      *(("JUNIPER-IVE-MIB2", "nodeName"),
        ("JUNIPER-IVE-MIB2", "vipChangeReason"))
)
if mibBuilder.loadTexts:
