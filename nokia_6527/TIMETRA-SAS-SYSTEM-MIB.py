...
# Notes
# -----
# ASN.1 source file:///Users/rob/MIBs/nokia_6527/TIMETRA-SAS-SYSTEM-MIB.mib
...
class _SysResRouterMaxIPSubnetsOperVal_Type(Integer32):
    """Custom type sysResRouterMaxIPSubnetsOperVal based on Integer32"""
    defaultValue = 2000
...
_SysResRouterMaxIPSubnetsOperVal_Type.__name__ = "Integer32"
_SysResRouterMaxIPSubnetsOperVal_Object = MibScalar
sysResRouterMaxIPSubnetsOperVal = _SysResRouterMaxIPSubnetsOperVal_Object(
    (1, 3, 6, 1, 4, 1, 6527, 6, 2, 2, 2, 5, 17, 59),
    _SysResRouterMaxIPSubnetsOperVal_Type()
)
sysResRouterMaxIPSubnetsOperVal.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    sysResRouterMaxIPSubnetsOperVal.setStatus("current")
...
mibBuilder.exportSymbols(
    ...
    **{"TmnxFanCfgMode": TmnxFanCfgMode,
       ...
       "sysResRouterMaxIPSubnetsOperVal": sysResRouterMaxIPSubnetsOperVal,
