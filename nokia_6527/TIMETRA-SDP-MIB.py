...
# Notes
# -----
# ASN.1 source file:///Users/rob/MIBs/nokia_6527/TIMETRA-SDP-MIB.mib
...
if mibBuilder.loadTexts:
    sdpBindIngressIPv6Flowspec.setStatus("current")
...
if mibBuilder.loadTexts:
    sdpBindForceQinqVcForwarding.setStatus("current")
...
if mibBuilder.loadTexts:
    pwTemplateForceQinqVcForwarding.setStatus("current")
...
if mibBuilder.loadTexts:
    tmnxSdpV8v0Group.setStatus("current")
...
if mibBuilder.loadTexts:
    tmnxSdpV12v0Group.setStatus("current")
...
if mibBuilder.loadTexts:
    tmnxSdpBindV11v0Group.setStatus("current")
