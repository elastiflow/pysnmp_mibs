# SNMP MIB module (EMUX-3XX-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/rob/MIBs/nsccomms_42926/EMUX-3XX-MIB.mib
# Produced by pysmi-1.6.1 at Sat Jun  7 20:13:33 2025
...
lldpPortConfigEntry.setIndexNames(
    (0, "EMUX-3XX-MIB", "lldpPortConfigPortNum"),
)
if mibBuilder.loadTexts:
...
lldpRemEntry.setIndexNames(
    (0, "EMUX-3XX-MIB", "lldpRemTimeMark"),
    (0, "EMUX-3XX-MIB", "lldpRemLocalPortNum"),
    (0, "EMUX-3XX-MIB", "lldpRemIndex"),
)
if mibBuilder.loadTexts:
...
e1SubChIndex.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
...
muxBaseGroup.setObjects(
      *(("EMUX-3XX-MIB", "hardwareVersion"),
        ("EMUX-3XX-MIB", "fwVersion"),
        ("EMUX-3XX-MIB", "softwareVersion"),
        ("EMUX-3XX-MIB", "bootloaderVersion"),
        ("EMUX-3XX-MIB", "systemID"),
        ("EMUX-3XX-MIB", "powerVoltage"),
        ("EMUX-3XX-MIB", "caseTemperature"),
        ("EMUX-3XX-MIB", "envVer"),
        ("EMUX-3XX-MIB", "accVoltage"),
        ("EMUX-3XX-MIB", "currentConsumption"))
)
if mibBuilder.loadTexts:
...
muxSensorGroup.setObjects(
      *(("EMUX-3XX-MIB", "sensor1"),
        ("EMUX-3XX-MIB", "sensor2"),
        ("EMUX-3XX-MIB", "sensor3"))
)
if mibBuilder.loadTexts:
...
muxDateTimeGroup.setObjects(
      *(("EMUX-3XX-MIB", "muxDate"),
        ("EMUX-3XX-MIB", "muxTime"),
        ("EMUX-3XX-MIB", "muxTimeZone"),
        ("EMUX-3XX-MIB", "muxTimeServer"),
        ("EMUX-3XX-MIB", "muxTimeSynchro"),
        ("EMUX-3XX-MIB", "muxTimeNextSynchro"),
        ("EMUX-3XX-MIB", "muxTimeSynchroPeriod"))
)
if mibBuilder.loadTexts:
...
muxIpGroup.setObjects(
      *(("EMUX-3XX-MIB", "muxMAC"),
        ("EMUX-3XX-MIB", "muxIPaddr"),
        ("EMUX-3XX-MIB", "muxMask"),
        ("EMUX-3XX-MIB", "muxGateway"),
        ("EMUX-3XX-MIB", "muxVLAN"),
        ("EMUX-3XX-MIB", "muxVLANPri"))
)
if mibBuilder.loadTexts:
...
muxMgmtGroup.setObjects(
      *(("EMUX-3XX-MIB", "muxManagementLocal"),
        ("EMUX-3XX-MIB", "muxManagementGlobal"),
        ("EMUX-3XX-MIB", "muxTelnetAccess"),
        ("EMUX-3XX-MIB", "muxHTTPAccess"),
        ("EMUX-3XX-MIB", "muxFTPAccess"),
        ("EMUX-3XX-MIB", "muxMenuOnStart"),
        ("EMUX-3XX-MIB", "muxStoreCfg"))
)
if mibBuilder.loadTexts:
...
muxRSGroup.setObjects(
      *(("EMUX-3XX-MIB", "muxRSBaudRate"),
        ("EMUX-3XX-MIB", "muxRSStopBits"),
        ("EMUX-3XX-MIB", "muxRSParity"),
        ("EMUX-3XX-MIB", "muxRSEnable"))
)
if mibBuilder.loadTexts:
...
muxMgmtIpGroup.setObjects(
      *(("EMUX-3XX-MIB", "muxManagementIP1"),
        ("EMUX-3XX-MIB", "muxManagementIP2"),
        ("EMUX-3XX-MIB", "muxManagementIP3"),
        ("EMUX-3XX-MIB", "muxManagementIP4"),
        ("EMUX-3XX-MIB", "muxManagementIP5"),
        ("EMUX-3XX-MIB", "muxManagementIP6"),
        ("EMUX-3XX-MIB", "muxManagementIP7"),
        ("EMUX-3XX-MIB", "muxManagementIP8"),
        ("EMUX-3XX-MIB", "muxManagementIP9"),
        ("EMUX-3XX-MIB", "muxManagementIP10"),
        ("EMUX-3XX-MIB", "muxManagementIP11"),
        ("EMUX-3XX-MIB", "muxManagementIP12"),
        ("EMUX-3XX-MIB", "muxManagementIP13"),
        ("EMUX-3XX-MIB", "muxManagementIP14"),
        ("EMUX-3XX-MIB", "muxManagementIP15"),
        ("EMUX-3XX-MIB", "muxManagementIP16"),
        ("EMUX-3XX-MIB", "muxManagementIP17"),
        ("EMUX-3XX-MIB", "muxManagementIP18"),
        ("EMUX-3XX-MIB", "muxManagementIP19"),
        ("EMUX-3XX-MIB", "muxManagementIP20"),
        ("EMUX-3XX-MIB", "muxManagementIP21"),
        ("EMUX-3XX-MIB", "muxManagementIP22"),
        ("EMUX-3XX-MIB", "muxManagementIP23"),
        ("EMUX-3XX-MIB", "muxManagementIP24"),
        ("EMUX-3XX-MIB", "muxManagementIP25"),
        ("EMUX-3XX-MIB", "muxManagementIP26"),
        ("EMUX-3XX-MIB", "muxManagementIP27"),
        ("EMUX-3XX-MIB", "muxManagementIP28"),
        ("EMUX-3XX-MIB", "muxManagementIP29"),
        ("EMUX-3XX-MIB", "muxManagementIP30"),
        ("EMUX-3XX-MIB", "muxManagementIP31"),
        ("EMUX-3XX-MIB", "muxManagementIP32"))
)
if mibBuilder.loadTexts:
...
muxMgmtMaskGroup.setObjects(
      *(("EMUX-3XX-MIB", "muxManagementMask1"),
        ("EMUX-3XX-MIB", "muxManagementMask2"),
        ("EMUX-3XX-MIB", "muxManagementMask3"),
        ("EMUX-3XX-MIB", "muxManagementMask4"),
        ("EMUX-3XX-MIB", "muxManagementMask5"),
        ("EMUX-3XX-MIB", "muxManagementMask6"),
        ("EMUX-3XX-MIB", "muxManagementMask7"),
        ("EMUX-3XX-MIB", "muxManagementMask8"),
        ("EMUX-3XX-MIB", "muxManagementMask9"),
        ("EMUX-3XX-MIB", "muxManagementMask10"),
        ("EMUX-3XX-MIB", "muxManagementMask11"),
        ("EMUX-3XX-MIB", "muxManagementMask12"),
        ("EMUX-3XX-MIB", "muxManagementMask13"),
        ("EMUX-3XX-MIB", "muxManagementMask14"),
        ("EMUX-3XX-MIB", "muxManagementMask15"),
        ("EMUX-3XX-MIB", "muxManagementMask16"),
        ("EMUX-3XX-MIB", "muxManagementMask17"),
        ("EMUX-3XX-MIB", "muxManagementMask18"),
        ("EMUX-3XX-MIB", "muxManagementMask19"),
        ("EMUX-3XX-MIB", "muxManagementMask20"),
        ("EMUX-3XX-MIB", "muxManagementMask21"),
        ("EMUX-3XX-MIB", "muxManagementMask22"),
        ("EMUX-3XX-MIB", "muxManagementMask23"),
        ("EMUX-3XX-MIB", "muxManagementMask24"),
        ("EMUX-3XX-MIB", "muxManagementMask25"),
        ("EMUX-3XX-MIB", "muxManagementMask26"),
        ("EMUX-3XX-MIB", "muxManagementMask27"),
        ("EMUX-3XX-MIB", "muxManagementMask28"),
        ("EMUX-3XX-MIB", "muxManagementMask29"),
        ("EMUX-3XX-MIB", "muxManagementMask30"),
        ("EMUX-3XX-MIB", "muxManagementMask31"),
        ("EMUX-3XX-MIB", "muxManagementMask32"))
)
if mibBuilder.loadTexts:
...
muxEthGroup.setObjects(
      *(("EMUX-3XX-MIB", "ethType"),
        ("EMUX-3XX-MIB", "ethMode"),
        ("EMUX-3XX-MIB", "ethReservMode"),
        ("EMUX-3XX-MIB", "ethVlan"),
        ("EMUX-3XX-MIB", "ethDuplexMode"),
        ("EMUX-3XX-MIB", "ethStringStatus"),
        ("EMUX-3XX-MIB", "ethLogLevel"),
        ("EMUX-3XX-MIB", "ethTrapLevel"),
        ("EMUX-3XX-MIB", "ethIngressRateLimit"),
        ("EMUX-3XX-MIB", "ethSecurity"),
        ("EMUX-3XX-MIB", "ethMonitorPort"),
        ("EMUX-3XX-MIB", "ethTrunkId"),
        ("EMUX-3XX-MIB", "ethPriorityMode"),
        ("EMUX-3XX-MIB", "ethDefaultPriority"),
        ("EMUX-3XX-MIB", "ethEgressRateLimit"),
        ("EMUX-3XX-MIB", "ethRateLimitMode"),
        ("EMUX-3XX-MIB", "ethIGMPsnooping"),
        ("EMUX-3XX-MIB", "ethCurrentStat"),
        ("EMUX-3XX-MIB", "ethMaxLearnNum"),
        ("EMUX-3XX-MIB", "ethDHCPrelay"),
        ("EMUX-3XX-MIB", "ethDHCPtrusted"),
        ("EMUX-3XX-MIB", "ethIGMPfastleave"),
        ("EMUX-3XX-MIB", "ethMVRtype"),
        ("EMUX-3XX-MIB", "ethUserport"),
        ("EMUX-3XX-MIB", "ethForceVlan"),
        ("EMUX-3XX-MIB", "ethResetStat"),
        ("EMUX-3XX-MIB", "ethStateInternal"))
)
if mibBuilder.loadTexts:
...
muxRSTPGroup.setObjects(
      *(("EMUX-3XX-MIB", "rSTPForwardDelay"),
        ("EMUX-3XX-MIB", "rSTPMaxAge"),
        ("EMUX-3XX-MIB", "rSTPHelloTime"),
        ("EMUX-3XX-MIB", "rSTPBridgePrio"))
)
if mibBuilder.loadTexts:
...
muxRSTPInterfacesGroup.setObjects(
      *(("EMUX-3XX-MIB", "rSTPPortPrio"),
        ("EMUX-3XX-MIB", "rSTPEdge"),
        ("EMUX-3XX-MIB", "rSTPPathCost"),
        ("EMUX-3XX-MIB", "rSTPp2p"),
        ("EMUX-3XX-MIB", "rSTPRootGuard"),
        ("EMUX-3XX-MIB", "rSTPState"),
        ("EMUX-3XX-MIB", "rSTPRole"))
)
if mibBuilder.loadTexts:
...
muxE1Group.setObjects(
      *(("EMUX-3XX-MIB", "e1aMode"),
        ("EMUX-3XX-MIB", "e1aSetupPayload"),
        ("EMUX-3XX-MIB", "e1aSetupJBuf"),
        ("EMUX-3XX-MIB", "e1aSetupGap"),
        ("EMUX-3XX-MIB", "e1ProtLevel"),
        ("EMUX-3XX-MIB", "e1Vlan"),
        ("EMUX-3XX-MIB", "e1VlanPri"),
        ("EMUX-3XX-MIB", "e1ToS"),
        ("EMUX-3XX-MIB", "e1DstChannel"),
        ("EMUX-3XX-MIB", "e1DstMAC"),
        ("EMUX-3XX-MIB", "e1DstIP"),
        ("EMUX-3XX-MIB", "e1Leds"),
        ("EMUX-3XX-MIB", "e1Framed"),
        ("EMUX-3XX-MIB", "e1Description"),
        ("EMUX-3XX-MIB", "e1TestStatus"),
        ("EMUX-3XX-MIB", "e1LogLevel"),
        ("EMUX-3XX-MIB", "e1TrapLevel"),
        ("EMUX-3XX-MIB", "e1AvgTime"),
        ("EMUX-3XX-MIB", "e1DstMask"),
        ("EMUX-3XX-MIB", "e1DstSubchIndex"),
        ("EMUX-3XX-MIB", "e1DstTextMask"),
        ("EMUX-3XX-MIB", "e1aUptime"),
        ("EMUX-3XX-MIB", "e1lState"),
        ("EMUX-3XX-MIB", "e1rState"),
        ("EMUX-3XX-MIB", "e1sMask"),
        ("EMUX-3XX-MIB", "e1stMask"),
        ("EMUX-3XX-MIB", "e1SubchNum"),
        ("EMUX-3XX-MIB", "e1Compression"),
        ("EMUX-3XX-MIB", "e1CompressTime"),
        ("EMUX-3XX-MIB", "e1LIUstate"),
        ("EMUX-3XX-MIB", "e1GatewayBypass"),
        ("EMUX-3XX-MIB", "e1OutFreq"),
        ("EMUX-3XX-MIB", "e1LeftSlip"),
        ("EMUX-3XX-MIB", "e1RightSlip"),
        ("EMUX-3XX-MIB", "usedTimeSlots"),
        ("EMUX-3XX-MIB", "liuStat"),
        ("EMUX-3XX-MIB", "pktStat"),
        ("EMUX-3XX-MIB", "stateStat"),
        ("EMUX-3XX-MIB", "e1LeftSlipPkt"),
        ("EMUX-3XX-MIB", "e1RightSlipPkt"),
        ("EMUX-3XX-MIB", "timeStat"),
        ("EMUX-3XX-MIB", "resetStat"),
        ("EMUX-3XX-MIB", "saveStat"),
        ("EMUX-3XX-MIB", "e1fstate"),
        ("EMUX-3XX-MIB", "spregMode"),
        ("EMUX-3XX-MIB", "spregQueueSize"),
        ("EMUX-3XX-MIB", "recoveryLost"),
        ("EMUX-3XX-MIB", "v5SignalLabel"),
        ("EMUX-3XX-MIB", "v5SignalLabelText"),
        ("EMUX-3XX-MIB", "e1IfIndex"),
        ("EMUX-3XX-MIB", "e1WanIP"),
        ("EMUX-3XX-MIB", "e1RemoteSIPPort"),
        ("EMUX-3XX-MIB", "e1RemoteTDMPort"),
        ("EMUX-3XX-MIB", "e1UsedTimeslotsCount"))
)
if mibBuilder.loadTexts:
    muxE1Group.setStatus("current")

muxE1InfoGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 18, 2, 31, 15)
)
muxE1InfoGroup.setObjects(
    ("EMUX-3XX-MIB", "e1Number")
)
if mibBuilder.loadTexts:
    muxE1InfoGroup.setStatus("current")

lldpConfigGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 18, 2, 33, 1)
)
lldpConfigGroup.setObjects(
    ("EMUX-3XX-MIB", "lldpPortConfigAdminStatus")
)
if mibBuilder.loadTexts:
...
lldpConfigTxGroup.setObjects(
      *(("EMUX-3XX-MIB", "lldpMessageTxInterval"),
        ("EMUX-3XX-MIB", "lldpMessageTxHoldMultiplier"),
        ("EMUX-3XX-MIB", "lldpPortConfigTLVsTxEnable"))
)
if mibBuilder.loadTexts:
...
lldpRemSysGroup.setObjects(
      *(("EMUX-3XX-MIB", "lldpRemChassisIdSubtype"),
        ("EMUX-3XX-MIB", "lldpRemChassisId"),
        ("EMUX-3XX-MIB", "lldpRemPortIdSubtype"),
        ("EMUX-3XX-MIB", "lldpRemPortId"),
        ("EMUX-3XX-MIB", "lldpRemPortDesc"),
        ("EMUX-3XX-MIB", "lldpRemSysName"),
        ("EMUX-3XX-MIB", "lldpRemSysDesc"))
)
if mibBuilder.loadTexts:
...
emuxCompliance.setObjects(
      *(("EMUX-3XX-MIB", "muxBaseGroup"),
        ("EMUX-3XX-MIB", "muxSensorGroup"),
        ("EMUX-3XX-MIB", "muxDateTimeGroup"),
        ("EMUX-3XX-MIB", "muxIpGroup"),
        ("EMUX-3XX-MIB", "muxMgmtGroup"),
        ("EMUX-3XX-MIB", "muxSNMPAccessGroup"),
        ("EMUX-3XX-MIB", "muxRSGroup"),
        ("EMUX-3XX-MIB", "muxMgmtIpGroup"),
        ("EMUX-3XX-MIB", "muxMgmtMaskGroup"),
        ("EMUX-3XX-MIB", "muxEthGroup"),
        ("EMUX-3XX-MIB", "muxRSTPGroup"),
        ("EMUX-3XX-MIB", "muxRSTPInterfacesGroup"),
        ("EMUX-3XX-MIB", "muxMaintenanceGroup"),
        ("EMUX-3XX-MIB", "muxE1Group"),
        ("EMUX-3XX-MIB", "muxE1InfoGroup"))
)
if mibBuilder.loadTexts:
...
lldpCompliance.setObjects(
      *(("EMUX-3XX-MIB", "lldpConfigGroup"),
        ("EMUX-3XX-MIB", "lldpConfigTxGroup"),
        ("EMUX-3XX-MIB", "lldpRemSysGroup"))
)
if mibBuilder.loadTexts:
