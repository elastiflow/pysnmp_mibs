...
# Notes
# -----
# ASN.1 source file:///Users/rob/MIBs/ruijie_4881/RUIJIE-INTERFACE-MIB.mib
...
_RuijieIfIsSubPort_Object = MibScalar
...
_RuijieInterfaceIndex_Type = Integer32
...
_RuijieApPhyAddress_Type = PhysAddress
...
_RuijieApPhysAddress_Type = PhysAddress
...
_RuijieApIfPhysAddress_Type = PhysAddress
...
_RuijieApInfoAddress_Type = PhysAddress
...
_RuijieIfNoBufferConut_Type = Counter64
_RuijieIfNoBufferConut_Object = MibTableColumn
ruijieIfNoBufferConut = _RuijieIfNoBufferConut_Object(
    (1, 3, 6, 1, 4, 1, 4881, 1, 1, 10, 2, 10, 1, 19, 1, 8),
    _RuijieIfNoBufferConut_Type()
)
ruijieIfNoBufferConut.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    ruijieIfNoBufferConut.setStatus("current")
...
class _RuijieIfOMCPortSubType_Type(Integer32):
    """Custom type ruijieIfOMCPortSubType based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_RuijieIfOMCPortSubType_Type.__name__ = "Integer32"
...
ruijieIfOMCCVID = _RuijieIfOMCCVID_Object(
    (1, 3, 6, 1, 4, 1, 4881, 1, 1, 10, 2, 10, 1, 21, 1, 9),
...
mibBuilder.exportSymbols(
    ...
    **{"ruijieInterfaceMIB": ruijieInterfaceMIB,
       ...
       "ruijieIfNoBufferConut": ruijieIfNoBufferConut,
