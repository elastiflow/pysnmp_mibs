...
# Notes
# -----
# ASN.1 source file:///Users/rob/MIBs/scte_5591/SCTE-HMS-QAM-MIB.mib
...
_QamChannelModulationFormat1_Type = QAMChannelModulationFormat
_QamChannelModulationFormat1_Object = MibTableColumn
qamChannelModulationFormat1 = _QamChannelModulationFormat1_Object(
    (1, 3, 6, 1, 4, 1, 5591, 1, 11, 5, 3, 1, 1, 1, 1, 2),
    _QamChannelModulationFormat1_Type()
)
qamChannelModulationFormat1.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    qamChannelModulationFormat1.setStatus("current")
...
qamChannelGroup.setObjects(
      *(("SCTE-HMS-QAM-MIB", "qamChannelFrequency"),
        ("SCTE-HMS-QAM-MIB", "qamChannelModulationFormat1"),
...
mibBuilder.exportSymbols(
    ...
    **{"heDigitalQamMIB": heDigitalQamMIB,
       ...
       "qamChannelModulationFormat1": qamChannelModulationFormat1,
