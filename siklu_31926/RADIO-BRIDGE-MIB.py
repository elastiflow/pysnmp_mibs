...
# Notes
# -----
# ASN.1 source file:///Users/rob/MIBs/siklu_31926/RADIO-BRIDGE-MIB.mib
...
trapRateChange = NotificationType(
    (1, 3, 6, 1, 4, 1, 31926, 3, 25)
)
trapRateChange.setObjects(
      *(("IF-MIB", "ifIndex"),
        ("RADIO-BRIDGE-MIB", "ifMauType"))
)
if mibBuilder.loadTexts:
    trapRateChange.setStatus(
        "current"
    )
