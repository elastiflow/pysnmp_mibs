...
# Notes
# -----
# ASN.1 source file:///Users/rob/MIBs/ubiquiti_41112/UBNT-AFLTU-MIB.mib
...
afLTUStaRemoteMac.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
_AfLTUGpsAltMeters_Type = DisplayString
_AfLTUGpsAltMeters_Object = MibScalar
afLTUGpsAltMeters = _AfLTUGpsAltMeters_Object(
    (1, 3, 6, 1, 4, 1, 41112, 1, 10, 1, 7, 5),
    _AfLTUGpsAltMeters_Type()
)
afLTUGpsAltMeters.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    afLTUGpsAltMeters.setStatus("current")
if mibBuilder.loadTexts:
    afLTUGpsAltMeters.setUnits("(m)")
...
ubntAFLTUStatusGroup.setObjects(
      *(("UBNT-AFLTU-MIB", "afLTURole"),
        ...
        ("UBNT-AFLTU-MIB", "afLTUGpsAltMeters"),
        ...
        ("UBNT-AFLTU-MIB", "afLTUStaRemoteMac"),
...
mibBuilder.exportSymbols(
    ...
    **{"afLTUCompliances": afLTUCompliances,
       ...
       "afLTUGpsAltMeters": afLTUGpsAltMeters,
