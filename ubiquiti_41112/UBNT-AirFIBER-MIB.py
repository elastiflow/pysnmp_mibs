# SNMP MIB module (UBNT-AirFIBER-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/rob/MIBs/ubiquiti_41112/UBNT-AirFIBER-MIB.mib
...
ubntAirFIBER = ModuleIdentity(
    (1, 3, 6, 1, 4, 1, 41112, 1, 3)
)
if mibBuilder.loadTexts:
    ubntAirFIBER.setRevisions(
        ("2014-05-09 00:00",)
    )
...
airFiberConfigEntry.setIndexNames(
    (0, "UBNT-AirFIBER-MIB", "airFiberConfigIndex"),
)
if mibBuilder.loadTexts:
...
airFiberStatusEntry.setIndexNames(
    (0, "UBNT-AirFIBER-MIB", "airFiberStatusIndex"),
)
if mibBuilder.loadTexts:
...
airFiberStatisticsEntry.setIndexNames(
    (0, "UBNT-AirFIBER-MIB", "airFiberStatisticsIndex"),
)
if mibBuilder.loadTexts:
