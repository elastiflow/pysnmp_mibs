# SNMP MIB module (LIEBERT-POWERSURE-INTERACTIVE-UPS-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/rob/MIBs/vertiv_476/LIEBERT-POWERSURE-INTERACTIVE-UPS-MIB.mib
...
lcUpsInputEntry.setIndexNames(
    (0, "LIEBERT-POWERSURE-INTERACTIVE-UPS-MIB", "lcUpsInputLine"),
)
if mibBuilder.loadTexts:
...
lcUpsOutputEntry.setIndexNames(
    (0, "LIEBERT-POWERSURE-INTERACTIVE-UPS-MIB", "lcUpsOutputLine"),
)
if mibBuilder.loadTexts:
...
lcUpsAlarmEntry.setIndexNames(
    (0, "LIEBERT-POWERSURE-INTERACTIVE-UPS-MIB", "lcUpsAlarmId"),
)
if mibBuilder.loadTexts:
...
mibBuilder.exportSymbols(
    "LIEBERT-POWERSURE-INTERACTIVE-UPS-MIB",
    **{"emerson": emerson,
