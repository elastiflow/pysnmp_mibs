# SNMP MIB module (LIEBERT-SERIES-300-UPS-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/rob/MIBs/vertiv_476/LIEBERT-SERIES-300-UPS-MIB.mib
...
lcUpsInputEntry.setIndexNames(
    (0, "LIEBERT-SERIES-300-UPS-MIB", "lcUpsInputLine"),
)
if mibBuilder.loadTexts:
...
lcUpsOutputEntry.setIndexNames(
    (0, "LIEBERT-SERIES-300-UPS-MIB", "lcUpsOutputLine"),
)
if mibBuilder.loadTexts:
...
lcUpsAlarmEntry.setIndexNames(
    (0, "LIEBERT-SERIES-300-UPS-MIB", "lcUpsAlarmId"),
)
if mibBuilder.loadTexts:
...
lsUpsBypassEntry.setIndexNames(
    (0, "LIEBERT-SERIES-300-UPS-MIB", "lsUpsBypassLine"),
)
if mibBuilder.loadTexts:
