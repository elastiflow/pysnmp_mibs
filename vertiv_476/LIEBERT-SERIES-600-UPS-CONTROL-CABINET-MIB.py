# SNMP MIB module (LIEBERT-SERIES-600-UPS-CONTROL-CABINET-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/rob/MIBs/vertiv_476/LIEBERT-SERIES-600-UPS-CONTROL-CABINET-MIB.mib
...
lcUpsInputEntry.setIndexNames(
    (0, "LIEBERT-SERIES-600-UPS-CONTROL-CABINET-MIB", "lcUpsInputLine"),
)
if mibBuilder.loadTexts:
...
lcUpsOutputEntry.setIndexNames(
    (0, "LIEBERT-SERIES-600-UPS-CONTROL-CABINET-MIB", "lcUpsOutputLine"),
)
if mibBuilder.loadTexts:
...
lcUpsAlarmEntry.setIndexNames(
    (0, "LIEBERT-SERIES-600-UPS-CONTROL-CABINET-MIB", "lcUpsAlarmId"),
)
if mibBuilder.loadTexts:
...
lcUpsBypassEntry.setIndexNames(
    (0, "LIEBERT-SERIES-600-UPS-CONTROL-CABINET-MIB", "lcUpsBypassLine"),
)
if mibBuilder.loadTexts:
...
mibBuilder.exportSymbols(
    "LIEBERT-SERIES-600-UPS-CONTROL-CABINET-MIB",
    **{"emerson": emerson,
