# SNMP MIB module (LIEBERT-UPSTATION-S-UPS-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/rob/MIBs/vertiv_476/LIEBERT-UPSTATION-S-UPS-MIB.mib
...
lcUpsInputEntry.setIndexNames(
    (0, "LIEBERT-UPSTATION-S-UPS-MIB", "lcUpsInputLine"),
)
if mibBuilder.loadTexts:
...
lcUpsOutputEntry.setIndexNames(
    (0, "LIEBERT-UPSTATION-S-UPS-MIB", "lcUpsOutputLine"),
)
if mibBuilder.loadTexts:
...
lcUpsAlarmEntry.setIndexNames(
    (0, "LIEBERT-UPSTATION-S-UPS-MIB", "lcUpsAlarmId"),
)
if mibBuilder.loadTexts:
...
lcUpsSwitchedReceptEntry.setIndexNames(
    (0, "LIEBERT-UPSTATION-S-UPS-MIB", "lcUpsSwitchedReceptIndex"),
)
if mibBuilder.loadTexts:
...
lsUpsBypassEntry.setIndexNames(
    (0, "LIEBERT-UPSTATION-S-UPS-MIB", "lsUpsBypassLine"),
)
if mibBuilder.loadTexts:
...
lcUpsReceptOffTrap.setObjects(
      *(("SNMPv2-MIB", "sysUpTime"),
        ("LIEBERT-UPSTATION-S-UPS-MIB", "lcUpsSwitchedReceptIndex"))
)
if mibBuilder.loadTexts:
