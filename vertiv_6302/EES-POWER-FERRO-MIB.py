# SNMP MIB module (EES-POWER-FERRO-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/rob/MIBs/vertiv_6302/EES-POWER-FERRO-MIB.mib
# Produced by pysmi-1.6.1 at Sat Jun  7 19:37:39 2025
...
psBatteryEntry.setIndexNames(
    (0, "EES-POWER-FERRO-MIB", "psBatteryIndex"),
)
if mibBuilder.loadTexts:
...
psTemperatureEntry.setIndexNames(
    (0, "EES-POWER-FERRO-MIB", "psTemperatureIndex"),
)
if mibBuilder.loadTexts:
...
psRectifierEntry.setIndexNames(
    (0, "EES-POWER-FERRO-MIB", "psRectifierIndex"),
)
if mibBuilder.loadTexts:
...
psDistributionLoadEntry.setIndexNames(
    (0, "EES-POWER-FERRO-MIB", "psDistributionLoadIndex"),
)
if mibBuilder.loadTexts:
...
psDistributionGeneralEntry.setIndexNames(
    (0, "EES-POWER-FERRO-MIB", "psDistributionGeneralIndex"),
)
if mibBuilder.loadTexts:
...
psConverterEntry.setIndexNames(
    (0, "EES-POWER-FERRO-MIB", "psConverterIndex"),
)
if mibBuilder.loadTexts:
...
equipmentSignalTableEntry.setIndexNames(
    (0, "EES-POWER-FERRO-MIB", "psEquipmentSignalTableEntryIndex"),
)
if mibBuilder.loadTexts:
...
psSMDUHCurrentEntry.setIndexNames(
    (0, "EES-POWER-FERRO-MIB", "psSMDUHCurrentIndex"),
)
if mibBuilder.loadTexts:
...
psSMDUHPowerEntry.setIndexNames(
    (0, "EES-POWER-FERRO-MIB", "psSMDUHPowerIndex"),
)
if mibBuilder.loadTexts:
...
psSMDUHEnergyEntry.setIndexNames(
    (0, "EES-POWER-FERRO-MIB", "psSMDUHEnergyIndex"),
)
if mibBuilder.loadTexts:
...
activeAlarmEntry.setIndexNames(
    (0, "EES-POWER-FERRO-MIB", "alarmIndex"),
)
if mibBuilder.loadTexts:
...
alarmTrap.setObjects(
      *(("EES-POWER-FERRO-MIB", "alarmIndex"),
        ("EES-POWER-FERRO-MIB", "alarmTime"),
        ("EES-POWER-FERRO-MIB", "alarmStatusChange"),
        ("EES-POWER-FERRO-MIB", "alarmSeverity"),
        ("EES-POWER-FERRO-MIB", "alarmDescription"),
        ("EES-POWER-FERRO-MIB", "alarmType"))
)
if mibBuilder.loadTexts:
    alarmTrap.setStatus(
        "current"
