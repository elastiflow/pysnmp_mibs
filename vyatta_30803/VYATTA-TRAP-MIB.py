# SNMP MIB module (VYATTA-TRAP-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/rob/MIBs/vyatta_30803/VYATTA-TRAP-MIB.mib
# Produced by pysmi-1.6.1 at Thu Jun  5 21:55:26 2025
...
(vyatta,) = mibBuilder.importSymbols(
    "VYATTA-SMI",
    "vyatta")
...
mgmtEventTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 30803, 1, 1, 2, 1)
)
mgmtEventTrap.setObjects(
      *(("VYATTA-TRAP-MIB", "mgmtEventUser"),
        ("VYATTA-TRAP-MIB", "mgmtEventSource"),
        ("VYATTA-TRAP-MIB", "mgmtEventType"),
        ("VYATTA-TRAP-MIB", "mgmtEventPrevCfg"),
        ("VYATTA-TRAP-MIB", "mgmtEventCurrCfg"))
)
if mibBuilder.loadTexts:
