...
# Notes
# -----
# ASN.1 source file:///Users/rob/MIBs/wwp_6141/WWP-LEOS-CHASSIS-MIB.mib
...
_WwpLeosSystemCleiCode_Type = DisplayString
_WwpLeosSystemCleiCode_Object = MibScalar
wwpLeosSystemCleiCode = _WwpLeosSystemCleiCode_Object(
    (1, 3, 6, 1, 4, 1, 6141, 2, 60, 11, 1, 1, 1, 68),
    _WwpLeosSystemCleiCode_Type()
)
wwpLeosSystemCleiCode.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    wwpLeosSystemCleiCode.setStatus("current")
...
_WwpLeosChassisPlatformCapsNetworkSync_Type = TruthValue
_WwpLeosChassisPlatformCapsNetworkSync_Object = MibScalar
wwpLeosChassisPlatformCapsNetworkSync = _WwpLeosChassisPlatformCapsNetworkSync_Object(
    (1, 3, 6, 1, 4, 1, 6141, 2, 60, 11, 1, 1, 8, 32),
    _WwpLeosChassisPlatformCapsNetworkSync_Type()
)
wwpLeosChassisPlatformCapsNetworkSync.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    wwpLeosChassisPlatformCapsNetworkSync.setStatus("current")
_WwpLeosChassisPlatformCapsBITSTiming_Type = TruthValue
_WwpLeosChassisPlatformCapsBITSTiming_Object = MibScalar
wwpLeosChassisPlatformCapsBITSTiming = _WwpLeosChassisPlatformCapsBITSTiming_Object(
    (1, 3, 6, 1, 4, 1, 6141, 2, 60, 11, 1, 1, 8, 33),
    _WwpLeosChassisPlatformCapsBITSTiming_Type()
)
wwpLeosChassisPlatformCapsBITSTiming.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    wwpLeosChassisPlatformCapsBITSTiming.setStatus("current")
_WwpLeosChassisPlatformCapsGPSTiming_Type = TruthValue
_WwpLeosChassisPlatformCapsGPSTiming_Object = MibScalar
wwpLeosChassisPlatformCapsGPSTiming = _WwpLeosChassisPlatformCapsGPSTiming_Object(
    (1, 3, 6, 1, 4, 1, 6141, 2, 60, 11, 1, 1, 8, 34),
    _WwpLeosChassisPlatformCapsGPSTiming_Type()
)
wwpLeosChassisPlatformCapsGPSTiming.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    wwpLeosChassisPlatformCapsGPSTiming.setStatus("current")
_WwpLeosChassisPlatformCapsPTPTiming_Type = TruthValue
_WwpLeosChassisPlatformCapsPTPTiming_Object = MibScalar
wwpLeosChassisPlatformCapsPTPTiming = _WwpLeosChassisPlatformCapsPTPTiming_Object(
    (1, 3, 6, 1, 4, 1, 6141, 2, 60, 11, 1, 1, 8, 35),
    _WwpLeosChassisPlatformCapsPTPTiming_Type()
)
wwpLeosChassisPlatformCapsPTPTiming.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    wwpLeosChassisPlatformCapsPTPTiming.setStatus("current")


class _WwpLeosChassisPlatformCapsMaxTunnelsNativePbt_Type(Unsigned32):
    """Custom type wwpLeosChassisPlatformCapsMaxTunnelsNativePbt based on Unsigned32"""
    subtypeSpec = Unsigned32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_WwpLeosChassisPlatformCapsMaxTunnelsNativePbt_Type.__name__ = "Unsigned32"
_WwpLeosChassisPlatformCapsMaxTunnelsNativePbt_Object = MibScalar
wwpLeosChassisPlatformCapsMaxTunnelsNativePbt = _WwpLeosChassisPlatformCapsMaxTunnelsNativePbt_Object(
    (1, 3, 6, 1, 4, 1, 6141, 2, 60, 11, 1, 1, 8, 36),
    _WwpLeosChassisPlatformCapsMaxTunnelsNativePbt_Type()
)
wwpLeosChassisPlatformCapsMaxTunnelsNativePbt.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    wwpLeosChassisPlatformCapsMaxTunnelsNativePbt.setStatus("current")


class _WwpLeosChassisPlatformCapsMaxDecapTunnelsNativePbt_Type(Unsigned32):
    """Custom type wwpLeosChassisPlatformCapsMaxDecapTunnelsNativePbt based on Unsigned32"""
    subtypeSpec = Unsigned32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_WwpLeosChassisPlatformCapsMaxDecapTunnelsNativePbt_Type.__name__ = "Unsigned32"
_WwpLeosChassisPlatformCapsMaxDecapTunnelsNativePbt_Object = MibScalar
wwpLeosChassisPlatformCapsMaxDecapTunnelsNativePbt = _WwpLeosChassisPlatformCapsMaxDecapTunnelsNativePbt_Object(
    (1, 3, 6, 1, 4, 1, 6141, 2, 60, 11, 1, 1, 8, 37),
    _WwpLeosChassisPlatformCapsMaxDecapTunnelsNativePbt_Type()
)
wwpLeosChassisPlatformCapsMaxDecapTunnelsNativePbt.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    wwpLeosChassisPlatformCapsMaxDecapTunnelsNativePbt.setStatus("current")


class _WwpLeosChassisPlatformCapsMaxEncapTunnelsNativePbt_Type(Unsigned32):
    """Custom type wwpLeosChassisPlatformCapsMaxEncapTunnelsNativePbt based on Unsigned32"""
    subtypeSpec = Unsigned32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 256),
    )
...
_WwpLeosChassisPlatformCapsMaxEncapTunnelsNativePbt_Type.__name__ = "Unsigned32"
_WwpLeosChassisPlatformCapsMaxEncapTunnelsNativePbt_Object = MibScalar
wwpLeosChassisPlatformCapsMaxEncapTunnelsNativePbt = _WwpLeosChassisPlatformCapsMaxEncapTunnelsNativePbt_Object(
    (1, 3, 6, 1, 4, 1, 6141, 2, 60, 11, 1, 1, 8, 38),
    _WwpLeosChassisPlatformCapsMaxEncapTunnelsNativePbt_Type()
)
wwpLeosChassisPlatformCapsMaxEncapTunnelsNativePbt.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    wwpLeosChassisPlatformCapsMaxEncapTunnelsNativePbt.setStatus("current")
...
mibBuilder.exportSymbols(
    ...
    **{"PortList": PortList,
       ...
       "wwpLeosSystemCleiCode": wwpLeosSystemCleiCode,
       ...
       "wwpLeosChassisPlatformCapsNetworkSync": wwpLeosChassisPlatformCapsNetworkSync,
       "wwpLeosChassisPlatformCapsBITSTiming": wwpLeosChassisPlatformCapsBITSTiming,
       "wwpLeosChassisPlatformCapsGPSTiming": wwpLeosChassisPlatformCapsGPSTiming,
       "wwpLeosChassisPlatformCapsPTPTiming": wwpLeosChassisPlatformCapsPTPTiming,
       "wwpLeosChassisPlatformCapsMaxTunnelsNativePbt": wwpLeosChassisPlatformCapsMaxTunnelsNativePbt,
       "wwpLeosChassisPlatformCapsMaxDecapTunnelsNativePbt": wwpLeosChassisPlatformCapsMaxDecapTunnelsNativePbt,
       "wwpLeosChassisPlatformCapsMaxEncapTunnelsNativePbt": wwpLeosChassisPlatformCapsMaxEncapTunnelsNativePbt,
