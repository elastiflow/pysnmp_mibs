...
# Notes
# -----
# ASN.1 source file:///Users/rob/MIBs/wwp_6141/WWP-LEOS-DHCP-CLIENT-MIB.mib
...
_WwpLeosDhcpRelayAgentL2Forward_Type = Counter32
_WwpLeosDhcpRelayAgentL2Forward_Object = MibScalar
wwpLeosDhcpRelayAgentL2Forward = _WwpLeosDhcpRelayAgentL2Forward_Object(
    (1, 3, 6, 1, 4, 1, 6141, 2, 60, 17, 1, 2, 1, 5),
    _WwpLeosDhcpRelayAgentL2Forward_Type()
)
wwpLeosDhcpRelayAgentL2Forward.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    wwpLeosDhcpRelayAgentL2Forward.setStatus("current")
_WwpLeosDhcpRelayAgentL2Relayed_Type = Counter32
_WwpLeosDhcpRelayAgentL2Relayed_Object = MibScalar
wwpLeosDhcpRelayAgentL2Relayed = _WwpLeosDhcpRelayAgentL2Relayed_Object(
    (1, 3, 6, 1, 4, 1, 6141, 2, 60, 17, 1, 2, 1, 6),
    _WwpLeosDhcpRelayAgentL2Relayed_Type()
)
wwpLeosDhcpRelayAgentL2Relayed.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    wwpLeosDhcpRelayAgentL2Relayed.setStatus("current")
_WwpLeosDhcpRelayAgentL2Dropped_Type = Counter32
_WwpLeosDhcpRelayAgentL2Dropped_Object = MibScalar
wwpLeosDhcpRelayAgentL2Dropped = _WwpLeosDhcpRelayAgentL2Dropped_Object(
    (1, 3, 6, 1, 4, 1, 6141, 2, 60, 17, 1, 2, 1, 7),
    _WwpLeosDhcpRelayAgentL2Dropped_Type()
)
wwpLeosDhcpRelayAgentL2Dropped.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    wwpLeosDhcpRelayAgentL2Dropped.setStatus("current")
_WwpLeosDhcpRelayAgentL2GlobalStatsClear_Type = TruthValue
_WwpLeosDhcpRelayAgentL2GlobalStatsClear_Object = MibScalar
wwpLeosDhcpRelayAgentL2GlobalStatsClear = _WwpLeosDhcpRelayAgentL2GlobalStatsClear_Object(
    (1, 3, 6, 1, 4, 1, 6141, 2, 60, 17, 1, 2, 1, 8),
    _WwpLeosDhcpRelayAgentL2GlobalStatsClear_Type()
)
wwpLeosDhcpRelayAgentL2GlobalStatsClear.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    wwpLeosDhcpRelayAgentL2GlobalStatsClear.setStatus("current")
...
_WwpLeosDhcpRelayAgentL2InvalidConfigPktDrop_Type = Counter32
_WwpLeosDhcpRelayAgentL2InvalidConfigPktDrop_Object = MibTableColumn
wwpLeosDhcpRelayAgentL2InvalidConfigPktDrop = _WwpLeosDhcpRelayAgentL2InvalidConfigPktDrop_Object(
    (1, 3, 6, 1, 4, 1, 6141, 2, 60, 17, 1, 2, 6, 1, 10),
    _WwpLeosDhcpRelayAgentL2InvalidConfigPktDrop_Type()
)
wwpLeosDhcpRelayAgentL2InvalidConfigPktDrop.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    wwpLeosDhcpRelayAgentL2InvalidConfigPktDrop.setStatus("current")
...
class _WwpLeosDhcpRelayAgentCidString_Type(DisplayString):
    """Custom type wwpLeosDhcpRelayAgentCidString based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_WwpLeosDhcpRelayAgentCidString_Type.__name__ = "DisplayString"
...
_WwpLeosDhcpRelayAgentRidStringTable_Object = MibTable
wwpLeosDhcpRelayAgentRidStringTable = _WwpLeosDhcpRelayAgentRidStringTable_Object(
    (1, 3, 6, 1, 4, 1, 6141, 2, 60, 17, 1, 2, 8)
)
if mibBuilder.loadTexts:
    wwpLeosDhcpRelayAgentRidStringTable.setStatus("current")
_WwpLeosDhcpRelayAgentRidStringEntry_Object = MibTableRow
wwpLeosDhcpRelayAgentRidStringEntry = _WwpLeosDhcpRelayAgentRidStringEntry_Object(
    (1, 3, 6, 1, 4, 1, 6141, 2, 60, 17, 1, 2, 8, 1)
)
wwpLeosDhcpRelayAgentRidStringEntry.setIndexNames(
    (0, "WWP-LEOS-DHCP-CLIENT-MIB", "wwpLeosDhcpRelayAgentVlan"),
    (0, "WWP-LEOS-DHCP-CLIENT-MIB", "wwpLeosDhcpRelayAgentRidStringPort"),
)
if mibBuilder.loadTexts:
    wwpLeosDhcpRelayAgentRidStringEntry.setStatus("current")


class _WwpLeosDhcpRelayAgentRidStringPort_Type(Integer32):
    """Custom type wwpLeosDhcpRelayAgentRidStringPort based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(1, 65535),
    )
...
_WwpLeosDhcpRelayAgentRidStringPort_Type.__name__ = "Integer32"
_WwpLeosDhcpRelayAgentRidStringPort_Object = MibTableColumn
wwpLeosDhcpRelayAgentRidStringPort = _WwpLeosDhcpRelayAgentRidStringPort_Object(
    (1, 3, 6, 1, 4, 1, 6141, 2, 60, 17, 1, 2, 8, 1, 1),
    _WwpLeosDhcpRelayAgentRidStringPort_Type()
)
wwpLeosDhcpRelayAgentRidStringPort.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    wwpLeosDhcpRelayAgentRidStringPort.setStatus("current")


class _WwpLeosDhcpRelayAgentRidString_Type(DisplayString):
    """Custom type wwpLeosDhcpRelayAgentRidString based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(1, 64),
    )
...
_WwpLeosDhcpRelayAgentRidString_Type.__name__ = "DisplayString"
_WwpLeosDhcpRelayAgentRidString_Object = MibTableColumn
wwpLeosDhcpRelayAgentRidString = _WwpLeosDhcpRelayAgentRidString_Object(
    (1, 3, 6, 1, 4, 1, 6141, 2, 60, 17, 1, 2, 8, 1, 2),
    _WwpLeosDhcpRelayAgentRidString_Type()
)
wwpLeosDhcpRelayAgentRidString.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    wwpLeosDhcpRelayAgentRidString.setStatus("current")
_WwpLeosDhcpRelayAgentRidStringRowStatus_Type = RowStatus
_WwpLeosDhcpRelayAgentRidStringRowStatus_Object = MibTableColumn
wwpLeosDhcpRelayAgentRidStringRowStatus = _WwpLeosDhcpRelayAgentRidStringRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 6141, 2, 60, 17, 1, 2, 8, 1, 3),
    _WwpLeosDhcpRelayAgentRidStringRowStatus_Type()
)
wwpLeosDhcpRelayAgentRidStringRowStatus.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    wwpLeosDhcpRelayAgentRidStringRowStatus.setStatus("current")
...
mibBuilder.exportSymbols(
    ...
    **{"wwpLeosDhcpClientMIB": wwpLeosDhcpClientMIB,
       ...
       "wwpLeosDhcpRelayAgentL2Forward": wwpLeosDhcpRelayAgentL2Forward,
       "wwpLeosDhcpRelayAgentL2Relayed": wwpLeosDhcpRelayAgentL2Relayed,
       "wwpLeosDhcpRelayAgentL2Dropped": wwpLeosDhcpRelayAgentL2Dropped,
       "wwpLeosDhcpRelayAgentL2GlobalStatsClear": wwpLeosDhcpRelayAgentL2GlobalStatsClear,
       ...
       "wwpLeosDhcpRelayAgentL2InvalidConfigPktDrop": wwpLeosDhcpRelayAgentL2InvalidConfigPktDrop,
       ...
       "wwpLeosDhcpRelayAgentRidStringTable": wwpLeosDhcpRelayAgentRidStringTable,
       "wwpLeosDhcpRelayAgentRidStringEntry": wwpLeosDhcpRelayAgentRidStringEntry,
       "wwpLeosDhcpRelayAgentRidStringPort": wwpLeosDhcpRelayAgentRidStringPort,
       "wwpLeosDhcpRelayAgentRidString": wwpLeosDhcpRelayAgentRidString,
       "wwpLeosDhcpRelayAgentRidStringRowStatus": wwpLeosDhcpRelayAgentRidStringRowStatus,
