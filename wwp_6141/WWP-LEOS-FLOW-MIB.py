...
# Notes
# -----
# ASN.1 source file:///Users/rob/MIBs/wwp_6141/WWP-LEOS-FLOW-MIB.mib
# Produced by pysmi-1.6.1 at Sun Jun  8 10:32:59 2025
...
class _WwpLeosFlowCpuRateLimitEsmc_Type(Integer32):
    """Custom type wwpLeosFlowCpuRateLimitEsmc based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 2500),
    )
...
_WwpLeosFlowCpuRateLimitEsmc_Type.__name__ = "Integer32"
_WwpLeosFlowCpuRateLimitEsmc_Object = MibTableColumn
wwpLeosFlowCpuRateLimitEsmc = _WwpLeosFlowCpuRateLimitEsmc_Object(
    (1, 3, 6, 1, 4, 1, 6141, 2, 60, 6, 1, 1, 31, 1, 35),
    _WwpLeosFlowCpuRateLimitEsmc_Type()
)
wwpLeosFlowCpuRateLimitEsmc.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    wwpLeosFlowCpuRateLimitEsmc.setStatus("current")
...
_WwpLeosFlowCpuRateLimitStatsEsmcPassed_Type = Gauge32
_WwpLeosFlowCpuRateLimitStatsEsmcPassed_Object = MibTableColumn
wwpLeosFlowCpuRateLimitStatsEsmcPassed = _WwpLeosFlowCpuRateLimitStatsEsmcPassed_Object(
    (1, 3, 6, 1, 4, 1, 6141, 2, 60, 6, 1, 1, 32, 1, 66),
    _WwpLeosFlowCpuRateLimitStatsEsmcPassed_Type()
)
wwpLeosFlowCpuRateLimitStatsEsmcPassed.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    wwpLeosFlowCpuRateLimitStatsEsmcPassed.setStatus("current")
_WwpLeosFlowCpuRateLimitStatsEsmcDropped_Type = Gauge32
_WwpLeosFlowCpuRateLimitStatsEsmcDropped_Object = MibTableColumn
wwpLeosFlowCpuRateLimitStatsEsmcDropped = _WwpLeosFlowCpuRateLimitStatsEsmcDropped_Object(
    (1, 3, 6, 1, 4, 1, 6141, 2, 60, 6, 1, 1, 32, 1, 67),
    _WwpLeosFlowCpuRateLimitStatsEsmcDropped_Type()
)
wwpLeosFlowCpuRateLimitStatsEsmcDropped.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    wwpLeosFlowCpuRateLimitStatsEsmcDropped.setStatus("current")
...
mibBuilder.exportSymbols(
    ...
    **{"PriorityMapping": PriorityMapping,
       ...
       "wwpLeosFlowCpuRateLimitEsmc": wwpLeosFlowCpuRateLimitEsmc,
       ...
       "wwpLeosFlowCpuRateLimitStatsEsmcPassed": wwpLeosFlowCpuRateLimitStatsEsmcPassed,
       "wwpLeosFlowCpuRateLimitStatsEsmcDropped": wwpLeosFlowCpuRateLimitStatsEsmcDropped,
