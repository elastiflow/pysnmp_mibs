...
# Notes
# -----
# ASN.1 source file:///Users/rob/MIBs/wwp_6141/WWP-LEOS-IP-INTERFACE-MIB.mib
...
wwpLeosIpInterfaceIndex.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
...
wwpLeosIpDataInterfaceIndex.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
...
_WwpLeosIpDataInterfaceCvid_Type = VlanId
_WwpLeosIpDataInterfaceCvid_Object = MibTableColumn
wwpLeosIpDataInterfaceCvid = _WwpLeosIpDataInterfaceCvid_Object(
    (1, 3, 6, 1, 4, 1, 6141, 2, 60, 24, 1, 1, 4, 1, 11),
    _WwpLeosIpDataInterfaceCvid_Type()
)
wwpLeosIpDataInterfaceCvid.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    wwpLeosIpDataInterfaceCvid.setStatus("current")
...
if mibBuilder.loadTexts:
    wwpLeosIpAclClearStats.setStatus("deprecated")
...
class _WwpLeosIpAclStatsClear_Type(TruthValue):
    """Custom type wwpLeosIpAclStatsClear based on TruthValue"""
    defaultValue = 2


_WwpLeosIpAclStatsClear_Type.__name__ = "TruthValue"
_WwpLeosIpAclStatsClear_Object = MibScalar
wwpLeosIpAclStatsClear = _WwpLeosIpAclStatsClear_Object(
    (1, 3, 6, 1, 4, 1, 6141, 2, 60, 24, 1, 2, 10),
    _WwpLeosIpAclStatsClear_Type()
)
wwpLeosIpAclStatsClear.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    wwpLeosIpAclStatsClear.setStatus("current")
...
mibBuilder.exportSymbols(
    ...
    **{"VlanId": VlanId,
       ...
       "wwpLeosIpDataInterfaceCvid": wwpLeosIpDataInterfaceCvid,
       ...
       "wwpLeosIpAclStatsClear": wwpLeosIpAclStatsClear,
