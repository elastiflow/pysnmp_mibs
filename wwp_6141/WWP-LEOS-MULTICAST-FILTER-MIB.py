...
# Notes
# -----
# ASN.1 source file:///Users/rob/MIBs/wwp_6141/WWP-LEOS-MULTICAST-FILTER-MIB.mib
...
class _WwpLeosMcastIgmpSnoopCompatibilityMode_Type(Integer32):
    """Custom type wwpLeosMcastIgmpSnoopCompatibilityMode based on Integer32"""
    defaultValue = 1
...
_WwpLeosMcastIgmpSnoopCompatibilityMode_Type.__name__ = "Integer32"
_WwpLeosMcastIgmpSnoopCompatibilityMode_Object = MibTableColumn
wwpLeosMcastIgmpSnoopCompatibilityMode = _WwpLeosMcastIgmpSnoopCompatibilityMode_Object(
    (1, 3, 6, 1, 4, 1, 6141, 2, 60, 7, 1, 1, 4, 1, 20),
    _WwpLeosMcastIgmpSnoopCompatibilityMode_Type()
)
wwpLeosMcastIgmpSnoopCompatibilityMode.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    wwpLeosMcastIgmpSnoopCompatibilityMode.setStatus("current")


class _WwpLeosMcastIgmpSnoopForkMode_Type(Integer32):
    """Custom type wwpLeosMcastIgmpSnoopForkMode based on Integer32"""
    defaultValue = 2
...
_WwpLeosMcastIgmpSnoopForkMode_Type.__name__ = "Integer32"
_WwpLeosMcastIgmpSnoopForkMode_Object = MibTableColumn
wwpLeosMcastIgmpSnoopForkMode = _WwpLeosMcastIgmpSnoopForkMode_Object(
    (1, 3, 6, 1, 4, 1, 6141, 2, 60, 7, 1, 1, 4, 1, 21),
    _WwpLeosMcastIgmpSnoopForkMode_Type()
)
wwpLeosMcastIgmpSnoopForkMode.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    wwpLeosMcastIgmpSnoopForkMode.setStatus("current")


class _WwpLeosMcastIgmpSnoopEnableOperState_Type(TruthValue):
    """Custom type wwpLeosMcastIgmpSnoopEnableOperState based on TruthValue"""
    defaultValue = 2


_WwpLeosMcastIgmpSnoopEnableOperState_Type.__name__ = "TruthValue"
_WwpLeosMcastIgmpSnoopEnableOperState_Object = MibTableColumn
wwpLeosMcastIgmpSnoopEnableOperState = _WwpLeosMcastIgmpSnoopEnableOperState_Object(
    (1, 3, 6, 1, 4, 1, 6141, 2, 60, 7, 1, 1, 4, 1, 22),
    _WwpLeosMcastIgmpSnoopEnableOperState_Type()
)
wwpLeosMcastIgmpSnoopEnableOperState.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    wwpLeosMcastIgmpSnoopEnableOperState.setStatus("current")
...
_WwpLeosMcastCompatibilityModeDiscards_Type = Counter32
_WwpLeosMcastCompatibilityModeDiscards_Object = MibTableColumn
wwpLeosMcastCompatibilityModeDiscards = _WwpLeosMcastCompatibilityModeDiscards_Object(
    (1, 3, 6, 1, 4, 1, 6141, 2, 60, 7, 1, 3, 1, 1, 21),
    _WwpLeosMcastCompatibilityModeDiscards_Type()
)
wwpLeosMcastCompatibilityModeDiscards.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    wwpLeosMcastCompatibilityModeDiscards.setStatus("current")
_WwpLeosMcastReplyTimeouts_Type = Counter32
_WwpLeosMcastReplyTimeouts_Object = MibTableColumn
wwpLeosMcastReplyTimeouts = _WwpLeosMcastReplyTimeouts_Object(
    (1, 3, 6, 1, 4, 1, 6141, 2, 60, 7, 1, 3, 1, 1, 22),
    _WwpLeosMcastReplyTimeouts_Type()
)
wwpLeosMcastReplyTimeouts.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    wwpLeosMcastReplyTimeouts.setStatus("current")
_WwpLeosMcastResourceExceed_Type = Counter32
_WwpLeosMcastResourceExceed_Object = MibTableColumn
wwpLeosMcastResourceExceed = _WwpLeosMcastResourceExceed_Object(
    (1, 3, 6, 1, 4, 1, 6141, 2, 60, 7, 1, 3, 1, 1, 23),
    _WwpLeosMcastResourceExceed_Type()
)
wwpLeosMcastResourceExceed.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    wwpLeosMcastResourceExceed.setStatus("current")
...
mibBuilder.exportSymbols(
    ...
    **{"VlanId": VlanId,
       ...
       "wwpLeosMcastIgmpSnoopCompatibilityMode": wwpLeosMcastIgmpSnoopCompatibilityMode,
       "wwpLeosMcastIgmpSnoopForkMode": wwpLeosMcastIgmpSnoopForkMode,
       "wwpLeosMcastIgmpSnoopEnableOperState": wwpLeosMcastIgmpSnoopEnableOperState,
       ...
       "wwpLeosMcastCompatibilityModeDiscards": wwpLeosMcastCompatibilityModeDiscards,
       "wwpLeosMcastReplyTimeouts": wwpLeosMcastReplyTimeouts,
       "wwpLeosMcastResourceExceed": wwpLeosMcastResourceExceed,
