...
# Notes
# -----
# ASN.1 source file:///Users/rob/MIBs/wwp_6141/WWP-LEOS-NTP-CLIENT-MIB.mib
...
if mibBuilder.loadTexts:
    wwpLeosNtpClientPollFreq.setUnits("seconds")
...
if mibBuilder.loadTexts:
    wwpLeosNtpClientMinPollFreq.setUnits("seconds")
...
if mibBuilder.loadTexts:
    wwpLeosNtpClientMaxPollFreq.setUnits("seconds")
...
_WwpLeosNtpClientDriftClear_Type = TruthValue
_WwpLeosNtpClientDriftClear_Object = MibScalar
wwpLeosNtpClientDriftClear = _WwpLeosNtpClientDriftClear_Object(
    (1, 3, 6, 1, 4, 1, 6141, 2, 60, 18, 1, 1, 20),
    _WwpLeosNtpClientDriftClear_Type()
)
wwpLeosNtpClientDriftClear.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    wwpLeosNtpClientDriftClear.setStatus("current")
_WwpLeosNtpClientDriftPPB_Type = Integer32
_WwpLeosNtpClientDriftPPB_Object = MibScalar
wwpLeosNtpClientDriftPPB = _WwpLeosNtpClientDriftPPB_Object(
    (1, 3, 6, 1, 4, 1, 6141, 2, 60, 18, 1, 1, 21),
    _WwpLeosNtpClientDriftPPB_Type()
)
wwpLeosNtpClientDriftPPB.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    wwpLeosNtpClientDriftPPB.setStatus("current")
if mibBuilder.loadTexts:
    wwpLeosNtpClientDriftPPB.setUnits("parts per billion")
...
mibBuilder.exportSymbols(
    ...
    **{"Md5Key": Md5Key,
       ...
       "wwpLeosNtpClientDriftClear": wwpLeosNtpClientDriftClear,
       "wwpLeosNtpClientDriftPPB": wwpLeosNtpClientDriftPPB,
