...
# Notes
# -----
# ASN.1 source file:///Users/rob/MIBs/wwp_6141/WWP-LEOS-PBT-MIB.mib
...
_WwpLeosPbtVirtualCircuitReplaceCTAG_Type = TruthValue
_WwpLeosPbtVirtualCircuitReplaceCTAG_Object = MibTableColumn
wwpLeosPbtVirtualCircuitReplaceCTAG = _WwpLeosPbtVirtualCircuitReplaceCTAG_Object(
    (1, 3, 6, 1, 4, 1, 6141, 2, 60, 38, 1, 1, 4, 1, 12),
    _WwpLeosPbtVirtualCircuitReplaceCTAG_Type()
)
wwpLeosPbtVirtualCircuitReplaceCTAG.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    wwpLeosPbtVirtualCircuitReplaceCTAG.setStatus("current")
_WwpLeosPbtVirtualCircuitCtag_Type = Integer32
_WwpLeosPbtVirtualCircuitCtag_Object = MibTableColumn
wwpLeosPbtVirtualCircuitCtag = _WwpLeosPbtVirtualCircuitCtag_Object(
    (1, 3, 6, 1, 4, 1, 6141, 2, 60, 38, 1, 1, 4, 1, 13),
    _WwpLeosPbtVirtualCircuitCtag_Type()
)
wwpLeosPbtVirtualCircuitCtag.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    wwpLeosPbtVirtualCircuitCtag.setStatus("current")
...
mibBuilder.exportSymbols(
    ...
    **{"wwpLeosPbtMIB": wwpLeosPbtMIB,
       ...
       "wwpLeosPbtVirtualCircuitReplaceCTAG": wwpLeosPbtVirtualCircuitReplaceCTAG,
       "wwpLeosPbtVirtualCircuitCtag": wwpLeosPbtVirtualCircuitCtag,
