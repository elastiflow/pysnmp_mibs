...
# Notes
# -----
# ASN.1 source file:///Users/rob/MIBs/wwp_6141/WWP-LEOS-TWAMP-MIB.mib
...
_WwpLeosTwampServerSessionDenyTable_Object = MibTable
wwpLeosTwampServerSessionDenyTable = _WwpLeosTwampServerSessionDenyTable_Object(
    (1, 3, 6, 1, 4, 1, 6141, 2, 60, 40, 1, 1, 1, 17)
)
if mibBuilder.loadTexts:
    wwpLeosTwampServerSessionDenyTable.setStatus("current")
_WwpLeosTwampServerSessionDenyEntry_Object = MibTableRow
wwpLeosTwampServerSessionDenyEntry = _WwpLeosTwampServerSessionDenyEntry_Object(
    (1, 3, 6, 1, 4, 1, 6141, 2, 60, 40, 1, 1, 1, 17, 1)
)
wwpLeosTwampServerSessionDenyEntry.setIndexNames(
    (0, "WWP-LEOS-TWAMP-MIB", "wwpLeosTwampServerSessionDenyIp"),
)
if mibBuilder.loadTexts:
    wwpLeosTwampServerSessionDenyEntry.setStatus("current")
_WwpLeosTwampServerSessionDenyIp_Type = IpAddress
_WwpLeosTwampServerSessionDenyIp_Object = MibTableColumn
wwpLeosTwampServerSessionDenyIp = _WwpLeosTwampServerSessionDenyIp_Object(
    (1, 3, 6, 1, 4, 1, 6141, 2, 60, 40, 1, 1, 1, 17, 1, 1),
    _WwpLeosTwampServerSessionDenyIp_Type()
)
wwpLeosTwampServerSessionDenyIp.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    wwpLeosTwampServerSessionDenyIp.setStatus("current")


class _WwpLeosTwampServerSessionDenyIngressPort_Type(Integer32):
    """Custom type wwpLeosTwampServerSessionDenyIngressPort based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_WwpLeosTwampServerSessionDenyIngressPort_Type.__name__ = "Integer32"
_WwpLeosTwampServerSessionDenyIngressPort_Object = MibTableColumn
wwpLeosTwampServerSessionDenyIngressPort = _WwpLeosTwampServerSessionDenyIngressPort_Object(
    (1, 3, 6, 1, 4, 1, 6141, 2, 60, 40, 1, 1, 1, 17, 1, 2),
    _WwpLeosTwampServerSessionDenyIngressPort_Type()
)
wwpLeosTwampServerSessionDenyIngressPort.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    wwpLeosTwampServerSessionDenyIngressPort.setStatus("current")
_WwpLeosTwampServerSessionDenyStatsTable_Object = MibTable
wwpLeosTwampServerSessionDenyStatsTable = _WwpLeosTwampServerSessionDenyStatsTable_Object(
    (1, 3, 6, 1, 4, 1, 6141, 2, 60, 40, 1, 1, 1, 18)
)
if mibBuilder.loadTexts:
    wwpLeosTwampServerSessionDenyStatsTable.setStatus("current")
_WwpLeosTwampServerSessionDenyStatsEntry_Object = MibTableRow
wwpLeosTwampServerSessionDenyStatsEntry = _WwpLeosTwampServerSessionDenyStatsEntry_Object(
    (1, 3, 6, 1, 4, 1, 6141, 2, 60, 40, 1, 1, 1, 18, 1)
)
wwpLeosTwampServerSessionDenyStatsEntry.setIndexNames(
    (0, "WWP-LEOS-TWAMP-MIB", "wwpLeosTwampServerSessionDenyStatsIp"),
)
if mibBuilder.loadTexts:
    wwpLeosTwampServerSessionDenyStatsEntry.setStatus("current")
_WwpLeosTwampServerSessionDenyStatsIp_Type = IpAddress
_WwpLeosTwampServerSessionDenyStatsIp_Object = MibTableColumn
wwpLeosTwampServerSessionDenyStatsIp = _WwpLeosTwampServerSessionDenyStatsIp_Object(
    (1, 3, 6, 1, 4, 1, 6141, 2, 60, 40, 1, 1, 1, 18, 1, 1),
    _WwpLeosTwampServerSessionDenyStatsIp_Type()
)
wwpLeosTwampServerSessionDenyStatsIp.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    wwpLeosTwampServerSessionDenyStatsIp.setStatus("current")
_WwpLeosTwampServerSessionDenyStatsDropPkts_Type = Unsigned32
_WwpLeosTwampServerSessionDenyStatsDropPkts_Object = MibTableColumn
wwpLeosTwampServerSessionDenyStatsDropPkts = _WwpLeosTwampServerSessionDenyStatsDropPkts_Object(
    (1, 3, 6, 1, 4, 1, 6141, 2, 60, 40, 1, 1, 1, 18, 1, 2),
    _WwpLeosTwampServerSessionDenyStatsDropPkts_Type()
)
wwpLeosTwampServerSessionDenyStatsDropPkts.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    wwpLeosTwampServerSessionDenyStatsDropPkts.setStatus("current")
...
mibBuilder.exportSymbols(
    ...
    **{"wwpLeosTwampMIB": wwpLeosTwampMIB,
       ...
       "wwpLeosTwampServerSessionDenyTable": wwpLeosTwampServerSessionDenyTable,
       "wwpLeosTwampServerSessionDenyEntry": wwpLeosTwampServerSessionDenyEntry,
       "wwpLeosTwampServerSessionDenyIp": wwpLeosTwampServerSessionDenyIp,
       "wwpLeosTwampServerSessionDenyIngressPort": wwpLeosTwampServerSessionDenyIngressPort,
       "wwpLeosTwampServerSessionDenyStatsTable": wwpLeosTwampServerSessionDenyStatsTable,
       "wwpLeosTwampServerSessionDenyStatsEntry": wwpLeosTwampServerSessionDenyStatsEntry,
       "wwpLeosTwampServerSessionDenyStatsIp": wwpLeosTwampServerSessionDenyStatsIp,
       "wwpLeosTwampServerSessionDenyStatsDropPkts": wwpLeosTwampServerSessionDenyStatsDropPkts}
)
