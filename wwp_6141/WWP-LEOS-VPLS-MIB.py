...
# Notes
# -----
# ASN.1 source file:///Users/rob/MIBs/wwp_6141/WWP-LEOS-VPLS-MIB.mib
...
class _WwpLeosVplsVirtualSwitchEthL2CftMode_Type(Integer32):
    """Custom type wwpLeosVplsVirtualSwitchEthL2CftMode based on Integer32"""
    defaultValue = 1
...
_WwpLeosVplsVirtualSwitchEthL2CftMode_Type.__name__ = "Integer32"
_WwpLeosVplsVirtualSwitchEthL2CftMode_Object = MibScalar
wwpLeosVplsVirtualSwitchEthL2CftMode = _WwpLeosVplsVirtualSwitchEthL2CftMode_Object(
    (1, 3, 6, 1, 4, 1, 6141, 2, 60, 28, 1, 1, 9, 8),
    _WwpLeosVplsVirtualSwitchEthL2CftMode_Type()
)
wwpLeosVplsVirtualSwitchEthL2CftMode.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    wwpLeosVplsVirtualSwitchEthL2CftMode.setStatus("current")
...
class _WwpLeosVplsVirtualSwitchEthCpuIfTagVid_Type(Integer32):
    """Custom type wwpLeosVplsVirtualSwitchEthCpuIfTagVid based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(1, 4094),
    )
...
_WwpLeosVplsVirtualSwitchEthCpuIfTagVid_Type.__name__ = "Integer32"
_WwpLeosVplsVirtualSwitchEthCpuIfTagVid_Object = MibTableColumn
wwpLeosVplsVirtualSwitchEthCpuIfTagVid = _WwpLeosVplsVirtualSwitchEthCpuIfTagVid_Object(
    (1, 3, 6, 1, 4, 1, 6141, 2, 60, 28, 1, 1, 26, 1, 19),
    _WwpLeosVplsVirtualSwitchEthCpuIfTagVid_Type()
)
wwpLeosVplsVirtualSwitchEthCpuIfTagVid.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    wwpLeosVplsVirtualSwitchEthCpuIfTagVid.setStatus("current")
...
_WwpLeosVplsVirtualSwitchEthIpInterfaceMemberTable_Object = MibTable
wwpLeosVplsVirtualSwitchEthIpInterfaceMemberTable = _WwpLeosVplsVirtualSwitchEthIpInterfaceMemberTable_Object(
    (1, 3, 6, 1, 4, 1, 6141, 2, 60, 28, 1, 1, 38)
)
if mibBuilder.loadTexts:
    wwpLeosVplsVirtualSwitchEthIpInterfaceMemberTable.setStatus("current")
_WwpLeosVplsVirtualSwitchEthIpInterfaceMemberEntry_Object = MibTableRow
wwpLeosVplsVirtualSwitchEthIpInterfaceMemberEntry = _WwpLeosVplsVirtualSwitchEthIpInterfaceMemberEntry_Object(
    (1, 3, 6, 1, 4, 1, 6141, 2, 60, 28, 1, 1, 38, 1)
)
wwpLeosVplsVirtualSwitchEthIpInterfaceMemberEntry.setIndexNames(
    (0, "WWP-LEOS-VPLS-MIB", "wwpLeosVplsVirtualSwitchEthIndx"),
    (0, "WWP-LEOS-VPLS-MIB", "wwpLeosVplsVirtualSwitchEthIpIfVlan"),
)
if mibBuilder.loadTexts:
    wwpLeosVplsVirtualSwitchEthIpInterfaceMemberEntry.setStatus("current")
_WwpLeosVplsVirtualSwitchEthIpIfIndex_Type = InterfaceIndex
_WwpLeosVplsVirtualSwitchEthIpIfIndex_Object = MibTableColumn
wwpLeosVplsVirtualSwitchEthIpIfIndex = _WwpLeosVplsVirtualSwitchEthIpIfIndex_Object(
    (1, 3, 6, 1, 4, 1, 6141, 2, 60, 28, 1, 1, 38, 1, 1),
    _WwpLeosVplsVirtualSwitchEthIpIfIndex_Type()
)
wwpLeosVplsVirtualSwitchEthIpIfIndex.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    wwpLeosVplsVirtualSwitchEthIpIfIndex.setStatus("current")
_WwpLeosVplsVirtualSwitchEthIpIfName_Type = DisplayString
_WwpLeosVplsVirtualSwitchEthIpIfName_Object = MibTableColumn
wwpLeosVplsVirtualSwitchEthIpIfName = _WwpLeosVplsVirtualSwitchEthIpIfName_Object(
    (1, 3, 6, 1, 4, 1, 6141, 2, 60, 28, 1, 1, 38, 1, 2),
    _WwpLeosVplsVirtualSwitchEthIpIfName_Type()
)
wwpLeosVplsVirtualSwitchEthIpIfName.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    wwpLeosVplsVirtualSwitchEthIpIfName.setStatus("current")


class _WwpLeosVplsVirtualSwitchEthIpIfVlan_Type(Integer32):
    """Custom type wwpLeosVplsVirtualSwitchEthIpIfVlan based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 4095),
    )
...
_WwpLeosVplsVirtualSwitchEthIpIfVlan_Type.__name__ = "Integer32"
_WwpLeosVplsVirtualSwitchEthIpIfVlan_Object = MibTableColumn
wwpLeosVplsVirtualSwitchEthIpIfVlan = _WwpLeosVplsVirtualSwitchEthIpIfVlan_Object(
    (1, 3, 6, 1, 4, 1, 6141, 2, 60, 28, 1, 1, 38, 1, 3),
    _WwpLeosVplsVirtualSwitchEthIpIfVlan_Type()
)
wwpLeosVplsVirtualSwitchEthIpIfVlan.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    wwpLeosVplsVirtualSwitchEthIpIfVlan.setStatus("current")
_WwpLeosVplsVirtualSwitchEthIpIfRowStatus_Type = RowStatus
_WwpLeosVplsVirtualSwitchEthIpIfRowStatus_Object = MibTableColumn
wwpLeosVplsVirtualSwitchEthIpIfRowStatus = _WwpLeosVplsVirtualSwitchEthIpIfRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 6141, 2, 60, 28, 1, 1, 38, 1, 4),
    _WwpLeosVplsVirtualSwitchEthIpIfRowStatus_Type()
)
wwpLeosVplsVirtualSwitchEthIpIfRowStatus.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    wwpLeosVplsVirtualSwitchEthIpIfRowStatus.setStatus("current")
...
mibBuilder.exportSymbols(
    ...
    **{"VlanId": VlanId,
       ...
       "wwpLeosVplsVirtualSwitchEthL2CftMode": wwpLeosVplsVirtualSwitchEthL2CftMode,
       ...
       "wwpLeosVplsVirtualSwitchEthCpuIfTagVid": wwpLeosVplsVirtualSwitchEthCpuIfTagVid,
       ...
       "wwpLeosVplsVirtualSwitchEthIpInterfaceMemberTable": wwpLeosVplsVirtualSwitchEthIpInterfaceMemberTable,
       "wwpLeosVplsVirtualSwitchEthIpInterfaceMemberEntry": wwpLeosVplsVirtualSwitchEthIpInterfaceMemberEntry,
       "wwpLeosVplsVirtualSwitchEthIpIfIndex": wwpLeosVplsVirtualSwitchEthIpIfIndex,
       "wwpLeosVplsVirtualSwitchEthIpIfName": wwpLeosVplsVirtualSwitchEthIpIfName,
       "wwpLeosVplsVirtualSwitchEthIpIfVlan": wwpLeosVplsVirtualSwitchEthIpIfVlan,
       "wwpLeosVplsVirtualSwitchEthIpIfRowStatus": wwpLeosVplsVirtualSwitchEthIpIfRowStatus,
