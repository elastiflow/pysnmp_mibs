# SNMP MIB module (DLINK-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/rob/MIBs/zyxel_890/DLINK-MIB.mib
...
_DI_106_ObjectIdentity = ObjectIdentity
DI_106 = _DI_106_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 890, 1, 1)
)
_PSysVariables_ObjectIdentity = ObjectIdentity
pSysVariables = _PSysVariables_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 890, 1, 1, 1)
)
