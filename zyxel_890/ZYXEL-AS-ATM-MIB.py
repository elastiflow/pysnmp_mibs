...
# Notes
# -----
# ASN.1 source file:///Users/rob/MIBs/zyxel_890/ZYXEL-AS-ATM-MIB.mib
...
_AsChannelTxRate_Type = Unsigned32
_AsChannelTxRate_Object = MibTableColumn
asChannelTxRate = _AsChannelTxRate_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 14, 7, 1, 5),
    _AsChannelTxRate_Type()
)
asChannelTxRate.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    asChannelTxRate.setStatus("mandatory")
_AsChannelRxRate_Type = Unsigned32
_AsChannelRxRate_Object = MibTableColumn
asChannelRxRate = _AsChannelRxRate_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 14, 7, 1, 6),
    _AsChannelRxRate_Type()
)
asChannelRxRate.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    asChannelRxRate.setStatus("mandatory")
_AsChannelErrors_Type = Counter32
_AsChannelErrors_Object = MibTableColumn
asChannelErrors = _AsChannelErrors_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 14, 7, 1, 7),
    _AsChannelErrors_Type()
)
asChannelErrors.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    asChannelErrors.setStatus("mandatory")
...
mibBuilder.exportSymbols(
    ...
    **{"asMaxNumOfChannels": asMaxNumOfChannels,
       ...
       "asChannelTxRate": asChannelTxRate,
       "asChannelRxRate": asChannelRxRate,
       "asChannelErrors": asChannelErrors}
)
