# SNMP MIB module (ZYXEL-NWA-SERIES-v1-4-2) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/rob/MIBs/zyxel_890/ZYXEL-NWA-SERIES-v1-4-2.mib
...
pwStationEntry.setIndexNames(
    (0, "ZYXEL-NWA-SERIES-v1-4-2", "pwStationIndex"),
)
if mibBuilder.loadTexts:
...
pwRogueAPDetectEntry.setIndexNames(
    (0, "ZYXEL-NWA-SERIES-v1-4-2", "pwRogueAPIndex"),
)
if mibBuilder.loadTexts:
...
pwFriendlyAPEntry.setIndexNames(
    (0, "ZYXEL-NWA-SERIES-v1-4-2", "pwFriendlyAPIndex"),
)
if mibBuilder.loadTexts:
...
pwTFTPStatus.setObjects(
      *(("ZYXEL-NWA-SERIES-v1-4-2", "pwTrapGenericMessage"),
        ("ZYXEL-NWA-SERIES-v1-4-2", "pwTftpOpStatus"),
        ("ZYXEL-NWA-SERIES-v1-4-2", "pwTftpServer"),
        ("ZYXEL-NWA-SERIES-v1-4-2", "pwTftpFileName"),
        ("ZYXEL-NWA-SERIES-v1-4-2", "pwTftpFileType"),
        ("ZYXEL-NWA-SERIES-v1-4-2", "pwTftpOpCommand"))
)
if mibBuilder.loadTexts:
