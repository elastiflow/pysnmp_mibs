...
# Notes
# -----
# ASN.1 source file:///Users/rob/MIBs/zyxel_890/ZYXEL-SYSTEM-MIB.mib
...
_ZyDateTimeServerAddress1_Type = DisplayString
_ZyDateTimeServerAddress1_Object = MibScalar
zyDateTimeServerAddress1 = _ZyDateTimeServerAddress1_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 15, 3, 82, 1, 11),
    _ZyDateTimeServerAddress1_Type()
)
zyDateTimeServerAddress1.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    zyDateTimeServerAddress1.setStatus("current")
_ZyDateTimeServerAddress2_Type = DisplayString
_ZyDateTimeServerAddress2_Object = MibScalar
zyDateTimeServerAddress2 = _ZyDateTimeServerAddress2_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 15, 3, 82, 1, 12),
    _ZyDateTimeServerAddress2_Type()
)
zyDateTimeServerAddress2.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    zyDateTimeServerAddress2.setStatus("current")
_ZyDateTimeServerAddress3_Type = DisplayString
_ZyDateTimeServerAddress3_Object = MibScalar
zyDateTimeServerAddress3 = _ZyDateTimeServerAddress3_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 15, 3, 82, 1, 13),
    _ZyDateTimeServerAddress3_Type()
)
zyDateTimeServerAddress3.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    zyDateTimeServerAddress3.setStatus("current")
...
mibBuilder.exportSymbols(
    ...
    **{"zyxelSystem": zyxelSystem,
       ...
       "zyDateTimeServerAddress1": zyDateTimeServerAddress1,
       "zyDateTimeServerAddress2": zyDateTimeServerAddress2,
       "zyDateTimeServerAddress3": zyDateTimeServerAddress3,
