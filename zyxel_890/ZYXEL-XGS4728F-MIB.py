# SNMP MIB module (ZYXEL-XGS4728F-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/rob/MIBs/zyxel_890/ZYXEL-XGS4728F-MIB.mib
...
faultMIB = ModuleIdentity(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 30)
)

faultTrapsMIB = ModuleIdentity(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 31)
)
...
rateLimitPortEntry = _RateLimitPortEntry_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 2, 2, 1)
)
...
rateLimitPortState = _RateLimitPortState_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 2, 2, 1, 1),
...
rateLimitPortCommitRate = _RateLimitPortCommitRate_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 2, 2, 1, 2),
...
rateLimitPortPeakRate = _RateLimitPortPeakRate_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 2, 2, 1, 3),
...
rateLimitPortEgrRate = _RateLimitPortEgrRate_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 2, 2, 1, 4),
...
rateLimitPortPeakState = _RateLimitPortPeakState_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 2, 2, 1, 5),
...
rateLimitPortEgrState = _RateLimitPortEgrState_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 2, 2, 1, 6),
...
rateLimitPortCommitState = _RateLimitPortCommitState_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 2, 2, 1, 7),
...
brLimitPortBrState = _BrLimitPortBrState_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 3, 2, 1, 1),
...
brLimitPortBrRate = _BrLimitPortBrRate_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 3, 2, 1, 2),
...
brLimitPortMcState = _BrLimitPortMcState_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 3, 2, 1, 3),
...
brLimitPortMcRate = _BrLimitPortMcRate_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 3, 2, 1, 4),
...
brLimitPortDlfState = _BrLimitPortDlfState_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 3, 2, 1, 5),
...
brLimitPortDlfRate = _BrLimitPortDlfRate_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 3, 2, 1, 6),
...
portSecurityPortEntry = _PortSecurityPortEntry_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 4, 2, 1)
)
...
portSecurityPortState = _PortSecurityPortState_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 4, 2, 1, 1),
...
portSecurityPortLearnState = _PortSecurityPortLearnState_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 4, 2, 1, 2),
...
portSecurityPortCount = _PortSecurityPortCount_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 4, 2, 1, 3),
...
portSecurityVMLEntry = _PortSecurityVMLEntry_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 4, 4, 1)
)
portSecurityVMLEntry.setIndexNames(
    (0, "ZYXEL-XGS4728F-MIB", "portSecurityVMLPort"),
    (0, "ZYXEL-XGS4728F-MIB", "portSecurityVMLVID"),
)
if mibBuilder.loadTexts:
...
portSecurityVMLPort = _PortSecurityVMLPort_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 4, 4, 1, 1),
...
portSecurityVMLVID = _PortSecurityVMLVID_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 4, 4, 1, 2),
...
portSecurityVMLMacLimit = _PortSecurityVMLMacLimit_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 4, 4, 1, 3),
...
portSecurityVMLRowStatus = _PortSecurityVMLRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 4, 4, 1, 4),
...
vlanTrunkPortEntry = _VlanTrunkPortEntry_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 5, 1, 1)
)
...
vlanTrunkPortState = _VlanTrunkPortState_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 5, 1, 1, 1),
...
ctlProtTransTunnelPortEntry = _CtlProtTransTunnelPortEntry_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 6, 2, 1)
)
...
ctlProtTransTunnelMode = _CtlProtTransTunnelMode_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 6, 2, 1, 1),
...
vlanStackPortEntry = _VlanStackPortEntry_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 7, 3, 1)
)
...
vlanStackPortMode = _VlanStackPortMode_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 7, 3, 1, 1),
...
vlanStackPortVid = _VlanStackPortVid_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 7, 3, 1, 2),
...
vlanStackPortPrio = _VlanStackPortPrio_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 7, 3, 1, 3),
...
vlanStackTunnelPortTpid = _VlanStackTunnelPortTpid_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 7, 3, 1, 4),
...
selectiveQinQEntry = _SelectiveQinQEntry_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 7, 4, 1)
)
selectiveQinQEntry.setIndexNames(
    (0, "ZYXEL-XGS4728F-MIB", "selectiveQinQPort"),
    (0, "ZYXEL-XGS4728F-MIB", "selectiveQinQCvid"),
)
if mibBuilder.loadTexts:
...
selectiveQinQName = _SelectiveQinQName_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 7, 4, 1, 1),
...
selectiveQinQPort = _SelectiveQinQPort_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 7, 4, 1, 2),
...
selectiveQinQCvid = _SelectiveQinQCvid_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 7, 4, 1, 3),
...
selectiveQinQSpvid = _SelectiveQinQSpvid_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 7, 4, 1, 4),
...
selectiveQinQPriority = _SelectiveQinQPriority_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 7, 4, 1, 5),
...
selectiveQinQRowStatus = _SelectiveQinQRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 7, 4, 1, 6),
...
portAuthEntryState = _PortAuthEntryState_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 8, 4, 1, 1),
...
portReAuthEntryState = _PortReAuthEntryState_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 8, 4, 1, 2),
...
portReAuthEntryTimer = _PortReAuthEntryTimer_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 8, 4, 1, 3),
...
fanRpmIndex = _FanRpmIndex_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 9, 1, 1, 1),
    _FanRpmIndex_Type()
)
...
fanRpmCurValue = _FanRpmCurValue_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 9, 1, 1, 2),
...
fanRpmMaxValue = _FanRpmMaxValue_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 9, 1, 1, 3),
...
fanRpmMinValue = _FanRpmMinValue_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 9, 1, 1, 4),
...
fanRpmLowThresh = _FanRpmLowThresh_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 9, 1, 1, 5),
...
fanRpmDescr = _FanRpmDescr_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 9, 1, 1, 6),
    _FanRpmDescr_Type()
)
...
tempIndex = _TempIndex_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 9, 2, 1, 1),
    _TempIndex_Type()
)
...
tempCurValue = _TempCurValue_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 9, 2, 1, 2),
    _TempCurValue_Type()
)
...
tempMaxValue = _TempMaxValue_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 9, 2, 1, 3),
    _TempMaxValue_Type()
)
...
tempMinValue = _TempMinValue_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 9, 2, 1, 4),
    _TempMinValue_Type()
)
...
tempHighThresh = _TempHighThresh_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 9, 2, 1, 5),
...
tempDescr = _TempDescr_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 9, 2, 1, 6),
    _TempDescr_Type()
)
...
voltageIndex = _VoltageIndex_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 9, 3, 1, 1),
    _VoltageIndex_Type()
)
...
voltageCurValue = _VoltageCurValue_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 9, 3, 1, 2),
...
voltageMaxValue = _VoltageMaxValue_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 9, 3, 1, 3),
...
voltageMinValue = _VoltageMinValue_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 9, 3, 1, 4),
...
voltageNominalValue = _VoltageNominalValue_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 9, 3, 1, 5),
...
voltageLowThresh = _VoltageLowThresh_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 9, 3, 1, 6),
...
voltageDescr = _VoltageDescr_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 9, 3, 1, 7),
    _VoltageDescr_Type()
)
...
snmpTrapDestIP = _SnmpTrapDestIP_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 10, 4, 1, 1),
...
snmpTrapDestRowStatus = _SnmpTrapDestRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 10, 4, 1, 2),
...
snmpTrapDestPort = _SnmpTrapDestPort_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 10, 4, 1, 3),
...
snmpTrapVersion = _SnmpTrapVersion_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 10, 4, 1, 4),
...
snmpTrapUserName = _SnmpTrapUserName_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 10, 4, 1, 5),
...
snmpUserName = _SnmpUserName_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 10, 6, 1, 1),
    _SnmpUserName_Type()
)
...
snmpUserSecurityLevel = _SnmpUserSecurityLevel_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 10, 6, 1, 2),
...
snmpUserAuthProtocol = _SnmpUserAuthProtocol_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 10, 6, 1, 3),
...
snmpUserPrivProtocol = _SnmpUserPrivProtocol_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 10, 6, 1, 4),
...
snmpTrapGroupEntry = _SnmpTrapGroupEntry_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 10, 7, 1)
)
...
snmpTrapSystemGroup = _SnmpTrapSystemGroup_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 10, 7, 1, 1),
...
snmpTrapInterfaceGroup = _SnmpTrapInterfaceGroup_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 10, 7, 1, 2),
...
snmpTrapAAAGroup = _SnmpTrapAAAGroup_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 10, 7, 1, 3),
...
snmpTrapIPGroup = _SnmpTrapIPGroup_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 10, 7, 1, 4),
...
snmpTrapSwitchGroup = _SnmpTrapSwitchGroup_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 10, 7, 1, 5),
...
dateTimeDaylightSavingTimeSetup = _DateTimeDaylightSavingTimeSetup_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 11, 10)
)
...
daylightSavingTimeState = _DaylightSavingTimeState_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 11, 10, 1),
...
daylightSavingTimeStartDateWeek = _DaylightSavingTimeStartDateWeek_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 11, 10, 2),
...
daylightSavingTimeStartDateDay = _DaylightSavingTimeStartDateDay_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 11, 10, 3),
...
daylightSavingTimeStartDateMonth = _DaylightSavingTimeStartDateMonth_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 11, 10, 4),
...
daylightSavingTimeStartDateHour = _DaylightSavingTimeStartDateHour_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 11, 10, 5),
...
daylightSavingTimeEndDateWeek = _DaylightSavingTimeEndDateWeek_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 11, 10, 6),
...
daylightSavingTimeEndDateDay = _DaylightSavingTimeEndDateDay_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 11, 10, 7),
...
daylightSavingTimeEndDateMonth = _DaylightSavingTimeEndDateMonth_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 11, 10, 8),
...
daylightSavingTimeEndDateHour = _DaylightSavingTimeEndDateHour_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 11, 10, 9),
...
sysMgmtTftpRemoteFileName = _SysMgmtTftpRemoteFileName_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 12, 10, 2),
...
sysMgmtTftpConfigIndex = _SysMgmtTftpConfigIndex_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 12, 10, 3),
...
sysMgmtTftpAction = _SysMgmtTftpAction_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 12, 10, 4),
...
sysMgmtTftpActionStatus = _SysMgmtTftpActionStatus_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 12, 10, 5),
...
igmpsnp8021pPriority = _Igmpsnp8021pPriority_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 13, 10),
...
igmpsnpVlanMode = _IgmpsnpVlanMode_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 13, 11),
...
stpMode = _StpMode_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 13, 12),
    _StpMode_Type()
)
...
igmpsnpVid = _IgmpsnpVid_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 13, 13, 1, 1),
    _IgmpsnpVid_Type()
)
...
igmpsnpVlanName = _IgmpsnpVlanName_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 13, 13, 1, 2),
...
igmpsnpVlanRowStatus = _IgmpsnpVlanRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 13, 13, 1, 3),
...
igmpsnpQuerierMode = _IgmpsnpQuerierMode_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 13, 14),
...
ethernetCfmStateSetup = _EthernetCfmStateSetup_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 13, 15),
...
lldpStateSetup = _LldpStateSetup_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 13, 16),
...
smartIsolationState = _SmartIsolationState_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 13, 17),
...
outOfBandSubnetMask = _OutOfBandSubnetMask_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 14, 4, 2),
...
outOfBandGateway = _OutOfBandGateway_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 14, 4, 3),
...
inbandIpTable = _InbandIpTable_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 14, 6)
)
if mibBuilder.loadTexts:
    inbandIpTable.setStatus("mandatory")
_InbandIpEntry_Object = MibTableRow
inbandIpEntry = _InbandIpEntry_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 14, 6, 1)
)
inbandIpEntry.setIndexNames(
    (0, "ZYXEL-XGS4728F-MIB", "inbandEntryIp"),
    (0, "ZYXEL-XGS4728F-MIB", "inbandEntrySubnetMask"),
)
if mibBuilder.loadTexts:
...
inbandEntryIp = _InbandEntryIp_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 14, 6, 1, 1),
    _InbandEntryIp_Type()
)
...
inbandEntrySubnetMask = _InbandEntrySubnetMask_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 14, 6, 1, 2),
...
inbandEntryVid = _InbandEntryVid_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 14, 6, 1, 3),
...
inbandEntryRowStatus = _InbandEntryRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 14, 6, 1, 4),
...
filterName = _FilterName_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 15, 1, 1, 1),
    _FilterName_Type()
)
...
filterActionState = _FilterActionState_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 15, 1, 1, 2),
...
filterMacAddr = _FilterMacAddr_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 15, 1, 1, 3),
    _FilterMacAddr_Type()
)
...
filterVid = _FilterVid_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 15, 1, 1, 4),
    _FilterVid_Type()
)
...
filterRowStatus = _FilterRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 15, 1, 1, 5),
...
mirrorMirroredState = _MirrorMirroredState_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 16, 3, 1, 1),
...
mirrorDirection = _MirrorDirection_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 16, 3, 1, 2),
...
aggrGroupIndex = _AggrGroupIndex_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 17, 3, 1, 1),
...
aggrGroupState = _AggrGroupState_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 17, 3, 1, 2),
...
aggrGroupDynamicState = _AggrGroupDynamicState_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 17, 3, 1, 3),
...
aggrGroupCriteria = _AggrGroupCriteria_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 17, 3, 1, 4),
...
aggrPortGroup = _AggrPortGroup_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 17, 4, 1, 1),
    _AggrPortGroup_Type()
)
...
aggrPortDynamicStateTimeout = _AggrPortDynamicStateTimeout_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 17, 4, 1, 2),
...
accessCtlService = _AccessCtlService_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 18, 1, 1, 1),
...
accessCtlEnable = _AccessCtlEnable_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 18, 1, 1, 2),
...
accessCtlServicePort = _AccessCtlServicePort_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 18, 1, 1, 3),
...
accessCtlTimeout = _AccessCtlTimeout_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 18, 1, 1, 4),
...
securedClientEntry = _SecuredClientEntry_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 18, 2, 1)
)
securedClientEntry.setIndexNames(
    (0, "ZYXEL-XGS4728F-MIB", "securedClientIndex"),
)
if mibBuilder.loadTexts:
...
securedClientIndex = _SecuredClientIndex_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 18, 2, 1, 1),
...
securedClientEnable = _SecuredClientEnable_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 18, 2, 1, 2),
...
securedClientStartIp = _SecuredClientStartIp_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 18, 2, 1, 3),
...
securedClientEndIp = _SecuredClientEndIp_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 18, 2, 1, 4),
...
securedClientService = _SecuredClientService_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 18, 2, 1, 5),
...
portQueuingMethodEntry = _PortQueuingMethodEntry_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 19, 1, 1)
)
portQueuingMethodEntry.setIndexNames(
    (0, "BRIDGE-MIB", "dot1dBasePort"),
    (0, "ZYXEL-XGS4728F-MIB", "portQueuingMethodQueue"),
)
if mibBuilder.loadTexts:
...
portQueuingMethodQueue = _PortQueuingMethodQueue_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 19, 1, 1, 1),
...
portQueuingMethodWeight = _PortQueuingMethodWeight_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 19, 1, 1, 2),
...
portQueuingMethodMode = _PortQueuingMethodMode_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 19, 1, 1, 3),
...
portQueuingMethodHybridSpqEntry = _PortQueuingMethodHybridSpqEntry_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 19, 2, 1)
)
...
portQueuingMethodHybridSpq = _PortQueuingMethodHybridSpq_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 19, 2, 1, 1),
...
globalDhcpRelayEnable = _GlobalDhcpRelayEnable_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 20, 1, 1),
...
globalDhcpRelayOption82Enable = _GlobalDhcpRelayOption82Enable_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 20, 1, 2),
...
globalDhcpRelayInfoEnable = _GlobalDhcpRelayInfoEnable_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 20, 1, 3),
...
globalDhcpRelayInfoData = _GlobalDhcpRelayInfoData_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 20, 1, 4),
...
maxNumberOfGlobalDhcpRelayRemoteServer = _MaxNumberOfGlobalDhcpRelayRemoteServer_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 20, 1, 5),
...
globalDhcpRelayRemoteServerTable = _GlobalDhcpRelayRemoteServerTable_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 20, 1, 6)
)
if mibBuilder.loadTexts:
...
globalDhcpRelayRemoteServerEntry = _GlobalDhcpRelayRemoteServerEntry_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 20, 1, 6, 1)
)
globalDhcpRelayRemoteServerEntry.setIndexNames(
    (0, "ZYXEL-XGS4728F-MIB", "globalDhcpRelayRemoteServerIp"),
)
if mibBuilder.loadTexts:
...
globalDhcpRelayRemoteServerIp = _GlobalDhcpRelayRemoteServerIp_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 20, 1, 6, 1, 1),
...
globalDhcpRelayRemoteServerRowStatus = _GlobalDhcpRelayRemoteServerRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 20, 1, 6, 1, 2),
...
maxNumberOfDhcpServers = _MaxNumberOfDhcpServers_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 20, 2, 1),
...
dhcpServerVid = _DhcpServerVid_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 20, 2, 2, 1, 1),
    _DhcpServerVid_Type()
)
...
dhcpServerStartAddr = _DhcpServerStartAddr_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 20, 2, 2, 1, 2),
...
dhcpServerPoolSize = _DhcpServerPoolSize_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 20, 2, 2, 1, 3),
...
dhcpServerMask = _DhcpServerMask_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 20, 2, 2, 1, 4),
...
dhcpServerGateway = _DhcpServerGateway_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 20, 2, 2, 1, 5),
...
dhcpServerPrimaryDNS = _DhcpServerPrimaryDNS_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 20, 2, 2, 1, 6),
...
dhcpServerSecondaryDNS = _DhcpServerSecondaryDNS_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 20, 2, 2, 1, 7),
...
dhcpServerRowStatus = _DhcpServerRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 20, 2, 2, 1, 8),
...
maxNumberOfDhcpRelay = _MaxNumberOfDhcpRelay_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 20, 3, 2),
...
maxNumberOfDhcpRelayRemoteServer = _MaxNumberOfDhcpRelayRemoteServer_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 20, 3, 3),
...
dhcpRelayRemoteServerTable = _DhcpRelayRemoteServerTable_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 20, 3, 4)
)
if mibBuilder.loadTexts:
...
dhcpRelayRemoteServerEntry = _DhcpRelayRemoteServerEntry_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 20, 3, 4, 1)
)
dhcpRelayRemoteServerEntry.setIndexNames(
    (0, "ZYXEL-XGS4728F-MIB", "dhcpRelayVid"),
    (0, "ZYXEL-XGS4728F-MIB", "dhcpRelayRemoteServerIp"),
)
if mibBuilder.loadTexts:
...
dhcpRelayVid = _DhcpRelayVid_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 20, 3, 4, 1, 1),
    _DhcpRelayVid_Type()
)
...
dhcpRelayRemoteServerIp = _DhcpRelayRemoteServerIp_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 20, 3, 4, 1, 2),
...
dhcpRelayRemoteServerRowStatus = _DhcpRelayRemoteServerRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 20, 3, 4, 1, 3),
...
dhcpRelayOption82Enable = _DhcpRelayOption82Enable_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 20, 3, 5, 1, 1),
...
dhcpRelayInfoEnable = _DhcpRelayInfoEnable_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 20, 3, 5, 1, 2),
...
staticRouteName = _StaticRouteName_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 21, 2, 1, 1),
...
staticRouteIp = _StaticRouteIp_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 21, 2, 1, 2),
    _StaticRouteIp_Type()
)
...
staticRouteMask = _StaticRouteMask_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 21, 2, 1, 3),
...
staticRouteGateway = _StaticRouteGateway_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 21, 2, 1, 4),
...
staticRouteMetric = _StaticRouteMetric_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 21, 2, 1, 5),
...
staticRouteRowStatus = _StaticRouteRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 21, 2, 1, 6),
...
arpIndex = _ArpIndex_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 22, 1, 1, 1),
    _ArpIndex_Type()
)
...
arpIpAddr = _ArpIpAddr_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 22, 1, 1, 2),
    _ArpIpAddr_Type()
)
...
arpMacAddr = _ArpMacAddr_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 22, 1, 1, 3),
    _ArpMacAddr_Type()
)
...
arpMacVid = _ArpMacVid_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 22, 1, 1, 4),
    _ArpMacVid_Type()
)
...
arpType = _ArpType_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 22, 1, 1, 5),
    _ArpType_Type()
)
...
portOpModePortEntry = _PortOpModePortEntry_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 23, 1, 1)
)
...
portOpModePortSpeedDuplex = _PortOpModePortSpeedDuplex_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 23, 1, 1, 1),
...
portOpModePortFlowCntl = _PortOpModePortFlowCntl_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 23, 1, 1, 2),
...
portOpModePortName = _PortOpModePortName_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 23, 1, 1, 3),
...
portOpModePortModuleType = _PortOpModePortModuleType_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 23, 1, 1, 4),
...
portOpModePortLinkUpType = _PortOpModePortLinkUpType_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 23, 1, 1, 5),
...
portOpModePortIntrusionLock = _PortOpModePortIntrusionLock_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 23, 1, 1, 6),
...
portOpModePortLBTestStatus = _PortOpModePortLBTestStatus_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 23, 1, 1, 7),
...
portOpModePortCounterReset = _PortOpModePortCounterReset_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 23, 1, 1, 8),
...
portOpModePortCX4CableLength = _PortOpModePortCX4CableLength_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 23, 1, 1, 9),
...
portBasedVlanPortListEntry = _PortBasedVlanPortListEntry_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 24, 1, 1)
)
...
portBasedVlanPortListMembers = _PortBasedVlanPortListMembers_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 24, 1, 1, 1),
...
multicastPortEntry = _MulticastPortEntry_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 25, 1, 1)
)
...
multicastPortMaxGroupLimited = _MulticastPortMaxGroupLimited_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 25, 1, 1, 2),
...
multicastPortMaxOfGroup = _MulticastPortMaxOfGroup_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 25, 1, 1, 3),
...
multicastPortIgmpFilteringProfile = _MulticastPortIgmpFilteringProfile_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 25, 1, 1, 4),
...
multicastPortQuerierMode = _MulticastPortQuerierMode_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 25, 1, 1, 5),
...
multicastPortThrottlingAction = _MulticastPortThrottlingAction_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 25, 1, 1, 6),
...
multicastPortLeaveMode = _MulticastPortLeaveMode_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 25, 1, 1, 7),
...
multicastPortLeaveTimeout = _MulticastPortLeaveTimeout_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 25, 1, 1, 8),
...
multicastPortFastLeaveTimeout = _MulticastPortFastLeaveTimeout_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 25, 1, 1, 9),
...
multicastStatusEntry = _MulticastStatusEntry_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 26, 1, 1)
)
multicastStatusEntry.setIndexNames(
    (0, "ZYXEL-XGS4728F-MIB", "multicastStatusVlanID"),
    (0, "ZYXEL-XGS4728F-MIB", "multicastStatusPort"),
    (0, "ZYXEL-XGS4728F-MIB", "multicastStatusGroup"),
)
if mibBuilder.loadTexts:
...
multicastStatusIndex = _MulticastStatusIndex_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 26, 1, 1, 1),
...
multicastStatusVlanID = _MulticastStatusVlanID_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 26, 1, 1, 2),
...
multicastStatusPort = _MulticastStatusPort_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 26, 1, 1, 3),
...
multicastStatusGroup = _MulticastStatusGroup_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 26, 1, 1, 4),
...
multicastVlanStatusEntry = _MulticastVlanStatusEntry_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 26, 2, 1)
)
...
multicastVlanStatusVlanID = _MulticastVlanStatusVlanID_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 26, 2, 1, 1),
...
multicastVlanStatusType = _MulticastVlanStatusType_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 26, 2, 1, 2),
...
multicastVlanQueryPort = _MulticastVlanQueryPort_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 26, 2, 1, 3),
...
igmpSnpCountIndex = _IgmpSnpCountIndex_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 26, 3, 1, 1),
...
igmpSnpV2CountQueryRx = _IgmpSnpV2CountQueryRx_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 26, 3, 1, 2),
...
igmpSnpV2CountReportRx = _IgmpSnpV2CountReportRx_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 26, 3, 1, 3),
...
igmpSnpV2CountLeaveRx = _IgmpSnpV2CountLeaveRx_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 26, 3, 1, 4),
...
igmpSnpV2CountQueryRxDrop = _IgmpSnpV2CountQueryRxDrop_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 26, 3, 1, 5),
...
igmpSnpV2CountReportRxDrop = _IgmpSnpV2CountReportRxDrop_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 26, 3, 1, 6),
...
igmpSnpV2CountLeaveRxDrop = _IgmpSnpV2CountLeaveRxDrop_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 26, 3, 1, 7),
...
igmpSnpV2CountQueryTx = _IgmpSnpV2CountQueryTx_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 26, 3, 1, 8),
...
igmpSnpV2CountReportTx = _IgmpSnpV2CountReportTx_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 26, 3, 1, 9),
...
igmpSnpV2CountLeaveTx = _IgmpSnpV2CountLeaveTx_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 26, 3, 1, 10),
...
igmpSnpV3CountQueryRx = _IgmpSnpV3CountQueryRx_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 26, 3, 1, 11),
...
igmpSnpV3CountReportRx = _IgmpSnpV3CountReportRx_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 26, 3, 1, 12),
...
igmpSnpV3CountQueryRxDrop = _IgmpSnpV3CountQueryRxDrop_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 26, 3, 1, 13),
...
igmpSnpV3CountReportRxDrop = _IgmpSnpV3CountReportRxDrop_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 26, 3, 1, 14),
...
igmpSnpV3CountQueryTx = _IgmpSnpV3CountQueryTx_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 26, 3, 1, 15),
...
igmpSnpV3CountReportTx = _IgmpSnpV3CountReportTx_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 26, 3, 1, 16),
...
igmpSnpCountVlanEntry = _IgmpSnpCountVlanEntry_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 26, 4, 1)
)
igmpSnpCountVlanEntry.setIndexNames(
    (0, "ZYXEL-XGS4728F-MIB", "igmpSnpCountVlanIndex"),
)
if mibBuilder.loadTexts:
...
igmpSnpCountVlanIndex = _IgmpSnpCountVlanIndex_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 26, 4, 1, 1),
...
igmpSnpV2CountVlanQueryRx = _IgmpSnpV2CountVlanQueryRx_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 26, 4, 1, 2),
...
igmpSnpV2CountVlanReportRx = _IgmpSnpV2CountVlanReportRx_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 26, 4, 1, 3),
...
igmpSnpV2CountVlanLeaveRx = _IgmpSnpV2CountVlanLeaveRx_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 26, 4, 1, 4),
...
igmpSnpV2CountVlanQueryRxDrop = _IgmpSnpV2CountVlanQueryRxDrop_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 26, 4, 1, 5),
...
igmpSnpV2CountVlanReportRxDrop = _IgmpSnpV2CountVlanReportRxDrop_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 26, 4, 1, 6),
...
igmpSnpV2CountVlanLeaveRxDrop = _IgmpSnpV2CountVlanLeaveRxDrop_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 26, 4, 1, 7),
...
igmpSnpV2CountVlanQueryTx = _IgmpSnpV2CountVlanQueryTx_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 26, 4, 1, 8),
...
igmpSnpV2CountVlanReportTx = _IgmpSnpV2CountVlanReportTx_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 26, 4, 1, 9),
...
igmpSnpV2CountVlanLeaveTx = _IgmpSnpV2CountVlanLeaveTx_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 26, 4, 1, 10),
...
igmpSnpV3CountVlanQueryRx = _IgmpSnpV3CountVlanQueryRx_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 26, 4, 1, 11),
...
igmpSnpV3CountVlanReportRx = _IgmpSnpV3CountVlanReportRx_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 26, 4, 1, 12),
...
igmpSnpV3CountVlanQueryRxDrop = _IgmpSnpV3CountVlanQueryRxDrop_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 26, 4, 1, 13),
...
igmpSnpV3CountVlanReportRxDrop = _IgmpSnpV3CountVlanReportRxDrop_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 26, 4, 1, 14),
...
igmpSnpV3CountVlanQueryTx = _IgmpSnpV3CountVlanQueryTx_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 26, 4, 1, 15),
...
igmpSnpV3CountVlanReportTx = _IgmpSnpV3CountVlanReportTx_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 26, 4, 1, 16),
...
igmpSnpCountPortEntry = _IgmpSnpCountPortEntry_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 26, 5, 1)
)
...
igmpSnpV2CountPortQueryRx = _IgmpSnpV2CountPortQueryRx_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 26, 5, 1, 1),
...
igmpSnpV2CountPortReportRx = _IgmpSnpV2CountPortReportRx_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 26, 5, 1, 2),
...
igmpSnpV2CountPortLeaveRx = _IgmpSnpV2CountPortLeaveRx_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 26, 5, 1, 3),
...
igmpSnpV2CountPortReportRxDrop = _IgmpSnpV2CountPortReportRxDrop_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 26, 5, 1, 4),
...
igmpSnpV2CountPortLeaveRxDrop = _IgmpSnpV2CountPortLeaveRxDrop_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 26, 5, 1, 5),
...
igmpSnpV2CountPortReportTx = _IgmpSnpV2CountPortReportTx_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 26, 5, 1, 6),
...
igmpSnpV2CountPortLeaveTx = _IgmpSnpV2CountPortLeaveTx_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 26, 5, 1, 7),
...
igmpSnpV3CountPortQueryRx = _IgmpSnpV3CountPortQueryRx_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 26, 5, 1, 8),
...
igmpSnpV3CountPortReportRx = _IgmpSnpV3CountPortReportRx_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 26, 5, 1, 9),
...
igmpSnpV3CountPortReportRxDrop = _IgmpSnpV3CountPortReportRxDrop_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 26, 5, 1, 10),
...
igmpSnpV3CountPortReportTx = _IgmpSnpV3CountPortReportTx_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 26, 5, 1, 11),
...
igmpSnpGroupCountNum = _IgmpSnpGroupCountNum_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 26, 6, 1),
...
igmpSnpGroupCountVlanTable = _IgmpSnpGroupCountVlanTable_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 26, 6, 2)
)
if mibBuilder.loadTexts:
...
igmpSnpGroupCountVlanEntry = _IgmpSnpGroupCountVlanEntry_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 26, 6, 2, 1)
)
...
igmpSnpGroupCountVlanIndex = _IgmpSnpGroupCountVlanIndex_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 26, 6, 2, 1, 1),
...
igmpSnpGroupCountVlanNum = _IgmpSnpGroupCountVlanNum_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 26, 6, 2, 1, 2),
...
igmpSnpGroupCountPortTable = _IgmpSnpGroupCountPortTable_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 26, 6, 3)
)
if mibBuilder.loadTexts:
...
igmpSnpGroupCountPortEntry = _IgmpSnpGroupCountPortEntry_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 26, 6, 3, 1)
)
...
igmpSnpGroupCountPortNum = _IgmpSnpGroupCountPortNum_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 26, 6, 3, 1, 1),
...
igmpFilteringProfileEntry = _IgmpFilteringProfileEntry_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 27, 2, 1)
)
igmpFilteringProfileEntry.setIndexNames(
    (0, "ZYXEL-XGS4728F-MIB", "igmpFilteringProfileName"),
    (0, "ZYXEL-XGS4728F-MIB", "igmpFilteringProfileStartAddress"),
    (0, "ZYXEL-XGS4728F-MIB", "igmpFilteringProfileEndAddress"),
)
if mibBuilder.loadTexts:
...
igmpFilteringProfileName = _IgmpFilteringProfileName_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 27, 2, 1, 1),
...
igmpFilteringProfileStartAddress = _IgmpFilteringProfileStartAddress_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 27, 2, 1, 2),
...
igmpFilteringProfileEndAddress = _IgmpFilteringProfileEndAddress_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 27, 2, 1, 3),
...
igmpFilteringProfileRowStatus = _IgmpFilteringProfileRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 27, 2, 1, 4),
...
mvrVlanID = _MvrVlanID_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 28, 2, 1, 1),
    _MvrVlanID_Type()
)
...
mvrName = _MvrName_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 28, 2, 1, 2),
    _MvrName_Type()
)
...
mvrMode = _MvrMode_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 28, 2, 1, 3),
    _MvrMode_Type()
)
...
mvrRowStatus = _MvrRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 28, 2, 1, 4),
    _MvrRowStatus_Type()
)
...
mvr8021pPriority = _Mvr8021pPriority_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 28, 2, 1, 5),
...
mvrPortRole = _MvrPortRole_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 28, 3, 1, 1),
    _MvrPortRole_Type()
)
...
mvrPortTagging = _MvrPortTagging_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 28, 3, 1, 2),
...
mvrGroupName = _MvrGroupName_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 28, 5, 1, 1),
    _MvrGroupName_Type()
)
...
mvrGroupStartAddress = _MvrGroupStartAddress_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 28, 5, 1, 2),
...
mvrGroupEndAddress = _MvrGroupEndAddress_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 28, 5, 1, 3),
...
mvrGroupRowStatus = _MvrGroupRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 28, 5, 1, 4),
...
clusterMaxNumOfManager = _ClusterMaxNumOfManager_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 29, 1, 1),
...
clusterManagerTable = _ClusterManagerTable_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 29, 1, 2)
)
if mibBuilder.loadTexts:
...
clusterManagerEntry = _ClusterManagerEntry_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 29, 1, 2, 1)
)
clusterManagerEntry.setIndexNames(
    (0, "ZYXEL-XGS4728F-MIB", "clusterManagerVid"),
)
if mibBuilder.loadTexts:
...
clusterManagerVid = _ClusterManagerVid_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 29, 1, 2, 1, 1),
...
clusterManagerName = _ClusterManagerName_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 29, 1, 2, 1, 2),
...
clusterManagerRowStatus = _ClusterManagerRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 29, 1, 2, 1, 3),
...
clusterMaxNumOfMember = _ClusterMaxNumOfMember_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 29, 2, 1),
...
clusterMemberTable = _ClusterMemberTable_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 29, 2, 2)
)
if mibBuilder.loadTexts:
...
clusterMemberEntry = _ClusterMemberEntry_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 29, 2, 2, 1)
)
clusterMemberEntry.setIndexNames(
    (0, "ZYXEL-XGS4728F-MIB", "clusterMemberMac"),
)
if mibBuilder.loadTexts:
...
clusterMemberMac = _ClusterMemberMac_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 29, 2, 2, 1, 1),
...
clusterMemberName = _ClusterMemberName_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 29, 2, 2, 1, 2),
...
clusterMemberModel = _ClusterMemberModel_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 29, 2, 2, 1, 3),
...
clusterMemberPassword = _ClusterMemberPassword_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 29, 2, 2, 1, 4),
...
clusterMemberRowStatus = _ClusterMemberRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 29, 2, 2, 1, 5),
...
clusterCandidateEntry = _ClusterCandidateEntry_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 29, 3, 1, 1)
)
clusterCandidateEntry.setIndexNames(
    (0, "ZYXEL-XGS4728F-MIB", "clusterCandidateMac"),
)
if mibBuilder.loadTexts:
...
clusterCandidateMac = _ClusterCandidateMac_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 29, 3, 1, 1, 1),
...
clusterCandidateName = _ClusterCandidateName_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 29, 3, 1, 1, 2),
...
clusterCandidateModel = _ClusterCandidateModel_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 29, 3, 1, 1, 3),
...
clusterStatusRole = _ClusterStatusRole_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 29, 4, 1),
...
clusterStatusManager = _ClusterStatusManager_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 29, 4, 2),
...
clsuterStatusMaxNumOfMember = _ClsuterStatusMaxNumOfMember_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 29, 4, 3),
...
clusterStatusMemberTable = _ClusterStatusMemberTable_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 29, 4, 4)
)
if mibBuilder.loadTexts:
...
clusterStatusMemberEntry = _ClusterStatusMemberEntry_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 29, 4, 4, 1)
)
clusterStatusMemberEntry.setIndexNames(
    (0, "ZYXEL-XGS4728F-MIB", "clusterStatusMemberMac"),
)
if mibBuilder.loadTexts:
...
clusterStatusMemberMac = _ClusterStatusMemberMac_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 29, 4, 4, 1, 1),
...
clusterStatusMemberName = _ClusterStatusMemberName_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 29, 4, 4, 1, 2),
...
clusterStatusMemberModel = _ClusterStatusMemberModel_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 29, 4, 4, 1, 3),
...
clusterStatusMemberStatus = _ClusterStatusMemberStatus_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 29, 4, 4, 1, 4),
...
eventSeqNum = _EventSeqNum_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 30, 1, 1, 1, 1),
    _EventSeqNum_Type()
)
...
eventEventId = _EventEventId_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 30, 1, 1, 1, 2),
    _EventEventId_Type()
)
...
eventName = _EventName_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 30, 1, 1, 1, 3),
    _EventName_Type()
)
...
eventInstanceType = _EventInstanceType_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 30, 1, 1, 1, 4),
...
eventInstanceId = _EventInstanceId_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 30, 1, 1, 1, 5),
...
eventInstanceName = _EventInstanceName_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 30, 1, 1, 1, 6),
...
eventSeverity = _EventSeverity_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 30, 1, 1, 1, 7),
    _EventSeverity_Type()
)
...
eventSetTime = _EventSetTime_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 30, 1, 1, 1, 8),
    _EventSetTime_Type()
)
...
eventDescription = _EventDescription_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 30, 1, 1, 1, 9),
...
eventServAffective = _EventServAffective_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 30, 1, 1, 1, 10),
...
eventInstanceIdNumber = _EventInstanceIdNumber_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 30, 1, 1, 1, 11),
...
trapPersistence = _TrapPersistence_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 31, 1, 2),
...
trapSenderNodeId = _TrapSenderNodeId_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 31, 1, 3),
...
trapSenderStatus = _TrapSenderStatus_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 31, 1, 4),
...
protoBasedVlanEntry = _ProtoBasedVlanEntry_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 32, 1, 1)
)
protoBasedVlanEntry.setIndexNames(
    (0, "ZYXEL-XGS4728F-MIB", "protoBasedVlanPort"),
    (0, "ZYXEL-XGS4728F-MIB", "protoBasedVlanPacketType"),
    (0, "ZYXEL-XGS4728F-MIB", "protoBasedVlanEtherType"),
)
if mibBuilder.loadTexts:
...
protoBasedVlanPort = _ProtoBasedVlanPort_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 32, 1, 1, 1),
...
protoBasedVlanPacketType = _ProtoBasedVlanPacketType_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 32, 1, 1, 2),
...
protoBasedVlanEtherType = _ProtoBasedVlanEtherType_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 32, 1, 1, 3),
...
protoBasedVlanName = _ProtoBasedVlanName_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 32, 1, 1, 4),
...
protoBasedVlanVid = _ProtoBasedVlanVid_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 32, 1, 1, 5),
...
protoBasedVlanPriority = _ProtoBasedVlanPriority_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 32, 1, 1, 6),
...
protoBasedVlanState = _ProtoBasedVlanState_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 32, 1, 1, 7),
...
sysLogTypeIndex = _SysLogTypeIndex_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 33, 2, 1, 1),
...
sysLogTypeName = _SysLogTypeName_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 33, 2, 1, 2),
...
sysLogTypeState = _SysLogTypeState_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 33, 2, 1, 3),
...
sysLogTypeFacility = _SysLogTypeFacility_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 33, 2, 1, 4),
...
sysLogServerAddress = _SysLogServerAddress_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 33, 3, 1, 1),
...
sysLogServerLogLevel = _SysLogServerLogLevel_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 33, 3, 1, 2),
...
sysLogServerRowStatus = _SysLogServerRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 33, 3, 1, 3),
...
diffservMapDscp = _DiffservMapDscp_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 34, 2, 1, 1),
...
diffservMapPriority = _DiffservMapPriority_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 34, 2, 1, 2),
...
diffservPortState = _DiffservPortState_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 34, 3, 1, 1),
...
routerVrrpTable = _RouterVrrpTable_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 36, 2)
)
if mibBuilder.loadTexts:
    routerVrrpTable.setStatus("mandatory")
_RouterVrrpEntry_Object = MibTableRow
routerVrrpEntry = _RouterVrrpEntry_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 36, 2, 1)
)
routerVrrpEntry.setIndexNames(
    (0, "ZYXEL-XGS4728F-MIB", "routerDomainIpAddress"),
    (0, "ZYXEL-XGS4728F-MIB", "routerDomainIpMaskBits"),
    (0, "ZYXEL-XGS4728F-MIB", "routerVrrpVirtualID"),
    (0, "ZYXEL-XGS4728F-MIB", "routerVrrpUplinkGateway"),
)
if mibBuilder.loadTexts:
...
routerVrrpVirtualID = _RouterVrrpVirtualID_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 36, 2, 1, 1),
...
routerVrrpUplinkGateway = _RouterVrrpUplinkGateway_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 36, 2, 1, 2),
...
routerVrrpPreempt = _RouterVrrpPreempt_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 36, 2, 1, 3),
...
routerVrrpInterval = _RouterVrrpInterval_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 36, 2, 1, 4),
...
routerVrrpPriority = _RouterVrrpPriority_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 36, 2, 1, 5),
...
routerVrrpPrimaryVirtualIP = _RouterVrrpPrimaryVirtualIP_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 36, 2, 1, 6),
...
routerVrrpName = _RouterVrrpName_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 36, 2, 1, 7),
...
routerVrrpSecondaryVirtualIP = _RouterVrrpSecondaryVirtualIP_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 36, 2, 1, 8),
...
rpVrrpRowStatus = _RpVrrpRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 36, 2, 1, 9),
...
routerVrrpDomainEntry = _RouterVrrpDomainEntry_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 36, 3, 1)
)
...
routerVrrpAuthType = _RouterVrrpAuthType_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 36, 3, 1, 1),
...
routerVrrpAuthKey = _RouterVrrpAuthKey_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 36, 3, 1, 2),
...
routerVrrpStatusEntry = _RouterVrrpStatusEntry_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 37, 1, 1)
)
routerVrrpStatusEntry.setIndexNames(
    (0, "ZYXEL-XGS4728F-MIB", "routerVrrpStatusIpAddress"),
    (0, "ZYXEL-XGS4728F-MIB", "routerVrrpStatusIpMaskBits"),
    (0, "ZYXEL-XGS4728F-MIB", "routerVrrpStatusVirtualID"),
)
if mibBuilder.loadTexts:
...
routerVrrpStatusIpAddress = _RouterVrrpStatusIpAddress_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 37, 1, 1, 1),
...
routerVrrpStatusIpMaskBits = _RouterVrrpStatusIpMaskBits_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 37, 1, 1, 2),
...
routerVrrpStatusVirtualID = _RouterVrrpStatusVirtualID_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 37, 1, 1, 3),
...
routerVrrpStatusVRStatus = _RouterVrrpStatusVRStatus_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 37, 1, 1, 4),
...
routerVrrpStatusUpLinkStatus = _RouterVrrpStatusUpLinkStatus_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 37, 1, 1, 5),
...
routerDomainIpAddress = _RouterDomainIpAddress_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 38, 1, 1, 1),
...
routerDomainIpMaskBits = _RouterDomainIpMaskBits_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 38, 1, 1, 2),
...
routerDomainVid = _RouterDomainVid_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 38, 1, 1, 3),
...
routerDomainIpEntry = _RouterDomainIpEntry_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 38, 2, 1)
)
...
routerDomainIpRipDirection = _RouterDomainIpRipDirection_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 38, 2, 1, 1),
...
routerDomainIpRipVersion = _RouterDomainIpRipVersion_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 38, 2, 1, 2),
...
routerDomainIpIgmpVersion = _RouterDomainIpIgmpVersion_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 38, 2, 1, 3),
...
routerDomainIpDvmrp = _RouterDomainIpDvmrp_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 38, 2, 1, 4),
...
ipStatusIPAddress = _IpStatusIPAddress_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 39, 1, 1, 1),
...
ipStatusVid = _IpStatusVid_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 39, 1, 1, 2),
    _IpStatusVid_Type()
)
...
ipStatusPort = _IpStatusPort_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 39, 1, 1, 3),
    _IpStatusPort_Type()
)
...
ipStatusType = _IpStatusType_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 39, 1, 1, 4),
    _IpStatusType_Type()
)
...
routingStatusEntry = _RoutingStatusEntry_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 40, 1, 1)
)
routingStatusEntry.setIndexNames(
    (0, "ZYXEL-XGS4728F-MIB", "routingStatusDestAddress"),
)
if mibBuilder.loadTexts:
...
routingStatusDestAddress = _RoutingStatusDestAddress_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 40, 1, 1, 1),
...
routingStatusDestMaskbits = _RoutingStatusDestMaskbits_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 40, 1, 1, 2),
...
routingStatusGateway = _RoutingStatusGateway_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 40, 1, 1, 3),
...
routingStatusInterface = _RoutingStatusInterface_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 40, 1, 1, 4),
...
routingStatusMetric = _RoutingStatusMetric_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 40, 1, 1, 5),
...
routingStatusType = _RoutingStatusType_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 40, 1, 1, 6),
...
ospfInterfaceEntry = _OspfInterfaceEntry_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 41, 1, 1)
)
...
ospfIfKeyId = _OspfIfKeyId_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 41, 1, 1, 1),
    _OspfIfKeyId_Type()
)
...
ospfIfMaskbits = _OspfIfMaskbits_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 41, 1, 1, 2),
...
ospfIfDesignatedRouterID = _OspfIfDesignatedRouterID_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 41, 1, 1, 3),
...
ospfIfBackupDesignatedRouterID = _OspfIfBackupDesignatedRouterID_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 41, 1, 1, 4),
...
ospfIfNbrCount = _OspfIfNbrCount_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 41, 1, 1, 5),
...
ospfIfAdjacentNbrCount = _OspfIfAdjacentNbrCount_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 41, 1, 1, 6),
...
ospfIfHelloDueTime = _OspfIfHelloDueTime_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 41, 1, 1, 7),
...
ospfAreaExtName = _OspfAreaExtName_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 41, 2, 1, 1),
...
ospfRedistributeRouteEntry = _OspfRedistributeRouteEntry_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 41, 3, 1)
)
ospfRedistributeRouteEntry.setIndexNames(
    (0, "ZYXEL-XGS4728F-MIB", "ospfRedistributeRouteProtocol"),
)
if mibBuilder.loadTexts:
...
ospfRedistributeRouteProtocol = _OspfRedistributeRouteProtocol_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 41, 3, 1, 1),
...
ospfRedistributeRouteState = _OspfRedistributeRouteState_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 41, 3, 1, 2),
...
ospfRedistributeRouteType = _OspfRedistributeRouteType_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 41, 3, 1, 3),
...
ospfRedistributeRouteMetric = _OspfRedistributeRouteMetric_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 41, 3, 1, 4),
...
ospfNbrExtRole = _OspfNbrExtRole_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 41, 4, 1, 1),
...
ospfNbrExtDeadtime = _OspfNbrExtDeadtime_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 41, 4, 1, 2),
...
ospfNbrExtInterface = _OspfNbrExtInterface_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 41, 4, 1, 3),
...
ospfNbrExtRXmtL = _OspfNbrExtRXmtL_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 41, 4, 1, 4),
...
ospfNbrExtRqstL = _OspfNbrExtRqstL_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 41, 4, 1, 5),
...
ospfNbrExtDBsmL = _OspfNbrExtDBsmL_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 41, 4, 1, 6),
...
ospfLsdbExtLinkCount = _OspfLsdbExtLinkCount_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 41, 5, 1, 1),
...
ospfLsdbExtRouteAddress = _OspfLsdbExtRouteAddress_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 41, 5, 1, 2),
...
ospfLsdbExtRouteMaskbits = _OspfLsdbExtRouteMaskbits_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 41, 5, 1, 3),
...
ospfVirtualLinkEntry = _OspfVirtualLinkEntry_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 41, 6, 1)
)
...
ospfVirtualLinkName = _OspfVirtualLinkName_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 41, 6, 1, 1),
...
ospfVirtualLinkKeyId = _OspfVirtualLinkKeyId_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 41, 6, 1, 2),
...
ospfSummaryAddrEntry = _OspfSummaryAddrEntry_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 41, 7, 1)
)
ospfSummaryAddrEntry.setIndexNames(
    (0, "ZYXEL-XGS4728F-MIB", "ospfSummaryAddress"),
    (0, "ZYXEL-XGS4728F-MIB", "ospfSummaryAddrMaskBit"),
)
if mibBuilder.loadTexts:
...
ospfSummaryAddress = _OspfSummaryAddress_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 41, 7, 1, 1),
...
ospfSummaryAddrMaskBit = _OspfSummaryAddrMaskBit_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 41, 7, 1, 2),
...
ospfSummaryAddrRowStatus = _OspfSummaryAddrRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 41, 7, 1, 3),
...
mrstpBridgeIndex = _MrstpBridgeIndex_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 42, 1, 1, 1, 1),
...
mrstpState = _MrstpState_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 42, 1, 1, 1, 2),
    _MrstpState_Type()
)
...
mrstpProtocolSpecification = _MrstpProtocolSpecification_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 42, 1, 1, 1, 3),
...
mrstpPriority = _MrstpPriority_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 42, 1, 1, 1, 4),
    _MrstpPriority_Type()
)
...
mrstpTimeSinceTopologyChange = _MrstpTimeSinceTopologyChange_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 42, 1, 1, 1, 5),
...
mrstpTopChanges = _MrstpTopChanges_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 42, 1, 1, 1, 6),
...
mrstpDesignatedRoot = _MrstpDesignatedRoot_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 42, 1, 1, 1, 7),
...
mrstpRootCost = _MrstpRootCost_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 42, 1, 1, 1, 8),
    _MrstpRootCost_Type()
)
...
mrstpRootPort = _MrstpRootPort_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 42, 1, 1, 1, 9),
    _MrstpRootPort_Type()
)
...
mrstpMaxAge = _MrstpMaxAge_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 42, 1, 1, 1, 10),
    _MrstpMaxAge_Type()
)
...
mrstpHelloTime = _MrstpHelloTime_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 42, 1, 1, 1, 11),
...
mrstpHoldTime = _MrstpHoldTime_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 42, 1, 1, 1, 12),
    _MrstpHoldTime_Type()
)
...
mrstpForwardDelay = _MrstpForwardDelay_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 42, 1, 1, 1, 13),
...
mrstpBridgeMaxAge = _MrstpBridgeMaxAge_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 42, 1, 1, 1, 14),
...
mrstpBridgeHelloTime = _MrstpBridgeHelloTime_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 42, 1, 1, 1, 15),
...
mrstpBridgeForwardDelay = _MrstpBridgeForwardDelay_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 42, 1, 1, 1, 16),
...
mrstpPort = _MrstpPort_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 42, 1, 2, 1, 1),
    _MrstpPort_Type()
)
...
mrstpPortPriority = _MrstpPortPriority_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 42, 1, 2, 1, 2),
...
mrstpPortState = _MrstpPortState_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 42, 1, 2, 1, 3),
...
mrstpPortEnable = _MrstpPortEnable_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 42, 1, 2, 1, 4),
...
mrstpPortPathCost = _MrstpPortPathCost_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 42, 1, 2, 1, 5),
...
mrstpPortDesignatedRoot = _MrstpPortDesignatedRoot_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 42, 1, 2, 1, 6),
...
mrstpPortDesignatedCost = _MrstpPortDesignatedCost_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 42, 1, 2, 1, 7),
...
mrstpPortDesignatedBridge = _MrstpPortDesignatedBridge_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 42, 1, 2, 1, 8),
...
mrstpPortDesignatedPort = _MrstpPortDesignatedPort_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 42, 1, 2, 1, 9),
...
mrstpPortForwardTransitions = _MrstpPortForwardTransitions_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 42, 1, 2, 1, 10),
...
mrstpPortOnBridgeIndex = _MrstpPortOnBridgeIndex_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 42, 1, 2, 1, 11),
...
dhcpSnpVlanEntryVid = _DhcpSnpVlanEntryVid_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 100, 1, 1, 1),
...
dhcpSnpVlanEntryEnable = _DhcpSnpVlanEntryEnable_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 100, 1, 1, 2),
...
dhcpSnpVlanEntryOption82Enable = _DhcpSnpVlanEntryOption82Enable_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 100, 1, 1, 3),
...
dhcpSnpVlanEntryInfo = _DhcpSnpVlanEntryInfo_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 100, 1, 1, 4),
...
dhcpSnpPortEntryPort = _DhcpSnpPortEntryPort_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 100, 2, 1, 1),
...
dhcpSnpPortEntryTrust = _DhcpSnpPortEntryTrust_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 100, 2, 1, 2),
...
dhcpSnpPortEntryRate = _DhcpSnpPortEntryRate_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 100, 2, 1, 3),
...
dhcpSnpBindEntryMac = _DhcpSnpBindEntryMac_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 100, 3, 1, 1),
...
dhcpSnpBindEntryVid = _DhcpSnpBindEntryVid_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 100, 3, 1, 2),
...
dhcpSnpBindEntryIP = _DhcpSnpBindEntryIP_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 100, 3, 1, 3),
...
dhcpSnpBindEntryLease = _DhcpSnpBindEntryLease_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 100, 3, 1, 4),
...
dhcpSnpBindEntryType = _DhcpSnpBindEntryType_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 100, 3, 1, 5),
...
dhcpSnpBindEntryPort = _DhcpSnpBindEntryPort_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 100, 3, 1, 6),
...
dhcpSnpEnable = _DhcpSnpEnable_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 100, 4),
    _DhcpSnpEnable_Type()
)
...
dhcpSnpDb = _DhcpSnpDb_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 100, 5)
)
...
dhcpSnpDbAbort = _DhcpSnpDbAbort_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 100, 5, 1),
...
dhcpSnpDbWriteDelay = _DhcpSnpDbWriteDelay_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 100, 5, 2),
...
dhcpSnpDbUrl = _DhcpSnpDbUrl_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 100, 5, 3),
    _DhcpSnpDbUrl_Type()
)
...
dhcpSnpDbUrlRenew = _DhcpSnpDbUrlRenew_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 100, 5, 4),
...
dhcpSnpDbStatAgentRunning = _DhcpSnpDbStatAgentRunning_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 100, 5, 5, 2),
...
dhcpSnpDbStatDelayExpiry = _DhcpSnpDbStatDelayExpiry_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 100, 5, 5, 3),
...
dhcpSnpDbStatAbortExpiry = _DhcpSnpDbStatAbortExpiry_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 100, 5, 5, 4),
...
dhcpSnpDbStatLastSuccTime = _DhcpSnpDbStatLastSuccTime_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 100, 5, 5, 5),
...
dhcpSnpDbStatLastFailTime = _DhcpSnpDbStatLastFailTime_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 100, 5, 5, 6),
...
dhcpSnpDbStatLastFailReason = _DhcpSnpDbStatLastFailReason_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 100, 5, 5, 7),
...
dhcpSnpDbStatTotalAttempt = _DhcpSnpDbStatTotalAttempt_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 100, 5, 5, 8),
...
dhcpSnpDbStatStartupFail = _DhcpSnpDbStatStartupFail_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 100, 5, 5, 9),
...
dhcpSnpDbStatSuccTrans = _DhcpSnpDbStatSuccTrans_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 100, 5, 5, 10),
...
dhcpSnpDbStatFailTrans = _DhcpSnpDbStatFailTrans_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 100, 5, 5, 11),
...
dhcpSnpDbStatSuccRead = _DhcpSnpDbStatSuccRead_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 100, 5, 5, 12),
...
dhcpSnpDbStatFailRead = _DhcpSnpDbStatFailRead_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 100, 5, 5, 13),
...
dhcpSnpDbStatSuccWrite = _DhcpSnpDbStatSuccWrite_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 100, 5, 5, 14),
...
dhcpSnpDbStatFailWrite = _DhcpSnpDbStatFailWrite_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 100, 5, 5, 15),
...
dhcpSnpDbStatFirstSuccAccess = _DhcpSnpDbStatFirstSuccAccess_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 100, 5, 5, 16),
...
dhcpSnpDbStatLastIgnoreBindCol = _DhcpSnpDbStatLastIgnoreBindCol_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 100, 5, 5, 17),
...
dhcpSnpDbStatLastIgnoreExpireLease = _DhcpSnpDbStatLastIgnoreExpireLease_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 100, 5, 5, 18),
...
dhcpSnpDbStatLastIgnoreInvalidIntf = _DhcpSnpDbStatLastIgnoreInvalidIntf_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 100, 5, 5, 19),
...
dhcpSnpDbStatLastIgnoreUnsuppVlan = _DhcpSnpDbStatLastIgnoreUnsuppVlan_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 100, 5, 5, 20),
...
dhcpSnpDbStatLastIgnoreParse = _DhcpSnpDbStatLastIgnoreParse_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 100, 5, 5, 21),
...
dhcpSnpDbStatTotalIgnoreBindCol = _DhcpSnpDbStatTotalIgnoreBindCol_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 100, 5, 5, 22),
...
dhcpSnpDbStatTotalIgnoreExpireLease = _DhcpSnpDbStatTotalIgnoreExpireLease_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 100, 5, 5, 23),
...
dhcpSnpDbStatTotalIgnoreInvalidIntf = _DhcpSnpDbStatTotalIgnoreInvalidIntf_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 100, 5, 5, 24),
...
dhcpSnpDbStatTotalIgnoreUnsuppVlan = _DhcpSnpDbStatTotalIgnoreUnsuppVlan_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 100, 5, 5, 25),
...
dhcpSnpDbStatTotalIgnoreParse = _DhcpSnpDbStatTotalIgnoreParse_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 100, 5, 5, 26),
...
dhcpSnpDbStatFirstSuccessAccess = _DhcpSnpDbStatFirstSuccessAccess_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 100, 5, 5, 27),
...
dhcpSnpDhcpVlan = _DhcpSnpDhcpVlan_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 100, 6)
)
...
dhcpSnpDhcpVlanVid = _DhcpSnpDhcpVlanVid_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 100, 6, 1),
...
ipsgEntryMac = _IpsgEntryMac_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 101, 1, 1, 1),
    _IpsgEntryMac_Type()
)
...
ipsgEntryVid = _IpsgEntryVid_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 101, 1, 1, 2),
    _IpsgEntryVid_Type()
)
...
ipsgEntryIp = _IpsgEntryIp_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 101, 1, 1, 3),
    _IpsgEntryIp_Type()
)
...
ipsgEntryLease = _IpsgEntryLease_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 101, 1, 1, 4),
...
ipsgEntryType = _IpsgEntryType_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 101, 1, 1, 5),
    _IpsgEntryType_Type()
)
...
ipsgEntryPort = _IpsgEntryPort_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 101, 1, 1, 6),
    _IpsgEntryPort_Type()
)
...
ipsgEntryState = _IpsgEntryState_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 101, 1, 1, 7),
...
arpInspectFilterAgingTime = _ArpInspectFilterAgingTime_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 102, 1, 2),
...
arpInspectLog = _ArpInspectLog_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 102, 1, 3)
)
...
arpInspectLogEntries = _ArpInspectLogEntries_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 102, 1, 3, 1),
...
arpInspectLogRate = _ArpInspectLogRate_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 102, 1, 3, 2),
...
arpInspectLogInterval = _ArpInspectLogInterval_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 102, 1, 3, 3),
...
arpInspectVlanTable = _ArpInspectVlanTable_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 102, 1, 4)
)
if mibBuilder.loadTexts:
...
arpInspectVlanEntry = _ArpInspectVlanEntry_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 102, 1, 4, 1)
)
arpInspectVlanEntry.setIndexNames(
    (0, "ZYXEL-XGS4728F-MIB", "arpInspectVlanVid"),
)
if mibBuilder.loadTexts:
...
arpInspectVlanVid = _ArpInspectVlanVid_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 102, 1, 4, 1, 1),
...
arpInspectVlanLog = _ArpInspectVlanLog_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 102, 1, 4, 1, 2),
...
arpInspectVlanStatus = _ArpInspectVlanStatus_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 102, 1, 4, 1, 3),
...
arpInspectPortTable = _ArpInspectPortTable_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 102, 1, 5)
)
if mibBuilder.loadTexts:
...
arpInspectPortEntry = _ArpInspectPortEntry_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 102, 1, 5, 1)
)
arpInspectPortEntry.setIndexNames(
    (0, "ZYXEL-XGS4728F-MIB", "arpInspectPortIndex"),
)
if mibBuilder.loadTexts:
...
arpInspectPortIndex = _ArpInspectPortIndex_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 102, 1, 5, 1, 1),
...
arpInspectPortTrust = _ArpInspectPortTrust_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 102, 1, 5, 1, 2),
...
arpInspectPortRate = _ArpInspectPortRate_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 102, 1, 5, 1, 3),
...
arpInspectPortInterval = _ArpInspectPortInterval_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 102, 1, 5, 1, 4),
...
arpInspectStatus = _ArpInspectStatus_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 102, 2)
)
...
arpInspectFilterClear = _ArpInspectFilterClear_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 102, 2, 1),
...
arpInspectLogClear = _ArpInspectLogClear_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 102, 2, 2),
...
arpInspectFilterTable = _ArpInspectFilterTable_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 102, 2, 3)
)
if mibBuilder.loadTexts:
...
arpInspectFilterEntry = _ArpInspectFilterEntry_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 102, 2, 3, 1)
)
arpInspectFilterEntry.setIndexNames(
    (0, "ZYXEL-XGS4728F-MIB", "arpInspectFilterMac"),
    (0, "ZYXEL-XGS4728F-MIB", "arpInspectFilterVid"),
)
if mibBuilder.loadTexts:
...
arpInspectFilterMac = _ArpInspectFilterMac_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 102, 2, 3, 1, 1),
...
arpInspectFilterVid = _ArpInspectFilterVid_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 102, 2, 3, 1, 2),
...
arpInspectFilterPort = _ArpInspectFilterPort_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 102, 2, 3, 1, 3),
...
arpInspectFilterExpiry = _ArpInspectFilterExpiry_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 102, 2, 3, 1, 4),
...
arpInspectFilterReason = _ArpInspectFilterReason_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 102, 2, 3, 1, 5),
...
arpInspectFilterRowStatus = _ArpInspectFilterRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 102, 2, 3, 1, 6),
...
arpInspectLogTable = _ArpInspectLogTable_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 102, 2, 4)
)
if mibBuilder.loadTexts:
...
arpInspectLogEntry = _ArpInspectLogEntry_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 102, 2, 4, 1)
)
arpInspectLogEntry.setIndexNames(
    (0, "ZYXEL-XGS4728F-MIB", "arpInspectLogMac"),
    (0, "ZYXEL-XGS4728F-MIB", "arpInspectLogVid"),
    (0, "ZYXEL-XGS4728F-MIB", "arpInspectLogPort"),
    (0, "ZYXEL-XGS4728F-MIB", "arpInspectLogIp"),
...
arpInspectLogMac = _ArpInspectLogMac_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 102, 2, 4, 1, 1),
...
arpInspectLogVid = _ArpInspectLogVid_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 102, 2, 4, 1, 2),
...
arpInspectLogPort = _ArpInspectLogPort_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 102, 2, 4, 1, 3),
...
arpInspectLogIp = _ArpInspectLogIp_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 102, 2, 4, 1, 4),
...
arpInspectLogNumPkt = _ArpInspectLogNumPkt_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 102, 2, 4, 1, 5),
...
arpInspectLogReason = _ArpInspectLogReason_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 102, 2, 4, 1, 6),
...
arpInspectLogTime = _ArpInspectLogTime_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 102, 2, 4, 1, 7),
...
arpInspectStatisticsTable = _ArpInspectStatisticsTable_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 102, 2, 5)
)
if mibBuilder.loadTexts:
...
arpInspectStatisticsEntry = _ArpInspectStatisticsEntry_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 102, 2, 5, 1)
)
arpInspectStatisticsEntry.setIndexNames(
    (0, "ZYXEL-XGS4728F-MIB", "arpInspectStatisticsVid"),
)
if mibBuilder.loadTexts:
...
arpInspectStatisticsVid = _ArpInspectStatisticsVid_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 102, 2, 5, 1, 1),
...
arpInspectStatisticsReceived = _ArpInspectStatisticsReceived_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 102, 2, 5, 1, 2),
...
arpInspectStatisticsRequest = _ArpInspectStatisticsRequest_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 102, 2, 5, 1, 3),
...
arpInspectStatisticsReply = _ArpInspectStatisticsReply_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 102, 2, 5, 1, 4),
...
arpInspectStatisticsForward = _ArpInspectStatisticsForward_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 102, 2, 5, 1, 5),
...
arpInspectStatisticsDrop = _ArpInspectStatisticsDrop_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 102, 2, 5, 1, 6),
...
arpInspectStatisticsClear = _ArpInspectStatisticsClear_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 102, 2, 5, 1, 7),
...
trTCMMode = _TrTCMMode_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 103, 2),
    _TrTCMMode_Type()
)
...
trTCMPortState = _TrTCMPortState_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 103, 3, 1, 1),
...
trTCMPortCIR = _TrTCMPortCIR_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 103, 3, 1, 2),
    _TrTCMPortCIR_Type()
)
...
trTCMPortPIR = _TrTCMPortPIR_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 103, 3, 1, 3),
    _TrTCMPortPIR_Type()
)
...
trTCMPortDscpGreen = _TrTCMPortDscpGreen_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 103, 3, 1, 4),
...
trTCMPortDscpYellow = _TrTCMPortDscpYellow_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 103, 3, 1, 5),
...
trTCMPortDscpRed = _TrTCMPortDscpRed_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 103, 3, 1, 6),
...
loopGuardPortTable = _LoopGuardPortTable_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 104, 2)
)
if mibBuilder.loadTexts:
...
loopGuardPortEntry = _LoopGuardPortEntry_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 104, 2, 1)
)
...
loopGuardPortState = _LoopGuardPortState_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 104, 2, 1, 1),
...
subnetBasedVlanState = _SubnetBasedVlanState_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 105, 1),
...
dhcpVlanOverrideState = _DhcpVlanOverrideState_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 105, 2),
...
subnetBasedVlanTable = _SubnetBasedVlanTable_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 105, 3)
)
if mibBuilder.loadTexts:
...
subnetBasedVlanEntry = _SubnetBasedVlanEntry_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 105, 3, 1)
)
subnetBasedVlanEntry.setIndexNames(
    (0, "ZYXEL-XGS4728F-MIB", "subnetBasedVlanSrcIp"),
    (0, "ZYXEL-XGS4728F-MIB", "subnetBasedVlanSrcMaskBit"),
)
if mibBuilder.loadTexts:
...
subnetBasedVlanSrcIp = _SubnetBasedVlanSrcIp_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 105, 3, 1, 1),
...
subnetBasedVlanSrcMaskBit = _SubnetBasedVlanSrcMaskBit_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 105, 3, 1, 2),
...
subnetBasedVlanName = _SubnetBasedVlanName_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 105, 3, 1, 3),
...
subnetBasedVlanVid = _SubnetBasedVlanVid_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 105, 3, 1, 4),
...
subnetBasedVlanPriority = _SubnetBasedVlanPriority_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 105, 3, 1, 5),
...
subnetBasedVlanEntryState = _SubnetBasedVlanEntryState_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 105, 3, 1, 6),
...
macAuthenticationState = _MacAuthenticationState_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 106, 1),
...
macAuthenticationNamePrefix = _MacAuthenticationNamePrefix_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 106, 2),
...
macAuthenticationPassword = _MacAuthenticationPassword_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 106, 3),
...
macAuthenticationTimeout = _MacAuthenticationTimeout_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 106, 4),
...
macAuthenticationPortTable = _MacAuthenticationPortTable_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 106, 5)
)
if mibBuilder.loadTexts:
...
macAuthenticationPortEntry = _MacAuthenticationPortEntry_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 106, 5, 1)
)
...
macAuthenticationPortState = _MacAuthenticationPortState_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 106, 5, 1, 1),
...
mstpGenCfgIdName = _MstpGenCfgIdName_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 107, 1, 2),
...
mstpGenCfgIdRevLevel = _MstpGenCfgIdRevLevel_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 107, 1, 3),
...
mstpGenCfgIdCfgDigest = _MstpGenCfgIdCfgDigest_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 107, 1, 4),
...
mstpGenHelloTime = _MstpGenHelloTime_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 107, 1, 5),
...
mstpGenMaxAge = _MstpGenMaxAge_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 107, 1, 6),
    _MstpGenMaxAge_Type()
)
...
mstpGenForwardDelay = _MstpGenForwardDelay_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 107, 1, 7),
...
mstpGenMaxHops = _MstpGenMaxHops_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 107, 1, 8),
...
mstpGenCistRootPathCost = _MstpGenCistRootPathCost_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 107, 1, 9),
...
mstpGenCistRootBrid = _MstpGenCistRootBrid_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 107, 1, 10),
...
mstMapIndex = _MstMapIndex_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 107, 20, 1, 1),
    _MstMapIndex_Type()
)
...
mstMapVlans1k = _MstMapVlans1k_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 107, 20, 1, 2),
    _MstMapVlans1k_Type()
)
...
mstMapVlans2k = _MstMapVlans2k_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 107, 20, 1, 3),
    _MstMapVlans2k_Type()
)
...
mstMapVlans3k = _MstMapVlans3k_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 107, 20, 1, 4),
    _MstMapVlans3k_Type()
)
...
mstMapVlans4k = _MstMapVlans4k_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 107, 20, 1, 5),
    _MstMapVlans4k_Type()
)
...
mstMapRowStatus = _MstMapRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 107, 20, 1, 6),
...
mstVlanIndex = _MstVlanIndex_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 107, 30, 1, 1),
    _MstVlanIndex_Type()
)
...
mstVlanMstIndex = _MstVlanMstIndex_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 107, 30, 1, 2),
...
mstpPortIndex = _MstpPortIndex_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 107, 40, 1, 1),
    _MstpPortIndex_Type()
)
...
mstpPortOperEdgePort = _MstpPortOperEdgePort_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 107, 40, 1, 2),
...
mstpPortOperPointToPointMAC = _MstpPortOperPointToPointMAC_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 107, 40, 1, 3),
...
mstpXstId = _MstpXstId_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 107, 50, 1, 1),
    _MstpXstId_Type()
)
...
mstpXstBridgePriority = _MstpXstBridgePriority_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 107, 50, 1, 2),
...
mstpXstBridgeId = _MstpXstBridgeId_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 107, 50, 1, 3),
...
mstpXstInternalRootCost = _MstpXstInternalRootCost_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 107, 50, 1, 4),
...
mstpXstRootPort = _MstpXstRootPort_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 107, 50, 1, 5),
...
mstpXstTimeSinceTopologyChange = _MstpXstTimeSinceTopologyChange_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 107, 50, 1, 6),
...
mstpXstTopologyChangesCount = _MstpXstTopologyChangesCount_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 107, 50, 1, 7),
...
mstpXstPortXstId = _MstpXstPortXstId_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 107, 60, 1, 1),
...
mstpXstPortIndex = _MstpXstPortIndex_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 107, 60, 1, 2),
...
mstpXstPortEnable = _MstpXstPortEnable_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 107, 60, 1, 3),
...
mstpXstPortPriority = _MstpXstPortPriority_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 107, 60, 1, 4),
...
mstpXstPortPathCost = _MstpXstPortPathCost_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 107, 60, 1, 5),
...
mstpXstPortState = _MstpXstPortState_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 107, 60, 1, 6),
...
mstpXstPortDesignatedRoot = _MstpXstPortDesignatedRoot_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 107, 60, 1, 7),
...
mstpXstPortDesignatedCost = _MstpXstPortDesignatedCost_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 107, 60, 1, 8),
...
mstpXstPortDesignatedBridge = _MstpXstPortDesignatedBridge_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 107, 60, 1, 9),
...
mstpXstPortDesignatedPort = _MstpXstPortDesignatedPort_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 107, 60, 1, 10),
...
radiusAuthServerMode = _RadiusAuthServerMode_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 108, 1, 1),
...
radiusAuthServerTimeout = _RadiusAuthServerTimeout_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 108, 1, 2),
...
radiusAuthServerTable = _RadiusAuthServerTable_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 108, 1, 3)
)
if mibBuilder.loadTexts:
...
radiusAuthServerEntry = _RadiusAuthServerEntry_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 108, 1, 3, 1)
)
radiusAuthServerEntry.setIndexNames(
    (0, "ZYXEL-XGS4728F-MIB", "radiusAuthServerIndex"),
)
if mibBuilder.loadTexts:
...
radiusAuthServerIndex = _RadiusAuthServerIndex_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 108, 1, 3, 1, 1),
...
radiusAuthServerIpAddr = _RadiusAuthServerIpAddr_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 108, 1, 3, 1, 2),
...
radiusAuthServerUdpPort = _RadiusAuthServerUdpPort_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 108, 1, 3, 1, 3),
...
radiusAuthServerSharedSecret = _RadiusAuthServerSharedSecret_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 108, 1, 3, 1, 4),
...
radiusAcctServerSetup = _RadiusAcctServerSetup_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 108, 2)
)
...
radiusAcctServerTimeout = _RadiusAcctServerTimeout_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 108, 2, 1),
...
radiusAcctServerTable = _RadiusAcctServerTable_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 108, 2, 2)
)
if mibBuilder.loadTexts:
...
radiusAcctServerEntry = _RadiusAcctServerEntry_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 108, 2, 2, 1)
)
radiusAcctServerEntry.setIndexNames(
    (0, "ZYXEL-XGS4728F-MIB", "radiusAcctServerIndex"),
)
if mibBuilder.loadTexts:
...
radiusAcctServerIndex = _RadiusAcctServerIndex_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 108, 2, 2, 1, 1),
...
radiusAcctServerIpAddr = _RadiusAcctServerIpAddr_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 108, 2, 2, 1, 2),
...
radiusAcctServerUdpPort = _RadiusAcctServerUdpPort_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 108, 2, 2, 1, 3),
...
radiusAcctServerSharedSecret = _RadiusAcctServerSharedSecret_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 108, 2, 2, 1, 4),
...
tacacsAuthServerMode = _TacacsAuthServerMode_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 109, 1, 1),
...
tacacsAuthServerTimeout = _TacacsAuthServerTimeout_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 109, 1, 2),
...
tacacsAuthServerTable = _TacacsAuthServerTable_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 109, 1, 3)
)
if mibBuilder.loadTexts:
...
tacacsAuthServerEntry = _TacacsAuthServerEntry_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 109, 1, 3, 1)
)
...
tacacsAuthServerIndex = _TacacsAuthServerIndex_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 109, 1, 3, 1, 1),
...
tacacsAuthServerIpAddr = _TacacsAuthServerIpAddr_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 109, 1, 3, 1, 2),
...
tacacsAuthServerTcpPort = _TacacsAuthServerTcpPort_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 109, 1, 3, 1, 3),
...
tacacsAuthServerSharedSecret = _TacacsAuthServerSharedSecret_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 109, 1, 3, 1, 4),
...
tacacsAcctServerSetup = _TacacsAcctServerSetup_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 109, 2)
)
...
tacacsAcctServerTimeout = _TacacsAcctServerTimeout_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 109, 2, 1),
...
tacacsAcctServerTable = _TacacsAcctServerTable_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 109, 2, 2)
)
if mibBuilder.loadTexts:
...
tacacsAcctServerEntry = _TacacsAcctServerEntry_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 109, 2, 2, 1)
)
tacacsAcctServerEntry.setIndexNames(
    (0, "ZYXEL-XGS4728F-MIB", "tacacsAcctServerIndex"),
)
if mibBuilder.loadTexts:
...
tacacsAcctServerIndex = _TacacsAcctServerIndex_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 109, 2, 2, 1, 1),
...
tacacsAcctServerIpAddr = _TacacsAcctServerIpAddr_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 109, 2, 2, 1, 2),
...
tacacsAcctServerTcpPort = _TacacsAcctServerTcpPort_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 109, 2, 2, 1, 3),
...
tacacsAcctServerSharedSecret = _TacacsAcctServerSharedSecret_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 109, 2, 2, 1, 4),
...
authenticationTypeEntry = _AuthenticationTypeEntry_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 110, 1, 1, 1)
)
...
authenticationTypeName = _AuthenticationTypeName_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 110, 1, 1, 1, 1),
...
authenticationTypeMethodList = _AuthenticationTypeMethodList_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 110, 1, 1, 1, 2),
...
accountingSetup = _AccountingSetup_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 110, 2)
)
...
accountingUpdatePeriod = _AccountingUpdatePeriod_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 110, 2, 1),
...
accountingTypeTable = _AccountingTypeTable_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 110, 2, 2)
)
if mibBuilder.loadTexts:
...
accountingTypeEntry = _AccountingTypeEntry_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 110, 2, 2, 1)
)
accountingTypeEntry.setIndexNames(
    (0, "ZYXEL-XGS4728F-MIB", "accountingTypeName"),
)
if mibBuilder.loadTexts:
...
accountingTypeName = _AccountingTypeName_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 110, 2, 2, 1, 1),
...
accountingTypeActive = _AccountingTypeActive_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 110, 2, 2, 1, 2),
...
accountingTypeBroadcast = _AccountingTypeBroadcast_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 110, 2, 2, 1, 3),
...
accountingTypeMode = _AccountingTypeMode_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 110, 2, 2, 1, 4),
...
accountingTypeMethod = _AccountingTypeMethod_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 110, 2, 2, 1, 5),
...
accountingTypePrivilege = _AccountingTypePrivilege_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 110, 2, 2, 1, 6),
...
authorizationTypeEntry = _AuthorizationTypeEntry_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 110, 3, 1, 1)
)
authorizationTypeEntry.setIndexNames(
    (0, "ZYXEL-XGS4728F-MIB", "authorizationTypeName"),
)
if mibBuilder.loadTexts:
...
authorizationTypeName = _AuthorizationTypeName_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 110, 3, 1, 1, 1),
...
authorizationTypeActive = _AuthorizationTypeActive_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 110, 3, 1, 1, 2),
...
authorizationTypeMethod = _AuthorizationTypeMethod_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 110, 3, 1, 1, 3),
...
portIsolationEntry = _PortIsolationEntry_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 112, 1, 1)
)
...
portIsolationState = _PortIsolationState_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 112, 1, 1, 1),
...
l2ptMacAddr = _L2ptMacAddr_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 115, 2),
    _L2ptMacAddr_Type()
)
...
l2ptProtocolGroup = _L2ptProtocolGroup_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 115, 3, 1, 1),
...
l2ptPointToPointProtocolGroup = _L2ptPointToPointProtocolGroup_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 115, 3, 1, 2),
...
l2ptMode = _L2ptMode_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 115, 3, 1, 3),
    _L2ptMode_Type()
)
...
vlanMappingPortTable = _VlanMappingPortTable_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 116, 2)
)
if mibBuilder.loadTexts:
...
vlanMappingPortEntry = _VlanMappingPortEntry_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 116, 2, 1)
)
...
vlanMappingPortState = _VlanMappingPortState_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 116, 2, 1, 1),
...
vlanMappingRuleTable = _VlanMappingRuleTable_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 116, 3)
)
if mibBuilder.loadTexts:
...
vlanMappingRuleEntry = _VlanMappingRuleEntry_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 116, 3, 1)
)
vlanMappingRuleEntry.setIndexNames(
    (0, "ZYXEL-XGS4728F-MIB", "vlanMappingRulePort"),
    (0, "ZYXEL-XGS4728F-MIB", "vlanMappingRuleVid"),
)
if mibBuilder.loadTexts:
...
vlanMappingRuleName = _VlanMappingRuleName_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 116, 3, 1, 1),
...
vlanMappingRulePort = _VlanMappingRulePort_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 116, 3, 1, 2),
...
vlanMappingRuleVid = _VlanMappingRuleVid_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 116, 3, 1, 3),
...
vlanMappingRuleTransVid = _VlanMappingRuleTransVid_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 116, 3, 1, 4),
...
vlanMappingRulePriority = _VlanMappingRulePriority_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 116, 3, 1, 5),
...
vlanMappingRuleRowStatus = _VlanMappingRuleRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 116, 3, 1, 6),
...
transceiverSerialInfoEntry = _TransceiverSerialInfoEntry_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 117, 1, 1)
)
transceiverSerialInfoEntry.setIndexNames(
    (0, "ZYXEL-XGS4728F-MIB", "transceiverSerialInfoEntryPort"),
)
if mibBuilder.loadTexts:
...
transceiverSerialInfoEntryPort = _TransceiverSerialInfoEntryPort_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 117, 1, 1, 1),
...
transceiverSerialInfoEntryStatus = _TransceiverSerialInfoEntryStatus_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 117, 1, 1, 2),
...
transceiverSerialInfoEntryVendor = _TransceiverSerialInfoEntryVendor_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 117, 1, 1, 3),
...
transceiverSerialInfoEntryPartNo = _TransceiverSerialInfoEntryPartNo_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 117, 1, 1, 4),
...
transceiverSerialInfoEntrySerialNo = _TransceiverSerialInfoEntrySerialNo_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 117, 1, 1, 5),
...
transceiverSerialInfoEntryRevision = _TransceiverSerialInfoEntryRevision_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 117, 1, 1, 6),
...
transceiverSerialInfoEntryDateCode = _TransceiverSerialInfoEntryDateCode_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 117, 1, 1, 7),
...
transceiverSerialInfoEntryTransceiver = _TransceiverSerialInfoEntryTransceiver_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 117, 1, 1, 8),
...
transceiverDdmInfoTable = _TransceiverDdmInfoTable_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 117, 2)
)
if mibBuilder.loadTexts:
...
transceiverDdmInfoEntry = _TransceiverDdmInfoEntry_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 117, 2, 1)
)
transceiverDdmInfoEntry.setIndexNames(
    (0, "ZYXEL-XGS4728F-MIB", "transceiverDdmInfoEntryPort"),
    (0, "ZYXEL-XGS4728F-MIB", "transceiverDdmInfoEntryType"),
)
if mibBuilder.loadTexts:
...
transceiverDdmInfoEntryPort = _TransceiverDdmInfoEntryPort_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 117, 2, 1, 1),
...
transceiverDdmInfoEntryType = _TransceiverDdmInfoEntryType_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 117, 2, 1, 2),
...
transceiverDdmInfoEntryAlarmMax = _TransceiverDdmInfoEntryAlarmMax_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 117, 2, 1, 3),
...
transceiverDdmInfoEntryAlarmMin = _TransceiverDdmInfoEntryAlarmMin_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 117, 2, 1, 4),
...
transceiverDdmInfoEntryWarnMax = _TransceiverDdmInfoEntryWarnMax_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 117, 2, 1, 5),
...
transceiverDdmInfoEntryWarnMin = _TransceiverDdmInfoEntryWarnMin_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 117, 2, 1, 6),
...
transceiverDdmInfoEntryCurrent = _TransceiverDdmInfoEntryCurrent_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 117, 2, 1, 7),
...
transceiverDdmInfoEntryDescription = _TransceiverDdmInfoEntryDescription_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 117, 2, 1, 8),
...
dot3OamFunctionsSupported = _Dot3OamFunctionsSupported_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 118, 2, 1, 1),
...
zyswdot1agCfmMepEntry = _Zyswdot1agCfmMepEntry_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 119, 1, 7, 1, 1)
)
...
zyswdot1agCfmMepTransmitLbmDataTlvSize = _Zyswdot1agCfmMepTransmitLbmDataTlvSize_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 119, 1, 7, 1, 1, 1),
...
vlanCounterVlanID = _VlanCounterVlanID_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 122, 1, 1, 1),
...
vlanCounterHCOctets = _VlanCounterHCOctets_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 122, 1, 1, 2),
...
vlanCounterHCPkts = _VlanCounterHCPkts_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 122, 1, 1, 3),
...
vlanCounterHCMulticastPkts = _VlanCounterHCMulticastPkts_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 122, 1, 1, 4),
...
vlanCounterHCBroadcastPkts = _VlanCounterHCBroadcastPkts_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 122, 1, 1, 5),
...
vlanCounterHCTaggedPkts = _VlanCounterHCTaggedPkts_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 122, 1, 1, 6),
...
vlanCounterHCPkts64Octets = _VlanCounterHCPkts64Octets_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 122, 1, 1, 7),
...
vlanCounterHCPkts65to127Octets = _VlanCounterHCPkts65to127Octets_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 122, 1, 1, 8),
...
vlanCounterHCPkts128to255Octets = _VlanCounterHCPkts128to255Octets_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 122, 1, 1, 9),
...
vlanCounterHCPkts256to511Octets = _VlanCounterHCPkts256to511Octets_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 122, 1, 1, 10),
...
vlanCounterHCPkts512to1023Octets = _VlanCounterHCPkts512to1023Octets_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 122, 1, 1, 11),
...
vlanCounterHCPkts1024to1518Octets = _VlanCounterHCPkts1024to1518Octets_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 122, 1, 1, 12),
...
vlanCounterHCOversizePkts = _VlanCounterHCOversizePkts_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 122, 1, 1, 13),
...
vlanCounterTimeout = _VlanCounterTimeout_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 122, 1, 1, 14),
...
vlanCounterRowStatus = _VlanCounterRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 122, 1, 1, 15),
...
privateVLANName = _PrivateVLANName_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 123, 1, 1, 1),
...
privateVLANVid = _PrivateVLANVid_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 123, 1, 1, 2),
...
privateVLANPromiscuousPorts = _PrivateVLANPromiscuousPorts_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 123, 1, 1, 3),
...
privateVLANRowStatus = _PrivateVLANRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 123, 1, 1, 4),
...
sysMemoryPoolId = _SysMemoryPoolId_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 124, 1, 1, 1),
...
sysMemoryPoolName = _SysMemoryPoolName_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 124, 1, 1, 2),
...
sysMemoryPoolTotal = _SysMemoryPoolTotal_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 124, 1, 1, 3),
...
sysMemoryPoolUsed = _SysMemoryPoolUsed_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 124, 1, 1, 4),
...
sysMemoryPoolUtil = _SysMemoryPoolUtil_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 124, 1, 1, 5),
...
eventOnTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 31, 2, 1)
)
eventOnTrap.setObjects(
      *(("ZYXEL-XGS4728F-MIB", "eventSeqNum"),
        ("ZYXEL-XGS4728F-MIB", "eventEventId"),
        ("ZYXEL-XGS4728F-MIB", "eventName"),
        ("ZYXEL-XGS4728F-MIB", "eventSetTime"),
        ("ZYXEL-XGS4728F-MIB", "eventSeverity"),
        ("ZYXEL-XGS4728F-MIB", "eventInstanceType"),
        ("ZYXEL-XGS4728F-MIB", "eventInstanceId"),
        ("ZYXEL-XGS4728F-MIB", "eventInstanceName"),
        ("ZYXEL-XGS4728F-MIB", "eventServAffective"),
        ("ZYXEL-XGS4728F-MIB", "eventDescription"),
        ("ZYXEL-XGS4728F-MIB", "trapPersistence"),
        ("ZYXEL-XGS4728F-MIB", "trapSenderNodeId"),
...
eventClearedTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 31, 2, 2)
)
eventClearedTrap.setObjects(
      *(("ZYXEL-XGS4728F-MIB", "eventSeqNum"),
        ...
        ("ZYXEL-XGS4728F-MIB", "eventInstanceType"),
        ("ZYXEL-XGS4728F-MIB", "eventInstanceId"),
        ("ZYXEL-XGS4728F-MIB", "trapRefSeqNum"),
        ("ZYXEL-XGS4728F-MIB", "trapSenderNodeId"),
        ("SNMPv2-MIB", "sysObjectID"))
)
if mibBuilder.loadTexts:
...
mrstpNewRoot = NotificationType(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 42, 2, 1)
)
mrstpNewRoot.setObjects(
    ("ZYXEL-XGS4728F-MIB", "mrstpBridgeIndex")
)
if mibBuilder.loadTexts:
...
mrstpTopologyChange = NotificationType(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 42, 2, 2)
)
...
mstpNewRoot = NotificationType(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 107, 70, 1)
)
mstpNewRoot.setObjects(
    ("ZYXEL-XGS4728F-MIB", "mstpXstId")
)
if mibBuilder.loadTexts:
...
mstpTopologyChange = NotificationType(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 46, 107, 70, 2)
)
